...
if (!/webp/.test(mime)) return m.reply(`⚠️ *Balas stiker animasi dengan perintah* \`${usedPrefix + command}\``)
...
await conn.sendFile(m.chat, result, 'tovideo.mp4', '🌷 *Berhasil mengonversi stiker ke video!*', m)
} catch (e) {
console.error(e)
