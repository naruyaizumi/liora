...
let handler = async (m, { conn, usedPrefix, command }) => {
    try {
        ...
        if (!/image\/(jpeg|png|jpg)/.test(mime)) return m.reply('❄️ *Format tidak valid! Gunakan JPG/PNG yaa~*')
        ...
        let apiUrl = global.API("btz", "/api/maker/jadiputih", { url: uploaded }, "apikey")
