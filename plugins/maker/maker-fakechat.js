...
let avatar = await conn.profilePictureUrl(q.sender, 'image').catch(_ => 'https://cloudkuimages.guru/uploads/images/cJuqy1o2.jpg') // eslint-disable-line no-unused-vars
