...
if (!m.quoted) return m.reply('⚠️ *Balas pesan gambar atau teks yang berisi error untuk diperbaiki!*')
let mediaUrl = null
...
? global.API('btz', '/api/search/bard-img', { url: mediaUrl, text: prompt + '\n\n' + text }, 'apikey')
...
console.error(e)
await conn.reply(m.chat, '💥 *Terjadi error saat memproses solusi.*\n🌸 *Coba sebentar lagi ya, sayang~*', m)
} finally {
