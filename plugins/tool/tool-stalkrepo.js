...
if (!text) return m.reply(`🍱 *Contoh penggunaan: ${usedPrefix + command} naruyaizumi liora atau ${usedPrefix + command} naruyaizumi/liora*`)
...
if (json.code !== 200 || !json.result?.items?.length) throw `🍡 *Repositori tidak ditemukan!*`
