...
if (!['enable', 'disable'].includes(mode)) 
  return m.reply(`🔥 *Format salah. Gunakan: ${usedPrefix + command } enable|disable [fitur]*`)
...
title: `${f.name} 🍘`,
description: aktif ? `🍱 Currently active` : `🍚 Currently inactive`,
...
title: `${f.name} 🍥`,
description: aktif ? `🍛 Click to disable` : `🍚 Already inactive`,
