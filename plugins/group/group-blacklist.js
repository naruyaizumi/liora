...
if (user.blacklist) return m.reply(`🍎 @${who.split("@")[0]} *sudah ada di daftar blacklist grup ini!*`, false, { mentions: [who] })
user.blacklist = true
user.blacklistTime = new Date() * 1
m.reply(`🍩 *Berhasil~*\n@${who.split("@")[0]} *telah dimasukkan ke dalam blacklist grup ini!*.`, false, { mentions: [who] })
