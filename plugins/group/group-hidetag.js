...
await conn.sendFile(m.chat, filePath, `file.${ext}`, '', m, true, { ...sendOpt, mimetype: "audio/mpeg" })
} else if (/document/.test(mime)) {
await conn.sendFile(m.chat, filePath, `file.${ext}`, finalText, m, false, { ...sendOpt, mimetype: mime })
}
