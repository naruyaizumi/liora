...
if (!q) return m.reply(`🍩 *Balas pesan yang berisi audio!*\n\n🍪 *Contoh: ${usedPrefix + command} Transkrip audio ini*`)
...
if (!response.ok) return m.reply('🍱 *Gagal memproses audio ke Bard AI. Ulangi beberapa saat lagi!*')
let json = await response.json()
let resultText = json?.result || "🍡 *Bard tidak bisa mengenali isi audio ini!*"
