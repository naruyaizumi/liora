...
if (!response.ok) return m.reply('🍜 *Terjadi kesalahan saat memproses audio. Coba lagi nanti!*')
...
await conn.sendFile(m.chat, instrumental_path, "instrumental.mp3", "", m, true, { mimetype: "audio/mpeg" })
await conn.sendFile(m.chat, vocal_path, "vocal.mp3", "", m, true, { mimetype: "audio/mpeg" })
} catch (e) {
console.error(e)
