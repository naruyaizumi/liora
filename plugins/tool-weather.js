...
let [kode, nama] = wilayahLengkap.find(([_, full]) => {
...
ctx.fill()
let logoBMKG = await loadImage('https://upload.wikimedia.org/wikipedia/commons/e/e3/BMG_2003.png')
let logoWidth = 64
...
ctx.fillText(`${lokasi.desa}, ${lokasi.kecamatan}, ${lokasi.provinsi}`, canvas.width / 2 + 20, 90)
ctx.textAlign = 'start'
...
return `🕒 *${jam} WIB*\n📍 *Wilayah ${lokasi.desa} diperkirakan akan mengalami ${w.weather_desc.toLowerCase()}.*\n`
}).join('\n')
