...
if (!/webp/.test(mime)) return m.reply(`⚠️ *Balas stiker dengan perintah* \`${usedPrefix + command}\``)
...
await conn.sendFile(m.chat, result, 'toimg.png', '🌼 *Berhasil mengonversi stiker ke gambar!*', m)
} catch (e) {
console.error(e)
