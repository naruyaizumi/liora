...
await conn.sendFile(m.chat, image, "pinterest.jpg", "🍙 *Pinterest Downloader (Image)*", m)
} else if (media_type.startsWith("video") && video) {
await conn.sendFile(m.chat, video, "pinterest.mp4", "🍙 *Pinterest Downloader (Video)*", m)
} else {
