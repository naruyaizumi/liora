...
if (!json.status || !json.result?.data) return m.reply("🍙 *Gagal memproses link Google Drive.*")
...
━━━━━━━━━━━━━━━━━━━
`.trim()
await conn.sendFile(m.chat, data, fileName, caption, m, false, { mimetype: mimetype || "application/octet-stream" })
} catch (e) {
console.error(e)
