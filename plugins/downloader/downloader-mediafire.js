...
let url = args[0]
if (!/^https:\/\/www\.mediafire\.com\/file\//i.test(url)) return m.reply("🍬 *URL tidak valid! Pastikan itu link MediaFire yang benar ya~*")
try {
...
━━━━━━━━━━━━━━━━━━━
`.trim()
await conn.sendFile(m.chat, download_url, filename, text, m, false, { mimetype: mimetype || "application/octet-stream" })
} catch (e) {
console.error(e)
