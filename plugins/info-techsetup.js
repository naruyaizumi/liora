...
const TECH_SETUP_ENDPOINT = '/api/tech/setup'
...
let res = await fetch(`${BASE_URL}${TECH_SETUP_ENDPOINT}?page=${page}`)
...
throw new Error('Tidak ada artikel Tech Setup ditemukan')
}
...
▸ *Kategori:* ${article.category || 'Tech Setup'}
...
`*🛠 TECH SETUP - HALAMAN ${page}*\n\n${formattedArticles}\n\nGunakan *${usedPrefix}${command} <page>* untuk halaman lainnya`,
m, {
contextInfo: {
externalAdReply: {
title: `Tech Setup - Page ${page}`,
body: "Panduan dan diskusi teknologi",
...
console.error('Error fetching Tech Setup:', error)
...
externalAdReply: {
title: "Error System",
body: "Tech Setup tidak tersedia",
...
handler.help = ['techsetup']
handler.tags = ['info']
handler.command = /^(techsetup|setup)$/i
