...
tags = { 'ai': '🧠 AI Menu' }
if (teks == 'downloader')
tags = { 'downloader': '🍥 Downloader Menu' }
if (teks == 'group')
tags = { 'group': '🧃 Grup Menu' }
if (teks == 'info')
tags = { 'info': '📖 Info Menu' }
if (teks == 'internet')
tags = { 'internet': '💌 Internet Menu' }
if (teks == 'maker')
tags = { 'maker': '🎀 Maker Menu' }
if (teks == 'owner')
tags = { 'owner': '🪄 Owner Menu' }
if (teks == 'islam')
tags = { 'islam': '🍃️ Islami Menu' }
if (teks == 'server')
tags = { 'server': '🖥️ Server Menu' }
if (teks == 'tools')
tags = { 'tools': '🧸 Tools Menu' }
let name = conn.getName(m.sender)
let status = isMods ? '🧁 Developer' : isOwner ? '🪄 Owmer' : isPrems ? '💖 Ptemium User' : '🍬 Free User'
...
const messages = {
0: ['🍩 Udah tengah malam, bobo yuk~', '🧁 Jangan begadang, sayangin badanmu~', '🍓 Malem sunyi, enaknya tidur~'],
