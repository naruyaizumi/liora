...
import bind from "./storage/store.js";
        ...
        */
                ...
                if (orderData.thumbnail) {
                    if (Buffer.isBuffer(orderData.thumbnail)) {
                        ...
                        try {
                            ...
                            this.logger?.warn({ err: e.message },
        ...
        sendButton: {
            async value(jid, content = {}, options = {}) {
                ...
                if (externalAdReply && typeof externalAdReply ===
                    "object") {
