...
export function smsg(conn, m) {
    ...
    try {
        ...
        if (m.mtype === "protocolMessage" && m.msg?.key) {
            ...
            if ((!key.participant || key.participant === "status_me") && m.sender) key.participant = m.sender;
        ...
        if (m.quoted && !m.quoted.mediaMessage && typeof m.quoted.download !== "undefined") delete m.quoted.download;
