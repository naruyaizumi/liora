...
export async function canvas(avatarUrl) {
  const cfg = {
    ...
    desc:  { text: "© 2024 - 2025 Naruya Izumi", color: "#FFFFFF", size: 14, shadow: false },
    overlayOpacity: 0.30,
    cardStroke: "#000000",
    cardStrokeWidth: 2,
  ...
  roundedRectPath(ctx, cfg.cardStrokeWidth / 2, cfg.cardStrokeWidth / 2, W - cfg.cardStrokeWidth, H - cfg.cardStrokeWidth, R - 1)
  ctx.stroke()
  ctx.restore()
