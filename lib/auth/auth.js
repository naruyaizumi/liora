...
export function PostgresAuth(_databaseUrl, _options = {}) {
    ...
    async function saveCreds() {
        try {
            ...
            logger.error({ err: e.message, stack: e.stack }, "saveCreds error");
            return false;
        }
    }
    ...
    async function transaction(work) {
        ...
        try {
            ...
            logger.error({ err: e.message, stack: e.stack }, "Transaction work failed");
            throw e;
        }
    }
    ...
    initPromise = initCreds().catch((e) => {
        logger.error({ err: e.message, stack: e.stack }, "Failed to initialize credentials");
        creds = ensureCredsStructure(initAuthCreds());
        initialized = true;
    });
