 ...
 * for Liora bot with environment-based configuration.
 * @license Apache-2.0
 * @author Naruya Izumi
 */
...
const initializeConfig = () => {
    ...
    const config = {
        ...
        printMessage: parseBoolean(Bun.env.PRINT_MESSAGE, true),
        autoRead: parseBoolean(Bun.env.AUTOREAD, false),
        development: parseBoolean(Bun.env.DEVELOPMENT, false),
        prefix: prefix,
    };
