...
class Retrier {
    ...
    #o;
    #c;
    constructor(e, { timeout: t = 6e4, maxDelay: r = 100, concurrency: i = 1e3 } = {}) {
        if ("function" != typeof e) throw new Error("Missing function to check errors");
    ...
    retry(e, { signal: t } = {}) {
        ...
        return (
            this.#t.push(() => this.#a(e, { signal: t, promise: r, resolve: i, reject: s })),
            this.#h(),
            r
        );
    }
    ...
    #h() {
        e(`Processing pending tasks: ${this.pending} pending, ${this.working} working.`);
        ...
        e(`Processed pending tasks: ${this.pending} pending, ${this.working} working.`);
    }
    #g() {
        (clearTimeout(this.#n),
            (this.#n = void 0),
            e(`Processing retry queue: ${this.retrying} retrying, ${this.working} working.`));
        const t = () => {
        ...
        return r
            ? (function (e, t) {
                ...
                ? (e(`Task ${r.id} was abandoned due to timeout.`), r.reject(r.error), void t())
                : (function (e, t) {
                  ...
                  : (e(`Task ${r.id} is not ready to retry, skipping.`), this.#e.push(r), void t())
