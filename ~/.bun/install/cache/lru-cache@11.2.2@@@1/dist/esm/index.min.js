...
var G = a => !x.has(a),
  ...
  L = class a {
    ...
    constructor(t) {
      ...
      if (v !== void 0 && typeof v?.now != 'function')
        throw new TypeError(
          'perf option must have a now() method if specified',
        )
      if (((this.#S = v ?? M), e !== 0 && !y(e)))
        throw new TypeError(
      ...
      ;((this.#d = t),
        ...
        (this.#j = (n, h, o = this.#S.now()) => {
          if (
            ...
            let r = setTimeout(() => {
              this.#g(n) && this.#E(this.#i[n], 'expire')
            }, h + 1)
            r.unref && r.unref()
          }
        }),
    ...
    *rvalues() {
    ...
    purgeStale() {
      ...
      for (let e of this.#T({ allowStale: !0 }))
        this.#g(e) && (this.#E(this.#i[e], 'expire'), (t = !0))
      return t
    }
    info(t) {
      let e = this.#s.get(t)
    ...
    set(t, e, i = {}) {
      ...
      if (f === void 0)
        ...
        if (e !== u) {
          ...
          if ((this.#R(f), this.#I(f, m, r), (this.#t[f] = e), r)) {
            r.set = 'replace'
      ...
      if (
        (s !== 0 && !this.#d && this.#G(),
        this.#d && (p || this.#j(f, s, n), r && this.#O(r, f)),
        !h && this.#f && this.#r)
      ) {
        let u = this.#r,
          d
    ...
    has(t, e = {}) {
      ...
      if (n !== void 0) {
        ...
        if (this.#g(n)) s && ((s.has = 'stale'), this.#O(s, n))
        else
          return (
            i && this.#C(n),
            s && ((s.has = 'hit'), this.#O(s, n)),
            !0
          )
      } else s && (s.has = 'miss')
      return !1
    ...
    async fetch(t, e = {}) {
      ...
      if (c === void 0) {
        ...
        let S = this.#t[c]
        if (this.#e(S)) {
          let E = i && S.__staleWhileFetching !== void 0
          return (
            l &&
              ((l.fetch = 'inflight'), E && (l.returnedStale = !0)),
