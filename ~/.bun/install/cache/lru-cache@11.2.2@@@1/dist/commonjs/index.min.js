...
var M =
  ...
  U = (a, t, e, i) => {
    typeof R.emitWarning == 'function' ?
      R.emitWarning(a, t, e, i)
    : console.error(`[${e}] ${t}: ${a}`)
  },
...
if (typeof C > 'u') {
  ...
  let a = R.env?.LRU_CACHE_IGNORE_AC_WARNING !== '1',
    t = () => {
      a &&
        ((a = !1),
        U(
...
var G = a => !x.has(a),
  ...
  D = class a {
    ...
    constructor(t) {
      ...
      if (z !== void 0 && typeof z?.now != 'function')
        throw new TypeError(
          'perf option must have a now() method if specified',
        )
      if (((this.#S = z ?? M), e !== 0 && !y(e)))
        throw new TypeError(
      ...
      if (w !== void 0 && typeof w != 'function')
        throw new TypeError(
          'memoMethod must be a function if defined',
        )
      if (((this.#L = w), l !== void 0 && typeof l != 'function'))
        throw new TypeError(
      ...
      if (
        ...
        (this.#n = 0),
        (this.#_ = 0),
        typeof p == 'function' && (this.#p = p),
        typeof m == 'function' && (this.#z = m),
        typeof f == 'function' ?
          ((this.#w = f), (this.#r = []))
    ...
    #G() {
      ...
      ;((this.#d = t),
        (this.#y = e),
        (this.#j = (n, h, o = this.#S.now()) => {
          if (
            ((e[n] = h !== 0 ? o : 0),
            (t[n] = h),
            h !== 0 && this.ttlAutopurge)
          ) {
            let r = setTimeout(() => {
    ...
    #V() {
      ...
      ;((this.#_ = 0),
        ...
        (this.#U = (e, i, s) => {
          if (((t[e] = i), this.#c)) {
            let n = this.#c - t[e]
            for (; this.#_ > n; ) this.#I(!0)
          }
          ;((this.#_ += t[e]),
            s &&
              ((s.entrySize = i), (s.totalCalculatedSize = this.#_)))
        }))
    }
    #R = t => {}
    #U = (t, e, i) => {}
    ...
    *rvalues() {
    ...
    set(t, e, i = {}) {
      ...
      let {
        ...
        { noUpdateTTL: p = this.noUpdateTTL } = i,
        m = this.#N(t, e, i.size || 0, o)
      ...
      if (f === void 0)
        ((f =
          this.#n === 0 ? this.#h
          : this.#m.length !== 0 ? this.#m.pop()
          : this.#n === this.#l ? this.#I(!1)
          : this.#n),
          (this.#i[f] = t),
          (this.#t[f] = e),
          this.#s.set(t, f),
        ...
        if (e !== u) {
          if (this.#v && this.#e(u)) {
            ...
            let { __staleWhileFetching: d } = u
            d !== void 0 &&
              !h &&
              (this.#A && this.#p?.(d, t, 'set'),
              this.#f && this.#r?.push([d, t, 'set']))
          } else
            h ||
              (this.#A && this.#p?.(u, t, 'set'),
              this.#f && this.#r?.push([u, t, 'set']))
          if ((this.#R(f), this.#U(f, m, r), (this.#t[f] = e), r)) {
            r.set = 'replace'
            let d = u && this.#e(u) ? u.__staleWhileFetching : u
            d !== void 0 && (r.oldValue = d)
          }
        } else r && (r.set = 'update')
        this.#x &&
          this.onInsert?.(e, t, e === u ? 'update' : 'replace')
      }
      if (
        (s !== 0 && !this.#d && this.#G(),
        this.#d && (p || this.#j(f, s, n), r && this.#E(r, f)),
        !h && this.#f && this.#r)
      ) {
        let u = this.#r,
          d
        for (; (d = u?.shift()); ) this.#w?.(...d)
      }
      return this
    }
    pop() {
    ...
    #I(t) {
      ...
      return (
        ...
        t &&
          ...
          this.#m.push(e)),
        this.#n === 1 ?
          ((this.#o = this.#h = 0), (this.#m.length = 0))
        : (this.#o = this.#a[e]),
        this.#s.delete(i),
        this.#n--,
        e
    ...
    has(t, e = {}) {
      ...
      if (n !== void 0) {
        ...
        if (this.#g(n)) s && ((s.has = 'stale'), this.#E(s, n))
        else
          return (
            i && this.#C(n),
            s && ((s.has = 'hit'), this.#E(s, n)),
            !0
          )
      } else s && (s.has = 'miss')
      return !1
      ...
      let r = { signal: h.signal, options: i, context: s },
        ...
        m = g => (
          i.status &&
            ...
            (i.status.fetchError = g)),
          f(g)
        ),
        f = g => {
          let { aborted: _ } = h.signal,
            l = _ && i.allowStaleOnFetchAbort,
            w = l || i.allowStaleOnFetchRejection,
            b = w || i.noDeleteOnFetchRejection,
            c = d
          if (
            (this.#t[e] === d &&
              (!b || c.__staleWhileFetching === void 0 ?
                this.#O(t, 'fetch')
              : l || (this.#t[e] = c.__staleWhileFetching)),
            w)
          )
            return (
              i.status &&
        ...
        u = (g, _) => {
          ...
          ;(l &&
            ...
            l.then(w => g(w === void 0 ? void 0 : w), _),
            h.signal.addEventListener('abort', () => {
              ;(!i.ignoreFetchAbort || i.allowStaleOnFetchAbort) &&
                (g(void 0),
                i.allowStaleOnFetchAbort && (g = w => p(w, !0)))
            }))
        }
      i.status && (i.status.fetchDispatched = !0)
      let d = new Promise(u).then(p, m),
        A = Object.assign(d, {
          __abortController: h,
    ...
    async fetch(t, e = {}) {
      let {
        ...
        allowStaleOnFetchRejection: u = this
          .allowStaleOnFetchRejection,
      ...
      if (c === void 0) {
        l && (l.fetch = 'miss')
        let S = this.#M(t, c, b, g)
        return (S.__returned = S)
      } else {
        let S = this.#t[c]
        if (this.#e(S)) {
          let O = i && S.__staleWhileFetching !== void 0
          return (
            l &&
              ((l.fetch = 'inflight'), O && (l.returnedStale = !0)),
            O ? S.__staleWhileFetching : (S.__returned = S)
          )
        }
        let v = this.#g(c)
        if (!_ && !v)
        ...
        let F = this.#M(t, c, b, g),
          T = F.__staleWhileFetching !== void 0 && i
        return (
          l &&
            ((l.fetch = v ? 'stale' : 'refresh'),
            T && v && (l.returnedStale = !0)),
          T ? F.__staleWhileFetching : (F.__returned = F)
        )
      }
    }
