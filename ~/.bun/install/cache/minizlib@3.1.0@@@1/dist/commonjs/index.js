...
exports.ZstdDecompress =
  exports.ZstdCompress =
...
class ZlibBase extends minipass_1.Minipass {
  ...
  write(chunk, encoding, cb) {
    ...
    if (this.#handle)
      this.#handle.on('error', er =>
        this.#onError(new ZlibError(er, this.write)),
      )
    let writeReturn
    if (result) {
...
class Zstd extends ZlibBase {
  constructor(opts, mode) {
    ...
    opts.finishFlush =
      opts.finishFlush || constants_js_1.constants.ZSTD_e_end
