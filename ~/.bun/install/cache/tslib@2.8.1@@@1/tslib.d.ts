 ...
 * @experimental
 */
export declare function __decorate(
    decorators: Function[],
    target: any,
    key?: string | symbol,
    desc?: any
 ...
 */
export declare function __esDecorate(
    ctor: Function | null,
    descriptorIn: object | null,
    decorators: Function[],
    contextIn: object,
    initializers: Function[] | null,
 ...
 */
export declare function __runInitializers(
    thisArg: unknown,
 ...
 */
export declare function __setFunctionName(
    f: Function,
    name: string | symbol,
    prefix?: string
): Function;
 ...
 * @throws {TypeError} If `state` doesn't have an entry for `receiver`.
 */
export declare function __classPrivateFieldGet<
    T extends object,
    V extends (...args: any[]) => unknown,
>(receiver: T, state: { has(o: T): boolean }, kind: "m", f: V): V;
...
export declare function __classPrivateFieldGet<
    ...
    V extends (...args: any[]) => unknown,
>(receiver: T, state: T, kind: "m", f: V): V;
 ...
 */
export declare function __createBinding(
    object: object,
    target: object,
    key: PropertyKey,
...
export declare function __addDisposableResource<T>(
    env: {
        stack: { value?: unknown; dispose?: Function; async: boolean }[];
        error: unknown;
        hasError: boolean;
    },
    value: T,
 ...
 */
export declare function __disposeResources(env: {
    stack: { value?: unknown; dispose?: Function; async: boolean }[];
    error: unknown;
    hasError: boolean;
}): any;
