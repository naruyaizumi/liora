...
function isLargeIdStart(cp) {
    return isInRange(
        cp,
        largeIdStartRanges !== null && largeIdStartRanges !== void 0
            ? largeIdStartRanges
...
function isLargeIdContinue(cp) {
    return isInRange(
        cp,
        largeIdContinueRanges !== null && largeIdContinueRanges !== void 0
...
class DataSet {
    ...
    get es2018() {
        var _a;
        return (_a = this._set2018) !== null && _a !== void 0
            ? _a
            : (this._set2018 = new Set(this._raw2018.split(" ")));
    }
    get es2019() {
        var _a;
        return (_a = this._set2019) !== null && _a !== void 0
            ? _a
            : (this._set2019 = new Set(this._raw2019.split(" ")));
    }
    get es2020() {
        var _a;
        return (_a = this._set2020) !== null && _a !== void 0
            ? _a
            : (this._set2020 = new Set(this._raw2020.split(" ")));
    }
    get es2021() {
        var _a;
        return (_a = this._set2021) !== null && _a !== void 0
            ? _a
            : (this._set2021 = new Set(this._raw2021.split(" ")));
    }
    get es2022() {
        var _a;
        return (_a = this._set2022) !== null && _a !== void 0
            ? _a
            : (this._set2022 = new Set(this._raw2022.split(" ")));
    }
    get es2023() {
        var _a;
        return (_a = this._set2023) !== null && _a !== void 0
            ? _a
            : (this._set2023 = new Set(this._raw2023.split(" ")));
    }
    get es2024() {
        var _a;
        return (_a = this._set2024) !== null && _a !== void 0
            ? _a
            : (this._set2024 = new Set(this._raw2024.split(" ")));
    }
    get es2025() {
        var _a;
        return (_a = this._set2025) !== null && _a !== void 0
            ? _a
            : (this._set2025 = new Set(this._raw2025.split(" ")));
    }
    get es2026() {
        var _a;
        return (_a = this._set2026) !== null && _a !== void 0
            ? _a
            : (this._set2026 = new Set(this._raw2026.split(" ")));
    }
}
...
class BranchID {
    ...
    separatedFrom(other) {
        ...
        return (_b =
            (_a = this.parent) === null || _a === void 0 ? void 0 : _a.separatedFrom(other)) !==
            null && _b !== void 0
            ? _b
            : false;
    }
...
const FLAG_CODEPOINT_TO_PROP = Object.fromEntries(
...
function isRegularExpressionModifier(ch) {
    return (
        ch === LATIN_SMALL_LETTER_I || ch === LATIN_SMALL_LETTER_M || ch === LATIN_SMALL_LETTER_S
    );
}
class RegExpValidator {
    ...
    raise(message, context) {
        ...
        throw newRegExpSyntaxError(
            ...
            {
                unicode:
                    (_a = context === null || context === void 0 ? void 0 : context.unicode) !==
                        null && _a !== void 0
                        ? _a
                        : this._unicodeMode && !this._unicodeSetsMode,
                unicodeSets:
                    (_b = context === null || context === void 0 ? void 0 : context.unicodeSets) !==
                        null && _b !== void 0
                        ? _b
                        : this._unicodeSetsMode,
            },
            (_c = context === null || context === void 0 ? void 0 : context.index) !== null &&
                _c !== void 0
                ? _c
                : this.index,
            message
    ...
    consumeTerm() {
        if (this._unicodeMode || this.strict) {
            return (
                this.consumeAssertion() || (this.consumeAtom() && this.consumeOptionalQuantifier())
            );
        }
        return (
            (this.consumeAssertion() &&
                (!this._lastAssertionIsQuantifiable || this.consumeOptionalQuantifier())) ||
        ...
        if (hasHyphen) {
            ...
            for (const [flagName] of Object.entries(modifiers).filter(([, enable]) => enable)) {
                if (addModifiers[flagName]) {
                    this.raise(
                        `Duplicated flag '${String.fromCodePoint(FLAG_PROP_TO_CODEPOINT[flagName])}'`
                    );
                }
            }
    ...
    consumeCharacterClassEscape() {
        ...
        if (
            ...
            (this.eat(LATIN_SMALL_LETTER_P) || (negate = this.eat(LATIN_CAPITAL_LETTER_P)))
        ) {
            this._lastIntValue = -1;
            let result = null;
            if (
                ...
                this.onUnicodePropertyCharacterSet(
                    ...
                    result.value,
                    negate,
                    (_a = result.strings) !== null && _a !== void 0 ? _a : false
                );
    ...
    consumeCharacterEscape() {
        ...
        if (
            ...
            (!this.strict && !this._unicodeMode && this.eatLegacyOctalEscapeSequence()) ||
...
class RegExpParserState {
    constructor(options) {
        ...
        this.ecmaVersion =
            (_a = options === null || options === void 0 ? void 0 : options.ecmaVersion) !== null &&
            _a !== void 0
                ? _a
                : latestEcmaVersion;
    }
    ...
    onUnicodePropertyCharacterSet(start, end, kind, key, value, negate, strings) {
        ...
        if (strings) {
            ...
            parent.elements.push(
                Object.assign(Object.assign({}, base), { parent, strings, value, negate })
            );
        } else {
            parent.elements.push(
                Object.assign(Object.assign({}, base), { parent, strings, value, negate })
    ...
    onCharacterClassEnter(start, negate, unicodeSets) {
        ...
        if (parent.type === "Alternative") {
            ...
            const node = Object.assign(Object.assign({}, base), { parent, unicodeSets });
            this._node = node;
            parent.elements.push(node);
        } else {
            throw new Error("UnknownError");
    ...
    onCharacterClassLeave(start, end) {
        ...
        if (
            node.type !== "CharacterClass" ||
            (node.parent.type !== "Alternative" && node.parent.type !== "CharacterClass")
        ) {
            throw new Error("UnknownError");
        }
    ...
    onClassIntersection(start, end) {
        ...
        const left =
            (_a = this._expressionBufferMap.get(parent)) !== null && _a !== void 0
                ? _a
                : parent.elements.pop();
        if (
            !left ||
