...
declare module "@eslint-community/regexpp/ast" {
     ...
     * E.g. `[ab]`, `[^ab]`
     */
    export type CharacterClass = ClassRangesCharacterClass | UnicodeSetsCharacterClass;
    ...
    export interface EscapeCharacterSet extends NodeBase {
        type: "CharacterSet";
        parent: Alternative | CharacterClass | ClassIntersection | ClassSubtraction | Quantifier;
    ...
    export interface CharacterUnicodePropertyCharacterSet extends BaseUnicodePropertyCharacterSet {
        strings: false;
        value: string | null;
        negate: boolean;
    }
    /** StringsUnicodePropertyCharacterSet is Unicode property escape with property of strings. */
    export interface StringsUnicodePropertyCharacterSet extends BaseUnicodePropertyCharacterSet {
        parent:
            | Alternative
            | ClassIntersection
            | ClassSubtraction
...
declare module "@eslint-community/regexpp/validator" {
    ...
    export namespace RegExpValidator {
        ...
        interface Options {
             ...
             */
            onCharacterClassEnter?: (start: number, negate: boolean, unicodeSets: boolean) => void;
            /**
             ...
             * @param index The 0-based index of alternatives in a disjunction.
             */
            onStringAlternativeLeave?: (start: number, end: number, index: number) => void;
        }
    }
    /**
...
declare module "@eslint-community/regexpp/visitor" {
    ...
    export namespace RegExpVisitor {
        interface Handlers {
            ...
            onExpressionCharacterClassEnter?: (node: ExpressionCharacterClass) => void;
            onExpressionCharacterClassLeave?: (node: ExpressionCharacterClass) => void;
