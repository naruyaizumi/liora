 ...
 */
export declare function copyArrayBuffer<Value extends ArrayBuffer>(
    arrayBuffer: Value,
    _state: State
): Value;
/**
...
declare function copyObjectLooseModern<Value extends Record<string, any>>(
    object: Value,
    state: State
): Value;
/**
 ...
 */
export declare function copyObjectStrict<Value extends Record<string, any>>(
    object: Value,
    state: State
): Value;
/**
