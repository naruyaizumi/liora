        ...
        /* end of prelude */ {
                ...
                function (require, module, exports) {
                    ...
                    function common(name, json) {
                        if (!commonRe.test(name)) {
                            ...
                            json = {
                                nested: { google: { nested: { protobuf: { nested: json } } } },
                            };
                        }
                        common[name] = json;
                    }
                    ...
                    Enum.prototype._resolveFeatures = function _resolveFeatures(edition) {
                        ...
                        Object.keys(this.values).forEach((key) => {
                            ...
                            this._valuesFeatures[key] = Object.assign(
                                parentFeaturesCopy,
                                this.valuesOptions &&
                                    this.valuesOptions[key] &&
                                    this.valuesOptions[key].features
                            );
                        });
            ...
            16: [
                function (require, module, exports) {
                    ...
                    Object.defineProperty(Field.prototype, "delimited", {
                        get: function () {
                            return (
                                this.resolvedType instanceof Type &&
                    ...
                    Field.prototype.resolve = function resolve() {
                        ...
                        if ((this.typeDefault = types.defaults[this.type]) === undefined) {
                            ...
                            if (this.resolvedType instanceof Type)
                                this.typeDefault = null; // instanceof Enum
                            else
                                this.typeDefault =
                     ...
                     */
                    Field.prototype._inferLegacyProtoFeatures = function _inferLegacyProtoFeatures(
                        edition
                    ) {
                    ...
                    Field.prototype._resolveFeatures = function _resolveFeatures(edition) {
                        return ReflectionObject.prototype._resolveFeatures.call(
                            this,
            ...
            23: [
                function (require, module, exports) {
                     ...
                     * @override
                     */
                    Namespace.prototype._resolveFeaturesRecursive =
                        function _resolveFeaturesRecursive(edition) {
                            if (!this._needsRecursiveFeatureResolution) return this;
                            this._needsRecursiveFeatureResolution = false;

                            edition = this._edition || edition;

                            ReflectionObject.prototype._resolveFeaturesRecursive.call(
                                this,
                                edition
                            );
                    ...
                    Namespace.prototype.lookup = function lookup(
                        ...
                        var found =
                            ...
                            this.root._fullyQualifiedObjects["." + flatPath];
                        if (
                            found &&
                            (!filterTypes || filterTypes.indexOf(found.constructor) > -1)
                        ) {
                            return found;
                        }
            ...
            24: [
                function (require, module, exports) {
                     ...
                     * @returns {ReflectionObject} `this`
                     */
                    ReflectionObject.prototype._resolveFeaturesRecursive =
                        function _resolveFeaturesRecursive(edition) {
                     ...
                     * @returns {object} The feature values to override
                     */
                    ReflectionObject.prototype._inferLegacyProtoFeatures =
                        function _inferLegacyProtoFeatures(/*edition*/) {
                            return {};
                        };
                ...
                function (require, module, exports) {
                    ...
                    Object.defineProperty(OneOf.prototype, "isProto3Optional", {
                        get: function () {
                            ...
                            return (
                                field.options != null && field.options["proto3_optional"] === true
                            );
                        },
                    });
                    ...
                    function parse(source, root, options) {
                        ...
                        function parseEnumValue(parent, token) {
                            ...
                            parent.add(
                                ...
                                value,
                                dummy.comment,
                                dummy.parsedOptions || dummy.options
                            );
                        }
                        ...
                        function parseOption(parent, token) {
                            ...
                            propName =
                                propName && propName[0] === "." ? propName.slice(1) : propName;
                            option =
            ...
            33: [
                function (require, module, exports) {
                     ...
                     * @override
                     */
                    Service.prototype._resolveFeaturesRecursive =
                        function _resolveFeaturesRecursive(edition) {
                            if (!this._needsRecursiveFeatureResolution) return this;
            ...
            35: [
                function (require, module, exports) {
                     ...
                     * @override
                     */
                    Type.prototype._resolveFeaturesRecursive = function _resolveFeaturesRecursive(
                        edition
                    ) {
                        if (!this._needsRecursiveFeatureResolution) return this;
