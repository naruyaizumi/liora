    ...
    !(function (r, e, t) {
    ...
    })(
        {
                ...
                function (t, i, n) {
                    ...
                    n.encode = function (t, i, n) {
                        for (var r, e = null, s = [], o = 0, u = 0; i < n; ) {
                            ...
                            8191 < o &&
                                ((e = e || []).push(String.fromCharCode.apply(String, s)), (o = 0));
                        }
                        return (
                            u && ((s[o++] = h[r]), (s[o++] = 61), 1 === u && (s[o++] = 61)),
                            e
                                ? (o && e.push(String.fromCharCode.apply(String, s.slice(0, o))),
                                  e.join(""))
            ...
            3: [
                function (t, i, n) {
                    function c(i, n) {
                        "string" == typeof i && ((n = i), (i = rt));
                        var f = [];
                        function h(t) {
                            if ("string" != typeof t) {
                                var i = a();
                                if (
                                    (c.verbose && console.log("codegen: " + i),
                                    (i = "return " + i),
                                    t)
                                ) {
                                    for (
            ...
            4: [
                function (t, i, n) {
                    ...
                    (((i.exports = r).prototype.on = function (t, i, n) {
                        return (
                            (this.i[t] || (this.i[t] = [])).push({ fn: i, ctx: n || this }),
                            this
                        );
                    }),
                        (r.prototype.off = function (t, i) {
                            if (t === rt) this.i = {};
                            else if (i === rt) this.i[t] = [];
                            else
            ...
            8: [
                function (t, i, n) {
                    ...
                    n.resolve = function (t, i, n) {
                        return (
                            n || (i = r(i)),
                            !e(i) && (t = (t = n ? t : r(t)).replace(/(?:\/|^)[^/]+$/, "")).length
                                ? r(t + "/" + i)
                                : i
                        );
                    };
                            ...
                            for (var r, e, s = n, o = 0; o < t.length; ++o)
                                (r = t.charCodeAt(o)) < 128
                                    ...
                                    : (r < 2048
                                          ? (i[n++] = (r >> 6) | 192)
                                          : (55296 == (64512 & r) &&
                                            56320 == (64512 & (e = t.charCodeAt(o + 1)))
                                                ? (++o,
                                                  (i[n++] =
                                                      ((r =
                                                          65536 +
                    ...
                    function o(t, i, n, r) {
                        ...
                        if (i.resolvedType)
                            if (i.resolvedType instanceof l) {
                                t("switch(d%s){", r);
                                for (
                                    var s = i.resolvedType.values, o = Object.keys(s), u = 0;
                                    u < o.length;
                                    ++u
                                )
                                    (s[o[u]] !== i.typeDefault ||
                    ...
                    ((n.fromObject = function (t) {
                        ...
                        (n.toObject = function (t) {
                            ...
                            for (
                                ...
                                i[o].partOf ||
                                    (i[o].resolve().repeated ? r : i[o].map ? e : s).push(i[o]);
                            if (r.length) {
                            ...
                            (i("case %i: {", r.id),
                                r.map
                                    ? (i("if(%s===util.emptyObject)", s)("%s={}", s)(
                                      ...
                                      f.defaults[r.keyType] !== rt
                                          ? i("k=%j", f.defaults[r.keyType])
                                          : i("k=null"),
                                      f.defaults[e] !== rt
                                          ? i("value=%j", f.defaults[e])
                                          : i("value=null"),
            ...
            14: [
                function (t, i, n) {
                    i.exports = function (t) {
                        for (
                            var i,
                                n = c.codegen(["m", "w"], t.name + "$encode")("if(!w)")(
                                    "w=Writer.create()"
                                ),
            ...
            15: [
                function (t, i, n) {
                    ...
                    var f = t(24),
                        r =
                            ((((s.prototype = Object.create(f.prototype)).constructor =
                                s).className = "Enum"),
                            t(23)),
                        e = t(37);
                    function s(t, i, n, r, e, s) {
                        if ((f.call(this, t, n), i && "object" != typeof i))
                        ...
                        if (
                            ...
                            for (var o = Object.keys(i), u = 0; u < o.length; ++u)
                                "number" == typeof i[o[u]] &&
                                    (this.valuesById[(this.values[o[u]] = i[o[u]])] = o[u]);
                    }
                    ((s.prototype.u = function (t) {
                        return (
                            ...
                            Object.keys(this.values).forEach((t) => {
                                var i = Object.assign({}, this.h);
                                this.o[t] = Object.assign(
                                    i,
                                    this.valuesOptions &&
                                        this.valuesOptions[t] &&
                                        this.valuesOptions[t].features
                                );
                            }),
                            this
                        );
                        ...
                        (s.fromJSON = function (t, i) {
                            ...
                            return (
                                (t.reserved = i.reserved),
                                i.edition && (t.f = i.edition),
                                (t.a = "proto3"),
                                t
                            );
                        }),
                        (s.prototype.toJSON = function (t) {
                            ...
                            return e.toObject([
                                ...
                                this.values,
                                "reserved",
                                this.reserved && this.reserved.length ? this.reserved : rt,
                                "comment",
                                t ? this.comment : rt,
                                "comments",
                                t ? this.comments : rt,
                        ...
                        (s.prototype.add = function (t, i, n, r) {
                            ...
                            return (
                                r &&
                                    (this.valuesOptions === rt && (this.valuesOptions = {}),
            ...
            16: [
                function (t, i, n) {
                    ...
                    var r,
                        u = t(24),
                        e =
                            ((((o.prototype = Object.create(u.prototype)).constructor =
                                o).className = "Field"),
                            t(15)),
                        f = t(36),
                        h = t(37),
                    ...
                    function o(t, i, n, r, e, s, o) {
                        if (
                            (h.isObject(r)
                                ? ((o = e), (s = r), (r = e = rt))
                                : h.isObject(e) && ((o = s), (s = e), (e = rt)),
                            u.call(this, t, s),
                            !h.isInteger(i) || i < 0)
                        )
                            throw TypeError("id must be a non-negative integer");
                        if (!h.isString(n)) throw TypeError("type must be a string");
                        if (r !== rt && !a.test((r = r.toString().toLowerCase())))
                            throw TypeError("rule must be a string rule");
                        if (e !== rt && !h.isString(e)) throw TypeError("extend must be a string");
                        ((this.rule =
                    ...
                    ((o.fromJSON = function (t, i) {
                        ...
                        return (i.edition && (t.f = i.edition), (t.a = "proto3"), t);
                    }),
                        ...
                        Object.defineProperty(o.prototype, "delimited", {
                            get: function () {
                                return (
                                    ...
                                    "DELIMITED" === this.h.message_encoding
                                );
                            },
                        }),
                            ...
                            get: function () {
                                return (
                                    ...
                                    (this.partOf ||
                                        this.declaringField ||
                                        this.extensionField ||
                                        "IMPLICIT" !== this.h.field_presence)
                                );
                            },
                        }),
                        ...
                        (o.prototype.toJSON = function (t) {
                            ...
                            return h.toObject([
                                ...
                                this.c(),
                                "rule",
                                ("optional" !== this.rule && this.rule) || rt,
                                "type",
                                this.type,
                                "id",
                                this.id,
                        ...
                        (o.prototype.resolve = function () {
                            ...
                            return this.resolved
                                ? this
                                : ((this.typeDefault = f.defaults[this.type]) === rt
                                      ? ((this.resolvedType = (
                                  ...
                                  this.options &&
                                      (this.options.packed === rt ||
                                          !this.resolvedType ||
                                          this.resolvedType instanceof e ||
                                          delete this.options.packed,
                                      Object.keys(this.options).length || (this.options = rt)),
                                  this.long
                                      ...
                                      : this.bytes &&
                                        ...
                                        (h.base64.test(this.typeDefault)
                                            ? h.base64.decode(
                                                  this.typeDefault,
                                                  (t = h.newBuffer(
                                                      h.base64.length(this.typeDefault)
                                                  )),
                                                  0
                                              )
                                            : h.utf8.write(
                                                  this.typeDefault,
                                                  (t = h.newBuffer(
                                                      h.utf8.length(this.typeDefault)
                                                  )),
                                                  0
                                              ),
                                        (this.typeDefault = t)),
                        ...
                        (o.prototype.l = function (t) {
                            var i;
                            return "proto2" !== t && "proto3" !== t
                                ? {}
                                : ((t = {}),
                                  "required" === this.rule &&
                                      (t.field_presence = "LEGACY_REQUIRED"),
                                  this.parent &&
                                      f.defaults[this.type] === rt &&
                                      (i = this.parent.get(this.type.split(".").pop())) &&
                                      i instanceof r &&
                                      i.group &&
                                      (t.message_encoding = "DELIMITED"),
                                  !0 === this.getOption("packed")
                                      ? (t.repeated_field_encoding = "PACKED")
                                      : !1 === this.getOption("packed") &&
                                        (t.repeated_field_encoding = "EXPANDED"),
                                  t);
                        }),
                        (o.prototype.u = function (t) {
                            return u.prototype.u.call(this, this.f || t);
                        }),
                        (o.d = function (n, r, e, s) {
                            return (
                                ...
                                function (t, i) {
                                    h.decorateType(t.constructor).add(
                                        new o(i, n, r, e, { default: s })
                                    );
                                }
                            );
                        }),
            ...
            17: [
                function (t, i, n) {
                    ...
                    ((r.build = "light"),
                        ...
                        (r.types = t(36)),
                        (r.util = t(37)),
                        r.ReflectionObject.p(r.Root),
                        r.Namespace.p(r.Type, r.Service, r.Enum),
                        r.Root.p(r.Type),
                        r.Field.p(r.Type));
                },
                {
            ...
            18: [
                function (t, i, n) {
                    var r = n;
                    function e() {
                        (r.util.p(), r.Writer.p(r.BufferWriter), r.Reader.p(r.BufferReader));
                    }
                    ((r.build = "minimal"),
                        (r.Writer = t(42)),
                        (r.BufferWriter = t(43)),
            ...
            19: [
                function (t, i, n) {
                    ...
                    ((i.build = "full"),
                        ...
                        (i.parse = t(26)),
                        (i.common = t(11)),
                        i.Root.p(i.Type, i.parse, i.common));
                },
            ...
            20: [
                function (t, i, n) {
                    ...
                    var o = t(16),
                        r =
                            ((((s.prototype = Object.create(o.prototype)).constructor =
                                s).className = "MapField"),
                            t(36)),
                        u = t(37);
                    function s(t, i, n, r, e, s) {
                        if ((o.call(this, t, i, r, rt, rt, e, s), !u.isString(n)))
            ...
            22: [
                function (t, i, n) {
                    ...
                    var h = t(24),
                        a =
                            ((((r.prototype = Object.create(h.prototype)).constructor =
                                r).className = "Method"),
                            t(37));
                    function r(t, i, n, r, e, s, o, u, f) {
                        ...
                        (h.call(this, t, o),
                            (this.type = i || "rpc"),
                            (this.requestType = n),
                            (this.requestStream = !!e || rt),
                            (this.responseType = r),
                            (this.responseStream = !!s || rt),
                    ...
                    ((c.fromJSON = function (t, i) {
                        ...
                        (c.prototype.add = function (t) {
                            ...
                            ((this.nested[t.name] = t),
                                ...
                                (this.w = !0),
                                (this.y = !0));
                            for (var e = this; (e = e.parent); ) ((e.w = !0), (e.y = !0));
                            return (t.onAdd(this), l(this));
                        }),
                        (c.prototype.remove = function (t) {
                            ...
                            return (
                                ...
                                Object.keys(this.nested).length || (this.nested = rt),
                                t.onRemove(this),
                                l(this)
                            );
                        }),
                        ...
                        (c.prototype.resolveAll = function () {
                            if (this.y) {
                                ...
                                var t = this.nestedArray,
                                    i = 0;
                                for (this.resolve(); i < t.length; )
                                    t[i] instanceof c ? t[i++].resolveAll() : t[i++].resolve();
                                this.y = !1;
                            }
                            return this;
                        }),
                        (c.prototype.g = function (i) {
                            return (
                                this.w &&
                                    ((this.w = !1),
                                    (i = this.f || i),
                                    r.prototype.g.call(this, i),
                                    this.nestedArray.forEach((t) => {
                                        t.g(i);
                                    })),
                                this
                            );
                        ...
                        (c.prototype.lookup = function (t, i, n) {
                            ...
                            var e = this.root.j && this.root.j["." + r];
                            if (e && (!i || ~i.indexOf(e.constructor))) return e;
                            if ((e = this.k(t, r)) && (!i || ~i.indexOf(e.constructor))) return e;
                            if (!n)
                                for (var s = this; s.parent; ) {
                                    if ((e = s.parent.k(t, r)) && (!i || ~i.indexOf(e.constructor)))
                                        return e;
                                    s = s.parent;
                                }
                            return null;
                        }),
                        (c.prototype.k = function (t, i) {
                            if (Object.prototype.hasOwnProperty.call(this.b, i)) return this.b[i];
                            var n = this.get(t[0]),
                                r = null;
                            if (n)
                                1 === t.length
                                    ? (r = n)
                                    : n instanceof c &&
                                      ((t = t.slice(1)), (r = n.k(t, t.join("."))));
                            else
                                for (var e = 0; e < this.nestedArray.length; ++e)
                                    this.v[e] instanceof c && (n = this.v[e].k(t, i)) && (r = n);
                            return (this.b[i] = r);
                        }),
            ...
            24: [
                function (t, i, n) {
                    (i.exports = h).className = "ReflectionObject";
                    const r = t(25);
                    var e,
                        o = t(37),
                        s = {
                    ...
                    (Object.defineProperties(h.prototype, {
                        ...
                        (h.prototype.onAdd = function (t) {
                            (this.parent && this.parent !== t && this.parent.remove(this),
                                ...
                                (this.resolved = !1));
                            t = t.root;
                            t instanceof e && t.A(this);
                        }),
                        (h.prototype.onRemove = function (t) {
                            t = t.root;
                            (t instanceof e && t.T(this),
                                (this.parent = null),
                                (this.resolved = !1));
                        }),
                        (h.prototype.resolve = function () {
                            return (
                                this.resolved || (this.root instanceof e && (this.resolved = !0)),
                                this
                            );
                        }),
                        (h.prototype.g = function (t) {
                            return this.u(this.f || t);
                        }),
                        (h.prototype.u = function (t) {
                            if (!this.O) {
                                ...
                                if (this.f) {
                                    ...
                                    else if ("proto3" === t) i = Object.assign({}, f);
                                    else {
                                        if ("2023" !== t) throw Error("Unknown edition: " + t);
                                        i = Object.assign({}, s);
                                    }
                                    this.h = Object.assign(i, n || {});
                                } else {
                                    if (this.partOf instanceof r) {
                                        t = Object.assign({}, this.partOf.h);
                                        this.h = Object.assign(t, n || {});
                                    } else if (!this.declaringField) {
                                        if (!this.parent)
                                            throw Error(
                                                "Unable to find a parent for " + this.fullName
                                            );
                                        i = Object.assign({}, this.parent.h);
                                        this.h = Object.assign(i, n || {});
                                    }
                        ...
                        (h.prototype.getOption = function (t) {
                            return this.options ? this.options[t] : rt;
                        }),
                        (h.prototype.setOption = function (t, i, n) {
                            return (
                                this.options || (this.options = {}),
                                /^features\./.test(t)
                                    ? o.setProperty(this.options, t, i, n)
                                    : (n && this.options[t] !== rt) ||
                                      (this.getOption(t) !== i && (this.resolved = !1),
                                      (this.options[t] = i)),
                                this
                            );
                        }),
                        (h.prototype.setParsedOption = function (i, t, n) {
                            ...
                            return (
                                n
                                    ? (r = s.find(function (t) {
                                        ...
                                        ? ((e = r[i]), o.setProperty(e, n, t))
                                        : (((r = {})[i] = o.setProperty({}, n, t)), s.push(r))
                                    : (((e = {})[i] = t), s.push(e)),
                                this
                            );
                        }),
                        (h.prototype.setOptions = function (t, i) {
                            if (t)
                        ...
                        (h.prototype.c = function () {
                            return this.f && "proto3" !== this.f ? this.f : rt;
                        }),
                        (h.p = function (t) {
                            e = t;
                        }));
            ...
            25: [
                function (t, i, n) {
                    ...
                    function o(t, i, n, r) {
                        if (
                            (Array.isArray(i) || ((n = i), (i = rt)),
                            e.call(this, t, n),
                            i !== rt && !Array.isArray(i))
                        )
                    ...
                    ((o.fromJSON = function (t, i) {
                        ...
                        Object.defineProperty(o.prototype, "isProto3Optional", {
                            get: function () {
                                var t;
                                return (
                                    null != this.fieldsArray &&
                                    1 === this.fieldsArray.length &&
                                    null != (t = this.fieldsArray[0]).options &&
                                    !0 === t.options.proto3_optional
                                );
                            },
                        }),
                        (o.d = function () {
            ...
            26: [
                function (t, i, n) {
                    (((i.exports = nt).filename = null), (nt.defaults = { keepCase: !1 }));
                    var $ = t(34),
                        F = t(29),
                        P = t(35),
                        R = t(16),
                        ...
                        it = /^(?:\.?[a-zA-Z_][a-zA-Z_0-9]*)(?:\.[a-zA-Z_][a-zA-Z_0-9]*)*$/;
                    function nt(t, i, n) {
                        ...
                        var r,
                            ...
                            o,
                            u,
                            f = (n = n || nt.defaults).preferTrailingComment || !1,
                            a = $(t, n.alternateCommentMode || !1),
                            c = a.next,
                            l = a.push,
                            d = a.peek,
                            p = a.skip,
                        ...
                        function O(i) {
                            ...
                            try {
                                ...
                                if (G.test(t)) return e * parseInt(t, 10);
                                if (Y.test(t)) return e * parseInt(t, 16);
                                if (W.test(t)) return e * parseInt(t, 8);
                                if (Q.test(t)) return e * parseFloat(t);
                                throw k(t, "number", r);
                            } catch (t) {
                                if (i && it.test(n)) return n;
                                throw k(n, "value");
                            }
                        }
                        function A(i, n) {
                            ...
                            do {
                                if (!n || ('"' !== (r = d()) && "'" !== r))
                                    try {
                                        i.push([(t = T(c())), p("to", !0) ? T(c()) : t]);
                                    } catch (t) {
                                        if (!(n && it.test(r) && 2023 <= w)) throw t;
                                        i.push(r);
                                    }
                                else {
                                    var r = E();
                                    if ((i.push(r), 2023 <= w)) throw k(r, "id");
                                }
                            } while (p(",", !0));
                            var e = {
                                options: rt,
                                setOption: function (t, i) {
                                    (this.options === rt && (this.options = {}),
                                        (this.options[t] = i));
                                },
                            };
                            x(
                        ...
                        function T(t, i) {
                            ...
                            if (i || "-" != (t[0] || "")) {
                                ...
                                if (K.test(t)) return parseInt(t, 16);
                        ...
                        function _(t, i) {
                            switch (i) {
                                ...
                                case "service":
                                    ...
                                    if (tt.test((r = c())))
                                        return (
                                            x((h = new C(r)), function (t) {
                                                if (!_(h, t)) {
                                                    if ("rpc" !== t) throw k(t);
                                                    var i = h,
                                                        n = v(),
                                                        r = t;
                                                    if (!tt.test((t = c()))) throw k(t, "name");
                                                    var e,
                                                        s,
                                                        o,
                                                        u = t;
                        ...
                        function x(t, i, n) {
                            ...
                            if (
                                (t &&
                                    ("string" != typeof t.comment && (t.comment = v()),
                                    (t.filename = nt.filename)),
                                p("{", !0))
                            ) {
                                for (; "}" !== (r = c()); ) i(r);
                                p(";", !0);
                                ...
                                (n && n(),
                                    p(";"),
                                    t &&
                                        ("string" != typeof t.comment || f) &&
                                        (t.comment = v(e) || t.comment));
                        }
                        function S(t, i) {
                            if (!tt.test((i = c()))) throw k(i, "type name");
                            var u = new P(i);
                            (x(u, function (t) {
                                if (!_(u, t))
                                    switch (t) {
                                        case "map":
                                            var i = u,
                                                n = (p("<"), c());
                                            if (Z.mapKey[n] === rt) throw k(n, "type");
                                            p(",");
                                            var r = c();
                                            if (!it.test(r)) throw k(r, "type");
                                            p(">");
                                            var e = c();
                                            if (!tt.test(e)) throw k(e, "name");
                                            p("=");
                                            var s = new U(j(e), T(c()), n, r);
                                            (x(
                                                s,
                                                function (t) {
                                                    if ("option" !== t) throw k(t);
                                            ...
                                            break;
                                        case "required":
                                            if ("proto2" !== w) throw k(t);
                                        case "repeated":
                                            I(u, t);
                                            break;
                                        case "optional":
                                            if ("proto3" === w) I(u, "proto3_optional");
                                            else {
                                                if ("proto2" !== w) throw k(t);
                                                I(u, "optional");
                                            }
                                        ...
                                        case "oneof":
                                            ...
                                            break;
                                        case "extensions":
                                            A(u.extensions || (u.extensions = []));
                                            break;
                                        case "reserved":
                                            A(u.reserved || (u.reserved = []), !0);
                                            break;
                                        default:
                                            if ("proto2" === w || !it.test(t)) throw k(t);
                                            (l(t), I(u, "optional"));
                                    }
                            }),
                                t.add(u),
                        ...
                        function I(t, i, n) {
                            ...
                            if ("group" === r) {
                                ...
                                if (tt.test(f))
                                    return (
                                        ...
                                        (h = T(c())),
                                        ((o = new P(f)).group = !0),
                                        ((u = new R(u, h, f, s)).filename = nt.filename),
                                        x(o, function (t) {
                                            switch (t) {
                                                case "option":
                                                    (L(o, t), p(";"));
                            ...
                            for (; r.endsWith(".") || d().startsWith("."); ) r += c();
                            if (!it.test(r)) throw k(r, "type");
                            var h = c();
                            if (!tt.test(h)) throw k(h, "name");
                            ((h = j(h)), p("="));
                            var a = new R(h, T(c()), r, i, n);
                            (x(
                                a,
                                function (t) {
                                    if ("option" !== t) throw k(t);
                            ...
                            (x(s, function (t) {
                                switch (t) {
                                    case "option":
                                        ...
                                        break;
                                    case "reserved":
                                        (A(s.reserved || (s.reserved = []), !0),
                                            s.reserved === rt && (s.reserved = []));
                                        break;
                                    default:
                                        var i = s,
                                            n = t;
                                        if (!tt.test(n)) throw k(n, "name");
                                        p("=");
                                        var r = T(c(), !0),
                                            e = {
                                                options: rt,
                                                ...
                                                setOption: function (t, i) {
                                                    X.prototype.setOption.call(e, t, i);
                                                },
                        ...
                        function L(t, i) {
                            ...
                            var s,
                                ...
                                u = (function t(i, n) {
                                    if (p("{", !0)) {
                                        for (var r = {}; !p("}", !0); ) {
                                            if (!tt.test((h = c()))) throw k(h, "name");
                                            if (null === h) throw k(h, "end of input");
                                            var e,
                                                s,
                                                o = h;
                                            if ((p(":", !0), "{" === d())) e = t(i, n + "." + h);
                                                ...
                                                if (((e = []), p("[", !0))) {
                                                    for (; (s = O(!0)), e.push(s), p(",", !0); );
                                                    (p("]"), void 0 !== s && V(i, n + "." + h, s));
                                                }
                                            } else ((e = O(!0)), V(i, n + "." + h, e));
                                            var u = r[o];
                                ...
                                f = f && "." === f[0] ? f.slice(1) : f;
                            ((e = e && "." === e[e.length - 1] ? e.slice(0, -1) : e),
                                (s = e),
                                (u = u),
                                (o = f),
                                (t = t).setParsedOption && t.setParsedOption(s, u, o));
                        }
                        function V(t, i, n) {
                            y === t && /^features\./.test(i)
                                ? (g[i] = n)
                        ...
                        for (; null !== (h = c()); )
                            switch (h) {
                                case "package":
                                    if (!b) throw k(h);
                                    if (r !== rt) throw k("package");
                                    if (((r = c()), !it.test(r))) throw k(r, "name");
                                    ((y = y.define(r)), p(";"));
                                    break;
                                case "import":
                                    if (!b) throw k(h);
                                ...
                                case "syntax":
                                    if (!b) throw k(h);
                                    if ((p("="), (w = E()) < 2023)) throw k(w, "syntax");
                                    p(";");
                                    break;
                                case "edition":
                                    if (!b) throw k(h);
                                    if ((p("="), (w = E()), !["2023"].includes(w)))
                                        throw k(w, "edition");
                                    p(";");
                                    break;
                                case "option":
                            ...
                            m.forEach((i) => {
                                ((i.f = w),
                                    Object.keys(g).forEach((t) => {
                                        i.getOption(t) === rt && i.setOption(t, g[t], !0);
                                    }));
                            }),
                            (nt.filename = null),
                            { package: r, imports: e, weakImports: s, root: i }
                        );
                    }
                },
                {
            ...
            27: [
                function (t, i, n) {
                    ...
                    function d(t, i) {
                        return (
                            (t[i - 4] | (t[i - 3] << 8) | (t[i - 2] << 16) | (t[i - 1] << 24)) >>> 0
                        );
                    }
                    function p() {
                    ...
                    ((f.create = h()),
                        (f.prototype._ = e.Array.prototype.subarray || e.Array.prototype.slice),
                        (f.prototype.uint32 =
                            ((a = 4294967295),
                            function () {
                                if (
                                    ...
                                    this.buf[this.pos++] < 128 ||
                                        ...
                                        this.buf[this.pos++] < 128 ||
                                            ...
                                            this.buf[this.pos++] < 128 ||
                                                ((a =
                                                    (a | ((127 & this.buf[this.pos]) << 21)) >>> 0),
                                                this.buf[this.pos++] < 128 ||
                                                    ((a =
                                                        (a | ((15 & this.buf[this.pos]) << 28)) >>>
                                                        0),
                                                    this.buf[this.pos++] < 128 ||
                                                        !((this.pos += 5) > this.len))))))
                                )
            ...
            28: [
                function (t, i, n) {
                    ...
                    ((s.p = function () {
                        e.Buffer && (s.prototype._ = e.Buffer.prototype.slice);
                    }),
            ...
            29: [
                function (t, i, n) {
                    ...
                    var r,
                        ...
                        e = t(23),
                        s =
                            ((((f.prototype = Object.create(e.prototype)).constructor =
                                f).className = "Root"),
                            t(16)),
                        o = t(15),
                        u = t(25),
                    ...
                    ((f.fromJSON = function (t, i) {
                        ...
                        (f.prototype.load = function t(i, s, e) {
                                    ...
                                    if (
                                        ...
                                        if (r.imports)
                                            for (; e < r.imports.length; ++e)
                                                (n =
                                                    h(r.imports[e]) ||
                                                    o.resolvePath(t, r.imports[e])) && c(n);
                                        if (r.weakImports)
                                            for (e = 0; e < r.weakImports.length; ++e)
                                                (n =
                                                    h(r.weakImports[e]) ||
                                                    o.resolvePath(t, r.weakImports[e])) && c(n, !0);
                            ...
                            return (u ? o.resolveAll() : l || f(null, o), o);
                        }),
                    ...
                    function a(t, i) {
                        ...
                        if (r)
                            return (
                                (n = new s(i.fullName, i.id, i.type, i.rule, rt, i.options)),
                                r.get(n.name) ||
                                    (((n.declaringField = i).extensionField = n), r.add(n)),
                                1
                            );
                    }
                    ((f.prototype.A = function (t) {
                        if (t instanceof s)
                            t.extend === rt || t.extensionField || a(0, t) || this.deferred.push(t);
                        else if (t instanceof o) h.test(t.name) && (t.parent[t.name] = t.values);
                        else if (!(t instanceof u)) {
                            if (t instanceof r)
                                for (var i = 0; i < this.deferred.length; )
                                    a(0, this.deferred[i]) ? this.deferred.splice(i, 1) : ++i;
                            for (var n = 0; n < t.nestedArray.length; ++n) this.A(t.v[n]);
                            h.test(t.name) && (t.parent[t.name] = t);
                        }
                        (t instanceof r || t instanceof o || t instanceof s) &&
                            (this.j[t.fullName] = t);
                    }),
                        (f.prototype.T = function (t) {
                            ...
                            if (t instanceof s)
                                ...
                                for (var n = 0; n < t.nestedArray.length; ++n) this.T(t.v[n]);
                                h.test(t.name) && delete t.parent[t.name];
                            }
                            delete this.j[t.fullName];
                        }),
                        (f.p = function (t, i, n) {
                            ((r = t), (d = i), (p = n));
                        }));
            ...
            33: [
                function (t, i, n) {
                    ...
                    var r = t(23),
                        s =
                            ((((o.prototype = Object.create(r.prototype)).constructor =
                                o).className = "Service"),
                            t(22)),
                        u = t(37),
                        f = t(31);
                    function o(t, i) {
                        (r.call(this, t, i), (this.methods = {}), (this.x = null));
                    }
                    function e(t) {
                        return ((t.x = null), t);
                    }
                    ((o.fromJSON = function (t, i) {
                        ...
                        (o.prototype.g = function (i) {
                            return (
                                this.w &&
                                    ((i = this.f || i),
                                    r.prototype.g.call(this, i),
                                    this.methodsArray.forEach((t) => {
                                        t.g(i);
                                    })),
                                this
                            );
                        ...
                        (o.prototype.create = function (t, i, n) {
                            for (
                                var r, e = new f.Service(t, i, n), s = 0;
                                s < this.methodsArray.length;
                                ++s
                            ) {
                                var o = u
                                    .lcFirst((r = this.x[s]).resolve().name)
                                    .replace(/[^$\w_]/g, "");
                                e[o] = u.codegen(
                                    ["r", "c"],
            ...
            34: [
                function (t, i, n) {
                    ...
                    function s(h, a) {
                        ...
                        function m(t, i, n) {
                            var r,
                                e = { type: h[0 | t++] || "", lineEmpty: !1, leading: n },
                                n = a ? 2 : 3,
                                s = t - n;
                            do {
                                if (--s < 0 || "\n" == (r = h[0 | s] || "")) {
                            ...
                            for (var o = h.substring(t, i).split(x), u = 0; u < o.length; ++u)
                                o[u] = o[u].replace(a ? _ : T, "").trim();
                            ((e.text = o.join("\n").trim()), (p[d] = e), (f = d));
                        }
                        function g(t) {
                            var i = j(t),
                        ...
                        function r() {
                            ...
                            if (b) {
                                ...
                                if (i) return ((c = t.lastIndex), k(b), (b = null), I(i[1]));
                                throw w("string");
                            }
                            var n,
                                r,
                            ...
                            do {
                                if (c === l) return null;
                                for (n = !1; S.test((e = y(c))); )
                                    if (("\n" === e && ((u = !0), ++d), ++c === l)) return null;
                                if ("/" === y(c)) {
                                    if (++c === l) throw w("comment");
                                    if ("/" === y(c))
                                        if (a) {
                                            if (((o = !1), g((s = c) - 1)))
                                                for (
                            ...
                            var f = c;
                            if (((E.lastIndex = 0), !E.test(y(f++))))
                                for (; f < l && !E.test(y(f)); ) ++f;
                            t = h.substring(c, (c = f));
                            return (('"' != t && "'" != t) || (b = t), t);
                        }
                        function k(t) {
            ...
            35: [
                function (t, i, n) {
                    ...
                    var o = t(23),
                        u =
                            ((((m.prototype = Object.create(o.prototype)).constructor =
                                m).className = "Type"),
                            t(15)),
                        f = t(25),
                        h = t(16),
                    ...
                    (Object.defineProperties(m.prototype, {
                        ...
                        oneofsArray: {
                            get: function () {
                                return this.I || (this.I = d.toArray(this.oneofs));
                            },
                        },
                        ctor: {
                            get: function () {
                                return this.N || (this.ctor = m.generateConstructor(this)());
                            },
                            set: function (t) {
                                for (
                                    var i = t.prototype,
                                ...
                                for (var r = {}, n = 0; n < this.oneofsArray.length; ++n)
                                    r[this.I[n].resolve().name] = {
                                        get: d.oneOfGetter(this.I[n].oneof),
                                        set: d.oneOfSetter(this.I[n].oneof),
                                    };
                        ...
                        (m.fromJSON = function (t, i) {
                            for (
                                ...
                                n.add(
                                    (void 0 !== i.fields[r[e]].keyType ? a : h).fromJSON(
                                        r[e],
                                        i.fields[r[e]]
                                    )
                                );
                        ...
                        (m.prototype.toJSON = function (t) {
                            ...
                            return d.toObject([
                                ...
                                "extensions",
                                this.extensions && this.extensions.length ? this.extensions : rt,
                                "reserved",
                                this.reserved && this.reserved.length ? this.reserved : rt,
                                "group",
                                this.group || rt,
                        ...
                        (m.prototype.resolveAll = function () {
                            if (this.y) {
                                ...
                                for (var t = this.oneofsArray, i = 0; i < t.length; )
                                    t[i++].resolve();
                                for (var n = this.fieldsArray, i = 0; i < n.length; )
                                    n[i++].resolve();
                            }
                            return this;
                        }),
                        (m.prototype.g = function (i) {
                            return (
                                this.w &&
                                    ((i = this.f || i),
                                    o.prototype.g.call(this, i),
                                    this.oneofsArray.forEach((t) => {
                                        t.u(i);
                                    }),
                        ...
                        (m.prototype.add = function (t) {
                            if (this.get(t.name))
                                throw Error("duplicate name '" + t.name + "' in " + this);
                            if (t instanceof h && t.extend === rt) {
                                if ((this.S || this.fieldsById)[t.id])
                        ...
                        (m.prototype.setup = function () {
                            ...
                            ((this.encode = p(this)({ Writer: l, types: i, util: d })),
                                (this.decode = v(this)({ Reader: s, types: i, util: d })),
                                (this.verify = b(this)({ types: i, util: d })),
                                (this.fromObject = w.fromObject(this)({ types: i, util: d })),
                        ...
                        (r.oneOfGetter = function (t) {
                            ...
                            return function () {
                                for (var t = Object.keys(this), i = t.length - 1; -1 < i; --i)
                                    if (1 === n[t[i]] && this[t[i]] !== rt && null !== this[t[i]])
                                        return t[i];
                            };
                        }),
                    ...
                    n[".google.protobuf.Any"] = {
                        ...
                        toObject: function (t, i) {
                            ...
                            return (
                                ...
                                !(t instanceof this.ctor) && t instanceof o
            ...
            42: [
                function (t, i, n) {
                    ...
                    var r,
                        ...
                        u = e.utf8;
                    function f(t, i, n) {
                        ((this.fn = t), (this.len = i), (this.next = rt), (this.val = n));
                    }
                    function h() {}
                    function a(t) {
                        ((this.head = t.head),
                    ...
                    function p(t, i) {
                        ((this.len = t), (this.next = rt), (this.val = i));
                    }
                    function v(t, i, n) {
                        for (; t.hi; )
                            ((i[n++] = (127 & t.lo) | 128),
                    ...
                    ((c.create = l()),
                        ...
                        e.Array !== Array &&
                            (c.alloc = e.pool(c.alloc, e.Array.prototype.subarray)),
                        (c.prototype.M = function (t, i, n) {
                            return (
                                (this.tail = this.tail.next = new f(t, i, n)),
                                (this.len += i),
                                this
                            );
                        }),
                        ...
                        (c.prototype.int32 = function (t) {
                            return t < 0 ? this.M(v, 10, s.fromNumber(t)) : this.uint32(t);
                        }),
                        ...
                        (c.prototype.bool = function (t) {
                            return this.M(d, 1, t ? 1 : 0);
                        }),
                        (c.prototype.sfixed32 = c.prototype.fixed32 =
                            function (t) {
                                return this.M(b, 4, t >>> 0);
                            }),
                        (c.prototype.sfixed64 = c.prototype.fixed64 =
                            function (t) {
                                t = s.from(t);
                                return this.M(b, 4, t.lo).M(b, 4, t.hi);
                            }),
                        (c.prototype.float = function (t) {
                            return this.M(e.float.writeFloatLE, 4, t);
                        }),
                        (c.prototype.double = function (t) {
                            return this.M(e.float.writeDoubleLE, 8, t);
                        }));
                    ...
                    ((c.prototype.bytes = function (t) {
                        ...
                        return n
                            ? (e.isString(t) &&
                                  ((i = c.alloc((n = o.length(t)))), o.decode(t, i, 0), (t = i)),
                              this.uint32(n).M(w, n, t))
                            : this.M(d, 1, 0);
                    }),
                        (c.prototype.string = function (t) {
                            var i = u.length(t);
                            return i ? this.uint32(i).M(u.write, i, t) : this.M(d, 1, 0);
                        }),
                        ...
                        (c.prototype.finish = function () {
                            for (
                                var t = this.head.next, i = this.constructor.alloc(this.len), n = 0;
                                t;
                ...
                function (t, i, n) {
                    ...
                    ((s.p = function () {
                        ...
                        (s.prototype.bytes = function (t) {
                            var i = (t = e.isString(t) ? e.L(t, "base64") : t).length >>> 0;
                            return (this.uint32(i), i && this.M(s.writeBytesBuffer, i, t), this);
                        }),
                        (s.prototype.string = function (t) {
                            var i = e.Buffer.byteLength(t);
                            return (this.uint32(i), i && this.M(o, i, t), this);
                        }),
                        s.p());
                },
                { 39: 39, 42: 42 },
