...
export declare type napi_addon_register_func = FunctionPointer<
    (env: napi_env, exports: napi_value) => napi_value
>;

export declare type napi_callback_info = Pointer<unknown>;
export declare type napi_callback = FunctionPointer<
    (env: napi_env, info: napi_callback_info) => napi_value
>;
...
export declare type napi_finalize = FunctionPointer<
    (env: napi_env, finalize_data: void_p, finalize_hint: void_p) => void
>;
...
export declare class ConstHandle<
    S extends undefined | null | boolean | typeof globalThis,
> extends Handle<S> {
...
export declare abstract class Env implements IStoreValue {
    ...
    callIntoModule<T>(
        fn: (env: Env) => T,
        handleException?: (envObject: Env, value: any) => void
    ): T;
    /** @virtual */
...
export declare class Finalizer {
    ...
    constructor(
        envObject: Env,
        _finalizeCallback?: napi_finalize,
        _finalizeData?: void_p,
        _finalizeHint?: void_p
    );
...
export declare const NODE_API_DEFAULT_MODULE_API_VERSION =
    Version.NODE_API_DEFAULT_MODULE_API_VERSION;
