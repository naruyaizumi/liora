(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var canSetFunctionName = /*#__PURE__*/ (function () {
        ...
        try {
            return Boolean(
                (_a = Object.getOwnPropertyDescriptor(Function.prototype, "name")) === null ||
                    _a === void 0
                    ? void 0
                    : _a.configurable
            );
    ...
    var Handle = /*#__PURE__*/ (function () {
        ...
        Handle.prototype.isBuffer = function (BufferConstructor) {
            ...
            BufferConstructor !== null && BufferConstructor !== void 0
                ? BufferConstructor
                : (BufferConstructor = _Buffer);
            return (
                typeof BufferConstructor === "function" && BufferConstructor.isBuffer(this.value)
            );
        };
    ...
    var Finalizer = /*#__PURE__*/ (function () {
        ...
        Finalizer.prototype.callback = function () {
            return this._finalizeCallback;
        };
        Finalizer.prototype.data = function () {
            return this._finalizeData;
        };
        Finalizer.prototype.hint = function () {
    ...
    var TrackedFinalizer = /*#__PURE__*/ (function (_super) {
        ...
        function TrackedFinalizer(envObject, finalize_callback, finalize_data, finalize_hint) {
            ...
            _this._finalizer = new Finalizer(
                envObject,
                finalize_callback,
                finalize_data,
                finalize_hint
        ...
        TrackedFinalizer.create = function (
            envObject,
            finalize_callback,
            finalize_data,
            finalize_hint
        ) {
            var finalizer = new TrackedFinalizer(
                envObject,
                finalize_callback,
                finalize_data,
                finalize_hint
    ...
    function throwNodeApiVersionError(moduleName, moduleApiVersion) {
        var errorMessage = ""
            .concat(moduleName, " requires Node-API version ")
            .concat(moduleApiVersion, ", but this version of Node.js only supports version ")
    ...
    var Env = /*#__PURE__*/ (function () {
        ...
        Env.prototype.getReturnStatus = function () {
            return !this.tryCatch.hasCaught()
                ? 0 /* napi_status.napi_ok */
                : this.setLastError(10 /* napi_status.napi_pending_exception */);
        };
    ...
    var NodeEnv = /*#__PURE__*/ (function (_super) {
        ...
        function NodeEnv(
            ...
            var _this =
                _super.call(this, ctx, moduleApiVersion, makeDynCall_vppp, makeDynCall_vp, abort) ||
                this;
        ...
        NodeEnv.prototype.callbackIntoModule = function (enforceUncaughtExceptionPolicy, fn) {
            return this.callIntoModule(fn, function (envObject, err) {
                ...
                if (
                    ...
                    var warn =
                        hasProcess && typeof process.emitWarning === "function"
                            ? process.emitWarning
    ...
    function newEnv(
        ...
        if (moduleApiVersion < NODE_API_DEFAULT_MODULE_API_VERSION) {
            ...
            moduleApiVersion > NODE_API_SUPPORTED_VERSION_MAX &&
            moduleApiVersion !== NAPI_VERSION_EXPERIMENTAL
        ) {
            ...
            return (
                _super.call(
                    ...
                    ""
                        .concat(
                            api,
                            ': The current runtime does not support "FinalizationRegistry" and "WeakRef".'
                        )
    ...
    var Reference = /*#__PURE__*/ (function (_super) {
        ...
        Reference.prototype.refcount = function () {
            return this._refcount;
        };
        Reference.prototype.ownership = function () {
    ...
    var ReferenceWithData = /*#__PURE__*/ (function (_super) {
        ...
        ReferenceWithData.create = function (envObject, value, initialRefcount, ownership, data) {
            var reference = new ReferenceWithData(
                envObject,
                value,
                initialRefcount,
                ownership,
    ...
    var ReferenceWithFinalizer = /*#__PURE__*/ (function (_super) {
        ...
        function ReferenceWithFinalizer(
            envObject,
            value,
            initialRefcount,
            ownership,
        ...
        ReferenceWithFinalizer.create = function (
            envObject,
            value,
            initialRefcount,
            ownership,
            ...
            var reference = new ReferenceWithFinalizer(
                envObject,
                value,
                initialRefcount,
                ownership,
    ...
    var CleanupQueue = /*#__PURE__*/ (function () {
        ...
        CleanupQueue.prototype.add = function (envObject, fn, arg) {
            ...
            this._cleanupHooks.push(
                new CleanupHookCallback(envObject, fn, arg, this._cleanupHookCounter++)
            );
        };
    ...
    var Context = /*#__PURE__*/ (function () {
        ...
        Context.prototype.createReference = function (
            envObject,
            handle_id,
            initialRefcount,
            ownership
        ...
        Context.prototype.createReferenceWithData = function (
            envObject,
            handle_id,
            initialRefcount,
            ownership,
        ...
        Context.prototype.createReferenceWithFinalizer = function (
            envObject,
            handle_id,
            initialRefcount,
            ownership,
        ...
        Context.prototype.createEnv = function (
            filename,
            moduleApiVersion,
            makeDynCall_vppp,
            makeDynCall_vp,
        ...
        Context.prototype.createTrackedFinalizer = function (
            envObject,
            finalize_callback,
            finalize_data,
            finalize_hint
        ) {
            return TrackedFinalizer.create(
                envObject,
                finalize_callback,
                finalize_data,
                finalize_hint
