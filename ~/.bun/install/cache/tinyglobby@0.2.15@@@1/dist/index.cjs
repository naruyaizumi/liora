...
function getPartialMatcher(patterns, options = {}) {
    ...
    for (let i = 0; i < patternsCount; i++) {
        ...
        for (let j = 0; j < partsCount; j++)
            partMatchers[j] = (0, picomatch.default)(parts[j], options);
...
function isDynamicPattern(pattern, options) {
    if ((options === null || options === void 0 ? void 0 : options.caseSensitiveMatch) === false)
        return true;
...
function normalizePattern(pattern, expandDirectories, cwd, props, isIgnore) {
    ...
    if (!isIgnore && props.depthOffset >= 0) {
        ...
        ((_props$commonPath = props.commonPath) !== null && _props$commonPath !== void 0) ||
...
function processPatterns(
    ...
    for (const pattern of patterns) {
        ...
        if (pattern[0] !== "!" || pattern[1] === "(")
            ...
            ignorePatterns.push(
                normalizePattern(pattern.slice(1), expandDirectories, cwd, props, true)
            );
    }
    return {
        match: matchPatterns,
