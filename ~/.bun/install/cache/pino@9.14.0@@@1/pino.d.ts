...
declare namespace pino {
    ...
    export type LevelChangeEventListener<
        CustomLevels extends string = never,
        UseOnlyCustomLevels extends boolean = boolean,
    > = (
    ...
    export interface TransportSingleOptions<TransportOptions = Record<string, any>>
        extends TransportBaseOptions<TransportOptions> {
        target: string;
    }

    export interface TransportPipelineOptions<TransportOptions = Record<string, any>>
        extends TransportBaseOptions<TransportOptions> {
        pipeline: TransportSingleOptions<TransportOptions>[];
        level?: LevelWithSilentOrString;
    }

    export interface TransportMultiOptions<TransportOptions = Record<string, any>>
        extends TransportBaseOptions<TransportOptions> {
        targets: readonly (
    ...
    function pino<
        ...
        UseOnlyCustomLevels extends boolean = boolean,
    >(
        optionsOrStream?: LoggerOptions<CustomLevels, UseOnlyCustomLevels> | DestinationStream
...
declare function pino<
    ...
    UseOnlyCustomLevels extends boolean = boolean,
>(
    options: pino.LoggerOptions<CustomLevels, UseOnlyCustomLevels>,
