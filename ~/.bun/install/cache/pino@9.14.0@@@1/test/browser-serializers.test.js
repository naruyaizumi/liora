...
if (process.title !== "browser") {
    test("if serialize option is true, standard error serializer is auto enabled", ({
        end,
        same,
    }) => {
    ...
    test("if serialize option is array, standard error serializer is auto enabled", ({
        end,
        same,
    }) => {
        const err = Error("test");
    ...
    test("if serialize option is array containing !stdSerializers.err, standard error serializer is disabled", ({
        end,
        is,
    }) => {
        const err = Error("test");
