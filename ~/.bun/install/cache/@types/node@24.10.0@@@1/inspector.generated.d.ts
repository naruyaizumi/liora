...
declare module "inspector" {
    ...
    interface Session {
        ...
        post(
            method: string,
            params?: object,
            callback?: (err: Error | null, params?: object) => void
        ): void;
        /**
        ...
        post(
            ...
            params?: Network.GetRequestPostDataParameterType,
            callback?: (err: Error | null, params: Network.GetRequestPostDataReturnType) => void
        ): void;
        post(
            method: "Network.getRequestPostData",
            callback?: (err: Error | null, params: Network.GetRequestPostDataReturnType) => void
        ...
        post(
            ...
            params?: Network.GetResponseBodyParameterType,
            callback?: (err: Error | null, params: Network.GetResponseBodyReturnType) => void
        ): void;
        post(
            method: "Network.getResponseBody",
            callback?: (err: Error | null, params: Network.GetResponseBodyReturnType) => void
        ...
        post(
            ...
            params?: Network.LoadNetworkResourceParameterType,
            callback?: (err: Error | null, params: Network.LoadNetworkResourceReturnType) => void
        ): void;
        post(
            method: "Network.loadNetworkResource",
            callback?: (err: Error | null, params: Network.LoadNetworkResourceReturnType) => void
        ...
        post(
            ...
            params?: Target.SetAutoAttachParameterType,
            callback?: (err: Error | null) => void
        ): void;
        ...
        post(
            method: "IO.read",
            params?: IO.ReadParameterType,
            callback?: (err: Error | null, params: IO.ReadReturnType) => void
        ): void;
        post(
            method: "IO.read",
            callback?: (err: Error | null, params: IO.ReadReturnType) => void
        ...
        addListener(
            ...
            listener: (
                message: InspectorNotification<Network.RequestWillBeSentEventDataType>
            ) => void
        ): this;
        /**
        ...
        addListener(
            ...
            listener: (
                message: InspectorNotification<Network.ResponseReceivedEventDataType>
            ) => void
        ): this;
        addListener(
        ...
        addListener(
            ...
            listener: (message: InspectorNotification<Network.DataReceivedEventDataType>) => void
        ): this;
        /**
        ...
        addListener(
            ...
            listener: (
                message: InspectorNotification<Network.WebSocketCreatedEventDataType>
            ) => void
        ): this;
        /**
        ...
        addListener(
            ...
            listener: (message: InspectorNotification<Network.WebSocketClosedEventDataType>) => void
        ): this;
        /**
        ...
        addListener(
            ...
            listener: (
                message: InspectorNotification<Network.WebSocketHandshakeResponseReceivedEventDataType>
            ) => void
        ): this;
        /**
        ...
        addListener(
            ...
            listener: (message: InspectorNotification<Target.TargetCreatedEventDataType>) => void
        ): this;
        addListener(
            event: "Target.attachedToTarget",
            listener: (message: InspectorNotification<Target.AttachedToTargetEventDataType>) => void
        ): this;
        ...
        emit(
            event: "Network.loadingFailed",
            message: InspectorNotification<Network.LoadingFailedEventDataType>
        ): boolean;
        emit(
            event: "Network.loadingFinished",
            message: InspectorNotification<Network.LoadingFinishedEventDataType>
        ): boolean;
        emit(
            event: "Network.dataReceived",
            message: InspectorNotification<Network.DataReceivedEventDataType>
        ): boolean;
        emit(
            event: "Network.webSocketCreated",
            message: InspectorNotification<Network.WebSocketCreatedEventDataType>
        ...
        emit(
            event: "Network.webSocketClosed",
            message: InspectorNotification<Network.WebSocketClosedEventDataType>
        ): boolean;
        emit(
            event: "Network.webSocketHandshakeResponseReceived",
            message: InspectorNotification<Network.WebSocketHandshakeResponseReceivedEventDataType>
        ...
        emit(
            event: "Target.targetCreated",
            message: InspectorNotification<Target.TargetCreatedEventDataType>
        ): boolean;
        emit(
            event: "Target.attachedToTarget",
            message: InspectorNotification<Target.AttachedToTargetEventDataType>
        ): boolean;
...
declare module "inspector/promises" {
    ...
    interface Session {
        ...
        post(
            method: "Profiler.getBestEffortCoverage"
        ): Promise<Profiler.GetBestEffortCoverageReturnType>;
        ...
        post(
            method: "HeapProfiler.getSamplingProfile"
        ): Promise<HeapProfiler.GetSamplingProfileReturnType>;
        /**
         * Gets supported tracing categories.
         */
        ...
        post(
            method: "Network.getRequestPostData",
            params?: Network.GetRequestPostDataParameterType
        ): Promise<Network.GetRequestPostDataReturnType>;
        /**
         * Returns content served for the given request.
         */
        post(
            method: "Network.getResponseBody",
            params?: Network.GetResponseBodyParameterType
        ): Promise<Network.GetResponseBodyReturnType>;
        /**
         * Enables streaming of the response for the given requestId.
         * If enabled, the dataReceived event contains the data that was received during streaming.
         * @experimental
        ...
        post(
            method: "Network.streamResourceContent",
            params?: Network.StreamResourceContentParameterType
        ): Promise<Network.StreamResourceContentReturnType>;
        /**
         * Fetches the resource and returns the content.
         */
        post(
            method: "Network.loadNetworkResource",
            params?: Network.LoadNetworkResourceParameterType
        ): Promise<Network.LoadNetworkResourceReturnType>;
        /**
         * Enable the NodeRuntime events except by `NodeRuntime.waitingForDisconnect`.
         */
