...
declare module "fs" {
    ...
    export interface Utf8StreamOptions {
         ...
         */
        retryEAGAIN?:
            | ((err: Error | null, writeBufferLen: number, remainingBufferLen: number) => boolean)
            | undefined;
        /**
    ...
    // TODO: remove in future major
    export interface ReadAsyncOptions<T extends NodeJS.ArrayBufferView>
        extends ReadOptionsWithBuffer<T> {}
    /**
    ...
    export interface WriteVResult<
        T extends readonly NodeJS.ArrayBufferView[] = NodeJS.ArrayBufferView[],
    > {
        bytesWritten: number;
        buffers: T;
    }
