...
declare module "crypto" {
    ...
    function randomBytes(
        size: number,
        callback: (err: Error | null, buf: NonSharedBuffer) => void
    ): void;
     ...
     * @since v24.7.0
     */
    function encapsulate(key: KeyLike | PublicKeyInput | JsonWebKeyInput): {
        sharedKey: NonSharedBuffer;
        ciphertext: NonSharedBuffer;
    };
    function encapsulate(
        key: KeyLike | PublicKeyInput | JsonWebKeyInput,
        callback: (
            err: Error,
            result: { sharedKey: NonSharedBuffer; ciphertext: NonSharedBuffer }
        ) => void
    ): void;
    ...
    namespace webcrypto {
        ...
        interface Crypto {
             ...
             */
            getRandomValues<
                T extends Exclude<NodeJS.TypedArray, Float16Array | Float32Array | Float64Array>,
            >(
                typedArray: T
            ): T;
            /**
