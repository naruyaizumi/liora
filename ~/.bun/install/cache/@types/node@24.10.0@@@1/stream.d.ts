...
declare module "stream" {
    ...
    namespace Stream {
        interface StreamOptions<T extends Stream> extends Abortable {
            ...
            destroy?:
                | ((this: T, error: Error | null, callback: (error?: Error | null) => void) => void)
                | undefined;
         ...
         */
        function isErrored(
            stream: Readable | Writable | NodeJS.ReadableStream | NodeJS.WritableStream
        ): boolean;
        /**
