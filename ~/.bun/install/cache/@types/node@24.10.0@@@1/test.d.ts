...
declare module "node:test" {
    ...
    namespace test {
        ...
        interface TestsStream extends Readable {
            addListener(
                event: "test:coverage",
                listener: (data: EventData.TestCoverage) => void
            ): this;
            addListener(
                event: "test:complete",
                listener: (data: EventData.TestComplete) => void
            ): this;
            addListener(
                event: "test:dequeue",
                listener: (data: EventData.TestDequeue) => void
            ): this;
            addListener(
                event: "test:diagnostic",
                listener: (data: EventData.TestDiagnostic) => void
            ): this;
            addListener(
                event: "test:enqueue",
                listener: (data: EventData.TestEnqueue) => void
            ): this;
            ...
            addListener(
                event: "test:summary",
                listener: (data: EventData.TestSummary) => void
            ): this;
            ...
            prependListener(
                event: "test:start",
                listener: (data: EventData.TestStart) => void
            ): this;
            prependListener(
                event: "test:stderr",
                listener: (data: EventData.TestStderr) => void
            ): this;
            prependListener(
                event: "test:stdout",
                listener: (data: EventData.TestStdout) => void
            ): this;
            prependListener(
                event: "test:summary",
                listener: (data: EventData.TestSummary) => void
            ...
            prependOnceListener(
                event: "test:fail",
                listener: (data: EventData.TestFail) => void
            ): this;
            prependOnceListener(
                event: "test:pass",
                listener: (data: EventData.TestPass) => void
            ): this;
            prependOnceListener(
                event: "test:plan",
                listener: (data: EventData.TestPlan) => void
            ): this;
            prependOnceListener(
                event: "test:start",
                listener: (data: EventData.TestStart) => void
        ...
        interface MockTracker {
             ...
             */
            property<MockedObject extends object, PropertyName extends keyof MockedObject>(
                object: MockedObject,
        ...
        namespace snapshot {
            ...
            function setDefaultSnapshotSerializers(
                serializers: ReadonlyArray<(value: any) => any>
            ): void;
            /**
