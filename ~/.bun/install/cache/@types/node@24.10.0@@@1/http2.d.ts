...
declare module "http2" {
    ...
    export interface Http2Stream extends stream.Duplex {
        ...
        prependOnceListener(
            event: "data",
            listener: (chunk: NonSharedBuffer | string) => void
        ): this;
    ...
    export interface ServerHttp2Session<
        ...
        Http1Response extends typeof ServerResponse<
            InstanceType<Http1Request>
        > = typeof ServerResponse,
        Http2Request extends typeof Http2ServerRequest = typeof Http2ServerRequest,
        Http2Response extends typeof Http2ServerResponse<
    ...
    > extends Http2Session {
        ...
        altsvc(
            alt: string,
            originOrStream: number | string | url.URL | AlternativeServiceOptions
        ): void;
        /**
    ...
    export interface ClientSessionOptions extends SessionOptions {
         ...
         */
        createConnection?:
            | ((authority: url.URL, option: SessionOptions) => stream.Duplex)
            | undefined;
        /**
    ...
    export interface SecureClientSessionOptions
