...
declare global {
    var Crypto: typeof globalThis extends { onmessage: any; Crypto: infer T }
        ? T
        : {
    ...
    var CryptoKey: typeof globalThis extends { onmessage: any; CryptoKey: infer T }
        ? T
        : {
    ...
    var SubtleCrypto: typeof globalThis extends { onmessage: any; SubtleCrypto: infer T }
        ? T
        : {
