...
declare module "vm" {
    ...
    interface RunningScriptInNewContextOptions
        extends RunningScriptOptions,
            Pick<CreateContextOptions, "microtaskMode"> {
        /**
    ...
    interface CompileFunctionOptions
        extends BaseOptions,
            Pick<ScriptOptions, "cachedData" | "produceCachedData"> {
        /**
    ...
    interface ModuleEvaluateOptions
        extends Pick<RunningScriptOptions, "breakOnSigint" | "timeout"> {}
    type ModuleLinker = (
        specifier: string,
    ...
    interface SourceTextModuleOptions
        extends Pick<ScriptOptions, "cachedData" | "columnOffset" | "lineOffset"> {
        /**
