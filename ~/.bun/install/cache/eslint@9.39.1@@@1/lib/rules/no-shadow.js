...
const TYPES_HOISTED_NODES = new Set(["TSInterfaceDeclaration", "TSTypeAliasDeclaration"]);
...
module.exports = {
        ...
        schema: [
            {
                ...
                properties: {
                    ...
                    hoist: {
                        enum: ["all", "functions", "never", "types", "functions-and-types"],
                    },
                    allow: {
                        type: "array",
                        items: {
    ...
    create(context) {
        ...
        function isTypeValueShadow(variable, shadowedVariable) {
            ...
            const isTypeImport =
                ...
                (firstDefinition.parent.importKind === "type" ||
                    firstDefinition.parent.specifiers.some((s) => s.importKind === "type"));

            const isShadowedValue =
                !firstDefinition || (isTypeImport ? false : shadowedVariable.isValueVariable);
        ...
        function isExternalDeclarationMerging(scope, variable, shadowedVariable) {
            ...
            const moduleName =
                moduleDecl.id.type === "Literal" ? moduleDecl.id.value : moduleDecl.id.name;
