    ...
    create(context) {
        ...
        function checkForDanglingUnderscoreInVariableExpression(node) {
            sourceCode.getDeclaredVariables(node).forEach((variable) => {
                ...
                while (
                    !["VariableDeclarator", "ArrayPattern", "ObjectPattern"].includes(parent.type)
                ) {
        ...
        function checkForDanglingUnderscoreInMethod(node) {
            ...
            const isMethod =
                node.type === "MethodDefinition" || (node.type === "Property" && node.method);
            ...
            if (
                ...
                context.report({
                    ...
                    data: {
                        identifier:
                            node.key.type === "PrivateIdentifier" ? `#${identifier}` : identifier,
                    },
                });
            }
        }
