...
module.exports = {
    ...
    create(context) {
        ...
        if (context.options.length) {
            ...
            maxEOF =
                typeof context.options[0].maxEOF !== "undefined" ? context.options[0].maxEOF : max;
            maxBOF =
                typeof context.options[0].maxBOF !== "undefined" ? context.options[0].maxBOF : max;
        }
        ...
        const allLines =
            sourceCode.lines.at(-1) === "" ? sourceCode.lines.slice(0, -1) : sourceCode.lines;
