...
module.exports = {
    ...
    create(context) {
        ...
        const isGlobalsObject =
            typeof options[0] === "object" && Object.hasOwn(options[0], "globals");
        ...
        const globalObjects = new Set([...GLOBAL_OBJECTS, ...userGlobalObjects]);
        ...
        const restrictedGlobalMessages = restrictedGlobals.reduce((memo, option) => {
        ...
        return {
            ...
            "Program:exit"(node) {
                ...
                globalObjects.forEach((globalObjectName) => {
                    const variable = astUtils.getVariableByName(globalScope, globalObjectName);
                    ...
                    variable.references.forEach((reference) => {
                        ...
                        while (astUtils.isSpecificMemberAccess(parent, null, globalObjectName)) {
                            parent = parent.parent;
                        }

                        const propertyName = astUtils.getStaticPropertyName(parent);
