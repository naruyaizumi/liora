...
module.exports = {
    ...
    create(context) {
        const config = context.options[0] || {},
            ...
            ignoreReadonlyClassProperties = !!config.ignoreReadonlyClassProperties,
        ...
        return {
            Literal(node) {
                ...
                if (
                    ...
                    (ignoreEnums && isParentTSEnumDeclaration(fullNumberNode)) ||
                    (ignoreNumericLiteralTypes && isTSNumericLiteralType(fullNumberNode)) ||
                    (ignoreTypeIndexes && isAncestorTSIndexedAccessType(fullNumberNode)) ||
                    (ignoreReadonlyClassProperties &&
