...
var NodeCacheErrors = /* @__PURE__ */ ((NodeCacheErrors2) => {
    ...
    NodeCacheErrors2["ETTLTYPE"] =
        "The ttl argument has to be a number or a string for shorthand ttl.";
    ...
    set(key, value, ttl = 0) {
        if (typeof key !== "string" && typeof key !== "number") {
            throw this.createError(
                "The key argument has to be of type `string` or `number`. Found: `__key`" /* EKEYTYPE */,
                key
            );
        }
        if (ttl && typeof ttl !== "number" && typeof ttl !== "string") {
            throw this.createError(
                "The ttl argument has to be a number or a string for shorthand ttl." /* ETTLTYPE */,
                this.formatKey(key)
            );
        }
        ...
        if (this.options.maxKeys) {
            ...
            if (maxKeys > -1 && this.store.size >= maxKeys) {
                throw this.createError(
                    "Cache max keys amount exceeded" /* ECACHEFULL */,
                    this.formatKey(key)
                );
            }
        }
...
export { NodeCache, NodeCacheErrors, NodeCacheStore, index_default as default };
