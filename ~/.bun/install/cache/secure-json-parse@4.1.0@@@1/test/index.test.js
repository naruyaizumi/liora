...
test("parse", (t) => {
    ...
    t.test("parses object string (reviver)", (t) => {
        ...
        t.deepEqual(j.parse('{"a": 5, "b": 6}', reviver), JSON.parse('{"a": 5, "b": 6}', reviver));
        t.end();
    });
    ...
    t.test("protoAction", (t) => {
        ...
        t.test("ignores proto value", (t) => {
            t.deepEqual(j.parse('{"a": 5, "b": "__proto__"}'), { a: 5, b: "__proto__" });
            t.end();
        });
    ...
    t.test("constructorAction", (t) => {
        t.test("sanitizes object string (reviver, options)", (t) => {
            ...
            t.deepEqual(
                j.parse('{"a": 5, "b": 6, "constructor":{"prototype":{"bar":"baz"}} }', reviver, {
        ...
        t.test("sanitizes object string (null, options)", (t) => {
            t.deepEqual(
                j.parse('{"a": 5, "b": 6,"constructor":{"prototype":{"bar":"baz"}} }', null, {
                    constructorAction: "remove",
                }),
                { a: 5, b: 6 }
            );
        ...
        t.test("ignores proto value", (t) => {
            t.deepEqual(j.parse('{"a": 5, "b": "constructor"}'), { a: 5, b: "constructor" });
            t.end();
        });
        ...
        t.test("Should not throw if the constructor key hasn't a child named prototype", (t) => {
            t.doesNotThrow(
                () => j.parse('{ "a": 5, "b": 6, "constructor":{"bar":"baz"} }', null, null),
                SyntaxError
            );
            t.end();
        });
        ...
        t.test("handles constructor null safely", (t) => {
            ...
            t.deepEqual(j.parse('{"constructor": null}', { constructorAction: "remove" }), {
                constructor: null,
            });

            // Test that constructor: null doesn't throw error when using error action
            t.deepEqual(j.parse('{"constructor": null}', { constructorAction: "error" }), {
                constructor: null,
            });

            // Test that constructor: null is preserved when using ignore action
            t.deepEqual(j.parse('{"constructor": null}', { constructorAction: "ignore" }), {
                constructor: null,
            });
            t.end();
        });
...
test("safeParse", (t) => {
    t.test("parses buffer", (t) => {
        t.strictEqual(j.safeParse(Buffer.from('"X"')), JSON.parse(Buffer.from('"X"')));
        t.end();
    });
    ...
    t.test("returns null on proto object string", (t) => {
        t.strictEqual(j.safeParse('{ "a": 5, "b": 6, "__proto__": { "x": 7 } }'), null);
        t.end();
    });
...
test("safe option", (t) => {
    ...
    t.test("parse with safe=true and protoAction=ignore returns object", (t) => {
        const text = '{ "a": 5, "b": 6, "__proto__": { "x": 7 } }';
        t.deepEqual(j.parse(text, { safe: true, protoAction: "ignore" }), JSON.parse(text));
        t.end();
    });

    t.test("parse with safe=true and constructorAction=ignore returns object", (t) => {
        const text = '{ "a": 5, "b": 6, "constructor": {"prototype": {"bar": "baz"}} }';
        t.deepEqual(j.parse(text, { safe: true, constructorAction: "ignore" }), JSON.parse(text));
        t.end();
    });
