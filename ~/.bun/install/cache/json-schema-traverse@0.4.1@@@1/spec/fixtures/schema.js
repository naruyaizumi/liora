...
function subschema(keyword) {
    var sch = {
        ...
        anyOf: [{ format: "email" }, { format: "hostname" }],
    };
...
module.exports = {
    ...
    expectedCalls: [[schema, "", schema, undefined, undefined, undefined, undefined]]
        ...
        .concat([
            ...
            [
                schema.allOf[2].items[0].properties.foo_items_0,
                "/allOf/2/items/0/properties/foo_items_0",
                schema,
                "/allOf/2/items/0",
                "properties",
                schema.allOf[2].items[0],
            ...
            [
                schema.allOf[2].items[0].properties.bar_items_0,
                "/allOf/2/items/0/properties/bar_items_0",
                schema,
                "/allOf/2/items/0",
                "properties",
                schema.allOf[2].items[0],
            ...
            [
                schema.allOf[2].items[0].anyOf[0],
                "/allOf/2/items/0/anyOf/0",
                schema,
                "/allOf/2/items/0",
                "anyOf",
                schema.allOf[2].items[0],
            ...
            [
                schema.allOf[2].items[0].anyOf[1],
                "/allOf/2/items/0/anyOf/1",
                schema,
                "/allOf/2/items/0",
                "anyOf",
                schema.allOf[2].items[0],
            ...
            [
                schema.allOf[2].items[1].properties.foo_items_1,
                "/allOf/2/items/1/properties/foo_items_1",
                schema,
                "/allOf/2/items/1",
                "properties",
                schema.allOf[2].items[1],
            ...
            [
                schema.allOf[2].items[1].properties.bar_items_1,
                "/allOf/2/items/1/properties/bar_items_1",
                schema,
                "/allOf/2/items/1",
                "properties",
                schema.allOf[2].items[1],
            ...
            [
                schema.allOf[2].items[1].anyOf[0],
                "/allOf/2/items/1/anyOf/0",
                schema,
                "/allOf/2/items/1",
                "anyOf",
                schema.allOf[2].items[1],
            ...
            [
                schema.allOf[2].items[1].anyOf[1],
                "/allOf/2/items/1/anyOf/1",
                schema,
                "/allOf/2/items/1",
                "anyOf",
                schema.allOf[2].items[1],
...
function expectedCalls(keyword) {
    return [
        ...
        [
            schema[keyword].properties[`foo_${keyword}`],
            `/${keyword}/properties/foo_${keyword}`,
            schema,
            `/${keyword}`,
            "properties",
            schema[keyword],
        ...
        [
            schema[keyword].properties[`bar_${keyword}`],
            `/${keyword}/properties/bar_${keyword}`,
            schema,
            `/${keyword}`,
            "properties",
            schema[keyword],
...
function expectedCallsChild(keyword, i) {
    return [
        ...
        [
            schema[keyword][i].properties[`foo_${keyword}_${i}`],
            `/${keyword}/${i}/properties/foo_${keyword}_${i}`,
            schema,
            `/${keyword}/${i}`,
            "properties",
            schema[keyword][i],
        ...
        [
            schema[keyword][i].properties[`bar_${keyword}_${i}`],
            `/${keyword}/${i}/properties/bar_${keyword}_${i}`,
            schema,
            `/${keyword}/${i}`,
            "properties",
            schema[keyword][i],
