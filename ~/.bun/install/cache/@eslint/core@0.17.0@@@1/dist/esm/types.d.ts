...
export type ViolationReport<Node = unknown, MessageIds = string> = ViolationReportBase &
...
export type CustomRuleDefinitionType<
    ...
    Options extends Partial<CustomRuleTypeDefinitions>,
> = RuleDefinition<
    LanguageSpecificOptions & Required<Options & Omit<CustomRuleTypeDefinitions, keyof Options>>
>;
/**
 ...
 */
export interface Processor<T extends string | ProcessorFile = string | ProcessorFile>
