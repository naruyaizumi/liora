 ...
 * <Options>
 */
export type TextSourceCode<
    Options extends SourceCodeBaseTypeOptions = $eslintcore.SourceCodeBaseTypeOptions,
> = import("@eslint/core").TextSourceCode<Options>;
...
export class CallMethodStep implements CallTraversalStep {
     ...
     */
    constructor({ target, args }: { target: string; args: Array<any> });
    /**
...
> implements TextSourceCode<Options>
{
     ...
     */
    public getText(
        node?: Options["SyntaxElementWithLoc"],
        beforeCount?: number,
        afterCount?: number
    ): string;
    /**
...
export class VisitNodeStep implements VisitTraversalStep {
     ...
     * @param {Array<any>} options.args The arguments of the step.
     */
    constructor({ target, phase, args }: { target: object; phase: 1 | 2; args: Array<any> });
    /**
     * The type of the step.
     * @type {"visit"}
     * @readonly
