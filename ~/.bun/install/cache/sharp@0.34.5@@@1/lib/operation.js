    ...
    if (is.defined(options)) {
        if (is.object(options)) {
            ...
            if (is.defined(options.interpolator)) {
                if (
                    is.inArray(options.interpolator, Object.values(this.constructor.interpolators))
                ) {
...
function convolve(kernel) {
    if (
        ...
        !is.integer(kernel.width) ||
        !is.integer(kernel.height) ||
        !is.inRange(kernel.width, 3, 1001) ||
        !is.inRange(kernel.height, 3, 1001) ||
