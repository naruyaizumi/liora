...
!(function (e, r) {
    ...
    function a(e) {
        return e !== undefined && null !== e
            ? e instanceof Array
                ? e
                : "number" != typeof e.length || e.split || e.setInterval || e.call
                  ? [e]
    ...
    function d(e) {
        for (var r = "", n = 0, t = e.length; n < t; ) {
            ...
            if (o < 128) ((r += String.fromCharCode(o)), (n += 3));
            else if (o >= 194 && o < 224) {
                if (t - n >= 6) {
        ...
        return (
            ...
            e.userinfo !== undefined &&
                (e.userinfo = String(e.userinfo)
                    .replace(r.PCT_ENCODED, n)
                    .replace(r.NOT_USERINFO, h)
                    .replace(r.PCT_ENCODED, o)),
            e.host !== undefined &&
                (e.host = String(e.host)
                    .replace(r.PCT_ENCODED, n)
                    .toLowerCase()
                    .replace(r.NOT_HOST, h)
                    .replace(r.PCT_ENCODED, o)),
            e.path !== undefined &&
                (e.path = String(e.path)
                    .replace(r.PCT_ENCODED, n)
                    .replace(e.scheme ? r.NOT_PATH : r.NOT_PATH_NOSCHEME, h)
                    .replace(r.PCT_ENCODED, o)),
            e.query !== undefined &&
                (e.query = String(e.query)
                    .replace(r.PCT_ENCODED, n)
                    .replace(r.NOT_QUERY, h)
                    .replace(r.PCT_ENCODED, o)),
            e.fragment !== undefined &&
                (e.fragment = String(e.fragment)
                    .replace(r.PCT_ENCODED, n)
                    .replace(r.NOT_FRAGMENT, h)
                    .replace(r.PCT_ENCODED, o)),
            e
        );
    }
    ...
    function v(e, r) {
        ...
        if (o) {
            for (
                var i = o.toLowerCase().split("::").reverse(),
                    u = T(i, 2),
                    s = u[0],
                    f = u[1],
                    c = f ? f.split(":").map(m) : [],
                    p = s.split(":").map(m),
                    h = r.IPV4ADDRESS.test(p[p.length - 1]),
                    d = h ? 7 : 8,
                    l = p.length - d,
                    v = Array(d),
                    E = 0;
            ...
            var C = v.reduce(function (e, r, n) {
                    if (!r || "0" === r) {
                        var t = e[e.length - 1];
                        t && t.index + t.length === n
                            ? t.length++
                            : e.push({ index: n, length: 1 });
                    }
                    return e;
                }, []),
    ...
    function E(e) {
        ...
        if (o) {
            ...
            if (r.unicodeSupport || (a && a.unicodeSupport)) l(n, t);
            else {
                if (n.host && (r.domainHost || (a && a.domainHost)))
                    try {
                        n.host = B.toASCII(n.host.replace(t.PCT_ENCODED, d).toLowerCase());
                    } catch (i) {
                        n.error =
                            n.error ||
                            "Host's domain name can not be converted to ASCII via punycode: " + i;
                    }
                l(n, F);
            }
    ...
    function C(e, r) {
        var n = !1 !== r.iri ? R : F,
            t = [];
        return (
            e.userinfo !== undefined && (t.push(e.userinfo), t.push("@")),
            e.host !== undefined &&
                t.push(
                    v(g(String(e.host), n), n).replace(n.IPV6ADDRESS, function (e, r, n) {
                        return "[" + r + (n ? "%25" + n : "") + "]";
                    })
                ),
            ("number" != typeof e.port && "string" != typeof e.port) ||
                (t.push(":"), t.push(String(e.port))),
            t.length ? t.join("") : undefined
        );
    }
    function y(e) {
        for (var r = []; e.length; )
            if (e.match(X)) e = e.replace(X, "");
            else if (e.match(ee)) e = e.replace(ee, "/");
            else if (e.match(re)) ((e = e.replace(re, "/")), r.pop());
            else if ("." === e || ".." === e) e = "";
            else {
                var n = e.match(ne);
    ...
    function S(e) {
        ...
        if ((o && o.serialize && o.serialize(e, r), e.host))
            ...
            else if (r.domainHost || (o && o.domainHost))
                try {
                    e.host = r.iri
                        ? B.toUnicode(e.host)
                        : B.toASCII(e.host.replace(n.PCT_ENCODED, d).toLowerCase());
                } catch (u) {
                    e.error =
                        e.error ||
        ...
        if (
            (a !== undefined &&
                ("suffix" !== r.reference && t.push("//"),
                t.push(a),
                e.path && "/" !== e.path.charAt(0) && t.push("/")),
            e.path !== undefined)
        ) {
            var i = e.path;
            (r.absolutePath || (o && o.absolutePath) || (i = y(i)),
                a === undefined && (i = i.replace(/^\/\//, "/%2F")),
                t.push(i));
        }
        return (
            e.query !== undefined && (t.push("?"), t.push(e.query)),
            e.fragment !== undefined && (t.push("#"), t.push(e.fragment)),
            t.join("")
        );
    }
    function A(e, r) {
        ...
        return (
            ...
            !n.tolerant && r.scheme
                ? ((o.scheme = r.scheme),
                  ...
                  (o.path = y(r.path || "")),
                  (o.query = r.query))
                : (r.userinfo !== undefined || r.host !== undefined || r.port !== undefined
                      ? ((o.userinfo = r.userinfo),
                        (o.host = r.host),
                        (o.port = r.port),
                        (o.path = y(r.path || "")),
                      ...
                      : (r.path
                            ? ("/" === r.path.charAt(0)
                              ...
                              (o.query = r.query))
                            : ((o.path = e.path),
                              r.query !== undefined ? (o.query = r.query) : (o.query = e.query)),
    ...
    function D(e, r, n) {
        var t = i({ scheme: "null" }, n);
        return S(A(E(e, t), E(r, t), t, !0), t);
    }
    function w(e, r) {
        return (
            "string" == typeof e ? (e = S(E(e, r), r)) : "object" === t(e) && (e = E(S(e, r), r)),
            e
        );
    }
    function b(e, r, n) {
        return (
            "string" == typeof e ? (e = S(E(e, n), n)) : "object" === t(e) && (e = S(e, n)),
            "string" == typeof r ? (r = S(E(r, n), n)) : "object" === t(r) && (r = S(r, n)),
            e === r
        );
    }
    function x(e, r) {
    ...
    var F = u(!1),
            ...
            function e(e, r) {
                ...
                try {
                    for (
                        ...
                        !(t = (i = u.next()).done) && (n.push(i.value), !r || n.length !== r);
                        t = !0
                    );
                } catch (s) {
                    ((o = !0), (a = s));
        ...
        ae = {
            ...
            serialize: function (e, r) {
                if (
                    ((e.port !== (N(e) ? 443 : 80) && "" !== e.port) || (e.port = undefined),
                    "boolean" == typeof e.secure &&
                        ((e.scheme = e.secure ? "wss" : "ws"), (e.secure = undefined)),
                    e.resourceName)
                ) {
        ...
        ie = { scheme: "wss", domainHost: ae.domainHost, parse: ae.parse, serialize: ae.serialize },
        ue = {},
        se =
            "[A-Za-z0-9\\-\\.\\_\\~\\xA0-\\u200D\\u2010-\\u2029\\u202F-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFEF]",
        fe = "[0-9A-Fa-f]",
        ce = n(
            n("%[EFef][0-9A-Fa-f]%" + fe + fe + "%" + fe + fe) +
                "|" +
                n("%[89A-Fa-f][0-9A-Fa-f]%" + fe + fe) +
                "|" +
                n("%" + fe + fe)
        ),
        ...
        ve = {
            ...
            parse: function (e, r) {
                ...
                if (((n.path = undefined), n.query)) {
                    for (
                        var o = !1, a = {}, i = n.query.split("&"), u = 0, s = i.length;
                        u < s;
                        ++u
                    ) {
                        var f = i[u].split("=");
                ...
                for (var d = 0, l = t.length; d < l; ++d) {
                    var m = t[d].split("@");
                    if (((m[0] = O(m[0])), r.unicodeSupport)) m[1] = O(m[1], r).toLowerCase();
                    else
                        try {
            ...
            serialize: function (e, r) {
                ...
                for (var m in d)
                    d[m] !== ue[m] &&
                        l.push(
                            m.replace(de, I).replace(de, o).replace(me, h) +
                                "=" +
                                d[m].replace(de, I).replace(de, o).replace(ge, h)
                        );
    ...
    ((J[te.scheme] = te),
        ...
        (e.pctDecChars = d),
        (e.parse = E),
        (e.removeDotSegments = y),
        (e.serialize = S),
        (e.resolveComponents = A),
        (e.resolve = D),
        (e.normalize = w),
        (e.equal = b),
        (e.escapeComponent = x),
        (e.unescapeComponent = O),
