...
const { LEVEL_NAMES } = require("../constants");
...
function parseFactoryOptions(options) {
    ...
    const includeKeys =
        options.include !== undefined ? new Set(options.include.split(",")) : undefined;
    const ignoreKeys =
        !includeKeys && options.ignore ? new Set(options.ignore.split(",")) : undefined;
