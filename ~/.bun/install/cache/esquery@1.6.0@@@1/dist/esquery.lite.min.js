!(function (t, e) {
                ...
                if (null != r) {
                    ...
                    try {
                        if (((o = (r = r.call(t)).next), 0 === e)) {
                            ...
                            for (
                                ;
                                !(c = (n = o.call(r)).done) && (s.push(n.value), s.length !== e);
                                c = !0
                            );
                    } catch (t) {
                        ((i = !0), (u = t));
                    ...
                    (t.buildMessage = function (t, e) {
                        ...
                        return (
                            ...
                            (function (t) {
                                ...
                                for (e = 0; e < t.length; e++) o[e] = ((u = t[e]), r[u.type](u));
                    ...
                    }),
                    {
                        ...
                        parse: function (e, r) {
                            ...
                            function Ct() {
                                ...
                                if (
                                    ((t = at),
                                    33 === e.charCodeAt(at) ? ((r = "!"), at++) : ((r = s), yt(x)),
                                    r === s && (r = null),
                                    r !== s)
                                ) {
                                    if (((n = []), (u = wt()) !== s))
                            ...
                            function Et(t) {
                                return { type: "nth-child", index: { type: "literal", value: t } };
                            }
                            function St(t) {
                                return {
                                    type: "nth-last-child",
    ...
    function f(e, r) {
        var n = (r && r.nodeTypeKey) || "type",
            u = e[n];
        return r && r.visitorKeys && r.visitorKeys[u]
            ? r.visitorKeys[u]
            : t.VisitorKeys[u]
              ? t.VisitorKeys[u]
              : r && "function" == typeof r.fallback
                ? r.fallback(e)
    ...
    function v(t, e, n, u, o) {
        ...
        for (var s = f(a, o), c = 0; c < s.length; ++c) {
            ...
            if (Array.isArray(i)) {
                var l = i.indexOf(t);
                if (l < 0) continue;
                if ("LEFT_SIDE" === u && l > 0 && h(i[l - 1], o) && e(i[l - 1], n, o)) return !0;
                if ("RIGHT_SIDE" === u && l < i.length - 1 && h(i[l + 1], o) && e(i[l + 1], n, o))
                    return !0;
            }
        }
        return !1;
