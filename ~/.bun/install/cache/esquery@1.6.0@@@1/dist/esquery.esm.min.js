...
var i = a(function (e, t) {
        !(function e(t) {
            ...
            function u(e) {
                ...
                for (t in e)
                    e.hasOwnProperty(t) &&
                        ((r = e[t]), (n[t] = "object" == typeof r && null !== r ? u(r) : r));
                return n;
            }
            function l(e, t) {
                ...
                (f.prototype.__initialize = function (e, t) {
                    ((this.visitor = t),
                        ...
                        "iteration" === t.fallback
                            ...
                            : "function" == typeof t.fallback && (this.__fallback = t.fallback),
                        (this.__keys = o),
                        t.keys &&
                    ...
                    }),
                    {
                        ...
                        parse: function (t, r) {
                            ...
                            function he(e) {
                                ...
                                if (n) return n;
                                for (r = e - 1; !se[r]; ) r--;
                                for (n = { line: (n = se[r]).line, column: n.column }; r < e; )
                                    (10 === t.charCodeAt(r)
                                        ? (n.line++, (n.column = 1))
                                        : n.column++,
                                        r++);
                            ...
                            function Se() {
                                ...
                                if (
                                    ((e = ie),
                                    33 === t.charCodeAt(ie) ? ((r = "!"), ie++) : ((r = s), de(v)),
                                    r === s && (r = null),
                                    r !== s)
                                ) {
                                    if (((n = []), (o = _e()) !== s))
...
function p(e, t) {
    var r = (t && t.nodeTypeKey) || "type",
        n = e[r];
    return t && t.visitorKeys && t.visitorKeys[n]
        ? t.visitorKeys[n]
        : i.VisitorKeys[n]
          ? i.VisitorKeys[n]
          : t && "function" == typeof t.fallback
            ? t.fallback(e)
...
function d(e, r, n, o, a) {
    ...
    for (var s = p(i, a), u = 0; u < s.length; ++u) {
        ...
        if (Array.isArray(l)) {
            ...
            if ("RIGHT_SIDE" === o && c < l.length - 1 && h(l[c + 1], a) && r(l[c + 1], n, a))
                return !0;
        }
    }
    return !1;
