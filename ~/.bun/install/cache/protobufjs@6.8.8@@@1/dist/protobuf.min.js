    ...
    ((r = {
        ...
        2: [
            function (t, i, n) {
                ...
                for (var h = Array(64), f = Array(123), e = 0; e < 64; )
                    f[(h[e] = e < 26 ? e + 65 : e < 52 ? e + 71 : e < 62 ? e - 4 : (e - 59) | 43)] =
                        e++;
                r.encode = function (t, i, n) {
                    for (var r, e = null, s = [], u = 0, o = 0; i < n; ) {
                        ...
                        8191 < u &&
                            ((e || (e = [])).push(String.fromCharCode.apply(String, s)), (u = 0));
                    }
                    return (
                        o && ((s[u++] = h[r]), (s[u++] = 61), 1 === o && (s[u++] = 61)),
                        e
                            ? (u && e.push(String.fromCharCode.apply(String, s.slice(0, u))),
                              e.join(""))
                ...
                function c(i, n) {
                    ...
                    function h(t) {
                        if ("string" != typeof t) {
                            var i = a();
                            if (
                                (c.verbose && console.log("codegen: " + i), (i = "return " + i), t)
                            ) {
                                for (
                                    var n = Object.keys(t),
                                        r = Array(n.length + 1),
                    ...
                    return (
                        "undefined" != typeof Float32Array
                            ? (function () {
                                  ...
                                  ((o.writeFloatLE = t ? i : n),
                                      (o.writeFloatBE = t ? n : i),
                                      (o.readFloatLE = t ? s : u),
                                      (o.readFloatBE = t ? u : s));
                              })()
                            : (function () {
                                  function t(t, i, n, r) {
                                      var e = i < 0 ? 1 : 0;
                                      if ((e && (i = -i), 0 === i))
                                          t(0 < 1 / i ? 0 : 2147483648, n, r);
                                      else if (isNaN(i)) t(2143289344, n, r);
                                      else if (34028234663852886e22 < i)
                                          t(((e << 31) | 2139095040) >>> 0, n, r);
                                  ...
                                  function i(t, i, n) {
                                      ...
                                      return 255 === s
                                          ? u
                                              ...
                                              : e * (1 / 0)
                                          : 0 === s
                                            ? 1401298464324817e-60 * e * u
                                            : e * Math.pow(2, s - 150) * (u + 8388608);
                                  }
                                  ((o.writeFloatLE = t.bind(null, r)),
                                      (o.writeFloatBE = t.bind(null, e)),
                                      (o.readFloatLE = i.bind(null, s)),
                        ...
                        "undefined" != typeof Float64Array
                            ? (function () {
                                  ...
                                  ((o.writeDoubleLE = t ? i : n),
                                      (o.writeDoubleBE = t ? n : i),
                                      (o.readDoubleLE = t ? s : u),
                            ...
                            : (function () {
                                  ...
                                  function i(t, i, n, r, e) {
                                      ...
                                      return 2047 === f
                                          ...
                                          : 0 === f
                                            ? 5e-324 * o * h
                                            : o * Math.pow(2, f - 1075) * (h + 4503599627370496);
                                  }
                                  ((o.writeDoubleLE = t.bind(null, r, 0, 4)),
                                      (o.writeDoubleBE = t.bind(null, e, 4, 0)),
                                      (o.readDoubleLE = i.bind(null, s, 0, 4)),
                                      (o.readDoubleBE = i.bind(null, u, 4, 0)));
                              })(),
                        o
                    );
                }
        ...
        12: [
            function (t, i, n) {
                ...
                function u(t, i, n, r) {
                    if (i.resolvedType)
                        if (i.resolvedType instanceof l) {
                            t("switch(d%s){", r);
                            for (
                                var e = i.resolvedType.values, s = Object.keys(e), u = 0;
                                u < s.length;
                                ++u
                            )
                                (i.repeated && e[s[u]] === i.typeDefault && t("default:"),
                                    t("case%j:", s[u])("case %i:", e[s[u]])("m%s=%j", r, e[s[u]])(
                                        "break"
                                    ));
                            t("}");
                        } else
                ...
                ((r.fromObject = function (t) {
                    var i = t.fieldsArray,
                        n = v.codegen(["d"], t.name + "$fromObject")("if(d instanceof this.ctor)")(
                            "return d"
                        );
                    ...
                    (r.toObject = function (t) {
                        ...
                        for (
                            var n = v.codegen(["m", "o"], t.name + "$toObject")("if(!o)")("o={}")(
                                    "var d={}"
                                ),
                                r = [],
                                e = [],
                        ...
                        if (s.length) {
                            for (n("if(o.defaults){"), u = 0; u < s.length; ++u) {
                                var o = s[u],
                                    f = v.safeProp(o.name);
                                if (o.resolvedType instanceof l)
                                    n(
                                        "d%s=o.enums===String?%j:%j",
                                        f,
                                        o.resolvedType.valuesById[o.typeDefault],
                                        o.typeDefault
                                    );
                                else if (o.long)
                                    n("if(util.Long){")(
                                        ...
                                        f,
                                        o.typeDefault.toString(),
                                        o.typeDefault.toNumber()
                                    );
                                else if (o.bytes) {
                                    var h =
                                        "[" +
                                        Array.prototype.slice.call(o.typeDefault).join(",") +
                                        "]";
                                    n(
                                        "if(o.bytes===String)d%s=%j",
                                        f,
                                        String.fromCharCode.apply(String, o.typeDefault)
                                    )("else{")("d%s=%s", f, h)(
                        ...
                        for (u = 0; u < i.length; ++u) {
                            ...
                            (o.map
                                ? (a || ((a = !0), n("var ks2")),
                                  n("if(m%s&&(ks2=Object.keys(m%s)).length){", f, f)("d%s={}", f)(
                                ...
                                : o.repeated
                                  ? (n("if(m%s&&m%s.length){", f, f)("d%s=[]", f)(
                                    ...
                                    d(n, o, c, f + "[j]")("}"))
                                  : (n("if(m%s!=null&&m.hasOwnProperty(%j)){", f, o.name),
                                    d(n, o, c, f),
                                    o.partOf &&
                                        n("if(o.oneofs)")(
                                            "d%s=%j",
                                            v.safeProp(o.partOf.name),
                                            o.name
                                        )),
                                n("}"));
                        }
            ...
            function (t, i) {
                i.exports = function (t) {
                    ...
                    for (var n = 0; n < t.fieldsArray.length; ++n) {
                        ...
                        (i("case %i:", r.id),
                            r.map
                                ? (i("r.skip().pos++")("if(%s===util.emptyObject)", s)("%s={}", s)(
                                      "k=r.%s()",
                                      r.keyType
                                  )("r.pos++"),
                                  f.long[r.keyType] !== tt
                                      ...
                                      : f.basic[e] === tt
                                        ? i("%s[k]=types[%i].decode(r,r.uint32())", s, n)
                                        : i("%s[k]=r.%s()", s, e))
                                : r.repeated
                            ...
                            s.map
                                ? (n(
                                  ...
                                  f === tt
                                      ...
                                      : n(".uint32(%i).%s(%s[ks[i]]).ldelim()", 16 | f, o, i),
                                  n("}")("}"))
                                : s.repeated
                                  ? (n("if(%s!=null&&%s.length){", i, i),
                                    s.packed && a.packed[o] !== tt
                                    ...
                                    n("}"))
                                  : (s.optional &&
                                        n("if(%s!=null&&m.hasOwnProperty(%j))", i, s.name),
                                    f === tt
                                        ? l(n, s, u, i)
                                        : n("w.uint32(%i).%s(%s)", ((s.id << 3) | f) >>> 0, o, i)));
                    }
                    return n("return w");
                };
                var h = t(15),
        ...
        15: [
            function (t, i) {
                ...
                function e(t, i, n, r, e) {
                    if ((o.call(this, t, n), i && "object" != typeof i))
                    ...
                    if (
                        ...
                        for (var s = Object.keys(i), u = 0; u < s.length; ++u)
                            "number" == typeof i[s[u]] &&
                                (this.valuesById[(this.values[s[u]] = i[s[u]])] = s[u]);
                }
                ((e.fromJSON = function (t, i) {
                    ...
                    (e.prototype.toJSON = function (t) {
                        ...
                        return r.toObject([
                            ...
                            this.values,
                            "reserved",
                            this.reserved && this.reserved.length ? this.reserved : tt,
                            "comment",
                            i ? this.comment : tt,
                            "comments",
                            i ? this.comments : tt,
            ...
            function (t, i) {
                ...
                function u(t, i, n, r, e, s, u) {
                    if (
                        (h.isObject(r)
                            ? ((u = e), (s = r), (r = e = tt))
                            : h.isObject(e) && ((u = s), (s = e), (e = tt)),
                        o.call(this, t, s),
                        !h.isInteger(i) || i < 0)
                    )
                        throw TypeError("id must be a non-negative integer");
                    if (!h.isString(n)) throw TypeError("type must be a string");
                    if (r !== tt && !a.test((r = r.toString().toLowerCase())))
                ...
                ((u.fromJSON = function (t, i) {
                    ...
                    Object.defineProperty(u.prototype, "packed", {
                        get: function () {
                            return (
                                null === this.u && (this.u = !1 !== this.getOption("packed")),
                                this.u
                            );
                        },
                    }),
                    ...
                    (u.prototype.toJSON = function (t) {
                        ...
                        return h.toObject([
                            "rule",
                            ("optional" !== this.rule && this.rule) || tt,
                            "type",
                            this.type,
                            "id",
                            this.id,
                    ...
                    (u.prototype.resolve = function () {
                        ...
                        if (
                            ((this.typeDefault = f.defaults[this.type]) === tt &&
                                ((this.resolvedType = (
                            ...
                            this.options &&
                                ((!0 !== this.options.packed &&
                                    (this.options.packed === tt ||
                                        !this.resolvedType ||
                                        this.resolvedType instanceof r)) ||
                                    delete this.options.packed,
                                Object.keys(this.options).length || (this.options = tt)),
                            this.long)
                        )
        ...
        18: [
            function (t, i, n) {
                var r = n;
                function e() {
                    (r.Reader.o(r.BufferReader), r.util.o());
                }
                ((r.build = "minimal"),
                    (r.Writer = t(42)),
                    (r.BufferWriter = t(43)),
        ...
        19: [
            function (t, i) {
                ...
                ((n.build = "full"),
                    ...
                    (n.parse = t(26)),
                    (n.common = t(11)),
                    n.Root.o(n.Type, n.parse, n.common));
            },
        ...
        20: [
            function (t, i) {
                ...
                function s(t, i, n, r, e, s) {
                    if ((u.call(this, t, i, r, tt, tt, e, s), !o.isString(n)))
        ...
        23: [
            function (t, i) {
                ...
                function h(t, i) {
                    (n.call(this, t, i), (this.nested = tt), (this.f = null));
                }
                function a(t) {
                    return ((t.f = null), t);
                }
                ((h.fromJSON = function (t, i) {
                    ...
                    (h.prototype.resolveAll = function () {
                        for (var t = this.nestedArray, i = 0; i < t.length; )
                            t[i] instanceof h ? t[i++].resolveAll() : t[i++].resolve();
                        return this.resolve();
                    }),
                    (h.prototype.lookup = function (t, i, n) {
                        ...
                        if (r) {
                            ...
                            } else if (r instanceof h && (r = r.lookup(t.slice(1), i, !0)))
                                return r;
                        } else
                            for (var e = 0; e < this.nestedArray.length; ++e)
                                if (this.f[e] instanceof h && (r = this.f[e].lookup(t, i, !0)))
                                    return r;
            ...
            function (t, i) {
                ...
                (Object.defineProperties(e.prototype, {
                    ...
                    (e.prototype.setOption = function (t, i, n) {
                        return (
                            (n && this.options && this.options[t] !== tt) ||
        ...
        25: [
            function (t, i) {
                ...
                function s(t, i, n, r) {
                    if (
                        (Array.isArray(i) || ((n = i), (i = tt)),
                        e.call(this, t, n),
                        i !== tt && !Array.isArray(i))
                    )
                ...
                ((s.fromJSON = function (t, i) {
                    ...
                    (s.d = function () {
                        for (var n = Array(arguments.length), t = 0; t < arguments.length; )
                            n[t] = arguments[t++];
                        return function (t, i) {
                            (r.decorateType(t.constructor).add(new s(i, n)),
        ...
        26: [
            function (t, i) {
                ...
                function Y(t, i, n) {
                    (i instanceof I || ((n = i), (i = new I())), n || (n = Y.defaults));
                    var r,
                        e,
                        s,
                        u,
                        o,
                        f = M(t, n.alternateCommentMode || !1),
                        h = f.next,
                        a = f.push,
                        c = f.peek,
                        l = f.skip,
                    ...
                    function g(i) {
                        ...
                        try {
                            return (function (t, i) {
                                var n = 1;
                                "-" === t.charAt(0) && ((n = -1), (t = t.substring(1)));
                                switch (t) {
                                    case "inf":
                                    case "INF":
                                    case "Inf":
                                ...
                                if (P.test(t)) return n * parseInt(t, 10);
                                if (X.test(t)) return n * parseInt(t, 16);
                                if (D.test(t)) return n * parseInt(t, 8);
                                if (W.test(t)) return n * parseFloat(t);
                                throw b(t, "number", i);
                            })(n, !0);
                        } catch (t) {
                    ...
                    function E() {
                        if (r !== tt) throw b("package");
                        if (((r = h()), !K.test(r))) throw b(r, "name");
                        ((w = w.define(r)), l(";"));
                    }
                    function O() {
                        var t,
                    ...
                    function x(t, i) {
                        switch (i) {
                            ...
                            case "message":
                                return (
                                    (function (t, i) {
                                        if (!G.test((i = h()))) throw b(i, "type name");
                                        var n = new F(i);
                                        (S(n, function (t) {
                                            if (!x(n, t))
                                                switch (t) {
                                                    case "map":
                                                        !(function (t) {
                                                            ...
                                                            l(",");
                                                            var n = h();
                                                            if (!K.test(n)) throw b(n, "type");
                                                            l(">");
                                                            var r = h();
                                                            if (!G.test(r)) throw b(r, "name");
                                                            l("=");
                                                            var e = new U(y(r), k(h()), i, n);
                                                            (S(
                                                                e,
                                                                function (t) {
                                                                    if ("option" !== t) throw b(t);
                                                                    (N(e, t), l(";"));
                                                                },
                                                                function () {
                                                                    $(e);
                                                    ...
                                                    case "oneof":
                                                        ...
                                                        break;
                                                    case "extensions":
                                                        j(n.extensions || (n.extensions = []));
                                                        break;
                                                    case "reserved":
                                                        j(n.reserved || (n.reserved = []), !0);
                                                        break;
                                                    default:
                                                        if (!p || !K.test(t)) throw b(t);
                                                        (a(t), T(n, "optional"));
                                                }
                                        }),
                                            t.add(n));
                            ...
                            case "service":
                                return (
                                    (function (t, i) {
                                        if (!G.test((i = h()))) throw b(i, "service name");
                                        var n = new R(i);
                                        (S(n, function (t) {
                                            if (!x(n, t)) {
                                                if ("rpc" !== t) throw b(t);
                            ...
                            case "extend":
                                return (
                                    (function (i, t) {
                                        if (!K.test((t = h()))) throw b(t, "reference");
                                        var n = t;
                                        S(null, function (t) {
                                            switch (t) {
                                                case "required":
                    ...
                    function S(t, i, n) {
                        var r = f.line;
                        if ((t && ((t.comment = v()), (t.filename = Y.filename)), l("{", !0))) {
                            for (var e; "}" !== (e = h()); ) i(e);
                            l(";", !0);
                        } else
                            (n && n(),
                                l(";"),
                                t && "string" != typeof t.comment && (t.comment = v(r)));
                    }
                    function T(t, i, n) {
                        var r = h();
                        if ("group" !== r) {
                            if (!K.test(r)) throw b(r, "type");
                            var e = h();
                            if (!G.test(e)) throw b(e, "name");
                            ((e = y(e)), l("="));
                            var s = new L(e, k(h()), r, i, n);
                            (S(
                                s,
                                function (t) {
                                    if ("option" !== t) throw b(t);
                                ...
                                p ||
                                    !s.repeated ||
                                    (Z.packed[r] === tt && Z.basic[r] !== tt) ||
                                    s.setOption("packed", !1, !0));
                        } else
                            !(function (t, i) {
                                var n = h();
                                if (!G.test(n)) throw b(n, "name");
                                var r = B.lcFirst(n);
                                n === r && (n = B.ucFirst(n));
                                l("=");
                                var e = k(h()),
                    ...
                    function N(t, i) {
                        var n = l("(", !0);
                        if (!K.test((i = h()))) throw b(i, "name");
                        var r = i;
                        (n &&
                            (l(")"), (r = "(" + r + ")"), (i = c()), Q.test(i) && ((r += i), h())),
                            l("="),
                            (function t(i, n) {
                                if (l("{", !0))
                                    do {
                                        if (!G.test((o = h()))) throw b(o, "name");
                                        ("{" === c()
                                            ? t(i, n + "." + o)
                                            : (l(":"),
                                              "{" === c()
                    ...
                    return (
                        (Y.filename = null),
                        { package: r, imports: e, weakImports: s, syntax: u, root: i }
                    );
                }
            },
            {
        ...
        27: [
            function (t, i) {
                ...
                function l() {
                    ...
                    return new e(c(this.buf, (this.pos += 4)), c(this.buf, (this.pos += 4)));
                }
                ((o.create = r.Buffer
                    ? function (t) {
                    ...
                    (o.prototype.uint32 =
                        ...
                        function () {
                            if (
                                ((f = (127 & this.buf[this.pos]) >>> 0), this.buf[this.pos++] < 128)
                            )
                                return f;
                            if (
                                ((f = (f | ((127 & this.buf[this.pos]) << 7)) >>> 0),
                                this.buf[this.pos++] < 128)
                            )
                                return f;
                            if (
                                ((f = (f | ((127 & this.buf[this.pos]) << 14)) >>> 0),
                                this.buf[this.pos++] < 128)
                            )
                                return f;
                            if (
                                ((f = (f | ((127 & this.buf[this.pos]) << 21)) >>> 0),
                                this.buf[this.pos++] < 128)
                            )
                                return f;
                            if (
                                ((f = (f | ((15 & this.buf[this.pos]) << 28)) >>> 0),
                                this.buf[this.pos++] < 128)
                            )
                                return f;
                    ...
                    (o.o = function (t) {
                        ...
                        r.merge(o.prototype, {
                            ...
                            sint64: function () {
                                return a.call(this).zzDecode()[i](!1);
                            },
                            fixed64: function () {
        ...
        29: [
            function (t, i) {
                ...
                ((n.fromJSON = function (t, i) {
                    ...
                    (n.prototype.resolvePath = p.path.resolve),
                    (n.prototype.load = function t(i, s, u) {
                        "function" == typeof s && ((u = s), (s = tt));
                        var o = this;
                        if (!u) return p.asPromise(t, o, i, s);
                        var f = u === w;
                        function h(t, i) {
                            if (u) {
                                var n = u;
                        ...
                        function a(t, i) {
                            try {
                                if (
                                    (p.isString(i) && "{" === i.charAt(0) && (i = JSON.parse(i)),
                                    p.isString(i))
                                ) {
                                    v.filename = t;
                                    var n,
                                    ...
                                    if (r.imports)
                                        for (; e < r.imports.length; ++e)
                                            (n = o.resolvePath(t, r.imports[e])) && c(n);
                                    if (r.weakImports)
                                        for (e = 0; e < r.weakImports.length; ++e)
                                            (n = o.resolvePath(t, r.weakImports[e])) && c(n, !0);
                        ...
                        function c(n, r) {
                            ...
                            if (!(-1 < o.files.indexOf(n)))
                                if ((o.files.push(n), n in d))
                                    ...
                                    var e;
                                    try {
                                        e = p.fs.readFileSync(n).toString("utf8");
                                    } catch (t) {
                                        return void (r || h(t));
                                    }
                                    a(n, e);
                                    ...
                                    (++l,
                                        p.fetch(n, function (t, i) {
                                            (--l,
                                                u && (t ? (r ? l || h(null, o) : h(t)) : a(n, i)));
                                        }));
                        }
                        var l = 0;
                        p.isString(i) && (i = [i]);
                        for (var n, r = 0; r < i.length; ++r) (n = o.resolvePath("", i[r])) && c(n);
                        return f ? o : (l || h(null, o), tt);
                    }),
                ...
                function h(t, i) {
                    ...
                    if (n) {
                        var r = new s(i.fullName, i.id, i.type, i.rule, tt, i.options);
                ...
                ((n.prototype.h = function (t) {
                    if (t instanceof s)
                        t.extend === tt || t.extensionField || h(0, t) || this.deferred.push(t);
                    else if (t instanceof u) f.test(t.name) && (t.parent[t.name] = t.values);
                    else if (!(t instanceof o)) {
                        if (t instanceof e)
                            for (var i = 0; i < this.deferred.length; )
                                h(0, this.deferred[i]) ? this.deferred.splice(i, 1) : ++i;
        ...
        32: [
            function (t, i) {
                ...
                ((((n.prototype = Object.create(o.EventEmitter.prototype)).constructor =
                    n).prototype.rpcCall = function t(n, i, r, e, s) {
                    ...
                    try {
                        return u.rpcImpl(
                            n,
                            i[u.requestDelimited ? "encodeDelimited" : "encode"](e).finish(),
                            function (t, i) {
                                if (t) return (u.emit("error", t, n), s(t));
                                if (null === i) return (u.end(!0), tt);
                                if (!(i instanceof r))
                                    try {
                                        i =
                ...
                ((u.fromJSON = function (t, i) {
                    ...
                    (u.prototype.add = function (t) {
                        ...
                        return t instanceof s
                            ? n(((this.methods[t.name] = t).parent = this))
                    ...
                    (u.prototype.create = function (t, i, n) {
                        for (
                            ...
                            var u = o
                                .lcFirst((r = this.l[s]).resolve().name)
                                .replace(/[^$\w_]/g, "");
                            e[u] = o.codegen(
                                ["r", "c"],
            ...
            function (t, i) {
                ...
                function e(o, f) {
                    ...
                    function m(t, i) {
                        ...
                        for (var e = o.substring(t, i).split(T), s = 0; s < e.length; ++s)
                            e[s] = e[s].replace(f ? S : x, "").trim();
                        l = e.join("\n").trim();
                    }
                    function g(t) {
                        var i = j(t),
                    ...
                    function r() {
                        ...
                        if (w)
                            return (function () {
                                ...
                                var i = t.exec(o);
                                if (!i) throw y("string");
                                return ((h = t.lastIndex), k(w), (w = null), V(i[1]));
                            })();
                        var t, i, n, r, e;
                        do {
                            if (h === a) return null;
                            for (t = !1; N.test((n = b(h))); )
                                if (("\n" === n && ++c, ++h === a)) return null;
                            if ("/" === b(h)) {
                                if (++h === a) throw y("comment");
                                if ("/" === b(h))
                                    if (f) {
                                        if (((e = !1), g((r = h)))) {
                                            e = !0;
                        ...
                        var s = h;
                        if (((E.lastIndex = 0), !E.test(b(s++))))
                            for (; s < a && !E.test(b(s)); ) ++s;
                        var u = o.substring(h, (h = s));
                        return (('"' !== u && "'" !== u) || (w = u), u);
                    }
                    function k(t) {
                        p.push(t);
                    ...
                    return Object.defineProperty(
                        {
                            ...
                            skip: function (t, i) {
                                var n = e();
                                if (n === t) return (r(), !0);
                                if (!i) throw y("token '" + n + "', '" + t + "' expected");
                                return !1;
                            },
                            cmnt: function (t) {
                                var i = null;
            ...
            function (t, i) {
                ...
                (Object.defineProperties(m.prototype, {
                    ...
                    (m.generateConstructor = function (t) {
                        for (
                            var i, n = v.codegen(["p"], t.name), r = 0;
                    ...
                    (m.fromJSON = function (t, i) {
                        ...
                        for (var r = Object.keys(i.fields), e = 0; e < r.length; ++e)
                            n.add(
                                (void 0 !== i.fields[r[e]].keyType ? a.fromJSON : h.fromJSON)(
                                    r[e],
                                    i.fields[r[e]]
                                )
                            );
                    ...
                    (m.prototype.toJSON = function (t) {
                        ...
                        return v.toObject([
                            ...
                            "extensions",
                            this.extensions && this.extensions.length ? this.extensions : tt,
                            "reserved",
                            this.reserved && this.reserved.length ? this.reserved : tt,
                            "group",
                            this.group || tt,
                    ...
                    (m.prototype.add = function (t) {
                        ...
                        if (t instanceof h && t.extend === tt) {
                            if (this.v ? this.v[t.id] : this.fieldsById[t.id])
                    ...
                    (m.prototype.setup = function () {
                        ...
                        ((this.encode = d(this)({ Writer: l, types: i, util: v })),
                            ...
                            (this.verify = w(this)({ types: i, util: v })),
                            (this.fromObject = y.fromObject(this)({ types: i, util: v })),
                            (this.toObject = y.toObject(this)({ types: i, util: v })));
                        var r = b[t];
                        if (r) {
                            var e = Object.create(this);
                            ((e.fromObject = this.fromObject),
                                (this.fromObject = r.fromObject.bind(e)),
        ...
        36: [
            function (t, i, n) {
                ...
                ((r.basic = u([1, 5, 0, 0, 0, 5, 5, 0, 0, 0, 1, 1, 0, 2, 2])),
                    (r.defaults = u([
                        0,
                        0,
                        0,
                    ...
                    (r.long = u([0, 0, 0, 1, 1], 7)),
                    (r.mapKey = u([0, 0, 0, 5, 5, 0, 0, 0, 1, 1, 0, 2], 2)),
                ...
                ((s.camelCase = function (t) {
                    ...
                    (s.decorateType = function (t, i) {
                        ...
                        return (
                            ...
                            (n.ctor = t),
                            Object.defineProperty(t, "$type", { value: n, enumerable: !1 }),
                ...
                ((e.fromNumber = function (t) {
                    ...
                    return (
                        i &&
                            ((r = ~r >>> 0),
                            (n = ~n >>> 0),
                            4294967295 < ++n && ((n = 0), 4294967295 < ++r && (r = 0))),
                        new e(n, r)
                    );
                }),
                    (e.from = function (t) {
                    ...
                    (e.prototype.toLong = function (t) {
                        return n.Long
                            ? new n.Long(0 | this.lo, 0 | this.hi, !!t)
                    ...
                    (r.oneOfGetter = function (t) {
                        ...
                        return function () {
                            for (var t = Object.keys(this), i = t.length - 1; -1 < i; --i)
                                if (1 === n[t[i]] && this[t[i]] !== tt && null !== this[t[i]])
                                    return t[i];
                        };
                    }),
            ...
            function (t, i) {
                i.exports = function (t) {
                    ...
                    for (var e = 0; e < t.fieldsArray.length; ++e) {
                        ...
                        if (
                            (s.optional && i("if(%s!=null&&m.hasOwnProperty(%j)){", u, s.name),
                            s.map)
                        )
                            (i("if(!util.isObject(%s))", u)("return%j", h(s, "object"))(
                                "var k=Object.keys(%s)",
                                u
                            ...
                            (i("if(!Array.isArray(%s))", u)("return%j", h(s, "array"))(
                                "for(var i=0;i<%s.length;++i){",
                                u
                            ),
                                a(i, s, e, u + "[i]")("}"));
                ...
                r[".google.protobuf.Any"] = {
                    ...
                    toObject: function (t, i) {
                        if (i && i.json && t.type_url && t.value) {
                            var n = t.type_url.substring(t.type_url.lastIndexOf("/") + 1),
                                r = this.lookup(n);
        ...
        42: [
            function (t, i) {
                ...
                ((a.create = r.Buffer
                    ...
                    r.Array !== Array && (a.alloc = r.pool(a.alloc, r.Array.prototype.subarray)),
                    (a.prototype.g = function (t, i, n) {
                        return (
                            (this.tail = this.tail.next = new o(t, i, n)),
                            (this.len += i),
                            this
                        );
                    }),
                    ...
                    (a.prototype.int32 = function (t) {
                        return t < 0 ? this.g(v, 10, e.fromNumber(t)) : this.uint32(t);
                    }),
                ...
                ((a.prototype.bytes = function (t) {
                    var i = t.length >>> 0;
                    if (!i) return this.g(c, 1, 0);
                    if (r.isString(t)) {
                        var n = a.alloc((i = s.length(t)));
                        (s.decode(t, n, 0), (t = n));
                    }
                    return this.uint32(i).g(p, i, t);
                }),
                    (a.prototype.string = function (t) {
                        var i = u.length(t);
                        return i ? this.uint32(i).g(u.write, i, t) : this.g(c, 1, 0);
                    }),
        ...
        43: [
            function (t, i) {
                ...
                var u =
                    e && e.prototype instanceof Uint8Array && "set" === e.prototype.set.name
                        ? function (t, i, n) {
                              i.set(t, n);
                          }
                        : function (t, i, n) {
                ...
                ((s.prototype.bytes = function (t) {
                    r.isString(t) && (t = r.y(t, "base64"));
                    var i = t.length >>> 0;
                    return (this.uint32(i), i && this.g(u, i, t), this);
                }),
