    ...
    ((r = {
                        ...
                        i[e] = function (t) {
                            if (s)
                                if (((s = !1), t)) u(t);
                                    ...
                                    for (var n = Array(arguments.length - 1), i = 0; i < n.length; )
                                        n[i++] = arguments[i];
                                    r.apply(null, n);
                                }
                        };
        ...
        2: [
            function (t, n, i) {
                ...
                for (var o = Array(64), f = Array(123), u = 0; u < 64; )
                    f[(o[u] = u < 26 ? u + 65 : u < 52 ? u + 71 : u < 62 ? u - 4 : (u - 59) | 43)] =
                        u++;
                    ...
                    return (
                        "undefined" != typeof Float32Array
                            ? (function () {
                                  ...
                                  ((h.writeFloatLE = t ? n : i),
                                      (h.writeFloatBE = t ? i : n),
                                      (h.readFloatLE = t ? e : s),
                                      (h.readFloatBE = t ? s : e));
                              })()
                            : (function () {
                                  function t(t, n, i, r) {
                                      ...
                                      else if (34028234663852886e22 < n)
                                          t(((u << 31) | 2139095040) >>> 0, i, r);
                                      else if (n < 11754943508222875e-54)
                                          t(
                                              ((u << 31) | Math.round(n / 1401298464324817e-60)) >>>
                                                  0,
                                              i,
                                              r
                                          );
                                  ...
                                  function n(t, n, i) {
                                      ...
                                      return 255 === e
                                          ? s
                                              ...
                                              : u * (1 / 0)
                                          : 0 === e
                                            ? 1401298464324817e-60 * u * s
                                            : u * Math.pow(2, e - 150) * (s + 8388608);
                                  }
                                  ((h.writeFloatLE = t.bind(null, r)),
                                      (h.writeFloatBE = t.bind(null, u)),
                                      (h.readFloatLE = n.bind(null, e)),
                                      (h.readFloatBE = n.bind(null, s)));
                              })(),
                        "undefined" != typeof Float64Array
                            ? (function () {
                                  ...
                                  ((h.writeDoubleLE = t ? n : i),
                                      (h.writeDoubleBE = t ? i : n),
                                      (h.readDoubleLE = t ? e : s),
                                      (h.readDoubleBE = t ? s : e));
                              })()
                            : (function () {
                                  function t(t, n, i, r, u, e) {
                                      ...
                                      else if (isNaN(r)) (t(0, u, e + n), t(2146959360, u, e + i));
                                      else if (17976931348623157e292 < r)
                                          (t(0, u, e + n),
                                              t(((s << 31) | 2146435072) >>> 0, u, e + i));
                                      else {
                                          var h;
                                          if (r < 22250738585072014e-324)
                                              (t((h = r / 5e-324) >>> 0, u, e + n),
                                                  t(
                                                      ((s << 31) | (h / 4294967296)) >>> 0,
                                                      u,
                                                      e + i
                                  ...
                                  function n(t, n, i, r, u) {
                                      ...
                                      return 2047 === f
                                          ...
                                          : 0 === f
                                            ? 5e-324 * h * o
                                            : h * Math.pow(2, f - 1075) * (o + 4503599627370496);
                                  }
                                  ((h.writeDoubleLE = t.bind(null, r, 0, 4)),
                                      (h.writeDoubleBE = t.bind(null, u, 4, 0)),
                                      (h.readDoubleLE = n.bind(null, e, 0, 4)),
                                      (h.readDoubleBE = n.bind(null, s, 4, 0)));
                              })(),
                        h
                    );
                }
        ...
        9: [
            function (t, n) {
                ...
                ((h.create = r.Buffer
                    ...
                    : o),
                    (h.prototype.i = r.Array.prototype.subarray || r.Array.prototype.slice),
                    (h.prototype.uint32 =
                        ((f = 4294967295),
                        function () {
                            if (
        ...
        13: [
            function (t, n) {
                ...
                ((((i.prototype = Object.create(h.EventEmitter.prototype)).constructor =
                    i).prototype.rpcCall = function t(i, n, r, u, e) {
                        ...
                        return s.rpcImpl(
                            ...
                            function (t, n) {
                                ...
                                if (!(n instanceof r))
                                    try {
                                        n =
                                            r[s.responseDelimited ? "decodeDelimited" : "decode"](
                                                n
                                            );
                                    } catch (t) {
                ...
                ((u.fromNumber = function (t) {
                    ...
                    return (
                        n &&
                            ((r = ~r >>> 0),
                            (i = ~i >>> 0),
                            4294967295 < ++i && ((i = 0), 4294967295 < ++r && (r = 0))),
                        new u(i, r)
                    );
                }),
                    (u.from = function (t) {
                    ...
                    (r.isset = r.isSet =
                        function (t, n) {
                            ...
                            return (
                                ...
                                ("object" != typeof i ||
                                    0 < (Array.isArray(i) ? i.length : Object.keys(i).length))
                            );
                        }),
                    (r.Buffer = (function () {
                        try {
                    ...
                    (r.oneOfGetter = function (t) {
                        ...
                        return function () {
                            for (var t = Object.keys(this), n = t.length - 1; -1 < n; --n)
                                if (1 === i[t[n]] && this[t[n]] !== b && null !== this[t[n]])
                                    return t[n];
                        };
                    }),
