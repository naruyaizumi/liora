    ...
    ((r = {
                ...
                function a(i, n) {
                    ...
                    function h(t) {
                        if ("string" != typeof t) {
                            var i = c();
                            if (
                                (a.verbose && console.log("codegen: " + i), (i = "return " + i), t)
                            ) {
                                for (
                                    var n = Object.keys(t),
                                        r = Array(n.length + 1),
            ...
            function (t, i) {
                ...
                ((u.fromJSON = function (t, i) {
                    ...
                    (u.prototype.resolve = function () {
                        ...
                        if (
                            ((this.typeDefault = f.defaults[this.type]) === g &&
                                ((this.resolvedType = (
                    ...
                    (h.prototype.lookup = function (t, i, n) {
                        ...
                        if (r) {
                            ...
                            for (var e = 0; e < this.nestedArray.length; ++e)
                                if (this.e[e] instanceof h && (r = this.e[e].lookup(t, i, !0)))
                                    return r;
        ...
        24: [
            function (t, i) {
                ...
                ((o.create = r.Buffer
                    ...
                    : h),
                    (o.prototype.f = r.Array.prototype.subarray || r.Array.prototype.slice),
                    (o.prototype.uint32 =
                        ((f = 4294967295),
                        function () {
                            if (
        ...
        25: [
            function (t, i) {
                ...
                (r.Buffer && (e.prototype.f = r.Buffer.prototype.slice),
        ...
        26: [
            function (t, i) {
                ...
                ((n.fromJSON = function (t, i) {
                    ...
                    (n.prototype.resolvePath = b.path.resolve),
                    (n.prototype.load = function t(i, s, u) {
                        ...
                        function c(t, i) {
                            try {
                                if (
                                    (b.isString(i) && "{" === i.charAt(0) && (i = JSON.parse(i)),
                                    b.isString(i))
                                ) {
                                    v.filename = t;
                                    var n,
                                    ...
                                    if (r.imports)
                                        for (; e < r.imports.length; ++e)
                                            (n = o.resolvePath(t, r.imports[e])) && a(n);
                                    if (r.weakImports)
                                        for (e = 0; e < r.weakImports.length; ++e)
                                            (n = o.resolvePath(t, r.weakImports[e])) && a(n, !0);
                        ...
                        function a(n, r) {
                            ...
                            if (!(-1 < o.files.indexOf(n)))
                                if ((o.files.push(n), n in d))
                                    ...
                                    (++l,
                                        b.fetch(n, function (t, i) {
                                            (--l,
                                                u && (t ? (r ? l || h(null, o) : h(t)) : c(n, i)));
                                        }));
                        }
                        var l = 0;
                        b.isString(i) && (i = [i]);
                ...
                ((n.prototype.u = function (t) {
                    if (t instanceof s)
                        t.extend === g || t.extensionField || h(0, t) || this.deferred.push(t);
                ...
                ((u.fromJSON = function (t, i) {
                    ...
                    (u.prototype.create = function (t, i, n) {
                        for (
                            ...
                            var u = o
                                .lcFirst((r = this.h[s]).resolve().name)
                                .replace(/[^$\w_]/g, "");
                            e[u] = o.codegen(
                                ["r", "c"],
                ...
                (Object.defineProperties(w.prototype, {
                    ...
                    (w.fromJSON = function (t, i) {
                        ...
                        for (var r = Object.keys(i.fields), e = 0; e < r.length; ++e)
                            n.add(
                                (void 0 !== i.fields[r[e]].keyType ? c.fromJSON : h.fromJSON)(
                                    r[e],
                                    i.fields[r[e]]
                                )
                            );
                    ...
                    (w.prototype.add = function (t) {
                        ...
                        if (t instanceof h && t.extend === g) {
                            if (this.c ? this.c[t.id] : this.fieldsById[t.id])
                    ...
                    (w.prototype.setup = function () {
                        ...
                        ((this.encode = d(this)({ Writer: l, types: i, util: v })),
                            (this.decode = b(this)({ Reader: s, types: i, util: v })),
                            (this.verify = y(this)({ types: i, util: v })),
                            (this.fromObject = p.fromObject(this)({ types: i, util: v })),
                            (this.toObject = p.toObject(this)({ types: i, util: v })));
                        var r = m[t];
                        if (r) {
