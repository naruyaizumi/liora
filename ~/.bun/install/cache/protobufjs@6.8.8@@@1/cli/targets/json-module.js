...
function jsonSafeProp(json) {
    return json.replace(/^( +)"(\w+)":/gm, function ($0, $1, $2) {
        return protobuf.util.safeProp($2).charAt(0) === "." ? $1 + $2 + ":" : $0;
    });
}
...
function json_module(root, options, callback) {
    try {
        ...
        output = util.wrap(
            output.join(""),
            protobuf.util.merge({ dependency: "protobufjs/light" }, options)
        );
