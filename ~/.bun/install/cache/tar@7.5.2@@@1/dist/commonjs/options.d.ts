...
export declare const isSyncFile: <O extends TarOptions>(
  o: O,
) => o is O &
  TarOptions & {
    sync: true
...
export declare const isAsyncFile: <O extends TarOptions>(
  o: O,
) => o is O &
  TarOptions & {
...
export declare const isSyncNoFile: <O extends TarOptions>(
  o: O,
) => o is O &
  TarOptions & {
    sync: true
...
export declare const isAsyncNoFile: <O extends TarOptions>(
  o: O,
) => o is O &
  TarOptions & {
    sync?: false | undefined
...
export declare const isSync: <O extends TarOptions>(
  o: O,
) => o is O &
  TarOptions & {
    sync: true
  }
export declare const isAsync: <O extends TarOptions>(
  o: O,
) => o is O &
  TarOptions & {
    sync?: false | undefined
  }
export declare const isFile: <O extends TarOptions>(
  o: O,
) => o is O &
  TarOptions & {
    file: string
  }
export declare const isNoFile: <O extends TarOptions>(
  o: O,
) => o is O &
  TarOptions & {
    file?: undefined
  }
export declare const dealias: (
