...
exports.WriteEntryTar =
  exports.WriteEntrySync =
  exports.WriteEntry =
    void 0
...
class WriteEntry extends minipass_1.Minipass {
  ...
  [ONREADLINK](linkpath) {
    this.linkpath = (0,
    normalize_windows_path_js_1.normalizeWindowsPath)(linkpath)
    this[HEADER]()
    this.end()
  }
  [HARDLINK](linkpath) {
  ...
  [CLOSE](cb = () => {}) {
    /* c8 ignore stop */
    if (this.fd !== undefined) fs_1.default.close(this.fd, cb)
  }
  [ONREAD](bytesRead) {
...
class WriteEntrySync extends WriteEntry {
  ...
  [READ]() {
    ...
    try {
      ...
      /* c8 ignore stop */
      const bytesRead = fs_1.default.readSync(
        fd,
        buf,
        offset,
        length,
  ...
  [CLOSE](cb = () => {}) {
    /* c8 ignore stop */
    if (this.fd !== undefined) fs_1.default.closeSync(this.fd)
    cb()
  }
}
