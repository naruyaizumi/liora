...
(function () {
    ...
    ((ref$ = require("prelude-ls")),
        ...
        (unlines = ref$.unlines));
    ((ref$ = require("./util")),
        (nameToRaw = ref$.nameToRaw),
        (dasherize = ref$.dasherize),
        (naturalJoin = ref$.naturalJoin));
    wordWrap = require("word-wrap");
    wordwrap = function (a, b) {
        var ref$, indent, width;
        ((ref$ = b === undefined ? ["", a - 1] : [repeatString$(" ", a), b - a - 1]),
            (indent = ref$[0]),
            (width = ref$[1]));
    ...
    getPreText = function (option, arg$, maxWidth) {
        var mainName,
            ...
            wrap;
        ((mainName = option.option),
            (shortNames = (ref$ = option.shortNames) != null ? ref$ : []),
            (longNames = (ref$ = option.longNames) != null ? ref$ : []),
            (type = option.type),
            (description = option.description));
        ((aliasSeparator = arg$.aliasSeparator),
            (typeSeparator = arg$.typeSeparator),
            (initialIndent = arg$.initialIndent));
        ...
        if (
            maxWidth != null &&
            !option.boolean &&
            initialIndent + namesStringLen + typeSeparatorStringLen + type.length > maxWidth
        ) {
    ...
    generateHelpForOption = function (getOption, arg$) {
        ...
        return function (optionName) {
            ...
            defaultString =
                option["default"] && !option.negateName ? "\ndefault: " + option["default"] : "";
            restPositionalString = option.restPositional
                ? "Everything after this option is considered a positional argument, even if it looks like an option."
                : "";
            description =
                option.longDescription || (option.description && sentencize(option.description));
            fullDescription =
                description && restPositionalString
                    ? description + " " + restPositionalString
                    : (that = description || restPositionalString)
                      ? that
                      : "";
            ...
            exampleString = (that = option.example)
                ...
                : "";
            seperator =
                defaultString || descriptionString || exampleString
    ...
    generateHelp = function (arg$) {
        ...
        ((options = arg$.options),
            (prepend = arg$.prepend),
            (append = arg$.append),
            (helpStyle = (ref$ = arg$.helpStyle) != null ? ref$ : {}),
            (stdout = arg$.stdout));
        setHelpStyleDefaults(helpStyle);
        ((aliasSeparator = helpStyle.aliasSeparator),
            (typeSeparator = helpStyle.typeSeparator),
            (descriptionSeparator = helpStyle.descriptionSeparator),
            (maxPadFactor = helpStyle.maxPadFactor),
            (initialIndent = helpStyle.initialIndent),
            (secondaryIndent = helpStyle.secondaryIndent));
        return function (arg$) {
            var ref$,
                showHidden,
                interpolate,
            ...
            wrapAllFull =
                optionCount > 1 && fullWrapCount + partialWrapCount * 0.5 > optionCount * 0.5;
            for (i$ = 0, len$ = data.length; i$ < len$; ++i$) {
                i = i$;
                item = data[i$];
                if (item.type === "heading") {
                    ...
                    if (maxWidth != null) {
                        if (wrapAllFull || wrap === "full") {
                            ...
                            wrap = wordwrap(
                                initialIndent + descSepLen + max(padAmount, pre.length),
                                maxWidth
                            );
                            out(
                                initialSpace +
