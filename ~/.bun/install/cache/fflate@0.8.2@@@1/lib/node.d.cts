 ...
 */
export declare function deflate(
    data: Uint8Array,
 ...
 */
export declare function inflate(
    data: Uint8Array,
 ...
 * @returns A function that can be used to immediately terminate the decompression
 */
export declare function gunzip(
    data: Uint8Array,
 ...
 * @returns A function that can be used to immediately terminate the decompression
 */
export declare function unzlib(
    data: Uint8Array,
