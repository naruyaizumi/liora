...
interface WebidlErrors {
     ...
     */
    invalidArgument(opts: { prefix: string; value: string; type: string }): TypeError;
}
...
interface WebidlUtil {
    ...
    TypeValueToString(
        o: unknown
    ): "Undefined" | "Boolean" | "String" | "Symbol" | "Number" | "BigInt" | "Null" | "Object";
...
interface WebidlConverters {
     ...
     * @see https://webidl.spec.whatwg.org/#es-buffer-source-types
     */
    DataView(V: unknown, prefix: string, argument: string, flags?: number): DataView;
...
export interface Webidl {
    ...
    interfaceConverter<Interface>(
        typeCheck: WebidlIsFunction<Interface>,
        name: string
    ): (V: unknown, prefix: string, argument: string) => asserts V is Interface;
