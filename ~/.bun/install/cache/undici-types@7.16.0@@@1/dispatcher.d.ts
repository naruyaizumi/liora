...
declare class Dispatcher extends EventEmitter {
    ...
    request<TOpaque = null>(
        options: Dispatcher.RequestOptions<TOpaque>,
        callback: (err: Error | null, data: Dispatcher.ResponseData<TOpaque>) => void
    ): void;
    ...
    on(
        ...
        callback: (origin: URL, targets: readonly Dispatcher[], error: Errors.UndiciError) => void
    ): this;
    on(
    ...
    listeners(
        eventName: "disconnect"
    ): ((origin: URL, targets: readonly Dispatcher[], error: Errors.UndiciError) => void)[];
    listeners(
        eventName: "connectionError"
    ): ((origin: URL, targets: readonly Dispatcher[], error: Errors.UndiciError) => void)[];
