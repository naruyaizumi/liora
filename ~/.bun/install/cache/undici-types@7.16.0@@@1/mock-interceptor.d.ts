...
declare namespace MockInterceptor {
    ...
    export interface MockDispatch<TData extends object = object, TError extends Error = Error>
        extends Options {
        times: number | null;
        persist: boolean;
        consumed: boolean;
    ...
    export interface MockDispatchData<TData extends object = object, TError extends Error = Error>
...
export { Interceptable, MockInterceptor, MockScope };
