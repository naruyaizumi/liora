(function (t) {
    ...
    var Cu = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports),
        dt = (e, t) => {
            for (var r in t) Ue(e, r, { get: t[r], enumerable: !0 });
        },
        er = (e, t, r, n) => {
            if ((t && typeof t == "object") || typeof t == "function")
                for (let u of du(t))
                    !Eu.call(e, u) &&
                        u !== r &&
                        Ue(e, u, { get: () => t[u], enumerable: !(n = pu(t, u)) || n.enumerable });
            return e;
        };
    var hu = (e, t, r) => (
            (r = e != null ? Fu(mu(e)) : {}),
            er(t || !e || !e.__esModule ? Ue(r, "default", { value: e, enumerable: !0 }) : r, e)
        ),
        gu = (e) => er(Ue({}, "__esModule", { value: !0 }), e);
    var yu = (e, t, r) => t.has(e) || Zt("Cannot " + r);
    var tr = (e, t, r) =>
        t.has(e)
            ? Zt("Cannot add the same private member more than once")
    ...
    var Pn = Cu((Mt) => {
        ...
        function ho(e, t, r) {
            let n = Object.assign({ column: 0, line: -1 }, e.start),
                ...
                { linesAbove: o = 2, linesBelow: i = 3 } = r || {},
                s = n.line,
                a = n.column,
                c = u.line,
                D = u.column,
                p = Math.max(s - (o + 1), 0),
                l = Math.min(t.length, c + i);
            ...
            else a === D ? (a ? (f[s] = [a, 0]) : (f[s] = !0)) : (f[s] = [a, D - a]);
            return { start: p, end: l, markerLines: f };
        }
        function go(e, t, r = {}) {
            let u = Co(!1),
                o = e.split(On),
                { start: i, end: s, markerLines: a } = ho(t, o, r),
                c = t.start && typeof t.start.column == "number",
                D = String(s).length,
                l = e
                    .split(On, s)
                    .slice(i, s)
                    .map((F, f) => {
                        ...
                        if (E) {
                            let x = "";
                            if (Array.isArray(E)) {
                                let A = F.slice(0, Math.max(E[0] - 1, 0)).replace(/[^\t]/g, " "),
                                    $ = E[1] || 1;
                                ((x = [
                                    `
 `,
                                    ...
                                    h && r.message && (x += " " + u.message(r.message)));
                            }
                            return [
                                u.marker(">"),
                                u.gutter(C),
...
${l}`),
    ...
    var _e = class {
        diff(t, r, n = {}) {
            ...
            let o = this.castInput(t, n),
                i = this.castInput(r, n),
                s = this.removeEmpty(this.tokenize(o, n)),
            ...
            let d = -1 / 0,
                ...
                C = () => {
                    for (let E = Math.max(d, -c); E <= Math.min(m, c); E += 2) {
                        ...
                        if (
                            (!ue || ($ && x.oldPos < A.oldPos)
                                ? (h = this.addToPath(A, !0, !1, 0, n))
                                : (h = this.addToPath(x, !1, !0, 1, n)),
                            (f = this.extractCommon(h, r, t, E, n)),
                            h.oldPos + 1 >= a && f + 1 >= s)
                        )
                            return i(this.buildValues(h.lastComponent, r, t)) || !0;
                        ((F[E] = h),
                            h.oldPos + 1 >= a && (m = Math.min(m, E - 1)),
                            f + 1 >= s && (d = Math.max(d, E + 1)));
                    }
                    c++;
                };
            if (u)
        ...
        addToPath(t, r, n, u, o) {
            ...
            return i && !o.oneChangePerToken && i.added === r && i.removed === n
                ...
                : {
                      oldPos: t.oldPos + u,
                      lastComponent: { count: 1, added: r, removed: n, previousComponent: i },
                  };
        }
...
`
    ...
    var W = "string",
        ...
        S = "label",
        w = "break-parent",
        Ve = new Set([j, N, O, P, B, k, _, v, L, I, g, S, w]);
    var Bu = (e, t, r) => {
            if (!(e && t == null))
...
Expected it to be ${n}.`;
            ...
            switch (M(o)) {
                ...
                case B: {
                    ...
                    return (
                        ...
                        t({ ...o, contents: s, expandedStates: i })
                    );
                }
                case O:
                case N:
    ...
    function ar(e) {
        for (e = [...e]; e.length >= 2 && y(!1, e, -2).type === g && y(!1, e, -1).type === w; )
            e.length -= 2;
        if (e.length > 0) {
            let t = we(y(!1, e, -1));
            e[e.length - 1] = t;
...
`)
    ...
    function Q(e) {
        ...
        return e.type === _
            ? { ...e, breakContents: Q(e.breakContents), flatContents: Q(e.flatContents) }
            : e.type === B
              ? {
                    ...e,
              ...
              : e.type === k
                ? { type: "fill", parts: e.parts.map(Q) }
                : e.contents
                  ? { ...e, contents: Q(e.contents) }
                  : e;
    }
    function wr(e) {
        ...
        function n(o, i, s) {
            ...
            if (o.type === w)
                return ((c = s == null ? void 0 : s[i - 1]) == null ? void 0 : c.type) === g &&
                    s[i - 1].hard
                    ? void 0
                    : "breakParent";
            ...
            if (o.type === _)
                return (
                    ...
                    (o.groupId
                        ? (o.flatContents ? "" : ', ""') + `, { groupId: ${u(o.groupId)} }`
                        : "") +
                    ")"
                );
            if (o.type === v) {
                let D = [];
                (o.negate && D.push("negate: true"),
                    o.groupId && D.push(`groupId: ${u(o.groupId)}`));
                let p = D.length > 0 ? `, { ${D.join(", ")} }` : "";
                return `indentIfBreak(${n(o.contents)}${p})`;
            }
            if (o.type === B) {
                let D = [];
                (o.break && o.break !== "propagated" && D.push("shouldBreak: true"),
                    o.id && D.push(`id: ${u(o.id)}`));
                let p = D.length > 0 ? `, { ${D.join(", ")} }` : "";
                return o.expandedStates
                    ? `conditionalGroup([${o.expandedStates.map((l) => n(l)).join(",")}]${p})`
                    : `group(${n(o.contents)}${p})`;
            }
    ...
    var R = Symbol("MODE_BREAK"),
        H = Symbol("MODE_FLAT"),
        de = Symbol("cursor"),
        _t = Symbol("DOC_FILL_PRINTED_LENGTH");
    function Nr() {
        ...
        return t === Number.NEGATIVE_INFINITY
            ...
            : t < 0
              ...
              : t
                ? t.type === "root"
                    ? { ...e, root: e }
                    : xt(e, { type: typeof t == "string" ? "stringAlign" : "numberAlign", n: t }, r)
                : e;
    }
    function xt(e, t, r) {
        ...
        for (; r >= 0; ) {
            ...
            switch (p) {
                ...
                case B: {
                    ...
                    let l = D.break ? R : c,
                        F = D.expandedStates && l === R ? y(!1, D.expandedStates, -1) : D.contents;
                    s.push({ mode: l, doc: F });
                    break;
                }
                case _: {
                    let F =
                        (D.groupId ? u[D.groupId] || H : c) === R
                            ? D.breakContents
                            : D.flatContents;
...
`,
                ...
                case B:
                    switch (F) {
                        ...
                        case R: {
                            a = !1;
                            let d = { ind: l, mode: H, doc: f.contents },
                                m = n - o,
                                C = c.length > 0;
                            if (!f.break && ze(d, i, m, C, r)) i.push(d);
                                ...
                                if (f.break) {
                                    ...
                                    for (let h = 1; h < f.expandedStates.length + 1; h++)
                                        if (h >= f.expandedStates.length) {
                                            i.push({ ind: l, mode: R, doc: E });
                                            break;
                                        } else {
                                            let x = f.expandedStates[h],
                                                A = { ind: l, mode: H, doc: x };
                                            if (ze(A, i, m, C, r)) {
                                                i.push(A);
                                                break;
                                            }
                ...
                case k: {
                    ...
                    let Be = { ind: l, mode: H, doc: x },
                        Ft = { ind: l, mode: R, doc: x };
                    if (E === 2) {
                        ue ? i.push(Be, A) : i.push(Ft, $);
                        break;
                    }
                    let lu = C[m + 2],
                        pt = { ind: l, mode: F, doc: { ...f, [_t]: m + 2 } };
                    ze({ ind: l, mode: H, doc: [h, x, lu] }, [], d, c.length > 0, r, !0)
                        ? i.push(pt, Be, A)
                        : ue
                          ? i.push(pt, Ft, A)
                          : i.push(pt, Ft, $);
                ...
                case v: {
                    ...
                    if (d === R) {
                        let m =
                            f.type === _ ? f.breakContents : f.negate ? f.contents : ie(f.contents);
                        m && i.push({ ind: l, mode: F, doc: m });
                    }
                    if (d === H) {
                        let m =
                            f.type === _ ? f.flatContents : f.negate ? ie(f.contents) : f.contents;
                        m && i.push({ ind: l, mode: F, doc: m });
                    }
                    break;
                }
                ...
                case g:
                    switch (F) {
                        ...
                        case R:
                            if (c.length > 0) {
                                (i.push({ ind: l, mode: F, doc: f }, ...c.reverse()),
                                    (c.length = 0));
                                break;
                            }
                            f.literal
                                ? l.root
                                    ? (s.push(u, l.root.value), (o = l.root.length))
                                    : (s.push(u), (o = 0))
                                : ((o -= wt(s)), s.push(u + l.value), (o = l.length));
                            break;
                    }
                    break;
                case S:
        ...
        if (p !== -1) {
            ...
            let F = s.slice(0, p).join(""),
                f = s.slice(p + 1, l).join(""),
                d = s.slice(l + 1).join("");
    ...
    var Z,
        ...
        bt = class {
            ...
            callParent(t, r = 0) {
                let n = fe(this, Z, kt).call(this, r + 1),
            ...
            each(t, ...r) {
                ...
                try {
                    for (let i = 0; i < o.length; ++i)
                        (n.push(i, o[i]), t(this, i, o), (n.length -= 2));
                } finally {
                    n.length = u;
                }
            }
            ...
            match(...t) {
                ...
                for (let o of t) {
                    ...
                    if (
                        (typeof n == "number" &&
                            ((i = n), (n = this.stack[r--]), (u = this.stack[r--])),
                        o && !o(u, n, i))
                    )
                        return !1;
...
` ||
    ...
    function Qe(e, t) {
        ...
        if (!n) return [];
        let s = ((r == null ? void 0 : r(e, t)) ?? [...Ce(e, { getVisitorKeys: J(u) })]).flatMap(
            (a) => (n(a) ? [a] : Qe(a, t))
        );
        return (s.sort((a, c) => o(a) - o(c) || i(a) - i(c)), Tt.set(e, s), s);
    }
    function Ur(e, t, r, n) {
        let { locStart: u, locEnd: o } = r,
            i = u(t),
            s = o(t),
            a = Qe(e, r),
            c,
    ...
    function Vr(e, t) {
        ...
        let n = [],
            {
                printer: {
                    experimentalFeatures: { avoidAstMutation: u = !1 } = {},
                    handleComments: o = {},
                },
                originalText: i,
            } = t,
            { ownLine: s = Nt, endOfLine: a = Nt, remaining: c = Nt } = o,
            D = r.map((p, l) => ({
                ...Ur(e, p, t),
                comment: p,
                text: i,
        ...
        for (let [p, l] of D.entries()) {
            ...
            if (
                ...
                ((F.placement = "ownLine"),
                    s(...A) || (m ? se(m, F) : f ? ae(f, F) : d ? ee(d, F) : ee(h, F)));
            else if (Ku(C, E, D, p))
                ((F.placement = "endOfLine"),
                    a(...A) || (f ? ae(f, F) : m ? se(m, F) : d ? ee(d, F) : ee(h, F)));
    ...
    var $r = (e) => !/[\S\n\u2028\u2029]/u.test(e);
    function Gu(e, t, r, n) {
        let { comment: u, precedingNode: o } = r[n],
        ...
        return G(e, a, { backwards: !0 });
    }
    function Ku(e, t, r, n) {
        let { comment: u, followingNode: o } = r[n],
            { locStart: i, locEnd: s } = t,
            a = s(u);
        if (o)
    ...
    function jr(e, t) {
        ...
        for (i = r; i > 0; --i) {
            ...
            if (
                ((a = (s = t.printer).isGap) == null ? void 0 : a.call(s, l, t)) ??
                /^[\s(]*$/u.test(l)
            )
                o = t.locStart(c);
            else break;
        ...
        for (let c of [n, u])
            c.comments &&
                c.comments.length > 1 &&
                c.comments.sort((D, p) => t.locStart(D) - t.locStart(p));
        e.length = 0;
    }
    function Ot(e, t, r) {
    ...
    function Hu(e, t) {
        ...
        if ((D = u.isBlockComment) == null ? void 0 : D.call(u, r)) {
            let p = G(o, s(r)) ? (G(o, i(r), { backwards: !0 }) ? z : Ge) : " ";
            n.push(p);
        } else n.push(z);
        let c = U(o, T(o, s(r)));
    ...
    function Ju(e, t, r) {
        ...
        let n = e.node,
            u = Wr(e, t),
            { printer: o, originalText: i, locStart: s } = t,
            a = (c = o.isBlockComment) == null ? void 0 : c.call(o, n);
        if (
            (r != null && r.hasLineSuffix && !(r != null && r.isBlock)) ||
            G(i, s(n), { backwards: !0 })
        ) {
            let D = Pe(i, s(n));
            return { doc: Se([z, D ? z : "", u]), isBlock: a, hasLineSuffix: !0 };
        }
        return !a || (r != null && r.hasLineSuffix)
            ? { doc: [Se([" ", u]), pe], isBlock: a, hasLineSuffix: !0 }
...
The range will extend backwards to the start of the first line containing the selected statement.`,
        ...
        for (let u of Zu(Object.assign({}, ...e.map(({ options: o }) => o), zr)))
            (!t && u.deprecated) ||
                (Array.isArray(u.choices) &&
                    (t || (u.choices = u.choices.filter((o) => !o.deprecated)),
                    u.name === "parser" && (u.choices = [...u.choices, ...Qu(u.choices, r, e)])),
                (u.pluginDefaults = Object.fromEntries(
                    e
                        ...
                        .map((o) => [o.name, o.defaultOptions[u.name]])
                )),
                n.push(u));
            ...
            if (u.parsers) {
                for (let o of u.parsers)
                    if (!n.has(o)) {
                        ...
                        let i = r.find(
                                (a) =>
                                    a.parsers && Object.prototype.hasOwnProperty.call(a.parsers, o)
                            ),
                            s = u.name;
                        (i != null && i.name && (s += ` (plugin: ${i.name})`),
                            yield { value: o, description: s });
                    }
            }
    }
    function Zu(e) {
    ...
    var Jr,
        ...
        Zr,
        to =
            ((Jr = globalThis.Deno) == null ? void 0 : Jr.build.os) === "windows" ||
            ((Xr = (qr = globalThis.navigator) == null ? void 0 : qr.platform) == null
                ? void 0
                : Xr.startsWith("Win")) ||
            ((Zr = (Qr = globalThis.process) == null ? void 0 : Qr.platform) == null
                ? void 0
                : Zr.startsWith("win")) ||
            !1;
    function en(e) {
    ...
    function nn(e, t) {
        ...
        return (
            e.find(({ filenames: n }) =>
                n == null ? void 0 : n.some((u) => u.toLowerCase() === r)
    ...
    function io(e, t) {
        let r = Hr(!1, e.plugins).flatMap((u) => u.languages ?? []),
            n =
                oo(r, t.language) ??
                nn(r, t.physicalFile) ??
                nn(r, t.file) ??
    ...
    var re = {
        ...
        value(e) {
            ...
            return t.length === 0
                ? "{}"
                : `{ ${t.map((r) => `${re.key(r)}: ${re.value(e[r])}`).join(", ")} }`;
        },
    ...
    var an = (e, t, { descriptor: r }) => {
        ...
        return (
            t &&
                n.push(`we now treat it as ${V.blue(typeof t == "string" ? r.key(t) : r.pair(t))}`),
            n.join("; ") + "."
        );
    };
    var et = Symbol.for("vnopts.VALUE_NOT_EXIST"),
        ge = Symbol.for("vnopts.VALUE_UNCHANGED");
    var Dn = " ".repeat(2),
        fn = (e, t, r) => {
            let { text: n, list: u } = r.normalizeExpectedResult(r.schemas[e].expected(r)),
                o = [];
            return (
                n && o.push(cn(e, t, n, r.descriptor)),
                u &&
                    o.push(
                        [cn(e, t, u.title, r.descriptor)].concat(
                            u.values.map((i) => ln(i, r.loggerPrintWidth))
                        ).join(`
`)
                    ),
    ...
    function ln({ text: e, list: t }, r) {
        ...
        return (
            ...
            t &&
                n.push(
                    [`- ${V.blue(t.title)}:`].concat(
                        t.values.map((u) => ln(u, r - Dn.length).replace(/^|\n/g, `$&${Dn}`))
                    ).join(`
`)
                ),
            Fn(n, r)
...
`,
    ...
    function vt(e, t) {
        ...
        for (; p < u; )
            for (i = t.charCodeAt(o + p), a = p++, s = p, D = 0; D < n; D++)
                ((c = i === pn[D] ? a : a + 1),
                    (a = Pt[D]),
                    (s = Pt[D] = a > s ? (c > s ? s + 1 : c) : c > a ? a + 1 : c));
        return s;
    }
    var tt = (e, t, { descriptor: r, logger: n, schemas: u }) => {
        let o = [`Ignored unknown option ${V.yellow(r.pair({ key: e, value: t }))}.`],
            i = Object.keys(u)
                .sort()
                .find((s) => vt(e, s) < 3);
    ...
    function It(e) {
        ...
        return (
            ...
            r ? { text: t, list: { title: r.title, values: r.values.map(It) } } : { text: t }
        );
    }
    function Rt(e, t) {
    ...
    var ct = class {
        constructor(t, r) {
            ...
            ((this._utils = {
                ...
                (this._identifyMissing = (F, f) => !(F in f) || c(F, f)),
                (this._identifyRequired = D),
                (this._preprocess = p),
                (this._postprocess = l),
                this.cleanHistory());
        }
        ...
        _applyNormalization(t, r) {
            let n = [],
                { knownKeys: u, unknownKeys: o } = this._partitionOptionKeys(t);
            for (let i of u) {
                let s = this._utils.schemas[i],
                            ...
                            if (d === !0)
                                this._hasDeprecationWarned(i) ||
                                    this._utils.logger.warn(
                                        this._deprecatedHandler(i, f, this._utils)
                                    );
                            else
                                for (let { value: m } of d) {
                                    let C = { key: i, value: m };
                                    if (!this._hasDeprecationWarned(C)) {
                                        let E = typeof f == "string" ? { key: f, value: m } : f;
                                        this._utils.logger.warn(
                                            this._deprecatedHandler(C, E, this._utils)
                                        );
                                    }
                                }
                    };
        ...
        _applyRequiredCheck(t) {
            for (let r of Object.keys(this._utils.schemas))
                if (this._identifyMissing(r, t) && this._identifyRequired(r))
                    throw this._invalidHandler(r, et, this._utils);
        }
    ...
    function lo(
        e,
        t,
        { logger: r = !1, isCLI: n = !1, passThrough: u = !1, FlagSchema: o, descriptor: i } = {}
    ) {
        if (n) {
        ...
        let s = u
                ? Array.isArray(u)
                    ? (l, F) => (u.includes(l) ? { [l]: F } : void 0)
                    : (l, F) => ({ [l]: F })
                : (l, F, f) => {
                      let { _: d, ...m } = f.schemas;
                      return tt(l, F, { ...f, schemas: m });
                  },
            a = Fo(t, { isCLI: n, FlagSchema: o }),
            c = new ct(a, { logger: r, unknown: s, descriptor: i }),
            D = r !== !1;
    ...
    function Fo(e, { isCLI: t, FlagSchema: r }) {
        let n = [];
        t && n.push(nt.create({ name: "_" }));
        for (let u of e)
            (n.push(po(u, { isCLI: t, optionInfos: e, FlagSchema: r })),
                u.alias && t && n.push(rt.create({ name: u.alias, sourceName: u.name })));
        return n;
    }
    function po(e, { isCLI: t, optionInfos: r, FlagSchema: n }) {
        ...
        if (
            (e.exception
                ? (o.validate = (a, c, D) => e.exception(a) || c.validate(a, D))
                : (o.validate = (a, c, D) => a === void 0 || c.validate(a, D)),
            e.redirect &&
                (s.redirect = (a) =>
                    a
                        ? {
    ...
    async function Eo(e, t = {}) {
        ...
        if (!r.parser)
            if (r.filepath) {
                if (((r.parser = on(r, { physicalFile: r.filepath })), !r.parser))
                    throw new Le(`No parser could be inferred for file "${r.filepath}".`);
            } else throw new Le("No parser and no file path given, couldn't infer a parser.");
        let n = Ze({ plugins: e.plugins, showDeprecated: !0 }).options,
            u = {
                ...Nn,
                ...Object.fromEntries(
                    n.filter((l) => l.default !== void 0).map((l) => [l.name, l.default])
                ),
            },
            o = $t(r.plugins, r.parser),
            i = await Wt(o, r.parser);
        ((r.astFormat = i.astFormat), (r.locEnd = i.locEnd), (r.locStart = i.locStart));
        let s = (p = o.printers) != null && p[i.astFormat] ? o : Sn(r.plugins, i.astFormat),
            a = await Tn(s, i.astFormat);
        r.printer = a;
        let c = s.defaultOptions
                ? Object.fromEntries(
                      Object.entries(s.defaultOptions).filter(([, l]) => l !== void 0)
                  )
                : {},
            D = { ...u, ...c };
        ...
        return (
            ...
            kn(r, n, { passThrough: Object.keys(Nn), ...t })
        );
    }
    var ne = Eo;
    var vn = hu(Pn(), 1);
...
` + n),
    ...
    async function Ln(e, t, r, n, u) {
        ...
        let c = J(i.getVisitorKeys ?? a),
            D = [];
        F();
        let p = e.stack;
        for (let { print: f, node: d, pathStack: m } of D)
            try {
                e.stack = m;
    ...
    function Wn(e, t, r) {
        ...
        let c = zt(r, n, t, (F, f) => Vn(t, F, f), [], "rangeStart"),
            D = a ? c : zt(r, u, t, (F) => Vn(t, F), [], "rangeEnd");
    ...
    async function Hn(e, t, r = 0) {
        ...
        if (r > 0) {
            ...
            (i.cursorNodeStart !== void 0 &&
                ...
                i.cursorNodeStart < 0 &&
                    ((i.cursorNodeStart = 0), (i.cursorNodeText = i.cursorNodeText.trimStart())),
                i.cursorNodeStart + i.cursorNodeText.length > a.length &&
                    (i.cursorNodeText = i.cursorNodeText.trimEnd())),
                (i.formatted = a + xe(t.endOfLine)));
        }
        let s = t[Symbol.for("comments")];
        if (t.cursorOffset >= 0) {
            let a, c, D, p;
            if ((t.cursorNode || t.nodeBeforeCursor || t.nodeAfterCursor) && i.cursorNodeText)
                if (((D = i.cursorNodeStart), (p = i.cursorNodeText), t.cursorNode))
                    ((a = t.locStart(t.cursorNode)), (c = u.slice(a, t.locEnd(t.cursorNode))));
                else {
    ...
    async function Po(e, t) {
        let { ast: r, text: n } = await De(e, t),
            { rangeStart: u, rangeEnd: o } = Wn(n, t, r),
            i = n.slice(u, o),
            s = Math.min(
                u,
                n.lastIndexOf(
...
`,
            ...
            D = await Hn(
                i,
                {
                    ...
                    cursorOffset:
                        t.cursorOffset > u && t.cursorOffset <= o ? t.cursorOffset - u : -1,
                    endOfLine: "lf",
                },
                c
            ),
            p = D.formatted.trimEnd(),
            { cursorOffset: l } = t;
...
`,
    ...
    function Jn(e, t) {
        let { cursorOffset: r, rangeStart: n, rangeEnd: u, endOfLine: o } = Gn(e, t),
            i = e.charAt(0) === zn;
        if (
            (i && ((e = e.slice(1)), r--, n--, u--), o === "auto" && (o = nr(e)), e.includes("\r"))
        ) {
            let s = (a) =>
                Ct(
...
`
        ...
        return {
            hasBOM: i,
            text: e,
            options: Gn(e, { ...t, cursorOffset: r, rangeStart: n, rangeEnd: u, endOfLine: o }),
        };
    }
    ...
    async function Jt(e, t) {
        ...
        if (
            (u.rangeStart >= u.rangeEnd && n !== "") ||
            (u.requirePragma && !(await Kn(n, u))) ||
            (u.checkIgnorePragma && (await vo(n, u)))
        )
        ...
        return (
            u.rangeStart > 0 || u.rangeEnd < n.length
                ...
                : (!u.requirePragma &&
                  ...
                  (o = await Hn(n, u))),
            r && ((o.formatted = zn + o.formatted), o.cursorOffset >= 0 && o.cursorOffset++),
            o
        );
    }
    async function qn(e, t, r) {
        let { text: n, options: u } = Jn(e, await ne(t)),
            o = await De(n, u);
        return (
            r &&
                (r.preprocessForPrint && (o.ast = await Gt(o.ast, u)),
                r.massage && (o.ast = Yn(o.ast, u))),
            o
        );
    }
    ...
    async function Qn(e, t) {
        let r = wr(e),
            { formatted: n } = await Jt(r, { ...t, parser: "__js_expression" });
        return n;
    }
