(function (f) {
    ...
    var te = (t, e) => () => (e || t((e = { exports: {} }).exports, e), e.exports),
        hr = (t, e) => {
            for (var n in e) Xe(t, n, { get: e[n], enumerable: !0 });
        },
        gr = (t, e, n, r) => {
            if ((e && typeof e == "object") || typeof e == "function")
                for (let s of $i(e))
                    !Fi.call(t, s) &&
                        s !== n &&
                        Xe(t, s, { get: () => e[s], enumerable: !(r = Yi(e, s)) || r.enumerable });
            return t;
        };
    var dr = (t, e, n) => (
            (n = t != null ? Di(Bi(t)) : {}),
            gr(e || !t || !t.__esModule ? Xe(n, "default", { value: t, enumerable: !0 }) : n, t)
        ),
        Ui = (t) => gr(Xe({}, "__esModule", { value: !0 }), t);
    var cn = (t, e, n) => qi(t, typeof e != "symbol" ? e + "" : e, n),
        ln = (t, e, n) => e.has(t) || mr("Cannot " + n);
    var Te = (t, e, n) => (ln(t, e, "read from private field"), n ? n.call(t) : e.get(t)),
        Ot = (t, e, n) =>
            e.has(t)
                ...
                : e instanceof WeakSet
                  ...
                  : e.set(t, n),
        fn = (t, e, n, r) => (
            ln(t, e, "write to private field"),
            r ? r.call(t, n) : e.set(t, n),
            n
        ),
        ze = (t, e, n) => (ln(t, e, "access private method"), n);
    var oe = te(($) => {
        "use strict";
            ...
            return (
                typeof t == "string"
                    ...
                    : (Array.isArray(t) && (t = t[0]),
                      t &&
                          t.context &&
                          (t.lineStarts || (t.lineStarts = zr(t.context.src)),
                          (e = t.lineStarts),
                          (n = t.context.src))),
                { lineStarts: e, src: n }
            );
...
`;
        ...
        function Oo({ start: t, end: e }, n, r = 80) {
            let s = No(t.line, n);
            if (!s) return null;
            let { col: i } = t;
            if (s.length > r)
...
`)
                ...
                get jsonLike() {
                    return (
                        [mt.FLOW_MAP, mt.FLOW_SEQ, mt.QUOTE_DOUBLE, mt.QUOTE_SINGLE].indexOf(
                            this.type
                        ) !== -1
                    );
                }
...
` && (i += a > l ? r.slice(l, a + 1) : c);
                ...
                switch (o) {
                    case "	": {
                        ...
                        return { errors: [new ht(this, a)], str: i };
                    }
                    case "@":
                    case "`": {
...
` &&
        ...
        $.Type = mt;
        $.YAMLError = ye;
        $.YAMLReferenceError = Mn;
        $.YAMLSemanticError = ht;
        $.YAMLSyntaxError = Cn;
        $.YAMLWarning = kn;
        $._defineProperty = Ao;
        $.defaultTagPrefix = wo;
...
` &&
                            ...
                            if (
                                ((i = c + 1), (c = u.Node.endOfIndent(s, i)), u.Node.atBlank(s, c))
                            ) {
...
`),
            ...
            ae = { CLIP: "CLIP", KEEP: "KEEP", STRIP: "STRIP" },
            xn = class extends u.Node {
                constructor(e, n) {
                    (super(e, n),
                        (this.blockIndent = null),
                        (this.chomping = ae.CLIP),
                        (this.header = null));
                }
                get includesTrailingLines() {
...
`
                    ...
                    return (
                        this.chomping !== ae.KEEP && (i = r[o] ? o + 1 : o),
...
` + n.replace(/^/gm, `${e || ""}#`)
        ...
        var is = (t) => t == null || (typeof t == "object" && t[Symbol.iterator]().next().done),
            W = class t extends j {
                constructor(e) {
                ...
                addIn(e, n) {
                    if (is(e)) this.add(n);
                        ...
                        else if (i === void 0 && this.schema) this.set(r, ns(this.schema, s, n));
                        else
                            throw new Error(
                ...
                setIn([e, ...n], r) {
                    if (n.length === 0) this.set(e, r);
                        ...
                        else if (s === void 0 && this.schema) this.set(e, ns(this.schema, n, r));
                        else
                            throw new Error(
                ...
                toString(e, { blockItem: n, flowChars: r, isMap: s, itemIndent: i }, o, a) {
                    ...
                    let y = !1,
                        h = !1,
                        g = this.items.reduce((M, A, C) => {
                            let L;
                            (A &&
                                (!y && A.spaceBefore && M.push({ type: "comment", str: "" }),
                                A.commentBefore &&
                                    A.commentBefore.match(/^.*$/gm).forEach((xi) => {
                                        M.push({ type: "comment", str: `#${xi}` });
                                    }),
                                A.comment && (L = A.comment),
                                m &&
                                    ((!y && A.spaceBefore) ||
                                        A.commentBefore ||
                                        A.comment ||
                                        (A.key && (A.key.commentBefore || A.key.comment)) ||
                                        (A.value && (A.value.commentBefore || A.value.comment))) &&
                                    (h = !0)),
                                (y = !1));
                            let R = f(
                                A,
...
`) &&
                                    (h = !0),
                                m && C < this.items.length - 1 && (R += ","),
                                (R = Fe(R, i, L)),
                                y && (L || m) && (y = !1),
                                M.push({ type: "item", str: R }),
                                M
                            );
                        }, []),
                        w;
...
` + this.comment.replace(/^/gm, `${c}#`)),
        ...
        var le = class extends W {
            ...
            T = class t extends j {
                ...
                set commentBefore(e) {
                    if ((this.key == null && (this.key = new _(null)), this.key instanceof j))
...
${R}`;
                    ...
                    ((e.implicitKey = !1),
                        !f && !this.comment && c instanceof _ && (e.indentAtStart = w.length + 1),
                        (g = !1),
                        !i &&
                            s >= 2 &&
                            !e.inFlow &&
...
` && (L = ""),
            ...
            be = class t extends j {
                ...
                toJSON(e, n) {
                    ...
                    if (
                        s >= 0 &&
                        ((i.count += 1),
                        i.aliasCount === 0 && (i.aliasCount = Yt(this.source, r)),
        ...
        var yt = class extends W {
                ...
                delete(e) {
                    let n = dt(this.items, e);
                    return n ? this.items.splice(this.items.indexOf(n), 1).length > 0 : !1;
                }
                get(e, n) {
                    let r = dt(this.items, e),
                        s = r && r.value;
                    return !n && s instanceof _ ? s.value : s;
                }
                has(e) {
                    return !!dt(this.items, e);
                }
                set(e, n) {
            ...
            Ft = class extends T {
                constructor(e) {
                    if (e instanceof T) {
                        let n = e.value;
                        (n instanceof le ||
                            ((n = new le()), n.items.push(e.value), (n.range = e.value.range)),
                            super(e.key, n),
                            (this.range = e.range));
                    } else super(new _(os), new le());
                    this.type = T.Type.MERGE_PAIR;
                }
                addToJSMap(e, n) {
                    for (let { source: r } of this.value.items) {
                        if (!(r instanceof yt)) throw new Error("Merge sources must be maps");
            ...
            ko = { defaultType: p.Type.BLOCK_LITERAL, lineWidth: 76 },
            Po = { trueStr: "true", falseStr: "false" },
            Io = { asBigInt: !1 },
            vo = { nullStr: "null" },
            Ne = {
...
` &&
                    ...
                    if (g >= m)
                        if (d) (l.push(d), (m = d + c), (d = void 0));
                            ...
                            for (; y === " " || y === "	"; ) ((y = C), (C = t[(g += 1)]), (h = !0));
                            let L = g > M + 1 ? g - 2 : w - 1;
                            if (f[L]) return t;
                            (l.push(L), (f[L] = !0), (m = L + c), (d = void 0));
                        } else h = !0;
                }
                y = C;
            }
...
`),
            ...
            return ((a = c ? a + i.slice(c) : i), n ? a : qt(a, o, $t, Un(e)));
        }
        function cs(t, e) {
            if (e.implicitKey) {
...
${n}`
                    ...
                    "'";
            return e.implicitKey ? r : qt(r, n, as, Un(e));
        }
        function Bt({ comment: t, type: e, value: n }, r, s, i) {
            if (/\n[\t ]+$/.test(n) || /^\s*$/.test(n)) return we(n, r);
            let o = r.indent || (r.forceBlockIndent || Ut(n) ? "  " : ""),
                a = o ? "2" : "1",
                c =
                    e === p.Type.BLOCK_FOLDED
                        ...
                        : e === p.Type.BLOCK_LITERAL
                          ? !0
                          : !_o(n, Ne.fold.lineWidth, o.length),
                l = c ? "|" : ">";
            if (!n)
                return (
                    l +
...
`) !== -1
                ...
                return Bt(t, e, n, r);
            if (l === "" && Ut(o)) return ((e.forceBlockIndent = !0), Bt(t, e, n, r));
            let m = o.replace(
                /\n+/g,
                `$&
${l}`
...
`) !== -1)
        ...
        function Do({ format: t, minFractionDigits: e, tag: n, value: r }) {
...
` + s)
        ...
        function Uo(t, e) {
            let n = { before: [], after: [] },
                r = !1,
                s = !1,
                i = qo(e.context.parent) ? e.context.parent.props.concat(e.props) : e.props;
        ...
        function fe(t, e) {
            ...
            let { comments: n, hasAnchor: r, hasTag: s } = Uo(t.errors, e);
            if (r) {
                let { anchors: o } = t,
                    a = e.anchor,
                    c = o.getNode(a);
...
${a}`
        ...
        function Vo(t, e) {
            ...
            let { comments: n, items: r } = e.type === p.Type.FLOW_MAP ? Go(t, e) : Qo(t, e),
                s = new yt();
            ((s.items = r), ps(s, n));
            let i = !1;
            for (let o = 0; o < r.length; ++o) {
                let { key: a } = r[o];
                if ((a instanceof W && (i = !0), t.schema.merge && a && a.value === os)) {
                    r[o] = new Ft(r[o]);
                        ...
                        : c.type === p.Type.COMMENT
                          ...
                          : s === void 0
                            ...
                            : (o !== "," &&
                              ...
                              r.push(new T(s, fe(t, c))),
                              (s = void 0),
                              (i = !1));
            }
            return (ls(t.errors, e), s !== void 0 && r.push(new T(s)), { comments: n, items: r });
        }
        function Ho(t, e) {
            ...
            let { comments: n, items: r } = e.type === p.Type.FLOW_SEQ ? Xo(t, e) : Jo(t, e),
                s = new le();
            if (
                ((s.items = r),
                ps(s, n),
                !t.options.mapAsMap && r.some((i) => i instanceof T && i.key instanceof W))
            ) {
                let i =
                    "Keys with collection values will be stringified as YAML due to JS Object restrictions. Use mapAsMap: true to avoid this.";
            ...
            for (let s = 0; s < e.items.length; ++s) {
                ...
                switch (i.type) {
                    ...
                    case p.Type.SEQ_ITEM:
                        if (
                            (i.error && t.errors.push(i.error), r.push(fe(t, i.node)), i.hasProps)
                        ) {
                            let o =
...
`
                    ...
                    (fs(t.errors, f), n.push({ comment: f.comment, before: r.length }));
                else {
                    if (a) {
            ...
            return (ls(t.errors, e), i !== void 0 && r.push(new T(i)), { comments: n, items: r });
        }
        k.Alias = be;
        k.Collection = W;
        k.Merge = Ft;
        ...
        k.resolveString = Kn;
        k.strOptions = Ne;
        k.stringifyNumber = Do;
        k.stringifyString = xo;
        k.toJSON = ce;
    });
    var Qn = te((z) => {
        "use strict";
...
${i.comment}`
        ...
        var Zo = { default: !1, tag: "tag:yaml.org,2002:pairs", resolve: hs, createNode: gs },
        ...
        z.timestamp = ca;
        z.warn = Wn;
        z.warnFileDeprecation = la;
        z.warnOptionDeprecation = fa;
    });
    var Xn = te((ks) => {
        "use strict";
        var jt = oe(),
        ...
        var Wt = {
            ...
            Jn = (t, e, n) => (E.intOptions.asBigInt ? BigInt(t) : parseInt(e, n));
        function Ss(t, e, n) {
            let { value: r } = t;
        ...
        var ws = {
            ...
            Ns = {
                ...
                format: "OCT",
                test: /^0o([0-7]+)$/,
                resolve: (t, e) => Jn(t, e, 8),
                options: E.intOptions,
                stringify: (t) => Ss(t, 8, "0o"),
            },
            Os = {
                identify: Qt,
                default: !0,
            ...
            As = {
                ...
                format: "HEX",
                test: /^0x([0-9a-fA-F]+)$/,
                resolve: (t, e) => Jn(t, e, 16),
                options: E.intOptions,
                stringify: (t) => Ss(t, 16, "0x"),
            },
            Ls = {
                identify: (t) => typeof t == "number",
                default: !0,
            ...
            ha = Hn.concat([ws, bs, Ns, Os, As, Ls, Ts, Ms]),
            ys = (t) => typeof t == "bigint" || Number.isInteger(t),
            Kt = ({ value: t }) => JSON.stringify(t),
            Cs = [
                St,
                Wt,
                {
                ...
                },
                {
                    ...
                    stringify: ({ value: t }) => (ys(t) ? t.toString() : JSON.stringify(t)),
                },
                {
                    identify: (t) => typeof t == "number",
                    default: !0,
        ...
        var Es = ({ value: t }) => (t ? E.boolOptions.trueStr : E.boolOptions.falseStr),
            Et = (t) => typeof t == "bigint" || Number.isInteger(t);
        function Vt(t, e, n) {
            let r = e.replace(/_/g, "");
        ...
        var ga = Hn.concat(
            ...
            da = { core: ha, failsafe: Hn, json: Cs, yaml11: ga },
            ya = {
                binary: D.binary,
                bool: bs,
                float: Ms,
        ...
        function Sa(t, e, n) {
            ...
            if (!c) {
                ...
                c = t instanceof Map ? St : t[Symbol.iterator] ? Wt : St;
            }
        ...
        jt._defineProperty(wt, "defaultPrefix", jt.defaultTagPrefix);
        jt._defineProperty(wt, "defaultTags", jt.defaultTags);
        ks.Schema = wt;
    });
    var _s = te((Xt) => {
        "use strict";
        ...
        function Aa(t, e) {
            ...
            if (e instanceof S.Scalar) {
                r = e.value;
                let s = t.filter(
                    (i) => (i.identify && i.identify(r)) || (i.class && r instanceof i.class)
                );
        ...
        function La(t, e, { anchors: n, doc: r }) {
            let s = [],
                i = r.anchors.getName(t);
            return (
                i && ((n[i] = t), s.push(`&${i}`)),
                t.tag ? s.push(Is(r, t.tag)) : e.default || s.push(Is(r, e.tag)),
                s.join(" ")
            );
        }
        function Gt(t, e, n, r) {
...
${e.indent}${c}`
        ...
        var zn = class t {
                static validAnchorNode(e) {
                    return (
                        e instanceof S.Scalar || e instanceof S.YAMLSeq || e instanceof S.YAMLMap
                    );
                }
                constructor(e) {
            ...
            Ht = (t, e) => {
                if (t && typeof t == "object") {
                    ...
                    t instanceof S.Collection
                        ? (n && (e[n] = !0), t.items.forEach((r) => Ht(r, e)))
                        : t instanceof S.Pair
                          ? (Ht(t.key, e), Ht(t.value, e))
                          : t instanceof S.Scalar && n && (e[n] = !0);
                }
                return e;
            },
            Ta = (t) => Object.keys(Ht(t, {}));
        function Ma(t, e) {
            let n = { before: [], after: [] },
                r,
                s = !1;
...
`) || null;
        ...
        var Jt = class t {
            ...
            listNonDefaultTags() {
                return Ta(this.contents).filter((e) => e.indexOf(Ps.Schema.defaultPrefix) !== 0);
            }
            setTagPrefix(e, n) {
                if (e[0] !== "!" || e[e.length - 1] !== "!")
...
`
        ...
        Y._defineProperty(Jt, "defaults", vs);
        Xt.Document = Jt;
        Xt.defaultOptions = Na;
        Xt.scalarOptions = Oa;
    });
    var Ds = te((xs) => {
        "use strict";
        ...
        function Ra(t, e = !0, n) {
            ...
            return new Ia.Schema(r).createNode(t, e, n);
        }
        ...
        function Rs(t, e) {
            let n = Zn.parse(t),
                r = new je(e).parse(n[0]);
            if (n.length > 1) {
                let s = "Source contains multiple documents; please use YAML.parseAllDocuments()";
                r.errors.unshift(new va.YAMLSemanticError(n[1], s));
            }
            return r;
        }
        function Da(t, e) {
            let n = Rs(t, e);
            if ((n.warnings.forEach((r) => _a.warn(r)), n.errors.length > 0)) throw n.errors[0];
            return n.toJSON();
        }
        function Ya(t, e) {
            let n = new je(e);
    ...
    var rc = {};
    hr(rc, { languages: () => Jr, options: () => Xr, parsers: () => pr, printers: () => nc });
    var Ki = (t, e, n, r) => {
            if (!(t && e == null))
                return e.replaceAll
                    ? e.replaceAll(n, r)
    ...
    var Me = "string",
        ...
        rt = "indent-if-break",
        Ie = "line-suffix",
        st = "line-suffix-boundary",
        Z = "line",
        it = "label",
        ve = "break-parent",
        Lt = new Set([et, tt, Ce, nt, ke, Pe, ge, rt, Ie, st, Z, it, ve]);
    var Vi = (t, e, n) => {
            if (!(t && e == null))
...
`)
    ...
    function Tt(t) {
        return (Er(t), { type: Pe, parts: t });
    }
    function ct(t, e = "", n = {}) {
        return (
            de(t),
            e !== "" && de(e),
            { type: ge, breakContents: t, flatContents: e, groupId: n.groupId }
        );
    }
    function br(t) {
    ...
    var Mt = { type: ve };
    var Ji = { type: Z, hard: !0 },
        Xi = { type: Z, hard: !0, literal: !0 },
        ne = { type: Z },
        Ct = { type: Z, soft: !0 },
        N = [Ji, Mt],
        ot = [Xi, Mt];
...
` ||
    ...
    function Zi(t, e) {
        let n = e - 1;
        ((n = yn(t, n, { backwards: !0 })),
            (n = En(t, n, { backwards: !0 })),
            (n = yn(t, n, { backwards: !0 })));
        let r = En(t, n, { backwards: !0 });
        return n !== r;
    }
    var Nr = Zi;
    ...
    var lt = null;
    function ft(t) {
        if (lt !== null && typeof lt.property) {
            let e = lt;
            return ((lt = ft.prototype = null), e);
        }
        return ((lt = ft.prototype = t ?? Object.create(null)), new ft());
    }
    var eo = 10;
    for (let t = 0; t <= eo; t++) ft();
    function wn(t) {
        return ft(t);
    }
    function to(t, e = "type") {
        wn(t);
        function n(r) {
            let s = r[e],
                i = t[s];
...
${t}`;
    ...
    function bn(t, e, n) {
        return e("children" in t ? { ...t, children: t.children.map((r) => bn(r, e, t)) } : t, n);
    }
    function Ye(t, e, n) {
...
` && n++,
    ...
    function It(t) {
        return De(t.children) ? It(x(!1, t.children, -1)) : t;
    }
    function $r(t) {
    ...
    function Fr(t) {
        ...
        if (e.type === "documentBody") {
            let n = t.parent.head;
            return I(n) && $r(x(!1, n.endComments, -1));
        }
        return ee(e) && $r(x(!1, e.leadingComments, -1));
    }
    function $e(t) {
        return !De(t.children) && !io(t);
    }
    function io(t) {
        return ee(t) || ie(t) || Nn(t) || V(t) || I(t);
    }
    function ee(t) {
...
`
    ...
    function Kr(t, { parentIndent: e, isLastDescendant: n, options: r }) {
        let s =
...
`
    ...
    function vt(t, e) {
        let { node: n, root: r } = t,
            s;
        return (
            On.has(r) ? (s = On.get(r)) : ((s = new Set()), On.set(r, s)),
            !s.has(n.position.end.line) && (s.add(n.position.end.line), Br(n, e) && !An(t.parent))
                ? Ct
                : ""
        );
    }
    ...
    function oo(t, e, n) {
        ...
        (r.indent !== null && o.push(r.indent.toString()),
            ...
            Nn(r) && o.push(" ", n("indicatorComment")));
        let a = Kr(r, { parentIndent: s, isLastDescendant: i, options: e }),
            c = [];
        for (let [l, f] of a.entries())
            (l === 0 && c.push(N),
                c.push(Tt(P(ne, f))),
                l !== a.length - 1
                    ? c.push(f.length === 0 ? N : Sr(ot))
                    : r.chomping === "keep" && i && c.push(gn(f.length === 0 ? N : ot)));
        return (
            r.indent === null ? o.push(wr(v(e.tabWidth, c))) : o.push(gn(v(r.indent - 1 + s, c))),
            o
        );
    }
    var Vr = oo;
    function _t(t, e, n) {
        ...
        let c = x(!1, r.children, -1),
            l = (c == null ? void 0 : c.type) === "flowMappingItem" && $e(c.key) && $e(c.value);
        return [
            i,
            v(e.tabWidth, [
                a,
                ao(t, e, n),
                e.trailingComma === "none" ? "" : ct(","),
                I(r) ? [N, P(N, t.map(n, "endComments"))] : "",
            ]),
            l ? "" : a,
            o,
        ];
    ...
    function co(t, e, n) {
        ...
        if (c)
            return r.type === "flowMappingItem" && s.type === "flowMapping"
                ...
                : r.type === "mappingItem" &&
                    Ln(i.content, e) &&
                    !V(i.content) &&
                    ((M = s.tag) == null ? void 0 : M.value) !== "tag:yaml.org,2002:set"
                  ? [l, f, ":"]
                  : ["? ", v(2, l)];
        let m = n("value");
        if (a) return [": ", v(2, m)];
        if (ee(o) || !ut(i.content))
            return [
                "? ",
                v(2, l),
                N,
                ...t.map(() => [n(), N], "value", "leadingComments"),
                ": ",
                v(2, m),
            ];
        if (
        ...
        let d = Symbol("mappingKey"),
            y = Re([ct("? "), Re(v(2, l), { id: d })]),
            h = [N, ": ", v(2, m)],
            g = [f, ":"];
        (I(o) &&
        o.content &&
        K(o.content, ["flowMapping", "flowSequence"]) &&
        o.content.children.length === 0
            ? g.push(" ")
            : ee(o.content) ||
                (I(o) && o.content && !K(o.content, ["mapping", "sequence"])) ||
                (s.type === "mapping" && V(i.content) && ut(o.content)) ||
                (K(o.content, ["mapping", "sequence"]) &&
                    o.content.tag === null &&
        ...
        return Ln(i.content, e) && !ee(i.content) && !ie(i.content) && !I(i)
            ? dn([[l, w]])
            : dn([[y, ct(h, w, { groupId: d })]]);
    }
    function Ln(t, e) {
        if (!t) return !0;
        switch (t.type) {
        ...
        if (/\\$/mu.test(e.originalText.slice(t.position.start.offset, t.position.end.offset)))
            return !1;
        switch (e.proseWrap) {
            case "never":
...
`);
    ...
    function mo(t, e, n) {
        ...
        let a = "";
        return (
            K(r, ["mapping", "sequence", "comment", "directive", "mappingItem", "sequenceItem"]) &&
                !Pt(t) &&
                (a = vt(t, e.originalText)),
            (i || o) && (K(r, ["sequence", "mapping"]) && !ie(r) ? s.push(N) : s.push(" ")),
            ie(r) &&
                s.push([
                    r.middleComments.length === 1 ? "" : N,
                    P(N, t.map(n, "middleComments")),
                    N,
                ]),
            Fr(t)
                ? s.push(
            ...
            An(r) &&
                s.push(
                    v(r.type === "sequenceItem" ? 2 : 0, [
                        N,
                        P(
                            N,
                            t.map(
                                ({ node: c }) => [Nr(e.originalText, xe(c)) ? N : "", n()],
                                "endComments"
                            )
                        ),
                    ])
    ...
    function ho(t, e, n) {
        ...
        switch (r.type) {
            case "root": {
                ...
                t.each(({ node: o, next: a, isFirst: c }) => {
                    (c || s.push(N),
                        s.push(n()),
                        Qr(o, a)
                            ? (s.push(N, "..."), V(o) && s.push(" ", n("trailingComment")))
                            : a && !V(a.head) && s.push(N, "---"));
                }, "children");
                let i = It(r);
                return (
                    (!K(i, ["blockLiteral", "blockFolded"]) || i.chomping !== "keep") && s.push(N),
                    s
                );
            }
            case "document": {
            ...
            case "quoteSingle": {
                ...
                if (o.includes(i))
                    return [
                        ...
                        pt(
                            r.type,
                            r.type === "quoteDouble"
                                ? At(!1, At(!1, o, String.raw`\"`, i), "'", s.repeat(2))
                                : o,
                            e
                        ),
                        s,
                ...
                if (o.includes(s))
                    return [i, pt(r.type, r.type === "quoteSingle" ? At(!1, o, "''", s) : o, e), i];
                let a = e.singleQuote ? s : i;
                return [a, pt(r.type, o, e), a];
            }
            case "blockFolded":
            case "blockLiteral":
                return Vr(t, e, n);
    ...
    function yo(t, e) {
        let n = t.node;
        if (
            (t.isFirst && /---(?:\s|$)/u.test(e.originalText.slice(xe(n), xe(n) + 4))) ||
    ...
    Gr.ignoredProperties = new Set(["position"]);
    var Eo = {
            preprocess: Wr,
            embed: Lr,
            print: mo,
    ...
    var ur = dr($s(), 1);
    var H = dr(Bs(), 1),
        rf = H.default.findPair,
        sf = H.default.toJSON,
        of = H.default.parseMap,
        af = H.default.parseSeq,
        cf = H.default.stringifyNumber,
        lf = H.default.stringifyString,
        ff = H.default.Type,
        uf = H.default.YAMLError,
        pf = H.default.YAMLReferenceError,
        Fs = H.default.YAMLSemanticError,
        mf = H.default.YAMLSyntaxError,
        hf = H.default.YAMLWarning;
    function B(t, e = null) {
    ...
    function Fa(t, e, n) {
        ...
        if (s) {
            if (s.trailingComment)
                throw new Error(`Unexpected multiple trailing comment at ${Ae(t.position.start)}`);
        ...
        switch (t.type) {
            ...
            case "SEQ":
                for (let e = t.items.length - 1; e >= 0; e--) {
                    let n = t.items[e];
                    "char" in n || (n.type === "BLANK_LINE" ? t.items.splice(e, 1) : bt(n));
                }
                break;
            case "MAP_KEY":
            case "MAP_VALUE":
    ...
    function Zt(t, e) {
        let n = t.cstNode,
            ...
            l = zt(t, e, (f) => {
                ...
                if (c)
                    throw new Error(
                        `Unexpected multiple indicator comments at ${Ae(f.position.start)}`
                    );
                return ((c = f), !0);
            });
        return Xs(a, l, tr[n.chomping], o ? n.blockIndent : null, n.strValue, c);
    }
    function zs(t, e) {
        return Js(Zt(t, e));
    }
    ...
    function He(t, e) {
        for (let n of t.props) {
            ...
            switch (r) {
                case ue.Comment:
                    e.comments.push(
                        Ge(e.transformRange(n), e.text.slice(n.origStart + 1, n.origEnd))
                    );
                    break;
                default:
    ...
    function oi(t, e, n) {
        let r = t.cstNode,
            ...
            { position: l, documentEndPoint: f } = Ka(r, c, e);
        return (
            e.comments.push(...s, ...i),
            {
    ...
    function Ua(t, e, n) {
        ...
        if (i.length > 1)
            throw new Error(
                `Unexpected multiple document trailing comments at ${Ae(i[1].position.start)}`
            );
        if (o.length > 1)
            throw new Error(
                `Unexpected multiple documentHead trailing comments at ${Ae(o[1].position.start)}`
            );
        return {
            comments: r,
            endComments: s,
    ...
    function Ka(t, e, n) {
        let r = en(n.text.slice(t.valueRange.origEnd), /^\.\.\./),
    ...
    function ci(t, e) {
        let n = t.cstNode,
            { directives: r, comments: s, endComments: i } = Va(n, e),
            { position: o, endMarkerPoint: a } = ja(n, r, e);
        return (
            e.comments.push(...s, ...i),
            {
    ...
    function li(t, e) {
        let { createDocumentHeadWithTrailingComment: n, documentHeadEndMarkerPoint: r } = ci(t, e),
            {
                documentBody: s,
                documentEndPoint: i,
                documentTrailingComment: o,
        ...
        let i = e.transformNode(t.key),
            ...
            c =
                o || s
                    ...
                    : null;
        return n(
            J(a ? a.position.start : c.position.start, c ? c.position.end : a.position.end),
            a || nr(er(c.position.start), null),
            c || rr(er(a.position.end), null)
        );
    }
    function ui(t, e) {
        let n = me(t.cstNode.items, e),
            r = on(n),
            s = t.items.map((a, c) => {
                let l = r[c],
                    { additionalKeyRange: f, additionalValueRange: m } = rn(l);
    ...
    var sr,
        ...
        ir = class {
            constructor(e, n) {
                ...
                Ot(this, Le);
                Ot(this, Nt);
                ((this.text = n), fn(this, Le, e));
            }
            setOrigRanges() {
                if (!Te(this, Le).setOrigRanges())
                    for (let e of Te(this, Le)) e.setOrigRanges([], 0);
            }
            transformOffset(e) {
                return ze(this, he, or).call(this, { origStart: e, origEnd: e }).start;
            }
            transformRange(e) {
                let { start: n, end: r } = ze(this, he, or).call(this, e);
                return J(n, r);
            }
            transformNode(e) {
                return ki(e, this);
    ...
    ((Le = new WeakMap()),
        ...
        (or = function (e) {
            if (!sr) {
                let [o] = Te(this, Le),
                    a = Object.getPrototypeOf(Object.getPrototypeOf(o));
                sr = Object.getOwnPropertyDescriptor(a, "rangeAsLinePos").get;
            }
            Te(this, Nt) ?? fn(this, Nt, { root: { context: { src: this.text } } });
            let {
                start: { line: n, col: r },
                end: { line: s, col: i },
            } = sr.call({
                range: {
                    start: ze(this, he, ar).call(this, e.origStart),
                    end: ze(this, he, ar).call(this, e.origEnd),
                },
                context: Te(this, Nt),
            });
            return {
                start: { offset: e.origStart, line: n, column: r },
                end: { offset: e.origEnd, line: s, column: i },
            };
        }),
        (ar = function (e) {
    ...
    function fr(t) {
        ...
        let e = t.children;
        if ((e.forEach(fr), t.type === "document")) {
            let [i, o] = t.children;
        ...
        let n = lr(t.position, Qa, Ga, Xa),
            r = lr(t.position, Ha, Ja, za);
        "endComments" in t &&
            t.endComments.length !== 0 &&
            (n(t.endComments[0].position.start), r(U(t.endComments).position.end));
    ...
    function _i(t) {
        let e = ur.default.parseCST(t),
            n = new Pi(e, t);
        n.setOrigRanges();
        let r = e.map((i) => new ur.default.Document({ merge: !1, keepCstNodes: !0 }).parse(i));
        for (let i of r)
            for (let o of i.errors)
                if (!(o instanceof Fs && o.message === 'Map keys must be unique; "<<" is repeated'))
                    throw vi(o, n);
        r.forEach((i) => bt(i.cstNode));
        let s = Vs(
            n.transformRange({ origStart: 0, origEnd: t.length }),
            r.map((i) => n.transformNode(i)),
            n.comments
        );
        return (qs(s), fr(s), cr(s), s);
    }
    function Za(t, e) {
