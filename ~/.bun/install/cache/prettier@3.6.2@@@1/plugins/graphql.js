(function (f) {
        ...
        Nt = (e, t, n, i) => {
            if ((t && typeof t == "object") || typeof t == "function")
                for (let r of Tt(t))
                    !_t.call(e, r) &&
                        r !== n &&
                        ce(e, r, { get: () => t[r], enumerable: !(i = Et(t, r)) || i.enumerable });
            return e;
        };
    var xt = (e) => Nt(ce({}, "__esModule", { value: !0 }), e);
    var En = {};
    xe(En, { languages: () => Qe, options: () => Ke, parsers: () => Ne, printers: () => mn });
    var yt = (e, t, n, i) => {
            if (!(e && t == null))
                return t.replaceAll
                    ? t.replaceAll(n, i)
    ...
    function I(e, t = "", n = {}) {
        return (
            L(e),
            t !== "" && L(t),
            { type: w, breakContents: e, flatContents: t, groupId: n.groupId }
        );
    }
    var Dt = { type: X };
    var gt = { type: S, hard: !0 };
    var k = { type: S },
        p = { type: S, soft: !0 },
        f = [gt, Dt];
    function E(e, t) {
...
` ||
    ...
    var bt = 10;
    for (let e = 0; e <= bt; e++) B();
    function de(e) {
        return B(e);
    }
    function Pt(e, t = "type") {
        de(e);
        function n(i) {
            let r = i[t],
                s = e[r];
...
${e}`;
    ...
    function Ft(e, t, n) {
        ...
        let r = [n("description")];
        return (
            i.kind === "InputValueDefinition" && !i.description.block ? r.push(k) : r.push(f),
            r
        );
    }
    var D = Ft;
    function Bt(e, t, n) {
        ...
        switch (i.kind) {
            ...
            case "SelectionSet":
                return ["{", N([f, E(f, g(e, t, n, "selections"))]), f, "}"];
            case "Field":
                return y([
                    i.alias ? [n("alias"), ": "] : "",
                    n("name"),
                    i.arguments.length > 0
                        ? y(["(", N([p, E([I("", ", "), p], g(e, t, n, "arguments"))]), p, ")"])
                        : "",
                    x(e, n, i),
                    i.selectionSet ? " " : "",
                    n("selectionSet"),
...
`,
            ...
            case "Variable":
                return ["$", n("name")];
            case "ListValue":
                return y(["[", N([p, E([I("", ", "), p], e.map(n, "values"))]), p, "]"]);
            case "ObjectValue": {
            ...
            case "InterfaceTypeDefinition": {
                let { kind: r } = i,
                    s = [];
                return (
                    r.endsWith("TypeDefinition") ? s.push(D(e, t, n)) : s.push("extend "),
                    ...
                    s.push(x(e, n, i)),
                    i.fields.length > 0 &&
                        s.push([" {", N([f, E(f, g(e, t, n, "fields"))]), f, "}"]),
                    s
                );
            }
            ...
            case "EnumTypeDefinition":
                return [
                    ...
                    n("name"),
                    x(e, n, i),
                    i.values.length > 0 ? [" {", N([f, E(f, g(e, t, n, "values"))]), f, "}"] : "",
                ];
            case "EnumValueDefinition":
                return [D(e, t, n), n("name"), x(e, n, i)];
            ...
            case "SchemaExtension":
                return [
                    ...
                    ...(i.operationTypes.length > 0
                        ? [" {", N([f, E(f, g(e, t, n, "operationTypes"))]), f, "}"]
                        : []),
                ];
    ...
    function He(e, t) {
        ...
        return fe(n.variableDefinitions)
            ? y(["(", N([p, E([I("", ", "), p], e.map(t, "variableDefinitions"))]), p, ")"])
            : "";
    }
    function Je(e, t) {
        e.kind === "StringValue" &&
...
`) &&
    ...
    var jt = { bracketSpacing: We.bracketSpacing },
        Ke = jt;
    var Ne = {};
    xe(Ne, { graphql: () => dn });
    function ze(e) {
    ...
    function M(e, t) {
        let n = 0,
            i = 1;
        for (let r of e.body.matchAll($t)) {
    ...
    function tt(e) {
        return me(e.source, M(e.source, e.start));
    }
    function me(e, t) {
    ...
    var Z = class e extends Error {
        constructor(t, ...n) {
            ...
            (super(t),
                ...
                (this.nodes = nt(Array.isArray(a) ? a : a ? [a] : void 0)));
            let O = nt(
                (i = this.nodes) === null || i === void 0
                    ? void 0
                    : i.map((_) => _.loc).filter((_) => _ != null)
            );
            ((this.source =
                u ?? (O == null || (r = O[0]) === null || r === void 0 ? void 0 : r.source)),
                (this.positions = l ?? (O == null ? void 0 : O.map((_) => _.start))),
                (this.locations =
                    l && u
                        ? l.map((_) => M(u, _))
                        : O == null
                          ? void 0
                          : O.map((_) => M(_.source, _.start))));
            let ae = ze(h == null ? void 0 : h.extensions)
                ? h == null
                    ? void 0
                    : h.extensions
                : void 0;
            ((this.extensions = (s = A ?? ae) !== null && s !== void 0 ? s : Object.create(null)),
...
` + me(this.source, n);
    ...
    function Jt(e, t) {
        ...
        for (; r < i; ) {
            ...
            if (b(s) || s === 45) return Qt(e, r, s);
            if (Ee(s)) return tn(e, r);
            throw d(
                e.source,
                r,
                s === 39
                    ...
                    : P(s) || ne(n, r)
                      ? `Unexpected character: ${R(e, r)}.`
                      : `Invalid character: ${R(e, r)}.`
            );
        }
    ...
    function Qt(e, t, n) {
        ...
        if ((s === 45 && (s = i.charCodeAt(++r)), s === 48)) {
            if (((s = i.charCodeAt(++r)), b(s)))
                throw d(e.source, r, `Invalid number, unexpected digit after 0: ${R(e, r)}.`);
        } else ((r = Te(e, r, s)), (s = i.charCodeAt(r)));
        if (
            (s === 46 &&
                ((a = !0), (s = i.charCodeAt(++r)), (r = Te(e, r, s)), (s = i.charCodeAt(r))),
            (s === 69 || s === 101) &&
                ((a = !0),
                (s = i.charCodeAt(++r)),
            ...
            throw d(e.source, r, `Invalid number, expected digit but got: ${R(e, r)}.`);
    ...
    function at(e, t) {
        return (
            (V(e.charCodeAt(t)) << 12) |
            (V(e.charCodeAt(t + 1)) << 8) |
            (V(e.charCodeAt(t + 2)) << 4) |
            V(e.charCodeAt(t + 3))
        );
    }
    function V(e) {
...
`)
    ...
    function nn(e, t) {
        ...
        } else if (Array.isArray(e)) return on(e, n);
        return sn(e, n);
    }
    function rn(e) {
...
spurious results.`);
        ...
        node(t, n) {
            return (
                this._options.noLocation !== !0 &&
                    (n.loc = new Q(t, this._lexer.lastToken, this._lexer.source)),
                n
            );
        }
        peek(t) {
    ...
    var pn = { allowLegacyFragmentVariables: !0 };
    function fn(e) {
        if ((e == null ? void 0 : e.name) === "GraphQLError") {
            ...
            return mt(t, { loc: { start: n }, cause: e });
        }
        return e;
    }
    function hn(e) {
