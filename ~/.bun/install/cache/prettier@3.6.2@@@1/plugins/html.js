(function (f) {
    ...
    var vi = (t, e, r) =>
        e in t
            ? At(t, e, { enumerable: !0, configurable: !0, writable: !0, value: r })
            : (t[e] = r);
    var un = (t, e) => {
            for (var r in e) At(t, r, { get: e[r], enumerable: !0 });
        },
        yi = (t, e, r, n) => {
            if ((e && typeof e == "object") || typeof e == "function")
                for (let s of Ai(e))
                    !Di.call(t, s) &&
                        s !== r &&
                        At(t, s, { get: () => e[s], enumerable: !(n = Ei(e, s)) || n.enumerable });
            return t;
        };
    var wi = (t) => yi(At({}, "__esModule", { value: !0 }), t);
    var cr = (t, e, r) => vi(t, typeof e != "symbol" ? e + "" : e, r),
        ln = (t, e, r) => e.has(t) || on("Cannot " + r);
    var R = (t, e, r) => (ln(t, e, "read from private field"), r ? r.call(t) : e.get(t)),
        Dt = (t, e, r) =>
            e.has(t)
    ...
    var we = "string",
        ...
        Qe = "label",
        Le = "break-parent",
        vt = new Set([Ye, be, Te, je, xe, ke, ce, Be, Ke, Xe, j, Qe, Le]);
    var Ti = (t, e, r) => {
            if (!(t && e == null))
...
`)
    ...
    function pe(t, e = "", r = {}) {
        return (
            re(t),
            e !== "" && re(e),
            { type: ce, breakContents: t, flatContents: e, groupId: r.groupId }
        );
    }
    function gn(t, e) {
    ...
    var ne = { type: Le };
    var Fi = { type: j, hard: !0 },
        Pi = { type: j, hard: !0, literal: !0 },
        _ = { type: j },
        v = { type: j, soft: !0 },
        S = [Fi, ne],
        pn = [Pi, ne];
...
`,
    ...
    var Oi = new Set([
        ...
        Mi = new Set(["if", "else if", "for", "switch", "case"]);
    function An(t, e) {
        var r;
        if (
            t.type === "text" ||
        ...
        if (
            ...
            t.type === "angularControlFlowBlock" && (r = t.parameters) != null && r.children)
        )
            for (let n of e.parameters.children)
                Mi.has(t.name) ? delete n.expression : (n.expression = n.expression.trim());
    ...
    function Hi(t, e, r, n) {
        ...
        return /^\s*$/u.test(i)
            ? ""
            : T(i, t, { parser: "__ng_directive", __isInHtmlAttribute: !1 }, X);
    }
    var yn = Hi;
    var Vi = (t, e) => {
            if (!(t && e == null))
    ...
    var bn,
        ...
        Bn,
        Wi =
            ((bn = globalThis.Deno) == null ? void 0 : bn.build.os) === "windows" ||
            ((xn = (Tn = globalThis.navigator) == null ? void 0 : Tn.platform) == null
                ? void 0
                : xn.startsWith("Win")) ||
            ((Bn = (kn = globalThis.process) == null ? void 0 : kn.platform) == null
                ? void 0
                : Bn.startsWith("win")) ||
            !1;
    function Ln(t) {
    ...
    function zi(t) {
        ...
        let e = decodeURIComponent(
            t.pathname.replace(/\//g, "\\").replace(/%(?![0-9A-Fa-f]{2})/g, "%25")
        ).replace(/^\\*([A-Za-z]:)(\\|$)/, "$1\\");
    ...
    function Nn(t, e) {
        ...
        return (
            ...
            ) ?? t.find(({ extensions: n }) => (n == null ? void 0 : n.some((s) => r.endsWith(s))))
        );
    }
    function ji(t, e) {
        if (e)
    ...
    function In(t, e) {
        if (e) {
            ...
            if (typeof e == "string")
                return t.find(({ isSupported: r }) => (r == null ? void 0 : r({ filepath: e })));
        }
    }
    function Ki(t, e) {
        let r = wn(!1, t.plugins).flatMap((s) => s.languages ?? []),
            n =
                ji(r, e.language) ??
                Nn(r, e.physicalFile) ??
                Nn(r, e.file) ??
    ...
    function bt(t, e) {
        return !!(
            ...
            (de(t) && t.children.some((r) => r.type !== "text" && r.type !== "interpolation")) ||
            (kt(t, e) && !W(t, e) && t.type !== "interpolation")
        );
    }
    function ge(t) {
    ...
    function W(t, e) {
        return (
            ...
            (t.fullName === "script" ||
                ...
                (t.fullName === "mj-style" && e.parser === "mjml") ||
                (fe(t) && (t.name === "script" || t.name === "style")))
        );
    }
    function Mn(t, e) {
    ...
    function Hn(t, e) {
        ...
        return r;
        function n() {
            return Pe(t) || t.type === "angularControlFlowBlock"
                ? !1
                      ...
                      : !(
                            (!t.prev &&
                                (t.parent.type === "root" ||
                                    ...
                                    W(t.parent, e) ||
                                    et(t.parent, e) ||
                                    !sa(t.parent.cssDisplay))) ||
                            (t.prev && !oa(t.prev.cssDisplay))
                        );
        }
    }
    function Vn(t, e) {
                  ...
                  : !(
                        (!t.next &&
                            (t.parent.type === "root" ||
                                ...
                                W(t.parent, e) ||
                                et(t.parent, e) ||
                                !ia(t.parent.cssDisplay))) ||
                        (t.next && !aa(t.next.cssDisplay))
                    );
    }
    function Un(t, e) {
    ...
    function Je(t) {
        return (
            Pe(t) ||
            (t.next && t.sourceSpan.end && t.sourceSpan.end.line + 1 < t.next.sourceSpan.start.line)
        );
    }
    function Wn(t) {
        return (
            ...
            (t.type === "element" &&
                t.children.length > 0 &&
                (["body", "script", "style"].includes(t.name) || t.children.some((e) => ea(e)))) ||
            (t.firstChild &&
                t.firstChild === t.lastChild &&
                t.firstChild.type !== "text" &&
                zn(t.firstChild) &&
                (!t.lastChild.isTrailingSpaceSensitive || Yn(t.lastChild)))
        );
    }
    function vr(t) {
        return (
    ...
    function ta(t, e) {
        ...
        return !i && !s ? "babel" : (Ne(e, { language: i }) ?? Kn(s));
    }
    function ra(t, e) {
        if (!kt(t, e)) return;
        let { attrMap: r } = t;
    ...
    function Xn(t, e) {
        ...
        if (t.type === "element" && t.namespace === "svg")
            if (la(t, (s) => s.fullName === "svg:foreignObject")) r = !0;
        ...
        switch (e.htmlWhitespaceSensitivity) {
            ...
            default:
                if (
                    t.type === "element" &&
                    (!t.namespace || r || fe(t)) &&
                    Object.prototype.hasOwnProperty.call(_r, t.name)
                )
                    return _r[t.name];
        }
        return Rn;
    ...
    function Qn(t) {
        return t.type === "element" &&
            (!t.namespace || fe(t)) &&
            Object.prototype.hasOwnProperty.call(Er, t.name)
            ? Er[t.name]
            : $n;
    }
    function ca(t) {
...
`);
    ...
    var pa = new Set(["template", "style", "script"]);
    function et(t, e) {
    ...
    function Jn(t) {
        let e = t.fullName;
        return (
            e.charAt(0) === "#" || e === "slot-scope" || e === "v-slot" || e.startsWith("v-slot:")
        );
    }
    function Zn(t, e) {
        let r = t.parent;
    ...
    async function es(t, e) {
        let r = [];
        for (let [n, s] of t.split(Tr).entries())
            if (n % 2 === 0) r.push(B(s));
            else
                try {
                    r.push(
    ...
    var ha = xr({ parser: "__ng_action" }),
        ma = xr({ parser: "__ng_binding" }),
        fa = xr({ parser: "__ng_directive" });
    function da(t, e) {
...
` ||
    ...
    function Da(t) {
        ...
        for (;;) {
            ...
            ((u = o),
                (r = p(_a)),
                (n = []),
                r.slice(-1) === "," ? ((r = r.replace(Ea, "")), f()) : m());
        }
        function m() {
            for (p(Ca), s = "", i = "in descriptor"; ; ) {
                if (((a = t.charAt(o)), i === "in descriptor"))
                    if (ns(a)) s && (n.push(s), (s = ""), (i = "after descriptor"));
                    else if (a === ",") {
                        ((o += 1), s && n.push(s), f());
                        return;
                ...
                else if (i === "after descriptor" && !ns(a))
                    if (a === "") {
                        f();
                        return;
    ...
    var as = { width: "w", height: "h", density: "x" },
        ya = Object.keys(as);
    function wa(t) {
        let e = is(t),
            r = ya.filter((l) => e.some((m) => Object.prototype.hasOwnProperty.call(m, l)));
    ...
    function us(t, e) {
        ...
        if (r.fullName === "style" && !e.parentParser && !n.includes("{{"))
            return async (s) => he(await s(n, { parser: "css", __isHTMLStyleAttribute: !0 }));
    }
    var kr = new WeakMap();
    function ba(t, e) {
        let { root: r } = t;
        return (
            kr.has(r) ||
                kr.set(
                    r,
                    r.children.some(
                        (n) => Lt(n, e) && ["ts", "typescript"].includes(n.attrMap.lang)
                    )
                ),
            kr.get(r)
        );
    ...
    async function ps(t, e, r, n) {
        let s = P(r.node),
            { left: i, operator: a, right: o } = Ta(s),
            u = Ie(r, n);
        return [
            E(
    ...
    function Fa(t) {
        return async (e, r, n, s) => {
            ...
            if (i)
                return (
                    (i = mr(i, (a) => (typeof a == "string" ? w(!1, a, '"', "&quot;") : a))),
                    [n.node.rawName, '="', E(i), '"']
                );
        };
    }
    var fs = La;
    var Pa = new Proxy(() => {}, { get: () => Pa });
    function J(t) {
    ...
    function $a(t, e, r) {
        ...
        let s = ((m = n.prev) == null ? void 0 : m.type) === "comment" && Ra(n.prev.value),
            i =
                typeof s == "boolean"
                    ? () => s
                    : Array.isArray(s)
                      ? (f) => s.includes(f.rawName)
                      : () => !1,
            a = t.map(
                ({ node: f }) => (i(f) ? B(e.originalText.slice(J(f), se(f))) : r()),
                "attrs"
            ),
            o =
                n.type === "element" &&
                ...
                n.children.length === 0,
            p = e.singleAttributePerLine && n.attrs.length > 1 && !Ce(n, e) ? S : _,
            l = [k([o ? " " : _, H(p, a)])];
        return (
            (n.firstChild && nt(n.firstChild)) || (n.isSelfClosing && Ee(n.parent)) || o
                ? l.push(n.isSelfClosing ? " " : "")
                : l.push(
                      e.bracketSameLine ? (n.isSelfClosing ? " " : "") : n.isSelfClosing ? _ : v
                  ),
            l
        );
    }
    ...
    function Ma(t, e) {
        ...
        return (
            t.lastChild && Ae(t.lastChild)
                ? (n += Ft(t, e).length)
                : Ee(t) && (n -= _e(t.lastChild, e).length),
            e.originalText.slice(r, n)
        );
    }
    var It = Ma;
    var qa = new Set(["if", "else if", "for", "switch", "case"]);
    function Ha(t, e) {
        let { node: r } = t;
        switch (r.type) {
            case "element":
                    ...
                    if (n)
                        return async (s) => {
                            ...
                            if (e.parser === "html" && n === "babel") {
                                ...
                                (u &&
                                    (u.type === "module" ||
                                        ((u.type === "text/babel" || u.type === "text/jsx") &&
                                            u["data-type"] === "module")) &&
                                    (o = "module"),
            ...
            case "angularLetDeclarationInitializer":
                return (n) => T(r.value, n, { parser: "__ng_binding", __isInHtmlAttribute: !1 });
        }
    }
    var Cs = Ha;
    var it = null;
    ...
    var Ga = Ss(_s),
        Es = Ga;
    var As = "format";
    var Ds = /^\s*<!--\s*@(?:noformat|noprettier)\s*-->/u,
        vs = /^\s*<!--\s*@(?:format|prettier)\s*-->/u;
    function ys(t) {
        return vs.test(t);
    }
    function ws(t) {
...
${t}`;
    ...
    function xs(t) {
        ...
        return t.type === "element" && !t.endSourceSpan && me(t.children)
            ? Math.max(e, xs(K(!1, t.children, -1)))
            : e;
    }
    function ot(t, e, r) {
        let n = t.node;
                ...
                B(
                    O.trimEnd(
                        e.originalText.slice(
                            J(n) + (n.prev && rt(n.prev) ? Pt(n).length : 0),
                            s - (n.next && Q(n.next) ? _e(n, e).length : 0)
                        )
                    )
                ),
                G(n, e),
    ...
    function Rt(t, e) {
        return $(t) && $(e)
            ...
            : (rt(t) &&
                ...
                (t.type === "element" && t.isSelfClosing && Q(e))
              ? ""
    ...
    function Re(t, e, r) {
        ...
        return t.map((i, a) => {
            ...
            let u = [],
                ...
                l = [],
                m = [],
                f = o.prev ? Rt(o.prev, o) : "",
                C = o.next ? Rt(o, o.next) : "";
            return (
                f &&
                    (Je(o.prev)
                        ? u.push(S, S)
    ...
    function Fs(t, e, r) {
        ...
        return [
            ...
            E([
                ...
                ", ",
                n.clause,
                n.cases.length > 0 ? [",", k([_, H(_, t.map(r, "cases"))])] : "",
                v,
            ]),
            Se(n, e),
        ];
            ...
            E([
                k([
                    ...
                    t.map(({ node: s, isLast: i }) => {
                        ...
                        return (
                            s.type === "text" &&
                                (s.hasLeadingSpaces && a.unshift(_),
                                s.hasTrailingSpaces && !i && a.push(_)),
                            a
                        );
                    }, "expression"),
                ]),
    ...
    function Ns(t, e, r) {
        ...
        let s =
            ...
            a = (l) => E([E(st(t, e, r), { id: i }), l, tt(n, e)]),
            o = (l) =>
                s
                    ? gn(l, { groupId: i })
                    : (W(n, e) || et(n, e)) &&
        ...
        return n.children.length === 0
            ? a(n.hasDanglingSpaces && n.isDanglingSpaceSensitive ? _ : "")
            : a([Wn(n) ? ne : "", o([u(), Re(t, e, r)]), p()]);
    }
    function ut(t) {
...
`
    ...
    function eo(t) {
        let e = (r) => {
            ...
            return (
                ...
                !O.hasWhitespaceCharacter(r.children[0].value) &&
    ...
    function ro(t, e) {
        t.walk((r) => {
            ...
            if (
                n.length === 0 ||
                (n.length === 1 && n[0].type === "text" && O.trim(n[0].value).length === 0)
            ) {
            ...
            if (!s)
                for (let a = 0; a < n.length; a++) {
                    ...
                    let { leadingWhitespace: u, text: p, trailingWhitespace: l } = On(o.value),
                        m = o.prev,
                        f = o.next;
                    p
                        ? ((o.value = p),
                          (o.sourceSpan = new h(
                              o.sourceSpan.start.moveBy(u.length),
                              o.sourceSpan.end.moveBy(-l.length)
                          )),
                          u && (m && (m.hasTrailingSpaces = !0), (o.hasLeadingSpaces = !0)),
                          l && ((o.hasTrailingSpaces = !0), f && (f.hasLeadingSpaces = !0)))
                        : (r.removeChild(o),
                          a--,
                          (u || l) &&
                              (m && (m.hasTrailingSpaces = !0), f && (f.hasLeadingSpaces = !0)));
                }
    ...
    function ao(t, e) {
        t.walk((r) => {
            ...
            if (n) {
                ...
                for (let s of n)
                    ((s.isLeadingSpaceSensitive = Hn(s, e)),
                        (s.isTrailingSpaceSensitive = Vn(s, e)));
                for (let s = 0; s < n.length; s++) {
                    let i = n[s];
                    ((i.isLeadingSpaceSensitive =
                        (s === 0 || i.prev.isTrailingSpaceSensitive) && i.isLeadingSpaceSensitive),
    ...
    function oo(t, e, r) {
        ...
        switch (n.type) {
            ...
            case "docType":
                return [
                    E([De(n, e), " ", w(!1, n.value.replace(/^html\b/iu, "html"), /\s+/gu, " ")]),
                    Se(n, e),
                ];
            case "comment":
    ...
    var Pr = { name: "custom-elements" },
        Nr = { name: "no-errors-schema" };
    var Z;
    (function (t) {
        ((t[(t.NONE = 0)] = "NONE"),
            (t[(t.HTML = 1)] = "HTML"),
    ...
    function $r() {
        return (
            Vt ||
                ((Vt = {}),
                Ht(Z.HTML, ["iframe|srcdoc", "*|innerHTML", "*|outerHTML"]),
                Ht(Z.STYLE, ["*|style"]),
                Ht(Z.URL, [
                    "*|formAction",
                    "area|href",
    ...
    var co = "boolean",
        ...
        go = Array.from(Ys).reduce((t, [e, r]) => (t.set(e, r), t), new Map()),
        Wt = class extends Ut {
            constructor() {
                (super(),
            ...
            hasProperty(e, r, n) {
                if (n.some((i) => i.name === Nr.name)) return !0;
                if (e.indexOf("-") > -1) {
                    if (Ir(e) || Rr(e)) return !1;
                    if (n.some((i) => i.name === Pr.name)) return !0;
                }
                return (this._schema.get(e.toLowerCase()) || this._schema.get("unknown")).has(r);
            }
            hasElement(e, r) {
                return r.some((n) => n.name === Nr.name) ||
                    (e.indexOf("-") > -1 && (Ir(e) || Rr(e) || r.some((n) => n.name === Pr.name)))
                    ? !0
...
If '${e}' is a directive input, make sure the directive is imported by the current module.`,
            ...
            allKnownAttributesOfElement(e) {
                ...
                return Array.from(r.keys()).map((n) => go.get(n) ?? n);
            }
    ...
    function He(t) {
        return (
            pt ||
                ((js = new d({ canSelfClose: !0 })),
                (pt = Object.assign(Object.create(null), {
                    base: new d({ isVoid: !0 }),
                    meta: new d({ isVoid: !0 }),
                    area: new d({ isVoid: !0 }),
                    embed: new d({ isVoid: !0 }),
                    link: new d({ isVoid: !0 }),
                    img: new d({ isVoid: !0 }),
                    input: new d({ isVoid: !0 }),
                    param: new d({ isVoid: !0 }),
                    hr: new d({ isVoid: !0 }),
                    br: new d({ isVoid: !0 }),
                    source: new d({ isVoid: !0 }),
                    track: new d({ isVoid: !0 }),
                    wbr: new d({ isVoid: !0 }),
                    p: new d({
                        closedByChildren: [
                            "address",
                    ...
                    thead: new d({ closedByChildren: ["tbody", "tfoot"] }),
                    tbody: new d({ closedByChildren: ["tbody", "tfoot"], closedByParent: !0 }),
                    tfoot: new d({ closedByChildren: ["tbody"], closedByParent: !0 }),
                    tr: new d({ closedByChildren: ["tr"], closedByParent: !0 }),
                    td: new d({ closedByChildren: ["td", "th"], closedByParent: !0 }),
                    th: new d({ closedByChildren: ["td", "th"], closedByParent: !0 }),
                    col: new d({ isVoid: !0 }),
                    svg: new d({ implicitNamespacePrefix: "svg" }),
                    foreignObject: new d({
                        implicitNamespacePrefix: "svg",
                        preventNamespaceInheritance: !0,
                    }),
                    math: new d({ implicitNamespacePrefix: "math" }),
                    li: new d({ closedByChildren: ["li"], closedByParent: !0 }),
                    dt: new d({ closedByChildren: ["dt", "dd"] }),
                    dd: new d({ closedByChildren: ["dt", "dd"], closedByParent: !0 }),
                    rb: new d({ closedByChildren: ["rb", "rt", "rtc", "rp"], closedByParent: !0 }),
                    rt: new d({ closedByChildren: ["rb", "rt", "rtc", "rp"], closedByParent: !0 }),
                    rtc: new d({ closedByChildren: ["rb", "rtc", "rp"], closedByParent: !0 }),
                    rp: new d({ closedByChildren: ["rb", "rt", "rtc", "rp"], closedByParent: !0 }),
                    optgroup: new d({ closedByChildren: ["optgroup"], closedByParent: !0 }),
                    option: new d({ closedByChildren: ["option", "optgroup"], closedByParent: !0 }),
                    pre: new d({ ignoreFirstLf: !0 }),
                    listing: new d({ ignoreFirstLf: !0 }),
                    style: new d({ contentType: N.RAW_TEXT }),
                    script: new d({ contentType: N.RAW_TEXT }),
                    title: new d({
                        contentType: { default: N.ESCAPABLE_RAW_TEXT, svg: N.PARSABLE_DATA },
                    }),
                    textarea: new d({ contentType: N.ESCAPABLE_RAW_TEXT, ignoreFirstLf: !0 }),
                })),
                new Wt().allKnownElementNames().forEach((e) => {
                    !pt[e] && Me(e) === null && (pt[e] = new d({ canSelfClose: !1 }));
                })),
            pt[t] ?? js
        );
    }
        ...
        Gr = class {
            constructor(e, r, n) {
                ((this._getTagContentType = r),
                    ...
                    (this._interpolationConfig = n.interpolationConfig || Mr),
                ...
                ((this._cursor = n.escapedString ? new zr(e, s) : new sr(e, s)),
...
`
            ...
            _getBlockName() {
                ...
                return (
                    this._attemptCharCodeUntilFn((n) => (ut(n) ? !e : ni(n) ? ((e = !0), !1) : !0)),
            ...
            _consumeBlockParameters() {
                for (
                    this._attemptCharCodeUntilFn(si);
                    ...
                    for (
                        ;
                        (this._cursor.peek() !== 59 && this._cursor.peek() !== 0) || r !== null;
            ...
            _consumeLetDeclaration(e) {
                ...
                (this._attemptCharCodeUntilFn((s) => b(s) && !Ot(s)),
            ...
            _tokenizeExpansionForm() {
                ...
                if (Wo(this._cursor.peek()) && this._isInExpansionForm())
            ...
            _consumeEntity(e) {
                ...
                if ((this._cursor.advance(), this._attemptCharCode(35))) {
                    ...
                    try {
                        ...
                        throw this._createError(
                            ei(this._cursor.getChars(r)),
                            this._cursor.getSpan()
                        );
                    }
                } else {
                    let n = this._cursor.clone();
                    if ((this._attemptCharCodeUntilFn(Uo), this._cursor.peek() != 59))
            ...
            _consumePrefixAndName() {
                ...
                (this._cursor.peek() === 58
                    ...
                    : (n = e),
                    this._requireCharCodeUntilFn(ti, r === "" ? 0 : 1));
                let s = this._cursor.getChars(n);
                return [r, s];
            }
            _consumeTagOpen(e) {
                ...
                (this._handleFullNameStackForTagOpen(n, r),
                    a === N.RAW_TEXT
                        ...
                        : a === N.ESCAPABLE_RAW_TEXT && this._consumeRawTextWithTagClose(n, r, !0));
            }
            ...
            _isBlockStart() {
                if (this._tokenizeBlocks && this._cursor.peek() === 64) {
                    let e = this._cursor.clone();
                    if ((e.advance(), ni(e.peek()))) return !0;
                }
                return !1;
            }
            _readUntil(e) {
    ...
    function ti(t) {
        return (
            ut(t) || t === 62 || t === 60 || t === 47 || t === 39 || t === 34 || t === 61 || t === 0
        );
    }
    function Ho(t) {
    ...
    var sr = class t {
            ...
            advanceState(e) {
                ...
                (r === 10 ? (e.line++, (e.column = 0)) : Ot(r) || e.column++,
                    e.offset++,
                    this.updatePeek(e));
            }
            updatePeek(e) {
            ...
            decodeHexDigits(e, r) {
                ...
                if (isNaN(s))
                    throw (
                        ...
                        new St("Invalid hexadecimal escape sequence", e)
                    );
                return s;
            }
        },
    ...
    var L = class t extends Oe {
        ...
        ir = class {
            ...
            parse(e, r, n, s = !1, i) {
                let a =
                    ...
                    f = (n && n.canSelfClose) || !1,
                    C = (n && n.allowHtmComponentClosingTags) || !1,
                    A = new Xr(m.tokens, o, f, C, s);
        ...
        Xr = class t {
            ...
            _consumeCdata(e) {
                ...
                this._addToParent(
                    new zt(n, new h(e.sourceSpan.start, (s || r).sourceSpan.end), [r])
                );
            }
            _consumeComment(e) {
                let r = this._advanceIf(7),
                    ...
                    i =
                        n == null
                            ? e.sourceSpan
                            : new h(e.sourceSpan.start, n.sourceSpan.end, e.sourceSpan.fullStart);
            ...
            _consumeExpansion(e) {
                ...
                if (this._peek.type !== 24) {
                    this.errors.push(
                        L.create(null, this._peek.sourceSpan, "Invalid ICU message. Missing '}'.")
                    );
                    return;
                }
                let i = new h(
                ...
                (this._addToParent(new Yt(r.parts[0], n.parts[0], s, i, r.sourceSpan)),
                    this._advance());
            }
            _parseExpansionCase() {
                let e = this._advance();
                ...
                let a = new h(e.sourceSpan.start, s.sourceSpan.end, e.sourceSpan.fullStart),
...
`
            ...
            _consumeStartTag(e) {
                ...
                let o = this._peek.sourceSpan.fullStart,
                    ...
                    m = new Y(i, s, [], u, p, void 0, l),
                    f = this._getContainer();
                (this._pushContainer(
                    m,
                    f instanceof Y && this.getTagDefinition(f.name).isClosedByChild(m.name)
                ),
                    a
                        ? this._popContainer(i, Y, u)
                        : e.type === 4 &&
                          (this._popContainer(i, Y, null),
                          this.errors.push(L.create(i, u, `Opening tag "${i}" not terminated.`))));
            }
            _pushContainer(e, r) {
            ...
            _popContainer(e, r, n) {
                ...
                for (let i = this._containerStack.length - 1; i >= 0; i--) {
                    ...
                    (a instanceof ee ||
                        (a instanceof Y && !this.getTagDefinition(a.name).closedByParent)) &&
                        (s = !0);
                }
                return !1;
            }
            ...
            _consumeBlockOpen(e) {
                ...
                let n = this._peek.sourceSpan.fullStart,
                    ...
                    a = new ee(e.parts[0], r, [], s, e.sourceSpan, i);
                this._pushContainer(a, !1);
            }
            _consumeBlockClose(e) {
                this._popContainer(null, ee, e.sourceSpan) ||
                    this.errors.push(
                        L.create(
                            null,
                            e.sourceSpan,
            ...
            _consumeIncompleteBlock(e) {
                ...
                let n = this._peek.sourceSpan.fullStart,
                    ...
                    a = new ee(e.parts[0], r, [], s, e.sourceSpan, i);
                (this._pushContainer(a, !1),
                    this._popContainer(null, ee, null),
                    this.errors.push(
                        L.create(
                            e.parts[0],
                            s,
            ...
            _consumeLet(e) {
                ...
                let i = s.sourceSpan.fullStart,
                    ...
                    l = new mt(r, n.parts[0], a, p, n.sourceSpan);
                this._addToParent(l);
            }
            ...
            _getClosestParentElement() {
                for (let e = this._containerStack.length - 1; e > -1; e--)
                    if (this._containerStack[e] instanceof Y) return this._containerStack[e];
                return null;
            }
            _addToParent(e) {
...
...`,
    ...
    function Xo(t) {
        ...
        let { raw: r } = e;
        return { frontMatter: e, content: w(!1, r, /[^\n]/gu, " ") + t.slice(r.length) };
    }
    var hi = Xo;
    var or = { attrs: !0, children: !0, cases: !0, expression: !0 },
        mi = new Set(["parent"]),
        le,
        Zr,
        en,
        Ge = class Ge {
            constructor(e = {}) {
                ...
                cr(this, "type");
                cr(this, "parent");
                for (let r of new Set([...mi, ...Object.keys(e)])) this.setProperty(r, e[r]);
            }
            setProperty(e, r) {
                if (this[e] !== r) {
            ...
            map(e) {
                ...
                for (let n in or) {
                    ...
                    if (s) {
                        ...
                        r !== s &&
                            (r || (r = new Ge({ parent: this.parent })), r.setProperty(n, i));
                    }
                }
    ...
    ((le = new WeakSet()),
        (Zr = function () {
            return this.type === "angularIcuCase"
                ? "expression"
                : this.type === "angularIcuExpression"
                  ? "cases"
                  : "children";
        }),
        (en = function () {
    ...
    var Jo = [
        { regex: /^(\[if([^\]]*)\]>)(.*?)<!\s*\[endif\]$/su, parse: Zo },
        { regex: /^\[if([^\]]*)\]><!$/u, parse: eu },
        { regex: /^<!\s*\[endif\]$/u, parse: tu },
    ];
    function fi(t, e) {
        if (t.value)
    ...
    var lr = new Map([
        ...
        [
            "audio",
            new Set(["autoplay", "controls", "crossorigin", "loop", "muted", "preload", "src"]),
        ],
        ...
        if (t.type === "block") {
            ...
            t.parameters = {
                ...
                sourceSpan: new h(
                    ...
                    K(!1, t.parameters, -1).sourceSpan.end
                ),
            };
        }
    }
    ...
    function Ci(t, e, r) {
        ...
        if (n === "vue") {
            ...
            let g,
                ...
                q = (x) =>
                    y().rootNodes.find(
                        ({ startSourceSpan: U }) =>
                            U && U.start.offset === x.startSourceSpan.start.offset
                    ) ?? x;
            for (let [x, U] of l.entries()) {
                let { endSourceSpan: nn, startSourceSpan: _i } = U;
                if (nn === null) ((m = y().errors), (l[x] = q(U)));
                else if (iu(U, r)) {
                    let sn = y().errors.find(
                        (an) =>
                            an.span.start.offset > _i.start.offset &&
                            an.span.start.offset < nn.end.offset
                    );
                    (sn && gi(sn), (l[x] = q(U)));
                }
            }
        ...
        let f = (c) => {
                let g = c.name.startsWith(":") ? c.name.slice(1).split(":")[0] : null,
                    ...
                    q = g !== null && y.startsWith(`${g}:`),
                    x = q ? y.slice(g.length + 1) : y;
                    ...
                    for (let g of c.attrs)
                        g.namespace ||
                            (g.name = A(
                                g.name,
                                (y) =>
                                    lr.has(c.name) && (lr.get("*").has(y) || lr.get(c.name).has(y))
                            ));
            },
            I = (c) => {
                c.sourceSpan &&
            ...
            F = (c) => {
                if (c.type === "element") {
                    ...
                    !c.namespace || c.namespace === g.implicitNamespacePrefix || fe(c)
                        ? (c.tagDefinition = g)
                        : (c.tagDefinition = He(""));
                }
            };
    ...
    function Si(t, e, r = {}, n = !0) {
        let { frontMatter: s, content: i } = n ? hi(t) : { frontMatter: null, content: t },
            a = new ve(t, r.filepath),
            o = new ie(a, 0, 0, 0),
            u = o.moveBy(t.length),
            p = { type: "root", sourceSpan: new h(o, u), children: Ci(i, e, r) };
        if (s) {
            let f = new ie(a, 0, 0, 0),
                C = f.moveBy(s.raw.length);
        ...
        let l = new ur(p),
            m = (f, C) => {
                ...
                return (
                    c.length === A
                        ? F.children.shift()
                        : ((c.sourceSpan = new h(c.sourceSpan.start.moveBy(A), c.sourceSpan.end)),
    ...
    var tn = {
        ...
        au = Et(tn),
        ou = new Set(["mj-style", "mj-raw"]),
        uu = Et({ ...tn, name: "mjml", shouldParseAsRawText: (t) => ou.has(t) }),
        lu = Et({ name: "angular" }),
        cu = Et({
            name: "vue",
