...
var g = (t, e) => () => (e || t((e = { exports: {} }).exports, e), e.exports),
    rn = (t, e) => {
        for (var s in e) Wr(t, s, { get: e[s], enumerable: !0 });
    },
    Sl = (t, e, s, r) => {
        if ((e && typeof e == "object") || typeof e == "function")
            for (let n of _l(e))
                !kl.call(t, n) &&
                    n !== s &&
                    Wr(t, n, { get: () => e[n], enumerable: !(r = bl(e, n)) || r.enumerable });
        return t;
    };
var be = (t, e, s) => (
    (s = t != null ? xl(El(t)) : {}),
    Sl(e || !t || !t.__esModule ? Wr(s, "default", { value: t, enumerable: !0 }) : s, t)
);
var Oi = g((Pv, is) => {
    var _ = String,
        Ti = function () {
...
`,
    ...
    var ut = class {
        ...
        atrule(e, s) {
            ...
            if (
                (typeof e.raws.afterName < "u" ? (r += e.raws.afterName) : n && (r += " "), e.nodes)
            )
                this.block(e, r + n);
            else {
...
`
        ...
        rangeBy(e = {}) {
            ...
            if (e.word) {
                ...
                o !== -1 &&
                    ((r = this.positionInside(o)), (n = this.positionInside(o + e.word.length)));
            } else
                (e.start
                    ? (r = { column: e.start.column, line: e.start.line, offset: J(s, e.start) })
            ...
            return {
                        ...
                        : e[s]
                          ? s === "each" || (typeof s == "string" && s.startsWith("walk"))
                              ? (...r) =>
                                    e[s](
                                        ...r.map((n) =>
                                            typeof n == "function" ? (i, o) => n(i.toProxy(), o) : n
                                        )
                                    )
                              : s === "every" || s === "some"
                ...
                set(e, s, r) {
                    return (
                        e[s] === r ||
                            ((e[s] = r),
                            (s === "name" || s === "params" || s === "selector") && e.markDirty()),
                        !0
                    );
                },
            };
...
var De = g((Hv, eo) => {
    ...
    var { nanoid: Mc } = Hi(),
        ...
        { fileURLToPath: Qi, pathToFileURL: zt } = {},
        Xi = Gt(),
        Fc = ps(),
        hs = os(),
...
`),
    ...
    var Le = class {
        ...
        error(e, s, r, n = {}) {
            ...
            if (s && typeof s == "object") {
                ...
                if (typeof l.offset == "number") {
                    ...
                    ((o = l.line), (i = l.column), (u = this.fromLineAndColumn(l.line, l.column)));
            ...
            return (
                ...
                this.file &&
                    (zt && (c.input.url = zt(this.file).toString()), (c.input.file = this.file)),
                c
            );
        }
        ...
        origin(e, s, r, n) {
            ...
            ms(o.source)
                ? (a = zt(o.source))
                : (a = new URL(o.source, this.map.consumer().sourceRoot || zt(this.map.mapFile)));
            let c = {
                column: o.column,
        ...
        other(e) {
            ...
            if (
                ...
                if (!u)
                    for (
                        ;
                        a.length && ((c = a[a.length - 1][0]), !(c !== "space" && c !== "comment"));
        ...
        for (var u = 0; u < t.length; u++) {
            ...
            (n
                ...
                n &&
                    ...
                    i.type === "media-feature-expression" && (i.nodes = wa(i.value, i.sourceIndex)),
...
var M = g((B) => {
    ...
    var Ux = (B.TAG = "tag"),
        Fx = (B.STRING = "string"),
        $x = (B.SELECTOR = "selector"),
        Wx = (B.ROOT = "root"),
        Gx = (B.PSEUDO = "pseudo"),
        Yx = (B.NESTING = "nesting"),
        Vx = (B.ID = "id"),
        zx = (B.COMMENT = "comment"),
        Hx = (B.COMBINATOR = "combinator"),
        jx = (B.CLASS = "class"),
        Kx = (B.ATTRIBUTE = "attribute"),
        Qx = (B.UNIVERSAL = "universal");
});
var ur = g((ar, Ca) => {
    "use strict";
    ar.__esModule = !0;
...
`)),
                        ...
                        if (
                            ...
                            (C === 101 || C === 69) &&
                                ...
                                ((Ge.lastIndex = l + 2),
                                Ge.test(n),
                                Ge.lastIndex === 0 ? (l = n.length - 1) : (l = Ge.lastIndex - 2));
                        }
...
var en = {};
rn(en, { languages: () => Ei, options: () => Si, parsers: () => Zs, printers: () => Fy });
var Tl = (t, e, s, r) => {
        if (!(t && e == null))
            return e.replaceAll
                ? e.replaceAll(s, r)
...
var _e = "string",
    ...
    Ke = "label",
    Se = "break-parent",
    Tt = new Set([Ve, re, Ee, ze, se, ne, ie, He, ke, je, H, Ke, Se]);
var Ol = (t, e, s) => {
        if (!(t && e == null))
...
function qt(t) {
    return It(t) || tt(t) || X(t) || de(t) || ic(t);
}
function ni(t) {
...
function oc(t, e, s) {
    ...
    for (let y = 0; y < r.groups.length; ++y) {
        ...
        if (
            ...
            if ((v == null ? void 0 : v.value) !== "..." && !(it(w) && it(v) && P(w) === N(v))) {
...
function ye(t) {
    return E(!1, t, fc, (e, s, r, n, i) =>
        !r && n && (i ?? (i = ""), (i = i.toLowerCase()), !i || i === "n" || Ut.has(i))
            ? ss(n) + (i ? rs(i) : "")
            : e
    );
}
...
var Ft = pc;
function hc(t, e, s = {}) {
    let r = Pt(t, s.backwards ? e - 1 : e, s),
        n = Ft(t, r, s);
    return r !== n;
}
var $t = hc;
...
var vi = dc;
function mc(t, e) {
    return e === !1 ? !1 : t.charAt(e) === "/" && t.charAt(e + 1) === "/" ? Rt(t, e) : e;
}
var xi = mc;
function yc(t, e) {
    let s = null,
        r = e;
    for (; r !== s; ) ((s = r), (r = En(t, r)), (r = vi(t, r)), (r = Pt(t, r)));
    return ((r = xi(t, r)), (r = Ft(t, r)), r !== !1 && $t(t, r));
}
var Wt = yc;
    ...
    let o = t.map(({ node: d, isLast: x, index: h }) => {
            ...
            if (!x && d.type === "value-comma_group" && ue(d.groups)) {
                ...
                (!w.source && w.close && (w = w.close),
                    w.source && Wt(e.originalText, P(w)) && y.push(S));
            }
            return y;
        }, "groups"),
        u = ci(r, n),
    ...
    return (
        t.each(() => {
            ...
            if (
                ...
                return;
            let { next: o } = t;
            (o.type === "css-comment" && !$t(e.originalText, N(o), { backwards: !0 }) && !Oe(n)) ||
            (o.type === "css-atrule" && o.name === "else" && n.type !== "css-comment")
                ? r.push(" ")
                : (r.push(e.__isHTMLStyleAttribute ? A : S),
                  Wt(e.originalText, P(n)) && !Oe(n) && r.push(S));
        }, "nodes"),
        r
    );
}
...
function _c(t, e, s) {
    ...
    switch (r.type) {
        ...
        case "css-atrule": {
            let f = t.parent,
                p = Lt(r) && !f.raws.semicolon && e.originalText[P(r) - 1] !== ";";
            if (e.parser === "less") {
                ...
                if (r.variable)
                    return [
                        ...
                        r.nodes ? ["{", q([r.nodes.length > 0 ? D : "", Ie(t, e, s)]), D, "}"] : "",
                        p ? "" : ";",
                    ];
            }
            let l =
            ...
            return [
                "@",
                Zr(r) || r.name.endsWith(":") || Lt(r) ? r.name : Ae(r.name),
                r.params
                    ? [
                          Zr(r)
                              ? ""
        ...
        case "selector-root":
            return L([
                he(t, "custom-selector")
                    ...
                    : "",
                G([",", he(t, ["extend", "custom-selector", "nest"]) ? A : S], t.map(s, "nodes")),
            ]);
    ...
    for (let c = 0; c < s.length; ++c) {
        ...
        if (
            ...
            f.type === "func" &&
                f.value === "selector" &&
                (f.group.groups = [
                    te(Fr(t).text.slice(f.group.open.sourceIndex + 1, f.group.close.sourceIndex)),
                ]),
...
function cl(t, e) {
    if (t && typeof t == "object")
        for (let s in t)
            s !== "parent" &&
                (cl(t[s], e), s === "nodes" && ((t.group = $r(Ny(t, e))), delete t[s]));
    return t;
}
function Py(t, e) {
