...
var Or = (e, t, r) => t.has(e) || _r("Cannot " + r);
var I = (e, t, r) => (Or(e, t, "read from private field"), r ? r.call(e) : t.get(e)),
    Lt = (e, t, r) =>
        t.has(e)
            ? _r("Cannot add the same private member more than once")
            : t instanceof WeakSet
              ? t.add(e)
              : t.set(e, r),
    Y = (e, t, r, s) => (Or(e, t, "write to private field"), s ? s.call(e, r) : t.set(e, r), r);
var xr = {};
...
var qt = Ks;
var Ws = (e) => new Intl.ListFormat("en-US", { type: "disjunction" }).format(e);
function js(e) {
...
var qr = { type: Rt };
var Xs = { type: j, hard: !0 },
    Zs = { type: j, hard: !0, literal: !0 },
    L = { type: j },
    F = { type: j, soft: !0 },
    tt = [Xs, qr],
    Ir = [Zs, qr];
...
Ur.ignoredProperties = new Set(["loc", "selfClosing"]);
var Mr = Ur;
function nn(e) {
    let { node: t } = e;
...
var an = 10;
for (let e = 0; e <= an; e++) ee();
function Qe(e) {
    return ee(e);
}
function on(e, t = "type") {
    Qe(e);
    function r(s) {
        let n = s[t],
            i = e[n];
...
function cn(e) {
    return (
        ...
        typeof e.tag == "string" &&
        !e.tag.startsWith(":") &&
        (Qr(e.tag[0]) || e.tag.includes("."))
    );
}
function un(e) {
    return Wr.has(e.toLowerCase()) && !Qr(e[0]);
}
function Je(e) {
    return e.selfClosing === !0 || un(e.tag) || (cn(e) && e.children.every((t) => ge(t)));
}
function ge(e) {
    ...
    switch (s.type) {
        ...
        case "ElementNode": {
            ...
            return s.children.length === 0
                ? [y, B(C), v]
                : t.htmlWhitespaceSensitivity === "ignore"
                  ? [y, B($r(e, t, r)), tt, B(C), v]
                  : [y, B(R($r(e, t, r))), B(C), v];
        }
        case "BlockStatement":
            return kn(e)
                ? [Sn(e, r), ts(e, t, r), es(e, t, r)]
                : [bn(e, r), R([ts(e, t, r), es(e, t, r), En(e, t, r)])];
        case "ElementModifierStatement":
            return R(["{{", ss(e, r), "}}"]);
        case "MustacheStatement":
            return R([be(s), ss(e, r), ye(s)]);
        case "SubExpression":
            return R(["(", Pn(e, r), F, ")"]);
        case "AttrNode": {
            let { name: y, value: v } = s,
                C = v.type === "TextNode";
            if (C && v.chars === "" && St(v) === re(v)) return y;
            let w = C
                    ? de(v.chars, t.singleQuote)
                    : v.type === "ConcatStatement"
                      ? de(
                            v.parts.map((q) => (q.type === "TextNode" ? q.chars : "")).join(""),
                            t.singleQuote
                        )
                      : "",
                U = r("value");
        ...
        case "TextNode": {
            ...
            if (t.htmlWhitespaceSensitivity !== "ignore") {
                ...
                let H = K.getTrailingWhitespace(y),
                    st = [];
                if (H) {
                    if (!X) {
                        st = [L];
...
function bn(e, t) {
    ...
    return (
        n && s.push(R(n)),
        Zt(r.program.blockParams) && s.push(Xe(r.program)),
        R([dn(r), $e(e, t), s.length > 0 ? B([L, yt(L, s)]) : "", F, gn(r)])
    );
}
function yn(e, t) {
    return [t.htmlWhitespaceSensitivity === "ignore" ? tt : "", is(e), "else", as(e)];
}
var os = (e, t) =>
...
function kn(e) {
    ...
    return (
        ...
        t.inverse.body[0] === r &&
        os(t.inverse.body[0].path, t.path)
    );
}
function Sn(e, t) {
    ...
    return R([
        ...
        B([L, R(ke(e, t)), ...(Zt(r.program.blockParams) ? [L, Xe(r.program)] : [])]),
        F,
        as(s),
    ]);
}
...
function vn(e) {
    return (
        ...
        os(e.inverse.body[0].path, e.path)
    );
}
function cs(e) {
...
function es(e, t, r) {
    let { node: s } = e,
        n = r("inverse"),
        i = t.htmlWhitespaceSensitivity === "ignore" ? [tt, n] : n;
...
function Cn(e, t) {
    let {
        ...
        s = de(r, xn(e) ? !t.singleQuote : t.singleQuote);
...
var An = new Set("!\"#%&'()*+,./;<=>@[\\]^`{|}~"),
    Ln = new Set(["true", "false", "null", "undefined"]),
    Dn = (e, t) =>
        t === 0 && e.startsWith("@")
            ? !1
            : (t !== 0 && Ln.has(e)) ||
              /\s/u.test(e) ||
              /^\d/u.test(e) ||
              Array.prototype.some.call(e, (r) => An.has(r));
function _n(e) {
    return e.tail.length === 0 && e.original.includes("/")
        ? e.original
        : [e.head.original, ...e.tail].map((r, s) => (Dn(r, s) ? `[${r}]` : r)).join(".");
}
...
function ms(e, t = "unexpected unreachable branch") {
    throw (
        ps.log("unreachable", e),
        ps.log(`${t} :: ${JSON.stringify(e)} (${e})`),
        ...
        var e = function (it, d, k, g) {
            ...
            De = {
                ...
                table: [
                    ...
                    { 33: [2, 87] },
                    { 33: [1, 115] },
                    { 32: 116, 33: [2, 60], 73: 117, 74: Le },
                    e(V, [2, 57]),
                    e(A, [2, 59]),
                    { 33: [2, 66], 37: 119, 73: 120, 74: Le },
                    e(V, [2, 63]),
                    e(A, [2, 65]),
                    { 23: [1, 121] },
                    e(xt, [2, 49]),
                ...
                parse: function (d) {
                    var k = this,
                        ...
                        Hs = 2,
                        Lr = 1,
                        Fs = l.slice.call(arguments, 1),
                        P = Object.create(this.lexer),
                        dt = { yy: {} };
                    for (var Oe in this.yy)
                        Object.prototype.hasOwnProperty.call(this.yy, Oe) &&
                            (dt.yy[Oe] = this.yy[Oe]);
                    (P.setInput(d, dt.yy),
                        (dt.yy.lexer = P),
                        (dt.yy.parser = this),
                        ...
                        switch (M[0]) {
                            ...
                            case 2:
                                if (
                                    ...
                                    (Re = this.performAction.apply(
                                        At,
                                        [u, Yt, at, dt.yy, M[1], N, l].concat(Fs)
                                    )),
                                    typeof Re < "u")
                                )
                                    return Re;
                                (Z &&
                                    ...
                                    N.push(At.$),
                                    l.push(At._$),
                                    (Dr = Pt[g[g.length - 2]][g[g.length - 1]]),
                                    g.push(Dr));
                                break;
                            case 3:
                                return !0;
                    ...
                    performAction: function (k, g, b, N) {
                        ...
                        switch (b) {
                            ...
                            case 4:
                                return (
                                    this.popState(),
                                    this.conditionStack[this.conditionStack.length - 1] === "raw"
                                        ? 15
                                        : (l(5, 9), 18)
                                );
                            case 5:
...
function er(e, t) {
    ...
    r &&
        ...
        (a = r.end.column),
        (e += " - " + s + ":" + i));
    for (var o = Error.prototype.constructor.call(this, e), c = 0; c < tr.length; c++)
        this[tr[c]] = o[tr[c]];
...
Ee.prototype = {
    ...
    MustacheStatement: ve,
    Decorator: ve,
    BlockStatement: ds,
    DecoratorBlock: ds,
    PartialStatement: gs,
    PartialBlockStatement: function (e) {
        (gs.call(this, e), this.acceptKey(e, "program"));
    },
...
function ds(e) {
    (ve.call(this, e), this.acceptKey(e, "program"), this.acceptKey(e, "inverse"));
}
function gs(e) {
    ...
    for (var s = e.body, n = 0, i = s.length; n < i; n++) {
        ...
        if (o) {
            ...
            (o.close && Et(s, n, !0),
                ...
                t && p && (Et((a.program || a.inverse).body), lt(s, n)),
                t && m && (Et(s, n), lt((a.inverse || a.program).body)));
        }
    }
    return e;
};
    ...
    Q.prototype.PartialBlockStatement =
        function (e) {
            ...
            var i = {
                ...
                openStandalone: sr(t.body),
                closeStandalone: rr((s || t).body),
            };
            if ((e.openStrip.close && Et(t.body, null, !0), r)) {
                var a = e.inverseStrip;
                (a.open && lt(t.body, null, !0),
                    a.close && Et(s.body, null, !0),
    ...
    so = (function () {
        function e(t, r) {
            (r === void 0 && (r = {}),
                ...
                (this.startColumn = 0),
                (this.tokens = []),
                (this.tokenizer = new lr(this, t, r.mode)),
...
var Xn = !1,
    Zn = /["\x26\xa0]/u,
    go = new RegExp(Zn.source, "gu"),
    ti = /[&<>\xa0]/u,
    bo = new RegExp(ti.source, "gu");
var mr = new Set([
    "area",
    "base",
    "br",
...
function ei(e) {
    var t;
    return mr.has(e.toLowerCase()) && ((t = e[0]) == null ? void 0 : t.toLowerCase()) === e[0];
}
function ce(e) {
    return !!e && e.length > 0;
}
...
var pt = Object.freeze({ line: 1, column: 0 }),
    si = Object.freeze({ source: "(synthetic)", start: pt, end: pt }),
    dr = Object.freeze({ source: "(nonexistent)", start: pt, end: pt }),
...
var br = class {
    ...
    D = class e {
        ...
        constructor(t) {
            var r;
            ((this.data = t),
                (this.isInvisible = (r = t.kind) !== "CharPosition" && r !== "HbsPosition"));
        }
        getStart() {
        ...
        toHbsSpan() {
            ...
            if (t === null) {
                ...
                t = Y(
                    this,
                    Ut,
                    r === null || s === null ? ft : new oe(this.source, { start: r, end: s })
                );
            }
            return t === ft ? null : t;
        }
...
var ut,
    ...
    oe = class {
        ...
        updateProvided(t, r) {
            (I(this, vt) && (I(this, vt)[r] = t),
                Y(this, ut, null),
                Y(this, vt, { start: t, end: t }));
        }
...
function ws(e, t, r) {
    return new Nr("Cannot remove a node unless it is part of an array", e, t, r);
}
function ai(e, t, r) {
    return new Nr(
...
function Ts(e, t) {
    return new Nr("Replacing and removing in key handlers is not yet supported.", e, null, t);
}
var zt = class {
...
function Ae(e, t) {
    ...
    if ((c !== void 0 && ((r = Ds(c)), (s = _s(c))), r !== void 0 && (n = r(i, t)), n != null)) {
        if (JSON.stringify(i) !== JSON.stringify(n))
            return Array.isArray(n) ? (Os(e, n, a, o), n) : Ae(e, new zt(n, a, o)) || n;
        n = void 0;
    }
    if (n === void 0) {
        let h = ii[i.type];
        for (let p = 0; p < h.length; p++) oi(e, c, t, h[p]);
        s !== void 0 && (n = s(i, t));
    }
    return n;
}
...
function xs(e = [], t = [], r = !1, s) {
    return f.blockItself({ body: e, params: Is(t), chained: r, loc: T(s || null) });
}
function Ps(e = [], t = [], r) {
...
var ui = {
    ...
    block: function (e, t, r, s, n = null, i, a, o, c) {
        ...
        return (
            (h =
                s.type === "Template"
                    ? f.blockItself({ params: Is(s.blockParams), body: s.body, loc: s.loc })
                    : s),
    ...
    element: function (e, t = {}) {
        ...
        let S = i == null ? void 0 : i.map((v) => (typeof v == "string" ? Cs(v) : v)),
            y = null;
        return (
            p ? (y = T(p)) : p === void 0 && (y = s || ei(r.original) ? null : T(null)),
            f.element({
                path: r,
                selfClosing: s || !1,
                attributes: n || [],
    ...
    program: function (e, t, r) {
        return t && t.length ? xs(e, t, !1, r) : Ps(e, [], r);
    },
    blockItself: xs,
    template: Ps,
    loc: T,
    ...
    string: hr("StringLiteral"),
    boolean: hr("BooleanLiteral"),
    number: hr("NumberLiteral"),
    ...
    Sr = class {
        constructor(t, r = new or(Es), s = "precompile") {
            ((this.elementStack = []),
                ...
                (this.tokenizer = new lr(this, r, s)));
        }
        offset() {
    ...
    Er = class extends Sr {
        ...
        parseProgram(t, r) {
            ...
            if (t !== s) {
                if ((s == null ? void 0 : s.type) === "ElementNode")
                    throw E(`Unclosed element \`${s.tag}\``, s.loc);
                t.type;
            }
            return t;
        }
            ...
            if ((m = t.program.blockParams) != null && m.length) {
                ...
                ((S = t.program.loc
                    ...
                    : t.program.body[0]
                      ...
                      : S.withEnd(i.getEnd())),
                    (a = As(this.source, t, S)));
                let y = S.asString(),
                    v = y.indexOf("|") + 1,
                    C = y.indexOf("|", v);
                for (let x of t.program.blockParams) {
                    let w, U;
                    ((w = v >= C ? -1 : y.indexOf(x, v)),
                        w === -1 || w + x.length > C
                            ? ((v = C), (U = this.source.spanFor(dr)))
                            : ((v = w),
                              (U = S.sliceStartChars({ skipStart: v, chars: x.length })),
                              (v += x.length)),
        ...
        MustacheStatement(t) {
            ...
            if ("original" in t.path && t.path.original === "...attributes")
                throw E("Illegal use of ...attributes", this.source.spanFor(t.loc));
            if (Bs(t.path))
                s = f.mustache({
...
function fr(e, t) {
    ...
    if (Bs(r)) {
        ...
        throw E(`In <${e.name} ... ${o} ..., ${o} is not a valid modifier`, t.loc);
    }
...
var vr = class extends Er {
        ...
        finishTag() {
            ...
            if (t.type === "StartTag") {
                ...
                (mr.has(t.name) || t.selfClosing) && this.finishEndTag(!0);
...
`
        ...
        parsePossibleBlockParams() {
            ...
            let r = this.currentStartTag,
                ...
                i = {
                    ...
                    Error: (o) => {
                        if ((n.state, o === "" || o === "/" || o === ">" || Ht(o)))
                            throw E(n.message, n.start.until(this.offset()));
                        this.tokenizer.consume();
                    },
                    Done: () => {},
                },
        ...
        validateEndTag(t, r, s) {
            if (mr.has(t.name) && !s)
                throw E(`<${t.name}> elements do not need end tags. You should remove it`, t.loc);
            if (r.type !== "ElementNode")
                throw E(`Closing tag </${t.name}> without an open tag`, t.loc);
            if (r.tag !== t.name)
                throw E(
...
function Rs(e, t = {}) {
    ...
    (typeof e == "string"
        ? ((r = new wt(e, (c = t.meta) == null ? void 0 : c.moduleName)),
          (s = i === "codemod" ? Te(e, t.parseOptions) : ar(e, t.parseOptions)))
        : e instanceof wt
          ? ((r = e),
            (s = i === "codemod" ? Te(e.source, t.parseOptions) : ar(e.source, t.parseOptions)))
    ...
    if ((p = t.plugins) != null && p.ast)
        for (let m of t.plugins.ast)
            ci(o, m(Ze({}, t, { syntax: hi }, { plugins: void 0 })).visitor);
    return o;
}
var pi = { resolution: () => Ne.GetStrictKeyword, serialize: () => "Strict", isAngleBracket: !1 },
    yo = { ...pi, isAngleBracket: !0 };
function fi(e, t) {
