...
`,
        ...
        case "ObjectValue": {
            ...
            return y(["{", r, N([p, E([I("", ", "), p], e.map(n, "fields"))]), p, I("", r), "}"]);
        }
        case "ObjectField":
        case "Argument":
        ...
        case "InterfaceTypeDefinition": {
            ...
            return (
                ...
                !r.startsWith("InputObjectType") &&
                    ...
                    s.push(" implements ", ...Ft(e, t, n)),
                s.push(x(e, n, i)),
                i.fields.length > 0 && s.push([" {", N([f, E(f, g(e, t, n, "fields"))]), f, "}"]),
                s
            );
        }
...
function Xt(e, t, n) {
    ...
    if (
        (s === 46 && ((a = !0), (s = i.charCodeAt(++r)), (r = Ee(e, r, s)), (s = i.charCodeAt(r))),
        (s === 69 || s === 101) &&
            ((a = !0),
            (s = i.charCodeAt(++r)),
