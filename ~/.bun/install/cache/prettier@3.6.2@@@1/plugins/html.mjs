...
var Ai = (t, e, r) =>
    e in t ? on(t, e, { enumerable: !0, configurable: !0, writable: !0, value: r }) : (t[e] = r);
var ln = (t, e) => {
    for (var r in e) on(t, r, { get: e[r], enumerable: !0 });
};
var lr = (t, e, r) => Ai(t, typeof e != "symbol" ? e + "" : e, r),
    cn = (t, e, r) => e.has(t) || un("Cannot " + r);
var R = (t, e, r) => (cn(t, e, "read from private field"), r ? r.call(t) : e.get(t)),
    At = (t, e, r) =>
        e.has(t)
            ? un("Cannot add the same private member more than once")
            : e instanceof WeakSet
              ? e.add(t)
              : e.set(t, r),
    pn = (t, e, r, n) => (cn(t, e, "write to private field"), n ? n.call(t, r) : e.set(t, r), r);
var rn = {};
...
var ne = { type: Le };
var xi = { type: j, hard: !0 },
    ki = { type: j, hard: !0, literal: !0 },
    _ = { type: j },
    v = { type: j, soft: !0 },
    S = [xi, ne],
    hn = [ki, ne];
...
var Tn,
    ...
    Ln,
    qi =
        ((Tn = globalThis.Deno) == null ? void 0 : Tn.build.os) === "windows" ||
        ((kn = (xn = globalThis.navigator) == null ? void 0 : xn.platform) == null
            ? void 0
            : kn.startsWith("Win")) ||
        ((Ln = (Bn = globalThis.process) == null ? void 0 : Bn.platform) == null
            ? void 0
            : Ln.startsWith("win")) ||
        !1;
function Fn(t) {
...
function In(t, e) {
    ...
    return (
        t.find(({ filenames: n }) => (n == null ? void 0 : n.some((s) => s.toLowerCase() === r))) ??
...
function Gi(t, e) {
    let r = bn(!1, t.plugins).flatMap((s) => s.languages ?? []),
        n =
            Wi(r, e.language) ??
            In(r, e.physicalFile) ??
            In(r, e.file) ??
...
function zi(t) {
    return (
        t.type === "element" && !t.hasExplicitNamespace && !["html", "svg"].includes(t.namespace)
    );
}
var fe = zi;
var Yi = (t) => w(!1, t, /^[\t\f\r ]*\n/gu, ""),
...
function wt(t, e) {
    return !!(
        ...
        (xt(t, e) && !W(t, e) && t.type !== "interpolation")
    );
}
function ge(t) {
                  ...
                  : !(
                        (!t.prev &&
                            (t.parent.type === "root" ||
                                ...
                                W(t.parent, e) ||
                                et(t.parent, e) ||
                                !ea(t.parent.cssDisplay))) ||
                        (t.prev && !na(t.prev.cssDisplay))
                    );
    }
}
function Un(t, e) {
              ...
              : !(
                    (!t.next &&
                        (t.parent.type === "root" ||
                            ...
                            W(t.parent, e) ||
                            et(t.parent, e) ||
                            !ta(t.parent.cssDisplay))) ||
                    (t.next && !ra(t.next.cssDisplay))
                );
}
function Wn(t, e) {
...
function Gn(t) {
    return (
        ...
        (t.type === "element" &&
            t.children.length > 0 &&
            (["body", "script", "style"].includes(t.name) || t.children.some((e) => Xi(e)))) ||
        (t.firstChild &&
            t.firstChild === t.lastChild &&
            t.firstChild.type !== "text" &&
            Yn(t.firstChild) &&
            (!t.lastChild.isTrailingSpaceSensitive || jn(t.lastChild)))
    );
}
function Dr(t) {
    return (
...
function jn(t) {
    return (
        ...
        (t.next
            ...
            : t.parent.type === "root" ||
              (t.parent.endSourceSpan && t.parent.endSourceSpan.start.line > t.sourceSpan.end.line))
    );
}
function Kn(t) {
    switch (t.type) {
...
function Qn(t, e) {
    ...
    if (t.type === "element" && t.namespace === "svg")
        if (ia(t, (s) => s.fullName === "svg:foreignObject")) r = !0;
    ...
    switch (e.htmlWhitespaceSensitivity) {
        ...
        default:
            if (
                t.type === "element" &&
                (!t.namespace || r || fe(t)) &&
                Object.prototype.hasOwnProperty.call(Sr, t.name)
            )
                return Sr[t.name];
    }
    return $n;
...
function Aa(t) {
    let e = as(t),
        r = Ea.filter((l) => e.some((m) => Object.prototype.hasOwnProperty.call(m, l)));
...
function Da(t, e) {
    ...
    return (
        xr.has(r) ||
            xr.set(
                r,
                r.children.some((n) => Bt(n, e) && ["ts", "typescript"].includes(n.attrMap.lang))
            ),
        xr.get(r)
    );
}
...
function ps(t, e, { parseWithTs: r }) {
    return T(`function _(${t}) {}`, e, { parser: r ? "babel-ts" : "babel", __isVueBindings: !0 });
}
async function hs(t, e, r, n) {
    let s = P(r.node),
        { left: i, operator: a, right: o } = va(s),
        u = Ie(r, n);
    return [
        E(
...
function xa(t) {
    return async (e, r, n, s) => {
        ...
        if (i)
            return (
                (i = hr(i, (a) => (typeof a == "string" ? w(!1, a, '"', "&quot;") : a))),
                [n.node.rawName, '="', E(i), '"']
            );
    };
}
...
function Pa(t, e, r) {
    ...
    let s = ((m = n.prev) == null ? void 0 : m.type) === "comment" && Fa(n.prev.value),
        i =
            typeof s == "boolean"
                ? () => s
                : Array.isArray(s)
                  ...
                  : () => !1,
        a = t.map(({ node: f }) => (i(f) ? B(e.originalText.slice(J(f), se(f))) : r()), "attrs"),
        o =
            n.type === "element" &&
            n.fullName === "script" &&
            n.attrs.length === 1 &&
    ...
    return (
        (n.firstChild && nt(n.firstChild)) || (n.isSelfClosing && Ee(n.parent)) || o
            ...
            : l.push(e.bracketSameLine ? (n.isSelfClosing ? " " : "") : n.isSelfClosing ? _ : v),
        l
    );
}
function Na(t) {
            ...
            if (!r.isSelfClosing && xt(r, e)) {
                ...
                return n
                    ? async (s, i) => {
                          ...
                          return (
                              o ||
                                  ((u = await s(Er(a), { parser: n, __embeddedInHtml: !0 })),
                                  (o = u === "")),
                              [
                                  z(r, e),
                                  E(st(t, e, i)),
                ...
                return async (n) => {
                    ...
                    return (
                        e.parser === "angular"
                            ...
                            : e.parser === "vue"
                              ? (s.parser = Ie(t, e) ? "__vue_ts_expression" : "__vue_expression")
                              : (s.parser = "__js_expression"),
                        [k([_, await n(r.value, s)]), r.parent.next && Q(r.parent.next) ? " " : _]
                    );
                };
            break;
        case "attribute":
...
function ks(t) {
    ...
    return t.type === "element" && !t.endSourceSpan && me(t.children)
        ? Math.max(e, ks(K(!1, t.children, -1)))
        : e;
}
function ot(t, e, r) {
    let n = t.node;
            ...
            B(
                O.trimEnd(
                    e.originalText.slice(
                        J(n) + (n.prev && rt(n.prev) ? Ft(n).length : 0),
...
function Re(t, e, r) {
    ...
    return t.map((i, a) => {
        ...
        let u = [],
            ...
            l = [],
            m = [],
            f = o.prev ? It(o.prev, o) : "",
            C = o.next ? It(o, o.next) : "";
        return (
            f &&
                (Je(o.prev)
                    ? u.push(S, S)
...
function Is(t, e, r) {
    let { node: n } = t;
    if (wt(n, e)) return [z(n, e), E(st(t, e, r)), B(Nt(n, e)), ...tt(n, e), G(n, e)];
    let s =
            n.children.length === 1 &&
    ...
    t.walk((r) => {
        ...
        if (!s)
            for (let a = 0; a < n.length; a++) {
                ...
                let { leadingWhitespace: u, text: p, trailingWhitespace: l } = Mn(o.value),
                    m = o.prev,
                    f = o.next;
                p
                    ? ((o.value = p),
...
function Rr() {
    return (
        Ht ||
            ((Ht = {}),
            qt(Z.HTML, ["iframe|srcdoc", "*|innerHTML", "*|outerHTML"]),
            qt(Z.STYLE, ["*|style"]),
            qt(Z.URL, [
                "*|formAction",
                "area|href",
...
var ao = "boolean",
    ...
    po = Array.from(js).reduce((t, [e, r]) => (t.set(e, r), t), new Map()),
    Ut = class extends Vt {
        constructor() {
            (super(),
        ...
        hasElement(e, r) {
            return r.some((n) => n.name === Pr.name) ||
                (e.indexOf("-") > -1 && (Nr(e) || Ir(e) || r.some((n) => n.name === Fr.name)))
                ? !0
    ...
    Wr = class {
        constructor(e, r, n) {
            ((this._getTagContentType = r),
                ...
                (this._interpolationConfig = n.interpolationConfig || Or),
            ...
            ((this._cursor = n.escapedString ? new Gr(e, s) : new nr(e, s)),
...
`
        ...
        _getBlockName() {
            ...
            return (
                this._attemptCharCodeUntilFn((n) => (ut(n) ? !e : si(n) ? ((e = !0), !1) : !0)),
        ...
        _consumeLetDeclaration(e) {
            ...
            (this._attemptCharCodeUntilFn((s) => b(s) && !$t(s)),
        ...
        handleError(e) {
            if (
                (e instanceof St && (e = this._createError(e.msg, this._cursor.getSpan(e.cursor))),
                e instanceof Ct)
            )
        ...
        _consumePrefixAndName() {
            ...
            (this._cursor.peek() === 58
                ...
                : (n = e),
                this._requireCharCodeUntilFn(ri, r === "" ? 0 : 1));
            let s = this._cursor.getChars(n);
            return [r, s];
        }
        _consumeTagOpen(e) {
...
var nr = class t {
        ...
        advanceState(e) {
            ...
            (r === 10 ? (e.line++, (e.column = 0)) : $t(r) || e.column++,
                e.offset++,
                this.updatePeek(e));
        }
        updatePeek(e) {
    ...
    Kr = class t {
        ...
        build() {
            ...
            for (let e of this._containerStack)
                e instanceof ee &&
                    this.errors.push(L.create(e.name, e.sourceSpan, `Unclosed block "${e.name}"`));
        }
        _advance() {
            let e = this._peek;
            return (
...
`
        ...
        _consumeEndTag(e) {
            ...
            if (r && this.getTagDefinition(r).isVoid)
                this.errors.push(
                    L.create(r, e.sourceSpan, `Void elements do not have end tags "${e.parts[1]}"`)
                );
...
var mi = zo;
var ar = { attrs: !0, children: !0, cases: !0, expression: !0 },
    fi = new Set(["parent"]),
    le,
    Jr,
    Zr,
    Ge = class Ge {
        constructor(e = {}) {
            ...
            lr(this, "type");
            lr(this, "parent");
            for (let r of new Set([...fi, ...Object.keys(e)])) this.setProperty(r, e[r]);
        }
        setProperty(e, r) {
            if (this[e] !== r) {
        ...
        map(e) {
            ...
            for (let n in ar) {
                ...
                if (s) {
                    ...
                    r !== s && (r || (r = new Ge({ parent: this.parent })), r.setProperty(n, i));
                }
            }
...
var jo = [
    { regex: /^(\[if([^\]]*)\]>)(.*?)<!\s*\[endif\]$/su, parse: Ko },
    { regex: /^\[if([^\]]*)\]><!$/u, parse: Xo },
    { regex: /^<!\s*\[endif\]$/u, parse: Qo },
];
function di(t, e) {
    if (t.value)
        ...
        for (let [x, U] of l.entries()) {
            ...
            if (nn === null) ((m = y().errors), (l[x] = q(U)));
                ...
                let sn = y().errors.find(
                    (an) =>
                        an.span.start.offset > Ei.start.offset &&
            ...
            if (
                ...
                for (let g of c.attrs)
                    g.namespace ||
                        (g.name = A(
                            g.name,
                            (y) => ur.has(c.name) && (ur.get("*").has(y) || ur.get(c.name).has(y))
                        ));
        },
        I = (c) => {
            c.sourceSpan &&
...
function _i(t, e, r = {}, n = !0) {
    let { frontMatter: s, content: i } = n ? mi(t) : { frontMatter: null, content: t },
        a = new ve(t, r.filepath),
        o = new ie(a, 0, 0, 0),
        u = o.moveBy(t.length),
        p = { type: "root", sourceSpan: new h(o, u), children: Si(i, e, r) };
    if (s) {
...
var en = {
    ...
    su = Et({ ...en, name: "mjml", shouldParseAsRawText: (t) => nu.has(t) }),
    iu = Et({ name: "angular" }),
    au = Et({
        name: "vue",
