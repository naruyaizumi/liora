(function (n) {
    ...
    var at = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports),
        Vi = (e, t) => {
            for (var i in t) fe(e, i, { get: t[i], enumerable: !0 });
        },
        nt = (e, t, i, s) => {
            if ((t && typeof t == "object") || typeof t == "function")
                for (let r of Ii(t))
                    !Li.call(e, r) &&
                        r !== i &&
                        fe(e, r, { get: () => t[r], enumerable: !(s = Pi(t, r)) || s.enumerable });
            return e;
        };
    var ot = (e, t, i) => (
            (i = e != null ? wi(Ni(e)) : {}),
            nt(t || !e || !e.__esModule ? fe(i, "default", { value: e, enumerable: !0 }) : i, e)
        ),
        Ri = (e) => nt(fe({}, "__esModule", { value: !0 }), e);
    var zt = at((dr, Xt) => {
        Xt.exports = {};
    });
    var Xe = at((mr, We) => {
        ...
        function Yt(e) {
            ...
            if (!t) {
                let i = e.tokTypes,
                    ...
                    o = new s("</tag", !1),
                    p = new s("<tag>...</tag>", !0, !0),
                    u = { tc_oTag: n, tc_cTag: o, tc_expr: p },
                    c = {
                ...
                ((c.jsxTagStart.updateContext = function () {
                    (this.context.push(p), this.context.push(n), (this.exprAllowed = !1));
                }),
                    (c.jsxTagEnd.updateContext = function (f) {
                        let v = this.context.pop();
                        (v === n && f === i.slash) || v === o
                            ? (this.context.pop(), (this.exprAllowed = this.curContext() === p))
                            : (this.exprAllowed = !0);
                    }),
                    (t = { tokContexts: u, tokTypes: c }),
                    Qt.set(e, t));
            }
            return t;
        }
        ...
        function Ts(e, t) {
            let i = t.acorn || void 0,
                ...
                n = s.tokTypes,
                o = i.tokContexts,
                p = s.tokContexts.tc_oTag,
                u = s.tokContexts.tc_cTag,
                c = s.tokContexts.tc_expr,
                f = i.isNewLine,
                v = i.isIdentifierStart,
                T = i.isIdentifierChar;
...
`))
                    ...
                    for (; this.pos < this.input.length && m++ < 10; ) {
                        if (((g = this.input[this.pos++]), g === ";")) {
                            h[0] === "#"
                                ? h[1] === "x"
                                    ? ((h = h.substr(2)),
                                      Ss.test(h) && (x = String.fromCharCode(parseInt(h, 16))))
                                    : ((h = h.substr(1)),
                                      _s.test(h) && (x = String.fromCharCode(parseInt(h, 10))))
                                : (x = bs[h]);
                            break;
                        }
                        h += g;
                ...
                jsx_parseAttribute() {
                    ...
                    return this.eat(r.braceL)
                        ...
                        : ((h.name = this.jsx_parseNamespacedName()),
                          (h.value = this.eat(r.eq) ? this.jsx_parseAttributeValue() : null),
                ...
                jsx_parseOpeningElementAt(h, m) {
                    ...
                    for (g && (x.name = g); this.type !== r.slash && this.type !== n.jsxTagEnd; )
                ...
                jsx_parseElementAt(h, m) {
                    let x = this.startNodeAt(h, m),
                        g = [],
                        N = this.jsx_parseOpeningElementAt(h, m),
                        le = null;
                    if (!N.selfClosing) {
                        e: for (;;)
                            switch (this.type) {
                        ...
                        pe(le.name) !== pe(N.name) &&
                            this.raise(
                                le.start,
                                "Expected corresponding JSX closing tag for <" + pe(N.name) + ">"
                            );
                    }
                    let Le = N.name ? "Element" : "Fragment";
                    return (
                        (x["opening" + Le] = N),
                        (x["closing" + Le] = le),
                        (x.children = g),
                ...
                updateContext(h) {
                    if (this.type == r.braceL) {
                        ...
                        ((this.context.length -= 2), this.context.push(u), (this.exprAllowed = !1));
            ...
            : e < 91
              ...
              : e < 97
                ...
                : e < 123
                  ? !0
                  : e <= 65535
                    ? e >= 170 && Mi.test(String.fromCharCode(e))
                    : t === !1
                      ? !1
                      : Be(e, ft);
    }
                ...
                : e < 91
                  ...
                  : e < 97
                    ...
                    : e < 123
                      ? !0
                      : e <= 65535
                        ? e >= 170 && ji.test(String.fromCharCode(e))
                        : t === !1
                          ? !1
                          : Be(e, ft) || Be(e, Oi);
    }
    ...
    function R(e, t) {
        return new _(e, { beforeExpr: !0, binop: t });
    }
    var O = { beforeExpr: !0 },
        L = { startsExpr: !0 },
        je = {};
    ...
    var a = {
            ...
            relational: R("</>/<=/>=", 7),
            bitShift: R("<</>>/>>>", 8),
            plusMin: new _("+/-", { beforeExpr: !0, binop: 9, prefix: !0, startsExpr: !0 }),
            modulo: R("%", 10),
            star: R("*", 10),
            slash: R("/", 10),
...
Defaulting to 2020, but this will stop working in the future.`)),
    ...
    function Ki(e, t) {
        return function (i, s, r, n, o, p) {
            ...
            (e.locations && (u.loc = new ve(this, o, p)),
                e.ranges && (u.range = [r, n]),
                t.push(u));
        };
    }
    var ne = 1,
    ...
    var me = 0,
        ...
        E = function (t, i, s) {
            ((this.options = t = Hi(t)),
                ...
                (this.keywords = H(
                    Di[t.ecmaVersion >= 6 ? 6 : t.sourceType === "module" ? "5module" : 5]
                )));
            var r = "";
            (t.allowReserved !== !0 &&
                ((r = Ve[t.ecmaVersion >= 6 ? 6 : t.ecmaVersion === 5 ? 5 : 3]),
                t.sourceType === "module" && (r += " await")),
                (this.reservedWords = H(r)));
            var n = (r ? r + " " : "") + Ve.strict;
            ((this.reservedWordsStrict = H(n)),
                (this.reservedWordsStrictBind = H(n + " " + Ve.strictBind)),
                (this.input = String(i)),
                (this.containsEsc = !1),
                s
                    ? ((this.pos = s),
...
`,
    ...
    d.isLet = function (e) {
        ...
        if (M(s, !0)) {
            for (var r = i + 1; K((s = this.input.charCodeAt(r)), !0); ) ++r;
            if (s === 92 || (s > 55295 && s < 56320)) return !0;
            var n = this.input.slice(i, r);
            if (!Fi.test(n)) return !0;
        }
        return !1;
    };
    d.isAsyncFunction = function () {
        ...
        return (
            ...
            (t + 8 === this.input.length ||
                !(K((i = this.input.charCodeAt(t + 8))) || (i > 55295 && i < 56320)))
        );
    };
    d.isUsingKeyword = function (e, t) {
        ...
        if (V.test(this.input.slice(this.pos, s))) return !1;
        if (e) {
            var r = s + 5,
                n;
            if (
                ...
                r === this.input.length ||
                K((n = this.input.charCodeAt(r))) ||
                (n > 55295 && n < 56320)
            )
                return !1;
            A.lastIndex = r;
            var o = A.exec(this.input);
            if (o && V.test(this.input.slice(r, r + o[0].length))) return !1;
        }
        if (t) {
            var p = s + 2,
                u;
            if (
                this.input.slice(s, p) === "of" &&
                (p === this.input.length ||
                    (!K((u = this.input.charCodeAt(p))) && !(u > 55295 && u < 56320)))
            )
                return !1;
        }
        ...
        switch ((this.isLet(e) && ((s = a._var), (n = "let")), s)) {
            ...
            case a._import:
                if (this.options.ecmaVersion > 10 && s === a._import) {
                    A.lastIndex = this.pos;
                    var o = A.exec(this.input),
                        p = this.pos + o[0].length,
                        u = this.input.charCodeAt(p);
                    if (u === 40 || u === 46)
            ...
            default:
                ...
                return s === a.name && v.type === "Identifier" && this.eat(a.colon)
                    ? this.parseLabeledStatement(r, f, v, e)
                    : this.parseExpressionStatement(r, v);
        }
    };
    ...
    d.parseForStatement = function (e) {
        ...
        var n = this.isContextual("let"),
            o = !1,
            p = this.isUsing(!0) ? "using" : this.isAwaitUsing(!0) ? "await using" : null;
        if (p) {
            var u = this.startNode();
            return (
                this.next(),
                p === "await using" && this.next(),
                this.parseVar(u, !0, p),
                this.finishNode(u, "VariableDeclaration"),
                this.parseForAfterInit(e, u, t)
            );
        }
        var c = this.containsEsc,
            f = new _e(),
            v = this.start,
            T = t > -1 ? this.parseExprSubscripts(f, "await") : this.parseExpression(!0, f);
        return this.type === a._in || (o = this.options.ecmaVersion >= 6 && this.isContextual("of"))
            ? (t > -1
                  ? (this.type === a._in && this.unexpected(t), (e.await = !0))
                  : o &&
                    this.options.ecmaVersion >= 8 &&
                    (T.start === v && !c && T.type === "Identifier" && T.name === "async"
                        ? this.unexpected()
              ...
              this.toAssignable(T, !1, f),
              this.checkLValPattern(T),
              this.parseForIn(e, T))
    ...
    d.parseForAfterInit = function (e, t, i) {
        return (this.type === a._in ||
            ...
            ? (this.options.ecmaVersion >= 9 &&
                  (this.type === a._in ? i > -1 && this.unexpected(i) : (e.await = i > -1)),
              this.parseForIn(e, t))
            : (i > -1 && this.unexpected(i), this.parseFor(e, t));
    };
    d.parseFunctionStatement = function (e, t, i) {
        return (this.next(), this.parseFunction(e, re | (i ? 0 : Fe), !1, t));
    };
    ...
    d.parseCatchClauseParam = function () {
        var e = this.parseBindingAtom(),
            t = e.type === "Identifier";
        return (
            this.enterScope(t ? bt : 0),
            this.checkLValPattern(e, t ? Tt : J),
    ...
    d.parseTryStatement = function (e) {
        if (
            (this.next(), (e.block = this.parseBlock()), (e.handler = null), this.type === a._catch)
        ) {
    ...
    d.parseLabeledStatement = function (e, t, i, s) {
        ...
        for (
            var p = this.type.isLoop ? "loop" : this.type === a._switch ? "switch" : null,
        ...
        return (
            this.labels.push({ name: t, kind: p, statementStart: this.start }),
                ...
                this.eat(a.eq)
                    ...
                    : !s &&
                      ...
                      : !s &&
                        ...
                        ? this.raise(
                              this.lastTokEnd,
                              "Missing initializer in " + i + " declaration"
                          )
                        : !s &&
    ...
    d.parseFunction = function (e, t, i, s, r) {
        (this.initFunction(e),
            (this.options.ecmaVersion >= 9 || (this.options.ecmaVersion >= 6 && !s)) &&
                (this.type === a.star && t & Fe && this.unexpected(),
                (e.generator = this.eat(a.star))),
            this.options.ecmaVersion >= 8 && (e.async = !!s),
            t & re &&
                ((e.id = t & Et && this.type !== a.name ? null : this.parseIdent()),
                e.id &&
                    !(t & Fe) &&
        ...
        return (
            ...
            this.enterScope(qe(e.async, e.generator)),
            t & re || (e.id = this.type === a.name ? this.parseIdent() : null),
        ...
        for (r.body = [], this.expect(a.braceL); this.type !== a.braceR; ) {
            ...
            o &&
                ...
                o.type === "MethodDefinition" && o.kind === "constructor"
                    ? (n &&
                          this.raiseRecoverable(o.start, "Duplicate constructor in the same class"),
                      (n = !0))
                    : o.key &&
    ...
    d.parseClassElement = function (e) {
        ...
        if (
            ...
            (this.eatContextual("get") || this.eatContextual("set")) &&
                (this.isClassElementNameStart() ? (o = u) : (s = u));
        }
        if (
            (s
                ? ((i.computed = !1),
            ...
            var c = !i.static && xe(i, "constructor"),
                f = c && e;
            (c &&
                o !== "method" &&
                this.raise(i.key.start, "Constructor can't have get/set modifier"),
                (i.kind = c ? "constructor" : o),
                this.parseClassMethod(i, r, n, f));
    ...
    d.parseClassField = function (e) {
        return (
            ...
            this.eat(a.eq)
                ? (this.enterScope(oe | be), (e.value = this.parseMaybeAssign()), this.exitScope())
                : (e.value = null),
            this.semicolon(),
    ...
    d.parseClassStaticBlock = function (e) {
        e.body = [];
        var t = this.labels;
        for (this.labels = [], this.enterScope(X | be); this.type !== a.braceR; ) {
    ...
    function xe(e, t) {
        ...
        return (
            !i &&
            ((s.type === "Identifier" && s.name === t) || (s.type === "Literal" && s.value === t))
        );
    }
    ...
    d.parseExportDefaultDeclaration = function () {
        ...
        if (this.type === a._function || (e = this.isAsyncFunction())) {
            var t = this.startNode();
            return (this.next(), e && this.next(), this.parseFunction(t, re | Et, !1, e));
    ...
    d.checkExport = function (e, t, i) {
        e &&
            ...
            $(e, t) && this.raiseRecoverable(i, "Duplicate export '" + t + "'"),
            (e[t] = !0));
    };
    d.checkPatternExport = function (e, t) {
        ...
        if (i === "Identifier") this.checkExport(e, t, t.start);
            ...
            for (var o = 0, p = t.elements; o < p.length; o += 1) {
                var u = p[o];
    ...
    d.parseImport = function (e) {
        return (
            this.next(),
            this.type === a.string
                ? ((e.specifiers = zi), (e.source = this.parseExprAtom()))
    ...
    d.parseWithClause = function () {
        ...
        for (var t = {}, i = !0; !this.eat(a.braceR); ) {
            ...
            ($(t, r) && this.raiseRecoverable(s.key.start, "Duplicate attribute key '" + r + "'"),
                (t[r] = !0),
                e.push(s));
        }
        return e;
            ...
            case "Identifier":
                (this.strict &&
                    ...
                    s &&
                        ...
                        i &&
                            ($(i, e.name) && this.raiseRecoverable(e.start, "Argument name clash"),
                            (i[e.name] = !0)),
                        t !== Ct && this.declareName(e.name, t, e.start)));
                break;
            case "ChainExpression":
    ...
    ee.braceIsBlock = function (e) {
        ...
        return t === C.f_expr || t === C.f_stat
            ? !0
            : e === a.colon && (t === C.b_stat || t === C.b_expr)
              ? !t.isExpr
    ...
    a.parenR.updateContext = a.braceR.updateContext = function () {
        ...
        (e === C.b_stat && this.curContext().token === "function" && (e = this.context.pop()),
            (this.exprAllowed = !e.isExpr));
    };
    a.braceL.updateContext = function (e) {
        (this.context.push(this.braceIsBlock(e) ? C.b_stat : C.b_expr), (this.exprAllowed = !0));
    };
    a.dollarBraceL.updateContext = function () {
        (this.context.push(C.b_tmpl), (this.exprAllowed = !0));
    };
    a.parenL.updateContext = function (e) {
        var t = e === a._if || e === a._for || e === a._with || e === a._while;
        (this.context.push(t ? C.p_stat : C.p_expr), (this.exprAllowed = !0));
    };
    a.incDec.updateContext = function () {};
    a._function.updateContext = a._class.updateContext = function (e) {
        (e.beforeExpr &&
        e !== a._else &&
        !(e === a.semi && this.curContext() !== C.p_stat) &&
        !(e === a._return && V.test(this.input.slice(this.lastTokEnd, this.start))) &&
        !((e === a.colon || e === a.braceL) && this.curContext() === C.b_stat)
            ? this.context.push(C.f_expr)
            : this.context.push(C.f_stat),
            (this.exprAllowed = !1));
    };
    ...
    a.star.updateContext = function (e) {
        if (e === a._function) {
            ...
            this.context[t] === C.f_expr
                ? (this.context[t] = C.f_expr_gen)
                : (this.context[t] = C.f_gen);
        }
        this.exprAllowed = !0;
    };
    ...
    y.checkPropClash = function (e, t, i) {
        if (
            ...
            if (o) {
                var p;
                (n === "init"
                    ? (p = (this.strict && o.init) || o.get || o.set)
                    : (p = o.init || o[n]),
                    p && this.raiseRecoverable(s.start, "Redefinition of property"));
    ...
    y.parseMaybeAssign = function (e, t, i) {
        ...
        if ((i && (c = i.call(this, c, p, u)), this.type.isAssign)) {
            ...
            return (
                ...
                this.type === a.eq && (c = this.toAssignable(c, !1, t)),
    ...
    y.parseExprOp = function (e, t, i, s, r) {
        ...
        if (n != null && (!r || this.type !== a._in) && n > s) {
            var o = this.type === a.logicalOR || this.type === a.logicalAND,
                p = this.type === a.coalesce;
            p && (n = a.logicalAND.binop);
            var u = this.value;
            this.next();
            var c = this.start,
                f = this.startLoc,
                v = this.parseExprOp(this.parseMaybeUnary(null, !1, !1, r), c, f, n, r),
                T = this.buildBinary(t, i, e, v, u, o || p);
            return (
                ((o && this.type === a.coalesce) ||
                    (p && (this.type === a.logicalOR || this.type === a.logicalAND))) &&
                    this.raiseRecoverable(
                        this.start,
                        "Logical expressions and coalesce expressions cannot be mixed. Wrap either by parentheses"
                    ),
                this.parseExprOp(T, t, i, s, r)
            );
        }
        return e;
    };
    ...
    y.parseMaybeUnary = function (e, t, i, s) {
        ...
        if (this.isContextual("await") && this.canAwait) ((o = this.parseAwait(s)), (t = !0));
            ...
            var p = this.startNode(),
                u = this.type === a.incDec;
            ((p.operator = this.value),
                (p.prefix = !0),
                this.next(),
                (p.argument = this.parseMaybeUnary(null, !0, u, s)),
                this.checkExpressionErrors(e, !0),
                u
                    ? this.checkLValSimple(p.argument)
                    : this.strict && p.operator === "delete" && kt(p.argument)
                      ? this.raiseRecoverable(p.start, "Deleting local variable in strict mode")
                      : p.operator === "delete" && Me(p.argument)
                        ? this.raiseRecoverable(p.start, "Private fields can not be deleted")
                        : (t = !0),
                (o = this.finishNode(p, u ? "UpdateExpression" : "UnaryExpression")));
    ...
    function kt(e) {
        return (
            e.type === "Identifier" || (e.type === "ParenthesizedExpression" && kt(e.expression))
        );
    }
    function Me(e) {
        return (
            (e.type === "MemberExpression" && e.property.type === "PrivateIdentifier") ||
            (e.type === "ChainExpression" && Me(e.expression)) ||
            (e.type === "ParenthesizedExpression" && Me(e.expression))
        );
    }
    ...
    y.parseSubscripts = function (e, t, i, s, r) {
        for (
            ...
            if ((p.optional && (o = !0), p === e || p.type === "ArrowFunctionExpression")) {
                if (o) {
    ...
    y.parseSubscript = function (e, t, i, s, r, n, o) {
        ...
        if (c || (u && this.type !== a.parenL && this.type !== a.backQuote) || this.eat(a.dot)) {
            ...
            ((f.object = e),
                c
                    ? ((f.property = this.parseExpression()), this.expect(a.bracketR))
            ...
            var x = this.parseExprList(a.parenR, this.options.ecmaVersion >= 8, !1, v);
            ...
            ((N.tag = e),
                (N.quasi = this.parseTemplate({ isTagged: !0 })),
    ...
    y.parseExprAtom = function (e, t, i) {
        ...
        switch (this.type) {
                ...
                if (r && !this.canInsertSemicolon()) {
                    ...
                    if (
                        ...
                        return (
                            ...
                            this.parseArrowExpression(this.startNodeAt(n, o), [u], !0, t)
                        );
                }
                return u;
            case a.regexp:
                var c = this.value;
                return (
                    (s = this.parseLiteral(c.value)),
                    (s.regex = { pattern: c.pattern, flags: c.flags }),
                    s
                );
            case a.num:
            case a.string:
            ...
            case a.parenL:
                var f = this.start,
                    v = this.parseParenAndDistinguishExpression(r, t);
                return (
                    e &&
                        (e.parenthesizedAssign < 0 &&
                            !this.isSimpleAssignTarget(v) &&
            ...
            case a.braceL:
                return (this.overrideContext(C.b_expr), this.parseObj(!1, e));
            case a._function:
    ...
    y.parseLiteral = function (e) {
        ...
        return (
            ...
            t.raw.charCodeAt(t.raw.length - 1) === 110 &&
                (t.bigint =
                    t.value != null ? t.value.toString() : t.raw.slice(0, -1).replace(/_/g, "")),
            this.next(),
        ...
        if (this.options.ecmaVersion >= 6) {
            ...
            for (this.yieldPos = 0, this.awaitPos = 0; this.type !== a.parenR; )
                if (
                    ...
                    break;
                } else u.push(this.parseMaybeAssign(!1, v, this.parseParenItem));
            ...
            if ((this.expect(a.parenR), e && this.shouldParseArrow(u) && this.eat(a.arrow)))
                return (
                    ...
                    (this.yieldPos = T),
                    (this.awaitPos = h),
                    this.parseParenArrowList(i, s, u, t)
                );
...
`
    ...
    y.parseProperty = function (e, t) {
        ...
        return (
            ...
            !e && !p && this.options.ecmaVersion >= 8 && !s && this.isAsyncProp(i)
                ? ((r = !0),
                  (s = this.options.ecmaVersion >= 9 && this.eat(a.star)),
                  this.parsePropertyName(i))
                : (r = !1),
            this.parsePropertyValue(i, e, s, r, n, o, t, p),
    ...
    y.parseMethod = function (e, t, i) {
        ...
        return (
            ...
            (this.awaitPos = 0),
            (this.awaitIdentPos = 0),
            this.enterScope(qe(t, s.generator) | be | (i ? St : 0)),
            this.expect(a.parenL),
    ...
    y.parseFunctionBody = function (e, t, i, s) {
        ...
        if (r) ((e.body = this.parseMaybeAssign(s)), (e.expression = !0), this.checkParams(e, !1));
            ...
            ((this.labels = []),
                ...
                this.strict && e.id && this.checkLValSimple(e.id, Ct),
    ...
    y.checkUnreserved = function (e) {
        ...
        if (
            ...
            !(this.currentThisScope().flags & Se) &&
                s === "arguments" &&
    ...
    y.parseIdent = function (e) {
        ...
        return (
            ...
            e ||
                ...
                t.name === "await" && !this.awaitIdentPos && (this.awaitIdentPos = t.start)),
            t
        );
    };
    ...
    W.declareName = function (e, t, i) {
        ...
        if (t === J) {
            ...
            ((s =
                r.lexical.indexOf(e) > -1 || r.functions.indexOf(e) > -1 || r.var.indexOf(e) > -1),
                r.lexical.push(e),
                this.inModule && r.flags & ne && delete this.undefinedExports[e]);
        } else if (t === Tt) {
            ...
            for (var p = this.scopeStack.length - 1; p >= 0; --p) {
                ...
                if (
                    (u.lexical.indexOf(e) > -1 && !(u.flags & bt && u.lexical[0] === e)) ||
                    (!this.treatFunctionsAsVarInScope(u) && u.functions.indexOf(e) > -1)
                ) {
                    s = !0;
                    break;
                }
                if (
                    (u.var.push(e),
                    this.inModule && u.flags & ne && delete this.undefinedExports[e],
                    u.flags & Se)
                )
                    break;
            }
    ...
    W.currentVarScope = function () {
        for (var e = this.scopeStack.length - 1; ; e--) {
            var t = this.scopeStack[e];
            if (t.flags & (Se | oe | X)) return t;
        }
    };
    W.currentThisScope = function () {
        for (var e = this.scopeStack.length - 1; ; e--) {
            var t = this.scopeStack[e];
            if (t.flags & (Se | oe | X) && !(t.flags & Ge)) return t;
        }
    };
    var Te = function (t, i, s) {
            ((this.type = ""),
                (this.start = i),
                (this.end = 0),
                t.options.locations && (this.loc = new ve(t, s)),
    ...
    var Zi =
        ...
        Pt = wt + " Extended_Pictographic",
        It = Pt,
        Nt = It + " EBase EComp EMod EPres ExtPict",
        Lt = Nt,
        es = Lt,
        ts = { 9: wt, 10: Pt, 11: It, 12: Nt, 13: Lt, 14: es },
        is =
        ...
        Ot = Rt + " Elymaic Elym Nandinagari Nand Nyiakeng_Puachue_Hmong Hmnp Wancho Wcho",
        Bt = Ot + " Chorasmian Chrs Diak Dives_Akuru Khitan_Small_Script Kits Yezi Yezidi",
        Dt = Bt + " Cypro_Minoan Cpmn Old_Uyghur Ougr Tangsa Tnsa Toto Vithkuqi Vith",
        rs = Dt + " " + Zi,
        as = { 9: Vt, 10: Rt, 11: Ot, 12: Bt, 13: Dt, 14: rs },
        Ft = {};
    function ns(e) {
        var t = (Ft[e] = {
            binary: H(ts[e] + " " + ct),
            binaryOfStrings: H(ss[e]),
            nonBinary: { General_Category: H(ct), Script: H(as[e]) },
        });
    ...
    for (de = 0, Oe = [9, 10, 11, 12, 13, 14]; de < Oe.length; de += 1) ((lt = Oe[de]), ns(lt));
    var lt,
        de,
        Oe,
        l = E.prototype,
    ...
    var U = function (t) {
        ((this.parser = t),
            ...
            (this.unicodeProperties = Ft[t.options.ecmaVersion >= 14 ? 14 : t.options.ecmaVersion]),
            (this.source = ""),
            (this.flags = ""),
            (this.start = 0),
            (this.switchU = !1),
    ...
    l.validateRegExpFlags = function (e) {
        for (var t = e.validFlags, i = e.flags, s = !1, r = !1, n = 0; n < i.length; n++) {
            var o = i.charAt(n);
            (t.indexOf(o) === -1 && this.raise(e.start, "Invalid regular expression flag"),
                i.indexOf(o, n + 1) > -1 &&
    ...
    l.regexp_disjunction = function (e) {
        ...
        for (t && (e.branchID = new ge(e.branchID, null)), this.regexp_alternative(e); e.eat(124); )
    ...
    l.regexp_eatBracedQuantifier = function (e, t) {
        ...
        if (e.eat(123)) {
            ...
            if (
                ...
                return (
                    r !== -1 && r < s && !t && e.raise("numbers out of order in {} quantifier"),
                    !0
                );
                    ...
                    if (i || s) {
                        ...
                        if (s) {
                            ...
                            for (var p = 0; p < o.length; p++) {
                                var u = o.charAt(p);
                                (o.indexOf(u, p + 1) > -1 || i.indexOf(u) > -1) &&
                                    e.raise("Duplicate regular expression modifiers");
                            }
                        }
                    }
    ...
    l.regexp_eatRegExpIdentifierStart = function (e) {
        ...
        return (
            ...
            ps(s) ? ((e.lastIntValue = s), !0) : ((e.pos = t), !1)
        );
    };
    function ps(e) {
    ...
    l.regexp_eatRegExpIdentifierPart = function (e) {
        ...
        return (
            e.advance(i),
            s === 92 && this.regexp_eatRegExpUnicodeEscapeSequence(e, i) && (s = e.lastIntValue),
            hs(s) ? ((e.lastIntValue = s), !0) : ((e.pos = t), !1)
        );
    };
    function hs(e) {
    ...
    l.regexp_eatZero = function (e) {
        return e.current() === 48 && !Ce(e.lookahead())
    ...
    l.regexp_eatRegExpUnicodeEscapeSequence = function (e, t) {
        ...
        if (e.eat(117)) {
            if (this.regexp_eatFixedHexDigits(e, 4)) {
                ...
                if (s && r >= 55296 && r <= 56319) {
                    ...
                    if (e.eat(92) && e.eat(117) && this.regexp_eatFixedHexDigits(e, 4)) {
                        ...
                        if (o >= 56320 && o <= 57343)
                            return (
                                (e.lastIntValue = (r - 55296) * 1024 + (o - 56320) + 65536),
                                !0
                            );
                    }
            ...
            if (s && e.eat(123) && this.regexp_eatHexDigits(e) && e.eat(125) && cs(e.lastIntValue))
                return !0;
    ...
    l.regexp_eatCharacterClassEscape = function (e) {
        ...
        if (e.switchU && this.options.ecmaVersion >= 9 && ((i = t === 80) || t === 112)) {
            ...
            if (e.eat(123) && (s = this.regexp_eatUnicodePropertyValueExpression(e)) && e.eat(125))
                return (i && s === B && e.raise("Invalid property name"), s);
    ...
    l.regexp_validateUnicodePropertyNameAndValue = function (e, t, i) {
        ($(e.unicodeProperties.nonBinary, t) || e.raise("Invalid property name"),
    ...
    l.regexp_eatUnicodePropertyValue = function (e) {
        var t = 0;
        for (e.lastStringValue = ""; fs((t = e.current())); )
            ((e.lastStringValue += G(t)), e.advance());
        return e.lastStringValue !== "";
    };
    function fs(e) {
    ...
    l.regexp_eatCharacterClass = function (e) {
        if (e.eat(91)) {
            ...
            return (
                ...
                t && i === B && e.raise("Negated character class may contain strings"),
                !0
            );
        }
        return !1;
    ...
    l.regexp_eatNestedClass = function (e) {
        ...
        if (e.eat(91)) {
            ...
            if (e.eat(93))
                return (i && s === B && e.raise("Negated character class may contain strings"), s);
            e.pos = t;
        }
        if (e.eat(92)) {
        ...
        if (e.eat(92))
            return this.regexp_eatCharacterEscape(e) || this.regexp_eatClassSetReservedPunctuator(e)
                ...
                : e.eat(98)
                  ...
                  : ((e.pos = t), !1);
        var i = e.current();
        return i < 0 || (i === e.lookahead() && ds(i)) || ms(i)
            ? !1
    ...
    l.regexp_eatHexDigits = function (e) {
        ...
        for (e.lastIntValue = 0; qt((i = e.current())); )
            ((e.lastIntValue = 16 * e.lastIntValue + Jt(i)), e.advance());
        return e.pos !== t;
    };
    function qt(e) {
    ...
    var Ke = function (t) {
            ((this.type = t.type),
                ...
                (this.start = t.start),
                (this.end = t.end),
                t.options.locations && (this.loc = new ve(t, t.startLoc, t.endLoc)),
    ...
    b.next = function (e) {
        (!e &&
            ...
            this.options.onToken && this.options.onToken(new Ke(this)),
    ...
    b.skipBlockComment = function () {
        ...
        if (
            ...
            for (var s = void 0, r = t; (s = mt(this.input, r, this.pos)) > -1; )
    ...
    b.skipLineComment = function (e) {
        for (
            ...
            this.pos < this.input.length && !Y(s);
        ...
        e: for (; this.pos < this.input.length; ) {
            ...
            switch (e) {
                ...
                case 47:
                    ...
                    break;
                default:
                    if ((e > 8 && e < 14) || (e >= 5760 && xt.test(String.fromCharCode(e))))
                        ++this.pos;
                    else break e;
            }
        }
    ...
    b.readToken_plus_min = function (e) {
        ...
        return t === e
            ? t === 45 &&
              ...
              (this.lastTokEnd === 0 || V.test(this.input.slice(this.lastTokEnd, this.pos)))
    ...
    b.readRegexp = function () {
        for (var e, t, i = this.pos; ; ) {
            ...
            if ((V.test(s) && this.raise(i, "Unterminated regular expression"), e)) e = !1;
            else {
                if (s === "[") t = !0;
                else if (s === "]" && t) t = !1;
                else if (s === "/" && !t) break;
    ...
    b.readRadixNumber = function (e) {
        ...
        return (
            ...
            this.options.ecmaVersion >= 11 && this.input.charCodeAt(this.pos) === 110
                ? ((i = Kt(this.input.slice(t, this.pos))), ++this.pos)
            ...
            s === 92
                ...
                : s === 8232 || s === 8233
                  ? (this.options.ecmaVersion < 10 &&
                    ...
                    ++this.pos,
                    this.options.locations && (this.curLine++, (this.lineStart = this.pos)))
                  : (Y(s) && this.raise(this.start, "Unterminated string constant"), ++this.pos);
        }
...
`;
    ...
    b.readWord1 = function () {
        ...
        for (
            ...
            if (K(r, s)) this.pos += r <= 65535 ? 1 : 2;
                ...
                ((t ? M : K)(o, s) || this.invalidStringToken(n, "Invalid Unicode escape"),
                    (e += G(o)),
                    (i = this.pos));
            } else break;
            t = !1;
    ...
    var As = (e, t, i) => {
        ...
        te = As;
    var ws = new Proxy(() => {}, { get: () => ws });
    function w(e) {
        var s, r, n;
        let t = ((s = e.range) == null ? void 0 : s[0]) ?? e.start,
            i =
                (n = ((r = e.declaration) == null ? void 0 : r.decorators) ?? e.decorators) == null
                    ? void 0
                    : n[0];
    ...
    function Vs(e) {
        return (
            Qe.has(e) ||
                Qe.set(e, z(e) && e.value[0] === "*" && /@(?:type|satisfies)\b/u.test(e.value)),
            Qe.get(e)
        );
    }
    var ei = Vs;
...
`);
        ...
        for (let i = e.length - 1; i >= 0; i--) {
            ...
            if (
                (t &&
                    ...
                    $e(s) &&
                    $e(t) &&
                    (e.splice(i + 1, 1), (s.value += "*//*" + t.value), (s.range = [w(s), k(t)])),
                !ze(s) && !z(s))
            )
    ...
    function ce(e) {
        ...
        return ((he = ce.prototype = e ?? Object.create(null)), new ce());
    }
    var Ds = 10;
    ...
    function Fs(e, t = "type") {
        ...
        function i(s) {
            let r = s[t],
                n = e[r];
            if (!Array.isArray(n))
                throw Object.assign(new Error(`Missing visitor keys for '${r}'.`), { node: s });
            return n;
        }
        return i;
    }
    ...
    function js(e, t) {
        ...
        e = ai(e, (u) => {
            switch (u.type) {
                case "ParenthesizedExpression": {
                    ...
                    if (!v) return ((c.extra = { ...c.extra, parenthesized: !0 }), c);
                    break;
                }
                ...
                case "TemplateLiteral":
                    if (u.expressions.length !== u.quasis.length - 1)
                ...
                case "TSEnumDeclaration":
                    if (!u.body) {
                        let c = k(u.id),
                            { members: f } = u,
                            v = Zt(
                                { originalText: s, [Symbol.for("comments")]: r },
                                c,
                                f[0] ? w(f[0]) : k(u)
                            ),
                            T = c + v.indexOf("{");
                        ((u.body = { type: "TSEnumBody", members: f, range: [T, k(u)] }),
                            delete u.members);
                    }
                    break;
        ...
        return (
            p.interpreter && (r.unshift(p.interpreter), delete p.interpreter),
            n && e.hashbang && (r.unshift(e.hashbang), delete e.hashbang),
            e.type === "Program" && (e.range = [0, s.length]),
            e
        );
    }
    function ni(e) {
    ...
    function ci(e) {
        let t = `
`;
        e = se(!1, e.replace(qs, "").replace(Gs, ""), Ws, "$1");
        let i = "";
        for (; i !== e; ) ((i = e), (e = se(!1, e, Ks, `${t}$1 $2${t}`)));
        e = e.replace(ui, "").trimEnd();
        let s = Object.create(null),
            r = se(!1, e, pi, "").replace(ui, "").trimEnd(),
            n;
        for (; (n = pi.exec(e)); ) {
            let o = se(!1, n[2], Hs, "");
...
`);
    ...
    function $s(e) {
        ...
        return Ee(t.replace(/ \(\d+:\d+\)$/u, ""), {
            loc: { start: { line: s, column: r + 1 } },
            cause: e,
        });
    }
    var vi,
        Zs = () => (vi ?? (vi = E.extend((0, bi.default)())), vi);
    function er(e, t) {
        let i = Zs(),
            s = [],
            r = i.parse(e, {
                ...Ys,
                sourceType: t,
                allowImportExportEverywhere: t === Pe,
                onComment: s,
            });
        return ((r.comments = s), r);
    }
    function tr(e, t) {
        let i = Ne(t == null ? void 0 : t.filepath),
            s = (i ? [i] : Ie).map((n) => () => er(e, n)),
            r;
        try {
            r = ke(s);
        } catch ({ errors: [n] }) {
    ...
    function ir(e, t) {
        let i = e[0],
            s = te(!1, e, -1),
            r = { type: I.Template, value: t.slice(i.start, s.end) };
        return (
            i.loc && (r.loc = { start: i.loc.start, end: s.loc.end }),
            i.range && ((r.start = i.range[0]), (r.end = s.range[1]), (r.range = [r.start, r.end])),
            r
        );
    }
    function it(e, t) {
    ...
    it.prototype = {
        ...
        translate(e, t) {
            ...
            if (i === s.name)
                ((e.type = I.Identifier),
                    e.value === "static" && (e.type = I.Keyword),
                    t.ecmaVersion > 5 &&
                ...
                ((e.type = I.Punctuator), (e.value = this._code.slice(e.start, e.end)));
                ...
                ((e.type = I.Numeric), (e.value = this._code.slice(e.start, e.end)));
            else if (i === s.string)
                (t.jsxAttrValueToken
                    ? ((t.jsxAttrValueToken = !1), (e.type = I.JSXText))
                    : (e.type = I.String),
    ...
    function Ci(e) {
        ...
        let n = t === 3 ? e.allowReserved || "never" : !1,
            o = e.ecmaFeatures || {},
            p = e.sourceType === "commonjs" || !!o.globalReturn;
        if (i === "module" && t < 6)
            throw new Error(
    ...
    var Q = Symbol("espree's internal state"),
        st = Symbol("espree's esprimaFinishNode");
    function nr(e, t, i, s, r, n, o) {
        let p;
        e ? (p = "Block") : o.slice(i, i + 2) === "#!" ? (p = "Hashbang") : (p = "Line");
        let u = { type: p, value: t };
        return (
            typeof i == "number" && ((u.start = i), (u.end = s), (u.range = [i, s])),
            typeof r == "object" && (u.loc = { start: r, end: n }),
            u
        );
    }
    var rt = () => (e) => {
            ...
            class extends e {
                constructor(s, r) {
                    ...
                    let n = s.sourceType,
                        o = Ci(s),
                        p = o.ecmaFeatures || {},
                        u = o.tokens === !0 ? new _i(t, r) : null,
                        c = {
                            originalSourceType: n || o.sourceType,
                            tokens: u ? [] : null,
                            comments: o.comment === !0 ? [] : null,
                            impliedStrict: p.impliedStrict === !0 && o.ecmaVersion >= 5,
                ...
                parse() {
                    ...
                    return (
                        ...
                        this[Q].templateElements.forEach((n) => {
                            let p = n.tail ? 1 : 2;
                            ((n.start += -1),
                                (n.end += p),
                                n.range && ((n.range[0] += -1), (n.range[1] += p)),
                                n.loc && ((n.loc.start.column += -1), (n.loc.end.column += p)));
                        }),
                        r
                    );
                }
...
`,
                    ...
                    (this.end > this.start && (r += ` ${this.input.slice(this.start, this.end)}`),
                ...
                [st](s) {
                    return (
                        s.type === "TemplateElement" && this[Q].templateElements.push(s),
    ...
    var or = {
        ...
        get jsx() {
            return (
                this._jsx === null && (this._jsx = E.extend((0, Ei.default)(), rt())),
                this._jsx
            );
        },
        get(e) {
    ...
    function pr(e) {
        ...
        return typeof i != "number"
            ? e
            : Ee(t, { loc: { start: { line: i, column: s } }, cause: e });
    }
    function hr(e, t) {
        let i = Ne(t == null ? void 0 : t.filepath),
            s = (i ? [i] : Ie).map((n) => () => ki(e, { ...ur, sourceType: n })),
            r;
        try {
            r = ke(s);
        } catch ({ errors: [n] }) {
        ...
        return Ae(r, { parser: "espree", text: e });
    }
    var Ai = we(hr);
