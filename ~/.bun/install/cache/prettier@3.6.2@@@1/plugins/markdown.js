        ...
        $n = (e, r, t, n) => {
            if ((r && typeof r == "object") || typeof r == "function")
                for (let a of xl(r))
                    !Bl.call(e, a) &&
                        a !== t &&
                        kr(e, a, { get: () => r[a], enumerable: !(n = wl(r, a)) || n.enumerable });
            return e;
        };
    var Me = (e, r, t) => (
            (t = e != null ? yl(kl(e)) : {}),
            $n(r || !e || !e.__esModule ? kr(t, "default", { value: e, enumerable: !0 }) : t, e)
        ),
        Tl = (e) => $n(kr({}, "__esModule", { value: !0 }), e);
        ...
        jn = (e, r, t) =>
            r.has(e)
                ...
                : r instanceof WeakSet
                  ...
                  : r.set(e, t),
        Wn = (e, r, t, n) => (
            Vn(e, r, "write to private field"),
            n ? n.call(e, t) : r.set(e, t),
            t
        );
    var Br = C((cF, Hn) => {
        "use strict";
    ...
    var iu = C((cv, nu) => {
        ...
        function Hf(e, r) {
            ...
            function D(b, g, y) {
                for (
                    var w = this,
                        E = w.interruptFootnoteDefinition,
                        x = w.offset,
                        k = g.length + 1,
                        T = 0,
                        q = [],
                ...
                if (g.charCodeAt(T++) === We && g.charCodeAt(T++) === pr) {
                    for (P = T; T < k; ) {
                        if (((_ = g.charCodeAt(T)), _ !== _ || _ === Gr || _ === Dr || _ === je))
                            return;
                        if (_ === Pt) {
                            ((S = T), T++);
                            break;
                    ...
                    if (!(S === void 0 || P === S || g.charCodeAt(T++) !== Gf)) {
                        if (y) return !0;
                        for (
                            N = g.slice(P, S), O = b.now(), ee = 0, Z = 0, Ee = T, ve = [];
                            T < k;

                        ) {
                            if (((_ = g.charCodeAt(T)), _ !== _ || _ === Gr))
                                ((U = { start: ee, contentStart: Ee || T, contentEnd: T, end: T }),
                                    ve.push(U),
                                    _ === Gr &&
                                        ((ee = T + 1), (Z = 0), (Ee = void 0), (U.end = ee)));
                            else if (Z !== void 0)
                                if (_ === je || _ === Dr)
                                    ((Z += _ === je ? 1 : $r - (Z % $r)),
                                        Z > $r && ((Z = void 0), (Ee = T)));
                        ...
                        for (Be = b(g.slice(0, U.contentEnd)); ++T < k; )
                            ((U = ve[T]),
                                (x[O.line + T] = (x[O.line + T] || 0) + (U.contentStart - U.start)),
                                q.push(g.slice(U.contentStart, U.end)));
                        return (
                            (W = w.enterBlock()),
                            (I = w.tokenizeBlock(q.join(""), O)),
                            W(),
                            Be({
            ...
            function h(b, g, y) {
                ...
                if (g.charCodeAt(E++) === We && g.charCodeAt(E++) === pr) {
                    for (k = E; E < w; ) {
                        if (((q = g.charCodeAt(E)), q !== q || q === Gr || q === Dr || q === je))
                            return;
                        if (q === Pt) {
                            ((T = E), E++);
                            break;
                    ...
                    if (P !== void 0)
                        return y
                            ...
                            : ((T = b.now()),
                              ...
                              b(g.slice(0, x))({
                                  type: "footnote",
                                  children: w.tokenizeInline(g.slice(N, P), T),
                              }));
                }
            }
            function F(b, g, y) {
                ...
                if (
                    (g.charCodeAt(w) === zf && w++,
                    g.charCodeAt(w) === We && g.charCodeAt(w + 1) !== pr)
                )
        ...
        function nD(e, r) {
            ...
            function i(u, o, s) {
                let l = o.length,
                    ...
                    A,
                    v;
                if ((o.charCodeAt(p) === su && ((f = !0), p++), o.charCodeAt(p) === Vr)) {
                    if ((p++, f)) return s ? !0 : u(o.slice(0, p))({ type: "text", value: "$" });
                    if (
                        (o.charCodeAt(p) === Vr && ((c = !0), p++),
                        (h = o.charCodeAt(p)),
                        !(h === ou || h === au))
                    ) {
                        for (m = p; p < l; ) {
...
$$`
    ...
    var Au = C((mv, bu) => {
        ...
        function FD(e) {
            ...
            for (t in r)
                ((n = r[t]),
                    n && typeof n == "object" && (r[t] = "concat" in n ? n.concat() : mD(n)));
            return i;
            function a(u) {
    ...
    var dr = C((Bv, ea) => {
        ...
        function HD(e, r) {
            var t = r.additional,
                ...
                I;
            for (
                typeof t == "string" && (t = t.charCodeAt(0)), O = ee(), x = u ? Z : ID, d--, p++;
                ++d < p;
                    ...
                    ((b = e.charCodeAt(I) === UD),
                        ...
                        w
                            ? (Ee(),
                              ...
                              (Be = ee()),
                              Be.offset++,
                              i && i.call(s, w, { start: O, end: Be }, e.slice(P - 1, I)),
                              (O = Be))
...
`,
                    ...
                    (x === -1 ? (c += E.length) : (c = E.length - x),
                        l in i && (x !== -1 ? (c += i[l]) : c <= i[l] && (c = i[l] + 1)));
                }
                function A() {
                    var E = [],
                        x = l + 1;
...
`,
    ...
    var Sa = C((zv, _a) => {
        ...
        function xp(e, r, t) {
            for (
                var n, a = "", i = 0, u = r.length;
                i < u && ((n = wp.exec(r.slice(i))), n != null);
            ...
            if (a) {
                ...
                if (((v = u), (c = r.charAt(u)), !(c !== Op && c !== Na))) {
                    ...
                    if (!(s < Lp)) {
                        ...
                        for (
                            f = "", D = "";
                            u < i && ((c = r.charAt(u)), !(c === Qr || (l === Na && c === l)));
            ...
            if (((D = r.charAt(++s)), !(D !== Fe && D !== et && (i || (D !== ae && D !== ""))))) {
                ...
                for (s = 0, w = [], E = [], x = []; s < l; ) {
                    ...
                    if ((k && f >= k.indent && (O = !0), (D = r.charAt(s)), (v = null), !O)) {
                        ...
                        if (v)
                            if (((D = r.charAt(s)), D === et)) ((f += xe - (f % xe)), s++);
                            else if (D === Fe) {
                    ...
                    if (((g = y), (y = !A && !sh(B).length), O && k))
                        ...
                        (x.length !== 0 && ((N = !0), k.value.push(""), (k.trail = x.concat())),
...
`,
        ...
        function Th(e, r, t) {
            for (
                var n = this, a = e.now(), i = r.length, u = -1, o = "", s, l, c, f, p;
                ++u < i;
        ...
        function Dd(e, r, t) {
            ...
            if (((f = r.charAt(i)), f === cn)) {
                ...
                if (!(!c || r.charAt(i) !== vr || r.charAt(i + 1) !== wo)) {
                    for (
                        d = c, o += c + vr + wo, i = o.length, c = "";
                        i < u && ((f = r.charAt(i)), !(f !== rt && f !== tt && f !== Ze));
                    ...
                    if (c) {
                        ...
                        for (; i < u && ((f = r.charAt(i)), !(f !== rt && f !== tt)); )
                            ((o += f), i++);
                    ...
                    if (((c = r.charAt(u)), !(!o || c !== Dn)))
                        return t
                            ...
                            : ((l += o),
                              ...
                              f.offset++,
                              s &&
                                  (l.slice(0, it).toLowerCase() === hn
                                      ? ((p = p.slice(it)), (f.column += it), (f.offset += it))
                                      : (l = hn + l)),
                        ...
                        return t
                            ...
                            : ((a += Ar),
                              ...
                              F
                                  ...
                                  : ((x = n.enterLink()),
                                    (k.children = n.tokenizeInline(A, E)),
                                    x()),
                              e(a)(k));
                }
            }
        ...
        function As(e, r, t) {
            ...
            if ((i === _0 && ((c = B0), (l = i), (i = r.charAt(++u))), i === at)) {
                ...
                if (((s = F), (p = F), (i = r.charAt(u)), i === st)) {
                    if ((u++, (s += i), (F = ""), !a))
                        for (; u < o && ((i = r.charAt(u)), !!w0(i)); ) ((F += i), u++);
                    if (((i = r.charAt(u)), i === at)) {
                        for (
                            d = "", F += i, u++;
                            u < o && ((i = r.charAt(u)), !(i === at || i === st));

                        )
                            (i === ot && ((d += ot), (i = r.charAt(++u))), (d += i), u++);
                        ((i = r.charAt(u)),
                            i === st ? ((f = d ? xn : q0), (F += d + i), u++) : (d = ""),
                            (s += F),
                            (F = ""));
                    } else {
                        if (!p) return;
    ...
    var Ws = C((xC, js) => {
        ...
        function Vs(e, r, t) {
            var n = this,
                ...
                l,
                c;
            if (!(!n.options.gfm || r.charAt(0) !== ct || r.charAt(1) !== ct || Ys(r.charAt(2))))
                for (s = 1, l = r.length, c = e.now(), c.column += 2, c.offset += 2; ++s < l; ) {
                    if (((a = r.charAt(s)), a === ct && i === ct && (!u || !Ys(u))))
                        return t
                            ? !0
...
`,
    ...
    var cc = C((SC, sc) => {
        ...
        M.parse = qa();
        M.options = jt();
        M.exitStart = lt("atStart", !0);
        M.enterList = lt("inList", !1);
        M.enterLink = lt("inLink", !1);
        M.enterBlock = lt("inBlock", !1);
    ...
    var wc = C((IC, yc) => {
        ...
        var ft = Object.prototype.hasOwnProperty,
            ...
            vc = function (r) {
                ...
                var t = ft.call(r, "constructor"),
                    n =
                        r.constructor &&
                        r.constructor.prototype &&
                        ft.call(r.constructor.prototype, "isPrototypeOf");
        ...
        function il() {
            ...
            function s(m) {
                ...
                function b(g, y) {
                    var w = l(g);
                    w
                        ? (Zc(w[1]) && Zc(y) && (y = pt(!0, w[1], y)), (w[1] = y))
    ...
    var Y = "string",
        ...
        de = "label",
        ne = "break-parent",
        Tr = new Set([Ce, re, te, fe, X, J, K, De, pe, he, $, de, ne]);
    function Pl(e) {
...
.*-->`,
    ...
    var oi = (e) => Ir(Ge(e).content.trimStart(), Lr),
        si = (e) => Ir(Ge(e).content.trimStart(), ui),
        ci = (e) => {
            let r = Ge(e),
                t = `<!-- @${ai} -->`;
...
`,
    ...
    var vt = new Set([
        ...
        Rr = new Set([...vt, "tableCell", "paragraph", "heading"]),
        $e = "non-cjk",
        ie = "cj-letter",
        Le = "k-letter",
        sr = "cjk-punctuation",
...
`)
    ...
    function tf(e, r) {
            ...
            if (n)
                return async (a) => {
                    let i = r.__inJsTemplate ? "~" : "`",
                        u = i.repeat(Math.max(3, Pr(t.value, i) + 1)),
                        o = { parser: n };
        ...
        switch (t.type) {
            ...
            case "jsx":
                return (n) =>
                    n(`<$>${t.value}</$>`, { parser: "__js_expression", rootMarker: "mdx" });
        }
        return null;
    }
    var Bi = tf;
...
`,
                ...
                case J: {
                    ...
                    Ur({ ind: p, mode: ue, doc: [v, B, x] }, [], h, l.length > 0, t, !0)
                        ? u.push(k, w, b)
                        : y
                          ? u.push(k, E, b)
                          : u.push(k, E, g);
                ...
                case De: {
                    ...
                    if (h === V) {
                        let m =
                            D.type === K ? D.breakContents : D.negate ? D.contents : ir(D.contents);
                        m && u.push({ ind: p, mode: d, doc: m });
                    }
                    if (h === ue) {
                        let m =
                            D.type === K ? D.flatContents : D.negate ? ir(D.contents) : D.contents;
                        m && u.push({ ind: p, mode: d, doc: m });
                    }
                    break;
                }
                ...
                case $:
                    switch (d) {
                        ...
                        case V:
                            if (l.length > 0) {
                                (u.push({ ind: p, mode: d, doc: D }, ...l.reverse()),
                                    (l.length = 0));
                                break;
                            }
                            D.literal
                                ? p.root
                                    ...
                                    : (o.push(a), (i = 0))
                                : ((i -= wt(o)), o.push(a + p.value), (i = p.length));
                            break;
                    }
                    break;
                case de:
    ...
    function Mi(e, r, t) {
        ...
        function s(f) {
            return qr(
                ar,
                [c(i[0], f), l(f), ...i.slice(1).map((p) => c(p, f))].map(
                    (p) => `| ${p.join(" | ")} |`
                )
            );
        }
    ...
    function Cf(e) {
        return ye(e, (r, t, [n]) => {
            ...
            return (
                ...
                { type: "sentence", position: r.position, children: Nr(a) }
            );
        });
    }
    function bf(e, r) {
...
` &&
    ...
    function Tf(e, r, t) {
        ...
        if (Lf(e)) {
            let i = [""],
                u = Nr(r.originalText.slice(n.position.start.offset, n.position.end.offset));
            for (let o of u) {
                if (o.type === "word") {
        ...
        switch (n.type) {
            ...
            case "emphasis": {
                ...
                if (Ct(n.children[0])) i = r.originalText[n.position.start.offset];
                    ...
                    let u = ji(e),
                        o =
                            ((a = e.parent) == null ? void 0 : a.type) === "strong" &&
                            ji(e.ancestors);
...
`,
            ...
            case "code": {
                ...
                let i = r.__inJsTemplate ? "~" : "`",
                    u = i.repeat(Math.max(3, Pr(n.value, i) + 1));
                return [
                    u,
                    n.lang || "",
                    n.meta ? " " + n.meta : "",
                    L,
                    be(Mr(n, r.originalText), L),
                    L,
                    u,
                ];
            }
                    ...
                    processor(o) {
                        ...
                        if (
                            ...
                            l.children[0].position.start.column !==
                                l.children[1].position.start.column
                        )
                            return [s, Wi(o, r, t, s)];
            ...
            case "definition": {
                ...
                return Ue([
                    qt(n),
                    ":",
                    ir([i, Tt(n.url), n.title === null ? "" : [i, zr(n.title, r, !1)]]),
                ]);
            }
            case "footnote":
                return ["[^", j(e, r, t), "]"];
                    ...
                    i
                        ...
                        : Ue([
                              Ae(
                                  " ".repeat(4),
                                  j(e, r, t, {
                                      processor: ({ isFirst: u }) => (u ? Ue([Sr, t()]) : t()),
                                  })
                              ),
                          ]),
                ];
...
`,
    ...
    function Zm() {
        return (e) =>
            ye(e, (r, t, [n]) =>
                r.type !== "html" || sl.test(r.value) || Rr.has(n.type) ? r : { ...r, type: "jsx" }
            );
    }
    var hl = Zm;
    var eF = function () {
