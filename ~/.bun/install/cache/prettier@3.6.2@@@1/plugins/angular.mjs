...
var nn = (n, e) => {
    for (var t in e) qs(n, t, { get: e[t], enumerable: !0 });
};
var dt = (n, e, t) => e.has(n) || tn("Cannot " + t);
var L = (n, e, t) => (dt(n, e, "read from private field"), t ? t.call(n) : e.get(n)),
    V = (n, e, t) =>
        e.has(n)
            ...
            : e instanceof WeakSet
              ? e.add(n)
              : e.set(n, t),
    te = (n, e, t, s) => (dt(n, e, "write to private field"), s ? s.call(n, t) : e.set(n, t), t),
    c = (n, e, t) => (dt(n, e, "access private method"), t);
var Zt = {};
nn(Zt, { parsers: () => Kt });
var Kt = {};
nn(Kt, {
...
var ln;
(function (n) {
    ((n[(n.Directive = 0)] = "Directive"),
        (n[(n.Component = 1)] = "Component"),
        (n[(n.Injectable = 2)] = "Injectable"),
        (n[(n.Pipe = 3)] = "Pipe"),
        (n[(n.NgModule = 4)] = "NgModule"));
})(ln || (ln = {}));
var cn;
(function (n) {
    ((n[(n.Directive = 0)] = "Directive"),
        (n[(n.Pipe = 1)] = "Pipe"),
        (n[(n.NgModule = 2)] = "NgModule"));
})(cn || (cn = {}));
var un;
(function (n) {
    ((n[(n.Emulated = 0)] = "Emulated"),
...
var fn;
(function (n) {
    ((n[(n.Dynamic = 0)] = "Dynamic"),
        (n[(n.Bool = 1)] = "Bool"),
        (n[(n.String = 2)] = "String"),
        (n[(n.Int = 3)] = "Int"),
        (n[(n.Number = 4)] = "Number"),
        (n[(n.Function = 5)] = "Function"),
        (n[(n.Inferred = 6)] = "Inferred"),
        (n[(n.None = 7)] = "None"));
})(fn || (fn = {}));
var js = void 0;
var dn;
...
(function (n) {
    ((n[(n.Equals = 0)] = "Equals"),
        (n[(n.NotEquals = 1)] = "NotEquals"),
        (n[(n.Identical = 2)] = "Identical"),
        (n[(n.NotIdentical = 3)] = "NotIdentical"),
        (n[(n.Minus = 4)] = "Minus"),
        (n[(n.Plus = 5)] = "Plus"),
        (n[(n.Divide = 6)] = "Divide"),
        (n[(n.Multiply = 7)] = "Multiply"),
        (n[(n.Modulo = 8)] = "Modulo"),
        (n[(n.And = 9)] = "And"),
        (n[(n.Or = 10)] = "Or"),
        (n[(n.BitwiseOr = 11)] = "BitwiseOr"),
        (n[(n.BitwiseAnd = 12)] = "BitwiseAnd"),
        (n[(n.Lower = 13)] = "Lower"),
        (n[(n.LowerEquals = 14)] = "LowerEquals"),
        (n[(n.Bigger = 15)] = "Bigger"),
        (n[(n.BiggerEquals = 16)] = "BiggerEquals"),
        (n[(n.NullishCoalesce = 17)] = "NullishCoalesce"),
        (n[(n.Exponentiation = 18)] = "Exponentiation"),
        (n[(n.In = 19)] = "In"));
})(_ || (_ = {}));
function zs(n, e) {
...
var St = class n extends b {
        ...
        isEquivalent(e) {
            return (
                e instanceof n && this.classExpr.isEquivalent(e.classExpr) && ct(this.args, e.args)
            );
        }
        isConstant() {
            return !1;
...
var Pe = class {
        ...
        constructor(e, t, s, r) {
            ((this.input = t),
                (this.errLocation = s),
                (this.ctxLocation = r),
                (this.message = `Parser Error: ${e} ${s} [${t}] in ${r}`));
        }
    },
    J = class {
        start;
...
(function (n) {
    ((n[(n.DEFAULT = 0)] = "DEFAULT"),
        (n[(n.LITERAL_ATTR = 1)] = "LITERAL_ATTR"),
        (n[(n.ANIMATION = 2)] = "ANIMATION"),
        (n[(n.TWO_WAY = 3)] = "TWO_WAY"));
})(vn || (vn = {}));
var wn;
(function (n) {
    ((n[(n.Regular = 0)] = "Regular"),
        (n[(n.Animation = 1)] = "Animation"),
        (n[(n.TwoWay = 2)] = "TwoWay"));
})(wn || (wn = {}));
var U;
(function (n) {
    ((n[(n.Property = 0)] = "Property"),
        (n[(n.Attribute = 1)] = "Attribute"),
        (n[(n.Class = 2)] = "Class"),
        (n[(n.Style = 3)] = "Style"),
        (n[(n.Animation = 4)] = "Animation"),
        (n[(n.TwoWay = 5)] = "TwoWay"));
})(U || (U = {}));
var xn;
(function (n) {
    ((n[(n.RAW_TEXT = 0)] = "RAW_TEXT"),
        (n[(n.ESCAPABLE_RAW_TEXT = 1)] = "ESCAPABLE_RAW_TEXT"),
        (n[(n.PARSABLE_DATA = 2)] = "PARSABLE_DATA"));
})(xn || (xn = {}));
var Js = [/@/, /^\s*$/, /[<>]/, /^[{}]$/, /&(#|[a-z])/i, /^\/\//];
function Ys(n, e) {
...
var cs = "-shadowcsshost",
    Sr = "-shadowcsscontext",
    us = "(?:\\(((?:\\([^)(]*\\)|[^)(]*)+?)\\))",
    ri = new RegExp(cs + us + "?([^,{]*)", "gim"),
    ps = Sr + us + "?([^{]*)",
    ii = new RegExp(`${xr}(${ps})`, "gim"),
    oi = new RegExp(ps, "im"),
    Er = cs + "-no-combinator",
    ai = new RegExp(`${Er}(?![^(]*\\))`, "g");
var hs = "%COMMENT%",
...
var yr = "%COMMA_IN_PLACEHOLDER%",
    _r = "%SEMI_IN_PLACEHOLDER%",
    Cr = "%COLON_IN_PLACEHOLDER%",
    ui = new RegExp(yr, "g"),
    pi = new RegExp(_r, "g"),
    hi = new RegExp(Cr, "g");
var d;
(function (n) {
    ((n[(n.ListEnd = 0)] = "ListEnd"),
        (n[(n.Statement = 1)] = "Statement"),
        (n[(n.Variable = 2)] = "Variable"),
        (n[(n.ElementStart = 3)] = "ElementStart"),
        (n[(n.Element = 4)] = "Element"),
        (n[(n.Template = 5)] = "Template"),
        (n[(n.ElementEnd = 6)] = "ElementEnd"),
        (n[(n.ContainerStart = 7)] = "ContainerStart"),
        (n[(n.Container = 8)] = "Container"),
        (n[(n.ContainerEnd = 9)] = "ContainerEnd"),
        (n[(n.DisableBindings = 10)] = "DisableBindings"),
        (n[(n.ConditionalCreate = 11)] = "ConditionalCreate"),
        (n[(n.ConditionalBranchCreate = 12)] = "ConditionalBranchCreate"),
        (n[(n.Conditional = 13)] = "Conditional"),
        (n[(n.EnableBindings = 14)] = "EnableBindings"),
        (n[(n.Text = 15)] = "Text"),
        (n[(n.Listener = 16)] = "Listener"),
        (n[(n.InterpolateText = 17)] = "InterpolateText"),
        (n[(n.Binding = 18)] = "Binding"),
        (n[(n.Property = 19)] = "Property"),
        (n[(n.StyleProp = 20)] = "StyleProp"),
        (n[(n.ClassProp = 21)] = "ClassProp"),
        (n[(n.StyleMap = 22)] = "StyleMap"),
        (n[(n.ClassMap = 23)] = "ClassMap"),
        (n[(n.Advance = 24)] = "Advance"),
        (n[(n.Pipe = 25)] = "Pipe"),
        (n[(n.Attribute = 26)] = "Attribute"),
        (n[(n.ExtractedAttribute = 27)] = "ExtractedAttribute"),
        (n[(n.Defer = 28)] = "Defer"),
        (n[(n.DeferOn = 29)] = "DeferOn"),
        (n[(n.DeferWhen = 30)] = "DeferWhen"),
        (n[(n.I18nMessage = 31)] = "I18nMessage"),
        (n[(n.DomProperty = 32)] = "DomProperty"),
        (n[(n.Namespace = 33)] = "Namespace"),
        (n[(n.ProjectionDef = 34)] = "ProjectionDef"),
        (n[(n.Projection = 35)] = "Projection"),
        (n[(n.RepeaterCreate = 36)] = "RepeaterCreate"),
        (n[(n.Repeater = 37)] = "Repeater"),
        (n[(n.TwoWayProperty = 38)] = "TwoWayProperty"),
        (n[(n.TwoWayListener = 39)] = "TwoWayListener"),
        (n[(n.DeclareLet = 40)] = "DeclareLet"),
        (n[(n.StoreLet = 41)] = "StoreLet"),
        (n[(n.I18nStart = 42)] = "I18nStart"),
        (n[(n.I18n = 43)] = "I18n"),
        (n[(n.I18nEnd = 44)] = "I18nEnd"),
        (n[(n.I18nExpression = 45)] = "I18nExpression"),
        (n[(n.I18nApply = 46)] = "I18nApply"),
        (n[(n.IcuStart = 47)] = "IcuStart"),
        (n[(n.IcuEnd = 48)] = "IcuEnd"),
        (n[(n.IcuPlaceholder = 49)] = "IcuPlaceholder"),
        (n[(n.I18nContext = 50)] = "I18nContext"),
        (n[(n.I18nAttributes = 51)] = "I18nAttributes"),
        (n[(n.SourceLocation = 52)] = "SourceLocation"));
})(d || (d = {}));
var ge;
(function (n) {
    ((n[(n.LexicalRead = 0)] = "LexicalRead"),
        (n[(n.Context = 1)] = "Context"),
        (n[(n.TrackContext = 2)] = "TrackContext"),
        (n[(n.ReadVariable = 3)] = "ReadVariable"),
        (n[(n.NextContext = 4)] = "NextContext"),
        (n[(n.Reference = 5)] = "Reference"),
        (n[(n.StoreLet = 6)] = "StoreLet"),
        (n[(n.ContextLetReference = 7)] = "ContextLetReference"),
        (n[(n.GetCurrentView = 8)] = "GetCurrentView"),
        (n[(n.RestoreView = 9)] = "RestoreView"),
        (n[(n.ResetView = 10)] = "ResetView"),
        (n[(n.PureFunctionExpr = 11)] = "PureFunctionExpr"),
        (n[(n.PureFunctionParameterExpr = 12)] = "PureFunctionParameterExpr"),
        (n[(n.PipeBinding = 13)] = "PipeBinding"),
        (n[(n.PipeBindingVariadic = 14)] = "PipeBindingVariadic"),
        (n[(n.SafePropertyRead = 15)] = "SafePropertyRead"),
        (n[(n.SafeKeyedRead = 16)] = "SafeKeyedRead"),
        (n[(n.SafeInvokeFunction = 17)] = "SafeInvokeFunction"),
        (n[(n.SafeTernaryExpr = 18)] = "SafeTernaryExpr"),
        (n[(n.EmptyExpr = 19)] = "EmptyExpr"),
        (n[(n.AssignTemporaryExpr = 20)] = "AssignTemporaryExpr"),
        (n[(n.ReadTemporaryExpr = 21)] = "ReadTemporaryExpr"),
        (n[(n.SlotLiteralExpr = 22)] = "SlotLiteralExpr"),
        (n[(n.ConditionalCase = 23)] = "ConditionalCase"),
        (n[(n.ConstCollected = 24)] = "ConstCollected"),
        (n[(n.TwoWayBindingSet = 25)] = "TwoWayBindingSet"));
})(ge || (ge = {}));
var An;
(function (n) {
...
var Pn;
(function (n) {
    ((n[(n.Context = 0)] = "Context"),
        (n[(n.Identifier = 1)] = "Identifier"),
        (n[(n.SavedView = 2)] = "SavedView"),
        (n[(n.Alias = 3)] = "Alias"));
})(Pn || (Pn = {}));
var Ln;
(function (n) {
    ((n[(n.Normal = 0)] = "Normal"),
        (n[(n.TemplateDefinitionBuilder = 1)] = "TemplateDefinitionBuilder"));
})(Ln || (Ln = {}));
var H;
(function (n) {
    ((n[(n.Attribute = 0)] = "Attribute"),
        (n[(n.ClassName = 1)] = "ClassName"),
        (n[(n.StyleProperty = 2)] = "StyleProperty"),
        (n[(n.Property = 3)] = "Property"),
        (n[(n.Template = 4)] = "Template"),
        (n[(n.I18n = 5)] = "I18n"),
        (n[(n.Animation = 6)] = "Animation"),
...
(function (n) {
    ((n[(n.None = 0)] = "None"),
        (n[(n.ElementTag = 1)] = "ElementTag"),
        (n[(n.TemplateTag = 2)] = "TemplateTag"),
        (n[(n.OpenTag = 4)] = "OpenTag"),
        (n[(n.CloseTag = 8)] = "CloseTag"),
        (n[(n.ExpressionIndex = 16)] = "ExpressionIndex"));
})(Rn || (Rn = {}));
var Dn;
(function (n) {
...
(function (n) {
    ((n[(n.Idle = 0)] = "Idle"),
        ...
        (n[(n.Timer = 2)] = "Timer"),
        (n[(n.Hover = 3)] = "Hover"),
        (n[(n.Interaction = 4)] = "Interaction"),
        (n[(n.Viewport = 5)] = "Viewport"),
        (n[(n.Never = 6)] = "Never"));
})(Bn || (Bn = {}));
var On;
(function (n) {
...
var at = class {
    ...
    constructor(e, t, s) {
        if (
            ...
            s.length !== 0 && s.length !== t.length)
        )
            throw new Error(
                `Expected ${t.length} placeholders to match interpolation expression count, but got ${s.length}`
            );
    }
};
...
var Un = class n extends ve {
    ...
    isEquivalent(e) {
        return !(e instanceof n) || e.args.length !== this.args.length
            ? !1
            : e.body !== null &&
                  this.body !== null &&
                  e.body.isEquivalent(this.body) &&
                  e.args.every((t, s) => t.isEquivalent(this.args[s]));
    }
    isConstant() {
        return !1;
    }
    transformInternalExpressions(e, t) {
        this.body !== null
            ? (this.body = (this.body, t | Rt.InChildOperation, void 0))
    ...
    clone() {
        var t, s;
        let e = new n(
            ((t = this.body) == null ? void 0 : t.clone()) ?? null,
...
\r	\v\u1680\u180E\u2000-\u200A\u2028\u2029\u202F\u205F\u3000\uFEFF`,
    Ei = new RegExp(`[^${ds}]`),
    yi = new RegExp(`[${ds}]{2,}`, "g");
var m;
(function (n) {
    ((n[(n.Character = 0)] = "Character"),
        (n[(n.Identifier = 1)] = "Identifier"),
        (n[(n.PrivateIdentifier = 2)] = "PrivateIdentifier"),
        (n[(n.Keyword = 3)] = "Keyword"),
        (n[(n.String = 4)] = "String"),
        (n[(n.Operator = 5)] = "Operator"),
        (n[(n.Number = 6)] = "Number"),
        (n[(n.Error = 7)] = "Error"));
})(m || (m = {}));
var q;
(function (n) {
    ((n[(n.Plain = 0)] = "Plain"),
        (n[(n.TemplateLiteralPart = 1)] = "TemplateLiteralPart"),
        (n[(n.TemplateLiteralEnd = 2)] = "TemplateLiteralEnd"));
})(q || (q = {}));
var Ir = [
        "var",
        "let",
            ...
            for (this.advance(); ; ) {
                if (!z(this.peek))
                    if (this.peek === Ht) {
                        ...
                        if ((this.advance(), Rr(this.peek) && this.advance(), !z(this.peek)))
                ...
                if (this.peek === _n) {
                    ...
                    if ((this.advance(), this.peek === ot))
                        return (
                            ...
                            this.tokens.push(
                                new Ie(e, i, t + this.input.substring(s, i), q.TemplateLiteralPart)
                            ),
                            this.advance(),
    ...
    we = class {
        ...
        parseAction(e, t, s, r = ne) {
            ...
            let i = this._stripComments(e),
                ...
                l = new G(e, t, s, a, 1, this.errors, 0).parseChain();
        ...
        parseInterpolation(e, t, s, r, i = ne) {
            ...
            for (let v = 0; v < l.length; ++v) {
                let E = l[v].text,
                    ...
                    k = new G(e, t, s, T, 0, this.errors, h[v]).parseChain();
                f.push(k);
            }
...
var G = class {
        ...
        sourceSpan(e, t) {
            ...
            return (
                this.sourceSpanCache.has(s) ||
                    this.sourceSpanCache.set(s, this.span(e, t).toAbsolute(this.absoluteOffset)),
        ...
        parseExponentiation() {
            ...
            for (; this.next.type == m.Operator && this.next.strValue === "**"; ) {
                ((t instanceof X || t instanceof Q || t instanceof K || t instanceof Z) &&
                    this.error(
        ...
        parseCallChain() {
            let e = this.inputIndex,
                t = this.parsePrimary();
            for (;;)
                if (this.consumeOptionalCharacter(re)) t = this.parseAccessMember(t, e, !1);
                else if (this.consumeOptionalOperator("?."))
                    this.consumeOptionalCharacter(tt)
                        ? (t = this.parseCall(t, e, !0))
                        : (t = this.consumeOptionalCharacter(nt)
                              ? this.parseKeyedReadOrWrite(t, e, !0)
                              : this.parseAccessMember(t, e, !0));
                    ...
                    t = new Ve(this.span(e), this.sourceSpan(e), t);
            ...
            if (this.consumeOptionalCharacter(tt)) {
                ...
                return (
                    this.consumeOptionalCharacter(se) ||
                        ...
                        this.consumeOptionalCharacter(se)),
                    this.rparensExpected--,
                    new He(this.span(e), this.sourceSpan(e), t)
                );
            } else {
                ...
                if (this.next.isKeywordThis())
                    return (this.advance(), new At(this.span(e), this.sourceSpan(e)));
                if (this.consumeOptionalCharacter(nt)) {
                    ...
                    return (
                        ...
                        new Oe(this.span(e), this.sourceSpan(e), t)
                    );
                } else {
            ...
            if (s)
                this.consumeOptionalOperator("=")
                    ? (this.error("The '?.' operator cannot be used in the assignment"),
                      (l = new P(this.span(t), this.sourceSpan(t))))
                    : (l = new ce(this.span(t), this.sourceSpan(t), a, e, i));
            else if (this.consumeOptionalOperator("=")) {
                if (!(this.parseFlags & 1))
                    return (
                        this.error("Bindings cannot contain assignments"),
                        new P(this.span(t), this.sourceSpan(t))
                    );
            ...
            for (
                ...
                if (s) t.push(s);
                    ...
                    i
                        ? t.push(i)
                        : ((r.source =
                              e.source + r.source.charAt(0).toUpperCase() + r.source.substring(1)),
                          t.push(...this.parseDirectiveKeywordBindings(r)));
                }
        ...
        parseKeyedReadOrWrite(e, t, s) {
            return this.withContext(oe.Writable, () => {
                ...
                if (
                    ...
                    return s
                        ? new ue(this.span(t), this.sourceSpan(t), e, r)
                        : new Re(this.span(t), this.sourceSpan(t), e, r);
        ...
        getDirectiveBoundTarget() {
            ...
            let e = this.parsePipe(),
                { start: t, end: s } = e.span,
                r = this.input.substring(t, s);
        ...
        error(e, t = null) {
            (this.errors.push(new Pe(e, this.input, this.locationText(t), this.location)),
                this.skip());
        }
        locationText(e = null) {
            return (
        ...
        skip() {
            ...
            for (
                ...
                (this.next.isError() &&
                    this.errors.push(
                        new Pe(this.next.toString(), this.input, this.locationText(), this.location)
                    ),
                    this.advance(),
                    (e = this.next));
        }
...
var Fr = new Map(
    ...
    _i = Array.from(Fr).reduce((n, [e, t]) => (n.set(e, t), n), new Map());
...
(function (n) {
    ((n[(n.None = 0)] = "None"),
        (n[(n.ViewContextRead = 1)] = "ViewContextRead"),
        (n[(n.ViewContextWrite = 2)] = "ViewContextWrite"),
        (n[(n.SideEffectful = 4)] = "SideEffectful"));
})(Xn || (Xn = {}));
var Li = new Map([
...
function Wr(n, e) {
    return e[n.start - 1] === "(" && e[n.end] === ")" ? { start: n.start - 1, end: n.end + 1 } : n;
}
function vs(n, e, t) {
    let s = 0,
    ...
    return {
        hasParens: (t ? s - 1 : s) !== 0,
        outerSpan: gs(t ? { start: r.start + 1, end: r.end - 1 } : r, e),
        innerSpan: gs(n, e),
    };
}
function ws(n) {
...
function jr(n, e) {
    let t = e ? qr(n) : null;
    if (t === null) return { text: n, comments: [] };
    let s = { type: "CommentLine", value: n.slice(t + 2), ...ze({ start: t, end: n.length }) };
    return { text: n.slice(0, t), comments: [s] };
}
function Ge(n, e = !0) {
    return (t) => {
        let s = new qe(),
            r = new we(s),
            { text: i, comments: a } = jr(t, e),
            l = n(i, r);
...
var ys = Ge((n, e) => e.parseBinding(n, "", 0)),
    zr = Ge((n, e) => e.parseSimpleBinding(n, "", 0)),
    _s = Ge((n, e) => e.parseAction(n, "", 0)),
    Cs = Ge((n, e) => e.parseInterpolationExpression(n, "", 0)),
    Ts = Ge((n, e) => e.parseTemplateBindings("", n, "", 0, 0), !1);
var Xr = (n, e, t) => {
        if (!(n && e == null))
        ...
        createNode(e, { stripSpaces: t = !0, hasParentParens: s = !1 } = {}) {
            let { type: r, start: i, end: a } = e,
                l = {
                    ...
                    ...this.transformSpan(
                        { start: i, end: a },
                        { stripSpaces: t, hasParentParens: s }
                    ),
                };
            switch (r) {
                case "NumericLiteral":
...
((Ye = new WeakMap()),
    (xe = new WeakMap()),
    (u = new WeakSet()),
    (w = function (t, { stripSpaces: s = !0, hasParentParens: r = !1 } = {}) {
    ...
    (pt = function (t, s) {
        ...
        if (t instanceof A) {
            let { left: i, operation: a, right: l } = t,
        ...
        if (t instanceof Me) {
            let { condition: i, trueExp: a, falseExp: l } = t,
                h = c(this, u, x).call(this, i),
        ...
        if (t instanceof P)
            return c(this, u, w).call(
                this,
                { type: "NGEmptyExpression", ...t.sourceSpan },
                { hasParentParens: r }
            );
        if (t instanceof Y)
            return c(this, u, w).call(
                this,
                { type: "ThisExpression", ...t.sourceSpan },
                { hasParentParens: r }
            );
        if (t instanceof Re || t instanceof ue)
            return c(this, u, Xe).call(this, t.receiver, c(this, u, x).call(this, t.key), {
                computed: !0,
        ...
        if (t instanceof Fe) {
            let { keys: i, values: a } = t,
                ...
                h = i.map(({ key: f, quoted: v }, E) => {
                    let y = l[E],
                        ...
                        ye = { start: F, end: Ee },
                        j = v
                            ? c(this, u, w).call(this, { type: "StringLiteral", value: f, ...ye })
            ...
            return c(this, u, w).call(
                this,
                { type: "ObjectExpression", properties: h, ...t.sourceSpan },
                { hasParentParens: r }
            );
        }
        if (t instanceof I) {
            ...
            switch (typeof i) {
                case "boolean":
                    return c(this, u, w).call(
                        this,
                        { type: "BooleanLiteral", value: i, ...t.sourceSpan },
                        { hasParentParens: r }
                    );
                case "number":
                    return c(this, u, w).call(
                        this,
                        { type: "NumericLiteral", value: i, ...t.sourceSpan },
                        { hasParentParens: r }
                    );
                case "object":
                    return c(this, u, w).call(
                        this,
                        { type: "NullLiteral", ...t.sourceSpan },
                        { hasParentParens: r }
                    );
                case "string":
                    return c(this, u, w).call(
                        this,
                        { type: "StringLiteral", value: i, ...t.sourceSpan },
                        { hasParentParens: r }
                    );
                case "undefined":
                    return c(this, u, w).call(
                        this,
                        { type: "Identifier", name: "undefined", ...t.sourceSpan },
                        { hasParentParens: r }
                    );
                default:
        ...
        if (t instanceof Ve) {
            ...
            return c(this, u, w).call(
                this,
                { type: "TSNonNullExpression", expression: i, start: $(i), end: t.sourceSpan.end },
                { hasParentParens: r }
            );
        }
        if (t instanceof Q || t instanceof K || t instanceof Z) {
            let i =
                t instanceof Q ? "!" : t instanceof K ? "typeof" : t instanceof Z ? "void" : void 0;
        ...
        if (t instanceof le || t instanceof ce) {
            let { receiver: i, name: a } = t,
                l = this.getCharacterLastIndex(/\S/, t.sourceSpan.end - 1) + 1,
                h = c(this, u, w).call(
                    this,
        ...
        if (t instanceof De) {
            let i = c(this, u, x).call(this, t.key),
                a = c(this, u, x).call(this, t.value),
                l = c(this, u, Xe).call(this, t.receiver, i, {
                    computed: !0,
                    optional: !1,
        ...
        if (t instanceof $e) {
            let { receiver: i, name: a, value: l } = t,
        ...
        if (t instanceof de) {
            let { elements: i } = s.parent,
                ...
                l = a === 0,
                h = a === i.length - 1,
                f = t.sourceSpan.end - (h ? 1 : 0),
                v = t.sourceSpan.start + (l ? 1 : 0),
                E = this.text.slice(v, f);
            return c(this, u, w).call(
                this,
                {
                    type: "TemplateElement",
                    value: { cooked: t.text, raw: E },
                    start: v,
                    end: f,
                    tail: h,
                },
...
((Se = new WeakMap()),
    ...
    (Jt = function (t) {
        ...
        let r = s[t.start],
            i = !1;
        for (let a = t.start + 1; a < s.length; a++)
            switch (s[a]) {
                case r:
                    if (!i) {
                        t.end = a + 1;
    ...
    (Ms = function (t) {
        (c(this, g, Jt).call(this, t.key.span),
            Ps(t) && t.value && c(this, g, Jt).call(this, t.value.span));
    }),
    ($s = function (t) {
    ...
    (Rs = function () {
        ...
        return c(this, g, N).call(this, {
            type: "NGMicrosyntax",
            body: i,
            ...(i.length === 0 ? t[0].sourceSpan : { start: i[0].start, end: ut(!1, i, -1).end }),
        });
    }),
    (Ds = function (t, s) {
        if (As(t)) {
...
function Qt(n) {
    var s, r, i;
    let e = ((s = n.range) == null ? void 0 : s[0]) ?? n.start,
        t =
            (i = ((r = n.declaration) == null ? void 0 : r.decorators) ?? n.decorators) == null
                ? void 0
                : i[0];
    ...
    return {
        ...
        parse(e) {
            ...
            return {
                type: "NGRoot",
                node:
                    n === Yt && t.type !== "NGChainedExpression"
                        ? { ...t, type: "NGChainedExpression", expressions: [t] }
                        : t,
            };
        },
        locStart: Qt,
