        ...
        rn = (t, e, s, r) => {
            if ((e && typeof e == "object") || typeof e == "function")
                for (let n of _l(e))
                    !kl.call(t, n) &&
                        n !== s &&
                        Tt(t, n, { get: () => e[n], enumerable: !(r = bl(e, n)) || r.enumerable });
            return t;
        };
    var be = (t, e, s) => (
            (s = t != null ? xl(El(t)) : {}),
            rn(e || !t || !t.__esModule ? Tt(s, "default", { value: t, enumerable: !0 }) : s, t)
        ),
        Sl = (t) => rn(Tt({}, "__esModule", { value: !0 }), t);
    var Oi = g((Rv, is) => {
        var _ = String,
            Ti = function () {
                return {
            ...
            at = class t extends Error {
                ...
                showSourceCode(e) {
                    ...
                    let r = (f) => f,
                        ...
                        i = (f) => f;
                    if (e) {
                        let { bold: f, gray: p, red: l } = Ci.createColors(!0);
                    ...
                    return o.slice(u, a).map((f, p) => {
                        ...
                        if (l === this.line) {
                            if (f.length > 160) {
                                let h = 20,
                                    m = Math.max(0, this.column - h),
                                    y = Math.max(this.column + h, this.endColumn + h),
                                    b = f.slice(m, y),
                                    w =
                                        r(d.replace(/\d/g, " ")) +
                                        f
                                            .slice(0, Math.min(this.column - 1, h - 1))
                                            .replace(/[^\t]/g, " ");
                                return (
                                    n(">") +
                                    r(d) +
...
`,
        ...
        var ut = class {
            ...
            atrule(e, s) {
                ...
                if (
                    (typeof e.raws.afterName < "u" ? (r += e.raws.afterName) : n && (r += " "),
                    e.nodes)
                )
                    this.block(e, r + n);
                else {
...
`) && (s = s.replace(/[^\n]+$/, "")),
            ...
            rawEmptyBody(e) {
                ...
                return (
                    e.walk((r) => {
                        if (r.nodes && r.nodes.length === 0 && ((s = r.raws.after), typeof s < "u"))
                            return !1;
                    }),
                    s
                );
...
`
        ...
        var ft = class {
            ...
            addToError(e) {
                if (
                    ((e.postcssNode = this), e.stack && this.source && /\n\s{4}at /.test(e.stack))
                ) {
                    let s = this.source;
            ...
            positionBy(e = {}) {
                ...
                if (e.index) s = this.positionInside(e.index);
                    ...
                    let r =
                        ...
                        i = r.slice(J(r, this.source.start), J(r, this.source.end)).indexOf(e.word);
...
`
            ...
            rangeBy(e = {}) {
                ...
                if (e.word) {
                    ...
                    (e.start
                        ...
                        e.end
                            ? (n = { column: e.end.column, line: e.end.line, offset: J(s, e.end) })
                            : typeof e.endIndex == "number"
                              ? (n = this.positionInside(e.endIndex))
                              : e.index && (n = this.positionInside(e.index + 1)));
                return (
                    (n.line < r.line || (n.line === r.line && n.column <= r.column)) &&
                        (n = { column: r.column + 1, line: r.line, offset: r.offset + 1 }),
                    { end: n, start: r }
                );
            }
            raw(e, s) {
            ...
            toJSON(e, s) {
                ...
                for (let o in this) {
                    ...
                    if (Array.isArray(u))
                        r[o] = u.map((a) =>
                            typeof a == "object" && a.toJSON ? a.toJSON(null, s) : a
                        );
    ...
    var le = g((Wv, Vi) => {
        ...
        function Yi(t) {
            if (((t[Ui] = !1), t.proxyOf.nodes)) for (let e of t.proxyOf.nodes) Yi(e);
        }
        var V = class t extends Ic {
            get first() {
        ...
        V.rebuild = (t) => {
            (t.type === "atrule"
                ? Object.setPrototypeOf(t, cs.prototype)
                : t.type === "rule"
                  ? Object.setPrototypeOf(t, fs.prototype)
                  : t.type === "decl"
                    ? Object.setPrototypeOf(t, Bi.prototype)
                    : t.type === "comment"
                      ? Object.setPrototypeOf(t, Mi.prototype)
                      : t.type === "root" && Object.setPrototypeOf(t, Wi.prototype),
                (t[Fi] = !0),
                t.nodes &&
                    t.nodes.forEach((e) => {
                        V.rebuild(e);
    ...
    var Hi = g((Gv, zi) => {
        var qc = "useandom-26T198340PX75pxJACKVERYMINDBUSHWOLF_GQZbfghjklqvwyzrict",
            Lc =
                (t, e = 21) =>
                (s = e) => {
                    let r = "",
    ...
    var De = g((jv, eo) => {
        "use strict";
        var { nanoid: Mc } = Hi(),
            { isAbsolute: ms, resolve: ys } = {},
            { SourceMapConsumer: Bc, SourceMapGenerator: Uc } = ji(),
            { fileURLToPath: Qi, pathToFileURL: Ht } = {},
            Xi = Yt(),
            Fc = ps(),
            hs = os(),
            ds = Symbol("lineToIndexCache"),
            $c = !!(Bc && Uc),
            Ji = !!(ys && ms);
        function Zi(t) {
            if (t[ds]) return t[ds];
...
`),
        ...
        var Le = class {
            ...
            constructor(e, s = {}) {
                ...
                (this.file || (this.id = "<input css " + Mc(6) + ">"),
            ...
            error(e, s, r, n = {}) {
                ...
                if (s && typeof s == "object") {
                    ...
                    if (typeof l.offset == "number") {
                        ...
                        ((o = l.line),
                            (i = l.column),
                            (u = this.fromLineAndColumn(l.line, l.column)));
                ...
                return (
                    f
                        ? (c = new Xi(
                              e,
                              f.endLine === void 0 ? f.line : { column: f.column, line: f.line },
                              f.endLine === void 0
                                  ? f.column
                                  : { column: f.endColumn, line: f.endLine },
                              f.source,
                              f.file,
                              n.plugin
                          ))
                    ...
                    this.file &&
                        (Ht && (c.input.url = Ht(this.file).toString()),
    ...
    var Be = g((Qv, oo) => {
        ...
        var so = le(),
            ...
            ce = class extends so {
                ...
                toResult(e = {}) {
                    return new no(new io(), this, e).stringify();
                }
            };
        ...
        fo.exports = function (e, s = {}) {
            ...
            function F(W) {
                ...
                switch (((i = r.charCodeAt(m)), i)) {
                    ...
                    default: {
                        i === 47 && r.charCodeAt(m + 1) === 42
                            ? ((a = r.indexOf("*/", m + 2) + 1),
                              a === 0 && (n || T ? (a = r.length) : v("comment")),
                              (f = ["comment", r.slice(m, a + 1), m, a]),
                              (m = a))
                            : ((Xt.lastIndex = m + 1),
                              Xt.test(r),
                              Xt.lastIndex === 0 ? (a = r.length - 1) : (a = Xt.lastIndex - 2),
                              (f = ["word", r.slice(m, a + 1), m, a]),
                              y.push(f),
                              (m = a));
                        break;
                    }
            ...
            return { back: Q, endOfFile: R, nextToken: F, position: w };
        };
    });
    var Zt = g((ex, mo) => {
        "use strict";
        ...
        var ws = class {
                ...
                for (; !this.tokenizer.endOfFile(); ) {
                    if (
                        ...
                        if (r === ";") {
                            ...
                            if (a.length > 0) {
                                for (i = a.length - 1, n = a[i]; n && n[0] === "space"; )
                                    n = a[--i];
                                n &&
            ...
            decl(e, s) {
                ...
                for (
                    n[0] === ";" && ((this.semicolon = !0), e.pop()),
                        r.source.end = this.getPosition(n[3] || n[2] || Kc(e)),
                        r.source.end.offset++;
                    e[0][0] !== "word";
                ...
                if (
                    ...
                    if (!u)
                        for (
                            ;
                            a.length &&
                            ((c = a[a.length - 1][0]), !(c !== "space" && c !== "comment"));
            ...
            spacesAndCommentsFromEnd(e) {
                ...
                for (
                    ;
                    e.length && ((s = e[e.length - 1][0]), !(s !== "space" && s !== "comment"));
...
`)
                    ...
                    return (
                        ...
                        n && ((this.input = new ef(n)), (this.tokenizer = Zc(this.input))),
                        !0
                    );
                } else if (t[1] === "/") {
                    ...
                    if (e[0] === "comment" && /^\/\*/.test(e[1]))
                        return (
                            ...
                            vs.exports.isInlineComment.bind(this)(t)
                        );
                }
                return !1;
            },
    ...
    var bo = g((nx, xo) => {
        var tf = /^#[0-9a-fA-F]{6}$|^#[0-9a-fA-F]{3}$/,
            rf = /\.[0-9]/,
            sf = (t) => {
                let [, e] = t,
                    [s] = e;
                return (s === "." || s === "#") && tf.test(e) === !1 && rf.test(e) === !1;
            };
        xo.exports = { isMixinToken: sf };
    });
    var Eo = g((ix, _o) => {
        var nf = Jt(),
            of = /^url\((.+)\)/;
    ...
    var No = g((ux, Ao) => {
        var af = qe(),
            uf = Zt(),
            { isInlineComment: lf } = go(),
            { interpolation: Co } = vo(),
            { isMixinToken: cf } = bo(),
            ff = Eo(),
            pf = Oo(),
            hf = /(!\s*important)$/i;
        Ao.exports = class extends uf {
            constructor(...e) {
            ...
            mixin(e) {
                ...
                if ((n < 0 || n > 3) && i > 0) {
                    let c = e.reduce((w, v, R) => (v[0] === ")" ? R : w)),
                        ...
                        [x] = e.slice(c, c + 1),
                        h = [x[2], x[3]],
                        m = ["brackets", p].concat(d, h),
                        y = e.slice(0, i),
                        b = e.slice(c + 1);
                    ((e = y), e.push(m), (e = e.concat(b)));
                }
                let u = [];
                for (let c of e)
                    if (((c[1] === "!" || u.length) && u.push(c), c[1] === "important")) break;
                if (u.length) {
                    let [c] = u,
                        f = e.indexOf(c),
                        p = u[u.length - 1],
                        l = [c[2], c[3]],
                        d = [p[4], p[5]],
                        h = ["word", u.map((m) => m[1]).join("")].concat(l, d);
            ...
            rule(e) {
                ...
                if (
                    r[0] === "at-word" &&
                    s[0] === "{" &&
                    (this.tokenizer.back(s), Co.bind(this)(r))
                ) {
            ...
            parse(t, e) {
                ...
                return (
                    ...
                    r.root.walk((n) => {
                        ...
                        if (
                            ((n.source.start = { offset: o, line: u.line, column: u.col }),
                            n.source.end)
                        ) {
    ...
    var tr = g((px, Do) => {
        ...
        var wf = le(),
            ...
            ge = class extends wf {
                ...
                toResult(e = {}) {
                    return new qo(new Lo(), this, e).stringify();
                }
            };
        ge.registerLazyResult = (t) => {
            qo = t;
        };
        ge.registerProcessor = (t) => {
            Lo = t;
        };
        Do.exports = ge;
        ge.default = ge;
    ...
    var Ts = g((xx, Ho) => {
        ...
        var Of = le(),
            ...
            Df = { Once: !0, postcssPlugin: !0, prepare: !0 },
            Fe = 0;
        function bt(t) {
        ...
        function ks(t) {
            return ((t[K] = !1), t.nodes && t.nodes.forEach((e) => ks(e)), t);
        }
        var Ss = {},
            fe = class t {
                get content() {
                ...
                constructor(e, s, r) {
                    ...
                    if (
                        ...
                        n = ks(s);
                    else if (s instanceof t || s instanceof Yo)
                        ((n = ks(s.root)),
                            s.map &&
                    ...
                    ((this.result = new Yo(e, n, r)),
                        (this.helpers = { ...Ss, postcss: Ss, result: this.result }),
                ...
                visitTick(e) {
                    ...
                    for (; s.eventIndex < i.length; ) {
                        ...
                        if (((s.eventIndex += 1), o === Fe)) {
                            r.nodes &&
                                r.nodes.length &&
                                ((r[K] = !0), (s.iterator = r.getIterator()));
                            return;
...
https://evilmartians.com/chronicles/postcss-8-plugin-migration`
        ...
        k.fromJSON = Hf;
        k.list = Qf;
        k.comment = (t) => new Zo(t);
        k.atRule = (t) => new Jo(t);
        k.decl = (t) => new ea(t);
        k.rule = (t) => new sa(t);
        k.root = (t) => new ra(t);
        k.document = (t) => new ta(t);
        k.CssSyntaxError = zf;
        k.Declaration = ea;
        k.Container = Vf;
        k.Processor = Os;
    ...
    var la = g((Tx, ua) => {
        ...
        ua.exports = function (e, s = {}) {
            ...
            return { back: W, endOfFile: R, nextToken: Q, position: w };
        };
    });
    var fa = g((Ox, ca) => {
        var { Comment: np } = sr(),
...
`)
    ...
    var Is = g((Rs) => {
        ...
        Et.prototype = Object.create(ma.default.prototype);
        ...
        Et.prototype.walk = function (e, s) {
            for (
                ...
                var u = this.nodes[o],
                    a = r ? i.test(u.type) : !0;
                if ((a && n && n(u, o, this.nodes) === !1) || (u.nodes && u.walk(e, s) === !1))
                    return !1;
            }
            return !0;
        };
                ...
                if (
                    ((p === "'" || p === '"') &&
                        (s[n].isCalculationEnabled === !0
                            ? (s.push({ mode: "string", isCalculationEnabled: !1, character: p }),
                              n++)
                            : s[n].mode === "string" &&
                              s[n].character === p &&
                              c[f - 1] !== "\\" &&
                ...
                (n
                    ...
                    n &&
                        ...
                        i.type === "media-feature-expression" &&
                            (i.nodes = wa(i.value, i.sourceIndex)),
                        s.push(Array.isArray(i.nodes) ? new qs.default(i) : new ya.default(i)),
                        (i = o()),
                        (n = !1)));
            }
    ...
    var xa = g((Ds) => {
        ...
        function bp(t) {
            return new wp.default({
                nodes: (0, vp.parseMediaList)(t),
    ...
    var M = g((B) => {
        ...
        var Fx = (B.TAG = "tag"),
            $x = (B.STRING = "string"),
            Wx = (B.SELECTOR = "selector"),
            Gx = (B.ROOT = "root"),
            Yx = (B.PSEUDO = "pseudo"),
            Vx = (B.NESTING = "nesting"),
            zx = (B.ID = "id"),
            Hx = (B.COMMENT = "comment"),
            jx = (B.COMBINATOR = "combinator"),
            Kx = (B.CLASS = "class"),
            Qx = (B.ATTRIBUTE = "attribute"),
            Xx = (B.UNIVERSAL = "universal");
    });
    var lr = g((ur, Ca) => {
        "use strict";
        ur.__esModule = !0;
            ...
            return (
                ...
                (e.prototype.insertAfter = function (r, n) {
                    ...
                    for (var u in this.indexes)
                        ((o = this.indexes[u]),
                            i <= o && (this.indexes[u] = o + this.nodes.length));
                    return this;
                }),
                ...
                (e.prototype.walkAttributes = function (r) {
                    ...
                    return this.walk(function (i) {
                        if (i.type === ee.ATTRIBUTE) return r.call(n, i);
                    });
                }),
                (e.prototype.walkClasses = function (r) {
                    var n = this;
                    return this.walk(function (i) {
                        if (i.type === ee.CLASS) return r.call(n, i);
                    });
                }),
                (e.prototype.walkCombinators = function (r) {
                    var n = this;
                    return this.walk(function (i) {
                        if (i.type === ee.COMBINATOR) return r.call(n, i);
                    });
                }),
                (e.prototype.walkComments = function (r) {
                    var n = this;
                    return this.walk(function (i) {
                        if (i.type === ee.COMMENT) return r.call(n, i);
                    });
                }),
                (e.prototype.walkIds = function (r) {
                    var n = this;
                    return this.walk(function (i) {
                        if (i.type === ee.ID) return r.call(n, i);
                    });
                }),
                (e.prototype.walkNesting = function (r) {
                    var n = this;
                    return this.walk(function (i) {
                        if (i.type === ee.NESTING) return r.call(n, i);
                    });
                }),
                (e.prototype.walkPseudos = function (r) {
                    var n = this;
                    return this.walk(function (i) {
                        if (i.type === ee.PSEUDO) return r.call(n, i);
                    });
                }),
                (e.prototype.walkTags = function (r) {
                    var n = this;
                    return this.walk(function (i) {
                        if (i.type === ee.TAG) return r.call(n, i);
                    });
                }),
                (e.prototype.walkUniversals = function (r) {
                    var n = this;
                    return this.walk(function (i) {
                        if (i.type === ee.UNIVERSAL) return r.call(n, i);
                    });
                }),
                (e.prototype.split = function (r) {
                    ...
                    return this.reduce(function (o, u, a) {
                        ...
                        return (
                            i.push(u),
                            c ? (o.push(i), (i = [])) : a === n.length - 1 && o.push(i),
                            o
                        );
                    }, []);
                }),
            ...
            for (
                var e = [],
                    ...
                    b = function (v, R) {
                        ...
                        else throw t.error("Unclosed " + v, m, y - h, y);
                    };
                y < x;

            ) {
                switch (((r = s.charCodeAt(y)), r === St && ((h = y), (m += 1)), r)) {
                    case St:
                    case Ws:
                    case Ys:
                    case Vs:
                    case Gs:
                        n = y;
                        do ((n += 1), (r = s.charCodeAt(n)), r === St && ((h = n), (m += 1)));
                        while (r === Ws || r === St || r === Ys || r === Vs || r === Gs);
                        (e.push(["space", s.slice(y, n), m, y - h, y]), (y = n - 1));
                        break;
                    case nu:
                    case iu:
                    case ou:
                    case au:
                        ...
                        while (r === nu || r === iu || r === ou || r === au);
                        (e.push(["combinator", s.slice(y, n), m, y - h, y]), (y = n - 1));
                        break;
                    case uu:
                        e.push(["*", "*", m, y - h, y]);
                        break;
                    ...
                    case Md:
                        ...
                        do
                            for (
                                l = !1, n = s.indexOf(i, n + 1), n === -1 && b("quote", i), d = n;
                                s.charCodeAt(d - 1) === $s;

                            )
                                ((d -= 1), (l = !l));
                        while (l);
                        (e.push(["string", s.slice(y, n + 1), m, y - h, m, n - h, y]), (y = n));
                        break;
                    case zd:
                        ((kr.lastIndex = y + 1),
                            kr.test(s),
                            kr.lastIndex === 0 ? (n = s.length - 1) : (n = kr.lastIndex - 2),
                            e.push(["at-word", s.slice(y, n + 1), m, y - h, m, n - h, y]),
                            (y = n));
                        break;
                    case $s:
                        for (n = y, c = !0; s.charCodeAt(n + 1) === $s; ) ((n += 1), (c = !c));
                        ((r = s.charCodeAt(n + 1)),
                            c &&
                                r !== su &&
                                r !== Ws &&
                                ...
                                r !== Gs &&
                                (n += 1),
                            e.push(["word", s.slice(y, n + 1), m, y - h, m, n - h, y]),
                            (y = n));
                        break;
                    default:
                        r === su && s.charCodeAt(y + 1) === uu
                            ? ((n = s.indexOf("*/", y + 2) + 1),
                              n === 0 && b("comment", "*/"),
                              (a = s.slice(y, n + 1)),
                              (o = a.split(`
`)),
                              (u = o.length - 1),
                              u > 0 ? ((f = m + u), (p = n - o[u].length)) : ((f = m), (p = h)),
                              e.push(["comment", a, m, y - h, f, n - p, y]),
                              (h = p),
                              (m = f),
                              (y = n))
                            : ((Sr.lastIndex = y + 1),
                              Sr.test(s),
                              Sr.lastIndex === 0 ? (n = s.length - 1) : (n = Sr.lastIndex - 2),
                              e.push(["word", s.slice(y, n + 1), m, y - h, m, n - h, y]),
                              (y = n));
                        break;
                }
        ...
        var Nm = (function () {
            function t(e) {
                (Am(this, t),
                    ...
                    (this.position = 0),
                    (this.root = new tm.default()));
                var s = new Hs.default();
                return (
                    this.root.append(s),
                    (this.current = s),
                    this.lossy
                        ? (this.tokens = (0, fu.default)({ safe: e.safe, css: e.css.trim() }))
                        : (this.tokens = (0, fu.default)(e)),
                    this.loop()
                );
            }
            return (
                (t.prototype.attribute = function () {
                    ...
                    if (
                        ...
                        ((r.value = this.lossy ? c : a[0]),
                            a[1] &&
                                ((r.insensitive = !0), this.lossy || (r.raws.insensitive = a[1])),
                            (r.quoted = c[0] === "'" || c[0] === '"'),
                ...
                (t.prototype.splitWord = function (s, r) {
                    for (
                        ...
                        if (((o += u), u.lastIndexOf("\\") === u.length - 1)) {
                            ...
                            a &&
                                a[0] === "space" &&
                                ((o += this.parseSpace(a[1], " ")), this.position++);
                        }
                        i = this.nextToken;
                    }
                    var c = (0, zs.default)(o, "."),
                        f = (0, zs.default)(o, "#"),
                        p = (0, zs.default)(o, "#{");
                    p.length &&
                    ...
                    (l.forEach(function (d, x) {
                        ...
                        (~c.indexOf(d)
                            ? (y = new nm.default({
                                  value: m.slice(1),
                                  source: {
                                      start: { line: n.currToken[2], column: n.currToken[3] + d },
                                      end: {
                                          line: n.currToken[4],
        ...
        Qu.exports = function (e, s) {
            ...
            for (; a < i; ) {
                switch (((p = n.charCodeAt(a)), p === 10 && ((o = a), (u += 1)), p)) {
                    ...
                    case 58:
                        ((l = a + 1),
                            r.push(["colon", n.slice(a, l), u, a - o, u, l - o, a]),
                            (a = l - 1));
                        break;
                    case 44:
                        ((l = a + 1),
                            r.push(["comma", n.slice(a, l), u, a - o, u, l - o, a]),
                            (a = l - 1));
                        break;
                    case 123:
                    ...
                    case 34:
                        ...
                        do
                            for (
                                v = !1, l = n.indexOf(d, l + 1), l === -1 && Q("quote", d), R = l;
                                n.charCodeAt(R - 1) === 92;
                    ...
                    case 64:
                        ((Fr.lastIndex = a + 1),
                            Fr.test(n),
                            Fr.lastIndex === 0 ? (l = n.length - 1) : (l = Fr.lastIndex - 2),
                    ...
                    case 42:
                        ...
                        if (p === 45 && F.charCodeAt(0) === 45) {
                            (l++,
                                r.push(["word", n.slice(a, l), u, a - o, u, l - o, a]),
                                (a = l - 1));
                            break;
                        }
...
`)),
                                ...
                                r.push(["comment", m, u, a - o, b, l - w, a]),
                                (o = w),
                                (u = b),
                                (a = l));
                        } else if (p === 35 && !oy.test(n.slice(a + 1, a + 2)))
                            ((l = a + 1),
                                r.push(["#", n.slice(a, l), u, a - o, u, l - o, a]),
                                (a = l - 1));
                        else if ((p === 117 || p === 85) && n.charCodeAt(a + 1) === 43) {
                            l = a + 2;
                            do ((l += 1), (p = n.charCodeAt(l)));
                            while (l < i && ay.test(n.slice(l, l + 1)));
                            (r.push(["unicoderange", n.slice(a, l), u, a - o, u, l - o, a]),
                                (a = l - 1));
                        } else if (p === 47)
                            ((l = a + 1),
                                r.push(["operator", n.slice(a, l), u, a - o, u, l - o, a]),
                                (a = l - 1));
                        else {
                            let O = iy;
                            if (
    ...
    var $y = {};
    tn($y, { languages: () => Ei, options: () => Si, parsers: () => Zs, printers: () => Fy });
    var Tl = (t, e, s, r) => {
            if (!(t && e == null))
                return e.replaceAll
                    ? e.replaceAll(s, r)
    ...
    var _e = "string",
        ...
        Ke = "label",
        Se = "break-parent",
        Ot = new Set([Ve, re, Ee, ze, se, ne, ie, He, ke, je, H, Ke, Se]);
    var Ol = (t, e, s) => {
            if (!(t && e == null))
...
Expected it to be 'string' or 'object'.`;
        if (j(t)) throw new Error("doc is valid.");
...
Expected it to be ${r}.`;
    ...
    function Il(t) {
        return t.type === H && !t.hard ? (t.soft ? "" : " ") : t.type === ie ? t.flatContents : t;
    }
    function sn(t) {
        return Rl(t, Il);
    }
    var Vr = () => {},
        ...
        nn = Vr;
    function q(t) {
        return (oe(t), { type: re, contents: t });
    }
    function on(t, e) {
        return (oe(e), { type: Ee, contents: e, n: t });
    }
    function L(t, e = {}) {
        return (
            oe(t),
            Qe(e.expandedStates, !0),
            {
                type: se,
                id: e.id,
                contents: t,
    ...
    function an(t) {
        return on({ type: "root" }, t);
    }
    function ae(t) {
        return on(-1, t);
    }
    function Te(t) {
        return (nn(t), { type: ne, parts: t });
    }
    function Ct(t, e = "", s = {}) {
        return (
            oe(t),
            e !== "" && oe(e),
            { type: ie, breakContents: t, flatContents: e, groupId: s.groupId }
        );
    }
    function un(t) {
        return (oe(t), { type: ke, contents: t });
    }
    var Xe = { type: Se };
    var ql = { type: H, hard: !0 };
    var A = { type: H },
        D = { type: H, soft: !0 },
        S = [ql, Xe];
    function G(t, e) {
    ...
    var ue = Ll;
    var ln = new Proxy(() => {}, { get: () => ln }),
        cn = ln;
    var At = "'",
        fn = '"';
    function Dl(t, e) {
        let s = e === !0 || e === At ? At : fn,
            r = s === At ? fn : At,
            n = 0,
            i = 0;
            ...
            r =
                ...
                (e.parser === "json5" && e.quoteProps === "preserve" && !e.singleQuote)
                    ...
                    : e.__isInHtmlAttribute
                      ? "'"
                      : pn(s, e.singleQuote);
        return t.charAt(0) === r ? t : hn(s, r, !1);
    }
    var Nt = Bl;
    ...
    function mn(t, e, s) {
        if (
            (Oe(t) && t.language === "yaml" && delete e.value,
            t.type === "css-comment" &&
                s.type === "css-root" &&
                s.nodes.length > 0 &&
                (((s.nodes[0] === t || (Oe(s.nodes[0]) && s.nodes[1] === t)) &&
        ...
        if (
            ...
            t.type === "selector-attribute" &&
                ...
                t.value &&
                    ((e.value = E(!1, e.value.trim(), /^["']|["']$/gu, "")), delete e.quoted)),
            (t.type === "media-value" ||
                t.type === "media-type" ||
                t.type === "value-number" ||
                t.type === "selector-root-invalid" ||
    ...
    async function Wl(t, e) {
        if (t.language === "yaml") {
            ...
            return an([t.startDelimiter, t.explicitLanguage, S, r, r ? S : "", t.endDelimiter]);
        }
    }
    var gn = Wl;
    function wn(t) {
    ...
    wn.getVisitorKeys = (t) => (t.type === "css-root" ? ["frontMatter"] : []);
    var vn = wn;
    var Je = null;
    function Ze(t) {
...
`,
    ...
    function Sn(t, e) {
        ...
        if (typeof t.sourceIndex == "number")
            return t.type === "value-word" ? kn(t, t.sourceIndex) : t.sourceIndex;
    ...
    function Kr(t, e) {
        ...
        if (
            typeof ((r = (s = t.source) == null ? void 0 : s.end) == null ? void 0 : r.offset) ==
            "number"
        )
            return t.source.end.offset;
        if (t.source) {
            if (t.source.end) {
                let n = jr(t.source.end, e);
                return t.type === "value-word" ? kn(t, n) : n;
            }
            if (ue(t.nodes)) return Kr($(!1, t.nodes, -1), e);
        }
        return null;
    }
    function Qr(t, e) {
        t.source && ((t.source.startOffset = Sn(t, e)), (t.source.endOffset = Kr(t, e)));
        for (let s in t) {
            let r = t[s];
            s === "source" ||
                !r ||
                ...
                (r.type === "value-root" || r.type === "value-unknown"
                    ? Tn(r, jl(t), r.text || r.value)
                    : Qr(r, e));
        }
    }
    function Tn(t, e, s) {
        t.source && ((t.source.startOffset = Sn(t, s) + e), (t.source.endOffset = Kr(t, s) + e));
        for (let r in t) {
            let n = t[r];
            r === "source" || !n || typeof n != "object" || Tn(n, e, s);
        }
    }
    function jl(t) {
        var s;
...
` ||
    ...
    function Ln(t) {
        let e = `
`;
        t = E(!1, t.replace(Ql, "").replace(Kl, ""), Zl, "$1");
        let s = "";
        for (; s !== t; ) ((s = t), (t = E(!1, t, Jl, `${e}$1 $2${e}`)));
        t = t.replace(Cn, "").trimEnd();
        let r = Object.create(null),
            n = E(!1, t, An, "").replace(Cn, "").trimEnd(),
            i;
        for (; (i = An.exec(t)); ) {
            let o = E(!1, i[2], Xl, "");
            if (typeof r[i[1]] == "string" || Array.isArray(r[i[1]])) {
                let u = r[i[1]];
                r[i[1]] = [...Rn, ...(Array.isArray(u) ? u : [u]), o];
            } else r[i[1]] = o;
        }
        return { comments: n, pragmas: r };
    }
    function Dn({ comments: t = "", pragmas: e = {} }) {
        let s = `
`,
            r = "/**",
            n = " *",
    ...
    function Nn(t, e) {
        return [...Rn, ...(Array.isArray(e) ? e : [e])].map((s) => `@${t} ${s}`.trim());
    }
    var Mn = ["noformat", "noprettier"],
        Bn = ["format", "prettier"],
        Un = "format";
    function ec(t) {
...
`);
    ...
    function Xr(t) {
        ...
        let s = In(t),
            { pragmas: r, comments: n } = Ln(s);
        return { shebang: e, text: t, pragmas: r, comments: n };
    }
    function $n(t) {
        let { pragmas: e } = Xr(t);
        return Bn.some((s) => Object.prototype.hasOwnProperty.call(e, s));
    }
    function Wn(t) {
        let { pragmas: e } = Xr(t);
    ...
    function Gn(t) {
        let { shebang: e, text: s, pragmas: r, comments: n } = Xr(t),
            i = qn(s),
            o = Dn({ pragmas: { [Un]: "", ...r }, comments: n.trimStart() });
        return (
            (e
                ? `${e}
`
...
...`,
    ...
    var Ce = rc;
    function Yn(t) {
        return $n(Ce(t).content);
    }
    function Vn(t) {
        return Wn(Ce(t).content);
    }
    function zn(t) {
        let { frontMatter: e, content: s } = Ce(t);
        return (
            (e
                ? e.raw +
                  `
...
`
    ...
    function Hn(t) {
        var e, s;
        return (s = (e = t.findAncestor((r) => r.type === "css-decl")) == null ? void 0 : e.prop) ==
            null
            ? void 0
            : s.toLowerCase();
    }
    var nc = new Set(["initial", "inherit", "unset", "revert"]);
    function jn(t) {
    ...
    function Xn(t) {
        ...
        return (
            ...
            e.groups.length === 2 &&
            ((s = t.findAncestor((r) => r.type === "css-atrule")) == null ? void 0 : s.name) ===
                "import"
        );
    }
    function Jn(t) {
    ...
    function Lt(t) {
        return qt(t) || tt(t) || X(t) || de(t) || ic(t);
    }
    function ni(t) {
    ...
    function Mt(t) {
        ...
        return (
            t.type === "value-comma_group" &&
            ((s = (e = t.groups) == null ? void 0 : e[1]) == null ? void 0 : s.type) ===
                "value-colon"
        );
    }
    function Jr(t) {
    ...
    function ci(t, e) {
        ...
        let { groups: s } = e,
            r = s.indexOf(t);
        return r === -1 ? !1 : nt(s[r + 1]);
    }
    function fi(t) {
        return t.value && ["not", "and", "or"].includes(t.value.toLowerCase());
    }
    function pi(t) {
        return t.type !== "value-func" ? !1 : sc.has(t.value.toLowerCase());
    }
    function Re(t) {
    ...
    function oc(t, e, s) {
        ...
        let { node: r } = t,
            ...
            a = t.findAncestor((y) => y.type === "css-atrule"),
            c = a && rt(a, e),
            f = r.groups.some((y) => Pe(y)),
            p = t.map(s, "groups"),
            l = [""],
            d = Ne(t, "url"),
            x = !1,
            h = !1;
        for (let y = 0; y < r.groups.length; ++y) {
            let b = r.groups[y - 1],
                w = r.groups[y],
                v = r.groups[y + 1],
                R = r.groups[y + 2];
            ...
            if ((l.push([l.pop(), p[y]]), d)) {
                ((v && X(v)) || X(w)) && l.push([l.pop(), " "]);
                continue;
            }
            if (
                (nt(v) &&
                    w.type === "value-word" &&
                    l.length > 2 &&
                    r.groups.slice(0, y).every((C) => C.type === "value-comment") &&
                    !Pe(b) &&
                    (l[l.length - 2] = ae($(!1, l, -2))),
                (he(t, "forward") &&
                    w.type === "value-word" &&
                    w.value &&
                    b !== void 0 &&
                    ...
                    (he(t, "utility") &&
                        ...
                        v.value === "*") ||
                    !v ||
                    (w.type === "value-word" && it(v) && P(w) === N(v)))
            )
                continue;
            if (w.type === "value-string" && w.quoted) {
                let C = w.value.lastIndexOf("#{"),
                    xe = w.value.lastIndexOf("}");
                C !== -1 && xe !== -1 ? (x = C > xe) : C !== -1 ? (x = !0) : xe !== -1 && (x = !1);
            }
            if (
                x ||
                nt(w) ||
            ...
            if (
                (((F && Bt(v)) || (Q && Ut(w))) && me(v)) ||
                (!b && tt(w)) ||
                (Ne(t, "calc") && (X(w) || X(v) || de(w) || de(v)) && me(v))
            )
                continue;
            let W =
                    (X(w) || de(w)) &&
            ...
            if (
                ...
                if (
                    ...
                    if (it(w) && ot(v) && P(w) === N(v.open)) {
                        l.push(D, "");
                        continue;
                    }
                    if (w.value === "with" && ot(v)) {
                        l = [[Te(l), " "]];
                        continue;
                    }
                    ((m = w.value) != null && m.endsWith("#") && v.value === "{" && ot(v.group)) ||
                        (Pe(v) && !R) ||
                        l.push(A, "");
                }
            }
    ...
    function rs(t) {
        let e = t.toLowerCase();
        return Ft.has(e) ? Ft.get(e) : t;
    }
    var yi = /(["'])(?:(?!\1)[^\\]|\\.)*\1/gsu,
        uc = /(?:\d*\.\d+|\d+\.?)(?:e[+-]?\d+)?/giu,
        lc = /[a-z]+/giu,
        cc = /[$@]?[_a-z\u0080-\uFFFF][\w\u0080-\uFFFF-]*/giu,
        fc = new RegExp(yi.source + `|(${cc.source})?(${uc.source})(${lc.source})?`, "giu");
    function Y(t, e) {
        return E(!1, t, yi, (s) => Nt(s, e));
    }
    function gi(t, e) {
        let s = e.singleQuote ? "'" : '"';
    ...
    function ye(t) {
        return E(!1, t, fc, (e, s, r, n, i) =>
            !r && n && (i ?? (i = ""), (i = i.toLowerCase()), !i || i === "n" || Ft.has(i))
                ? ss(n) + (i ? rs(i) : "")
                : e
        );
    }
...
` ||
    ...
    function yc(t, e) {
        let s = null,
            r = e;
        for (; r !== s; ) ((s = r), (r = En(t, r)), (r = vi(t, r)), (r = Rt(t, r)));
        return ((r = xi(t, r)), (r = $t(t, r)), r !== !1 && Wt(t, r));
    }
    var Gt = yc;
    ...
    function wc(t, e) {
        return Zn(t.grandparent) && gc(t, e)
            ? ","
    ...
    function bi(t, e, s) {
        let { node: r, parent: n } = t,
            i = t.map(({ node: d }) => (typeof d == "string" ? d : s()), "groups");
        if (
            n &&
            Jn(n) &&
            (r.groups.length === 1 ||
            ...
            return [r.open ? s("open") : "", G(",", i), r.close ? s("close") : ""];
        if (!r.open) {
            let d = ns(t);
            Qe(i);
            let x = xc(G(",", i), 2),
                h = G(d ? S : A, x);
            return q(d ? [S, h] : L([vc(t) ? D : "", Te(h)]));
        }
        let o = t.map(({ node: d, isLast: x, index: h }) => {
                var b;
                let m = i[h];
                Mt(d) &&
                    d.type === "value-comma_group" &&
                    d.groups &&
                    d.groups[0].type !== "value-paren_group" &&
                    ((b = d.groups[2]) == null ? void 0 : b.type) === "value-paren_group" &&
                    j(m) === se &&
                    j(m.contents) === re &&
                    j(m.contents.contents) === ne &&
                    (m = L(ae(m)));
                let y = [m, x ? wc(t, e) : ","];
                if (!x && d.type === "value-comma_group" && ue(d.groups)) {
                    let w = $(!1, d.groups, -1);
                    (!w.source && w.close && (w = w.close),
                        w.source && Gt(e.originalText, P(w)) && y.push(S));
                }
                return y;
            }, "groups"),
            u = ci(r, n),
            ...
            f = a || (c && !u),
            p = a || u,
            l = L([r.open ? s("open") : "", q([D, G(A, o)]), D, r.close ? s("close") : ""], {
                shouldBreak: f,
            });
        return p ? ae(l) : l;
    }
    ...
    function _c(t, e, s) {
        ...
        switch (r.type) {
                ...
                return (
                    ...
                    !d &&
                        ...
                        !(
                            ...
                            o.group &&
                            t.call(() => ns(t), "value", "group", "group")
                        ) &&
                        (h = q([S, ae(h)])),
                    [
                        E(!1, r.raws.before, /[\s;]/gu, ""),
                        (f.type === "css-atrule" && f.variable) || Qn(t) ? r.prop : Ae(r.prop),
                        l.startsWith("//") ? " " : "",
                        l,
                        r.extend || x ? "" : " ",
                        ...
                        r.nodes
                            ? [" {", q([D, Ie(t, e, s)]), D, "}"]
                            : oi(r) && !f.raws.semicolon && e.originalText[P(r) - 1] !== ";"
                              ? ""
            ...
            case "css-atrule": {
                let f = t.parent,
                    p = Dt(r) && !f.raws.semicolon && e.originalText[P(r) - 1] !== ";";
                if (e.parser === "less") {
                    if (r.mixin)
                        return [s("selector"), r.important ? " !important" : "", p ? "" : ";"];
                    if (r.function)
                        return [
                            r.name,
                    ...
                    if (r.variable)
                        return [
                            ...
                            r.nodes
                                ? ["{", q([r.nodes.length > 0 ? D : "", Ie(t, e, s)]), D, "}"]
                                : "",
                            p ? "" : ";",
                        ];
                }
                ...
                return [
                    "@",
                    Zr(r) || r.name.endsWith(":") || Dt(r) ? r.name : Ae(r.name),
                    r.params
                        ? [
                              Zr(r)
                                  ? ""
                        ...
                        ? [
                              rt(r, e)
                                  ...
                                  : (r.selector &&
                                          ...
                                          Re(r.selector.value)) ||
                                      (!r.selector && typeof r.params == "string" && Re(r.params))
                                    ? A
                                    : " ",
                              "{",
                              q([r.nodes.length > 0 ? D : "", Ie(t, e, s)]),
                              D,
                              "}",
                          ]
                        : p || l
            ...
            case "media-query":
                return [G(" ", t.map(s, "nodes")), t.isLast ? "" : ","];
            case "media-type":
                return ye(Y(r.value, e));
            case "media-feature-expression":
                return r.nodes ? ["(", ...t.map(s, "nodes"), ")"] : r.value;
            case "media-feature":
                return Ae(Y(E(!1, r.value, / +/gu, " "), e));
            case "media-colon":
                return [r.value, " "];
            case "media-value":
                return ye(Y(r.value, e));
            case "media-keyword":
                return Y(r.value, e);
            case "media-url":
                return Y(E(!1, E(!1, r.value, /^url\(\s+/giu, "url("), /\s+\)$/gu, ")"), e);
            case "media-unknown":
                return r.value;
            case "selector-root":
                return L([
                    he(t, "custom-selector")
                        ? [t.findAncestor((f) => f.type === "css-atrule").customSelector, A]
                        : "",
                    G(
                        [",", he(t, ["extend", "custom-selector", "nest"]) ? A : S],
                        t.map(s, "nodes")
                    ),
                ]);
            ...
            case "selector-tag":
                return [
                    ...
                    ((a = t.previous) == null ? void 0 : a.type) === "selector-nesting"
                        ? r.value
                        : ye(Kn(t, r.value) ? r.value.toLowerCase() : r.value),
                ];
            case "selector-id":
                return ["#", r.value];
            case "selector-class":
            ...
            case "selector-pseudo":
                return [
                    Ae(r.value),
                    ue(r.nodes) ? L(["(", q([D, G([",", A], t.map(s, "nodes"))]), D, ")"]) : "",
                ];
            case "selector-nesting":
                return r.value;
            case "selector-unknown": {
                let f = t.findAncestor((d) => d.type === "css-rule");
                if (f != null && f.isSCSSNesterProperty) return ye(Y(Ae(r.value), e));
                let p = t.parent;
                if ((c = p.raws) != null && c.selector) {
                    let d = N(p),
                        x = d + p.raws.selector.length;
                ...
                if (
                    ...
                    let d = P(p.open) + 1,
                        x = N(p.close),
                        h = e.originalText.slice(d, x).trim();
                    return Re(h) ? [Xe, h] : h;
                }
                return r.value;
            }
            ...
            case "value-paren_group":
                return bi(t, e, s);
            case "value-func":
                return [r.value, he(t, "supports") && fi(r) ? " " : "", s("group")];
            case "value-paren":
                return r.value;
            case "value-number":
    ...
    var Ec = { print: _c, embed: vn, insertPragma: zn, massageAstNode: yn, getVisitorKeys: _n },
        _i = Ec;
    var Ei = [
        {
            name: "CSS",
    ...
    function cl(t, e) {
        if (t && typeof t == "object")
            for (let s in t)
                s !== "parent" &&
                    (cl(t[s], e), s === "nodes" && ((t.group = Wr(Ny(t, e))), delete t[s]));
        return t;
    }
    function Py(t, e) {
        ...
        let s = null;
        try {
            s = new ll.default(t, { loose: !0 }).parse();
        } catch {
            return { type: "value-unknown", value: t };
        }
        s.text = t;
        let r = cl(s, e);
        return Z(r, "value-", /^selector-/u);
    }
    var pe = Py;
    var Ry = new Set(["import", "use", "forward"]);
    function Iy(t) {
        return Ry.has(t);
    }
    var fl = Iy;
        ...
        if (t && typeof t == "object") {
            ...
            if (
                ...
                return n.startsWith("@") && n.endsWith(":")
                    ...
                    : t.mixin
                      ? ((t.selector = pe(n, e)), t)
                      : (pl(t, e) && (t.isSCSSNesterProperty = !0), (t.selector = te(n)), t);
            if (i.trim().length > 0) {
                let u = i.match(Ly);
                u &&
                    ((i = i.slice(0, u.index)),
            ...
            if (
                (e.parser === "less" &&
                    ...
                    t.extend && !t.selector && (delete t.value, (t.selector = te(i.slice(7, -1))))),
                t.type === "css-atrule")
            ) {
                if (e.parser === "less") {
                    if (t.mixin) {
                        let u = t.raws.identifier + t.name + t.raws.afterName + t.raws.params;
                        return ((t.selector = te(u)), delete t.params, t);
                    }
                ...
                if (e.parser === "css" && t.name === "custom-selector") {
                    ...
                    return (
                        (t.customSelector = u),
                        (t.selector = te(t.params.slice(u.length).trim())),
                        delete t.params,
                        t
                    );
                }
            ...
            if (t.type === "css-atrule" && o.length > 0) {
                ...
                return u === "warn" || u === "error"
                    ...
                    : u === "extend" || u === "nest"
                      ? ((t.selector = te(o)), delete t.params, t)
                      : u === "at-root"
                        ? (/^\(\s*(?:without|with)\s*:.+\)$/su.test(o)
                              ? (t.params = pe(o, e))
                              : ((t.selector = te(o)), delete t.params),
                          t)
                        : fl(a)
    ...
    function Xs(t, e, s) {
        ...
        try {
            ...
            throw typeof c != "number"
                ? o
                : da(`${u}: ${a}`, { loc: { start: { line: c, column: f } }, cause: o });
        }
        return (
            (s.originalText = e),
            (i = yl(Z(i, "css-"), s)),
    ...
    var Js = { astFormat: "postcss", hasPragma: Yn, hasIgnorePragma: Vn, locStart: N, locEnd: P },
        My = { ...Js, parse: gl },
        By = { ...Js, parse: wl },
        Uy = { ...Js, parse: vl };
    var Fy = { postcss: _i };
