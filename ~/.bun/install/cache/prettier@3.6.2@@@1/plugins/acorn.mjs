...
var nt = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports),
    Vi = (e, t) => {
        for (var i in t) Le(e, i, { get: t[i], enumerable: !0 });
    },
    Ri = (e, t, i, s) => {
        if ((t && typeof t == "object") || typeof t == "function")
            for (let r of Ii(t))
                !Li.call(e, r) &&
                    r !== i &&
                    Le(e, r, { get: () => t[r], enumerable: !(s = Pi(t, r)) || s.enumerable });
        return e;
    };
var ot = (e, t, i) => (
    (i = e != null ? wi(Ni(e)) : {}),
    Ri(t || !e || !e.__esModule ? Le(i, "default", { value: e, enumerable: !0 }) : i, e)
);
var zt = nt((fr, Xt) => {
    Xt.exports = {};
});
...
`))
            ...
            readToken(h) {
                ...
                return h === 60 && this.exprAllowed && this.input.charCodeAt(this.pos + 1) !== 33
                    ? (++this.pos, this.finishToken(n.jsxTagStart))
                    : super.readToken(h);
            }
            updateContext(h) {
...
d.parseForStatement = function (e) {
    ...
    return this.type === a._in || (o = this.options.ecmaVersion >= 6 && this.isContextual("of"))
        ? (t > -1
          ...
          n &&
              o &&
              this.raise(T.start, "The left-hand side of a for-of loop may not start with 'let'."),
          this.toAssignable(T, !1, f),
          this.checkLValPattern(T),
          this.parseForIn(e, T))
        : (this.checkExpressionErrors(f, !0), t > -1 && this.unexpected(t), this.parseFor(e, T));
};
d.parseForAfterInit = function (e, t, i) {
    return (this.type === a._in || (this.options.ecmaVersion >= 6 && this.isContextual("of"))) &&
...
d.parseFunction = function (e, t, i, s, r) {
    (this.initFunction(e),
        (this.options.ecmaVersion >= 9 || (this.options.ecmaVersion >= 6 && !s)) &&
            (this.type === a.star && t & Fe && this.unexpected(), (e.generator = this.eat(a.star))),
        ...
        t & re &&
            ...
            e.id &&
                ...
                this.checkLValSimple(
                    e.id,
                    this.strict || e.generator || e.async ? (this.treatFunctionsAsVar ? Je : J) : _t
                )));
    var n = this.yieldPos,
        o = this.awaitPos,
    ...
    for (r.body = [], this.expect(a.braceL); this.type !== a.braceR; ) {
        ...
        o &&
            ...
            o.type === "MethodDefinition" && o.kind === "constructor"
                ? (n && this.raiseRecoverable(o.start, "Duplicate constructor in the same class"),
                  (n = !0))
                : o.key &&
...
d.parseClassElement = function (e) {
    ...
    if (
        ...
        !s &&
            ...
            ((this.isClassElementNameStart() || this.type === a.star) && !this.canInsertSemicolon()
                ? (n = !0)
                : (s = "async")),
    ...
    if (
        ...
        var c = !i.static && me(i, "constructor"),
            f = c && e;
        (c && o !== "method" && this.raise(i.key.start, "Constructor can't have get/set modifier"),
...
d.parseClassField = function (e) {
    return (
        ...
        this.eat(a.eq)
            ? (this.enterScope(oe | ve), (e.value = this.parseMaybeAssign()), this.exitScope())
            : (e.value = null),
        this.semicolon(),
...
y.checkPropClash = function (e, t, i) {
    if (
        ...
        if (o) {
            var p;
            (n === "init" ? (p = (this.strict && o.init) || o.get || o.set) : (p = o.init || o[n]),
...
y.parseMethod = function (e, t, i) {
    ...
    return (
        ...
        (this.awaitPos = 0),
        (this.awaitIdentPos = 0),
        this.enterScope(qe(t, s.generator) | ve | (i ? St : 0)),
        this.expect(a.parenL),
        ...
        (i && this.type === a.comma
            ...
            : this.type === a.ellipsis
              ? ((o = this.parseSpread(s)),
                s && this.type === a.comma && s.trailingComma < 0 && (s.trailingComma = this.start))
...
y.checkUnreserved = function (e) {
    ...
    if (
        ...
        !(this.currentThisScope().flags & be) &&
            s === "arguments" &&
...
var _e = function (t, i, s) {
        ((this.type = ""),
            (this.start = i),
            (this.end = 0),
            t.options.locations && (this.loc = new ge(t, s)),
...
l.validateRegExpFlags = function (e) {
    for (var t = e.validFlags, i = e.flags, s = !1, r = !1, n = 0; n < i.length; n++) {
        ...
        (t.indexOf(o) === -1 && this.raise(e.start, "Invalid regular expression flag"),
            i.indexOf(o, n + 1) > -1 && this.raise(e.start, "Duplicate regular expression flag"),
            o === "u" && (s = !0),
            o === "v" && (r = !0));
    }
...
l.regexp_disjunction = function (e) {
    ...
    for (t && (e.branchID = new ye(e.branchID, null)), this.regexp_alternative(e); e.eat(124); )
...
l.regexp_eatClassSetRange = function (e) {
    ...
    if (this.regexp_eatClassSetCharacter(e)) {
        ...
        if (e.eat(45) && this.regexp_eatClassSetCharacter(e)) {
            ...
            return (
                i !== -1 && s !== -1 && i > s && e.raise("Range out of order in character class"),
                !0
            );
        }
        e.pos = t;
...
var Ke = function (t) {
        ((this.type = t.type),
            ...
            (this.start = t.start),
            (this.end = t.end),
            t.options.locations && (this.loc = new ge(t, t.startLoc, t.endLoc)),
...
b.readNumber = function (e) {
    ...
    if (!i && !e && this.options.ecmaVersion >= 11 && s === 110) {
        ...
        return (
            ++this.pos,
            M(this.fullCharCodeAtPos()) && this.raise(this.pos, "Identifier directly after number"),
...
var As = (e, t, i) => {
        if (!(e && t == null))
            return Array.isArray(t) || typeof t == "string" ? t[i < 0 ? t.length + i : i] : t.at(i);
    },
    te = As;
...
function Qs(e) {
    return (
        ...
        { astFormat: "estree", hasPragma: xi, hasIgnorePragma: yi, locStart: w, locEnd: k, ...e }
    );
}
var Ae = Qs;
var we = "module",
...
function tr(e, t) {
    let i = Ie(t == null ? void 0 : t.filepath),
        s = (i ? [i] : Pe).map((n) => () => er(e, n)),
        r;
    try {
        r = Ee(s);
    } catch ({ errors: [n] }) {
...
function hr(e, t) {
    let i = Ie(t == null ? void 0 : t.filepath),
        s = (i ? [i] : Pe).map((n) => () => ki(e, { ...ur, sourceType: n })),
        r;
    try {
        r = Ee(s);
    } catch ({ errors: [n] }) {
