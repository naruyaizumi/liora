(function (f) {
    ...
    var Ci = (a, t) => () => (t || a((t = { exports: {} }).exports, t), t.exports),
        Ue = (a, t) => {
            for (var e in t) be(a, e, { get: t[e], enumerable: !0 });
        },
        os = (a, t, e, s) => {
            if ((t && typeof t == "object") || typeof t == "function")
                for (let i of Ai(t))
                    !Ei.call(a, i) &&
                        i !== e &&
                        be(a, i, { get: () => t[i], enumerable: !(s = bi(t, i)) || s.enumerable });
            return a;
        };
    var ls = (a, t, e) => (
            (e = a != null ? Ti(Si(a)) : {}),
            os(t || !a || !a.__esModule ? be(e, "default", { value: a, enumerable: !0 }) : e, a)
        ),
        wi = (a) => os(be({}, "__esModule", { value: !0 }), a);
    var Tt = Ci((Pe) => {
        "use strict";
...
- Did you mean \`import { "${a}" as foo }\`?`,
                ...
                InvalidLhs: ({ ancestor: a }) => `Invalid left-hand side in ${Ee(a)}.`,
                InvalidLhsBinding: ({ ancestor: a }) =>
                    `Binding invalid left-hand side in ${Ee(a)}.`,
                InvalidLhsOptionalChaining: ({ ancestor: a }) =>
                    `Invalid optional chaining in the left-hand side of ${Ee(a)}.`,
            ...
            Mi = Object.assign(
                {
                    ...
                    PipeUnparenthesizedBody: ({ type: a }) =>
                        `Hack-style pipe body cannot be an unparenthesized ${Ee({ type: a })}; please wrap it in parentheses.`,
                },
                {
                    PipelineBodyNoArrow:
            ...
            fr = (a) =>
                class extends a {
                    ...
                    flowParseDeclare(e, s) {
                        ...
                        if (this.eatContextual(127))
                            return this.match(16)
                                ...
                                : (s &&
                                      this.raise(g.NestedDeclareModule, this.state.lastTokStartLoc),
                    ...
                    flowParseDeclareModule(e) {
                        ...
                        return (
                            i.forEach((o) => {
                                hr(o)
                                    ? (r === "CommonJS" &&
                                          this.raise(g.AmbiguousDeclareModuleKind, o),
                                      (r = "ES"))
                    ...
                    checkNotUnderscore(e) {
                        e === "_" &&
                            this.raise(g.UnexpectedReservedUnderscore, this.state.startLoc);
                    }
                            ...
                            if (this.eat(0))
                                (x != null && this.unexpected(x),
                                    this.eat(0)
                                        ...
                                        : l.indexers.push(
                                              this.flowParseObjectTypeIndexer(N, d, S)
                                          ));
                            else if (this.match(10) || this.match(47))
                                (x != null && this.unexpected(x),
                                    S && this.unexpected(S.loc.start),
                                    l.callProperties.push(
                                        this.flowParseObjectTypeCallProperty(N, d)
                                    ));
                            else {
                                let I = "init";
                    ...
                    parseConditional(e, s, i) {
                        ...
                        if (h || u.length > 0) {
                            ...
                            (h &&
                                c.length > 1 &&
                                this.raise(g.AmbiguousConditionalArrow, r.startLoc),
                                h &&
                                    c.length === 1 &&
                                    ((this.state = r),
                                    f.push(c[0].start),
                        ...
                        (super.parseClassMember(e, s, i),
                            s.declare &&
                                ...
                                s.type !== "PropertyDefinition"
                                    ...
                                    : s.value &&
                                      this.raise(g.DeclareClassFieldInitializer, s.value)));
                    }
                    isIterator(e) {
                    ...
                    parseFunctionParamType(e) {
                        return (
                            ...
                            this.match(14)
                                ? (e.typeAnnotation = this.flowParseTypeAnnotation())
                                : this.isThisParam(e) &&
                                  this.raise(g.ThisParamAnnotationRequired, e),
                            this.match(29) &&
                                this.isThisParam(e) &&
                    ...
                    checkImportReflection(e) {
                        (super.checkImportReflection(e),
                            e.module &&
                                e.importKind !== "value" &&
                                this.raise(
                                    g.ImportReflectionHasImportType,
                                    e.specifiers[0].loc.start
                                ));
                    }
                        ...
                        switch (((e.hasUnknownMembers = l), n)) {
                            ...
                            default: {
                                ...
                                if (!u && !f && c >= d) {
                                    ...
                                    return (
                                        this.raise(g.EnumInconsistentMemberValues, r, {
                                            enumName: i,
                                        }),
                                        h()
                                    );
...
`);
                ...
                default:
                    if (l >= 48 && l <= 55) {
                        let h = t - 1,
                            ...
                            f = parseInt(u, 8);
                        (f > 255 && ((u = u.slice(0, -1)), (f = parseInt(u, 8))),
                            (t += u.length - 1));
        ...
        function Ds(a, t, e, s, i, r, n, o, l, h) {
            let c = t,
                ...
                f = i === 16 ? Se.hex : i === 10 ? Se.dec : i === 8 ? Se.oct : Se.bin,
                d = !1,
                x = 0;
        ...
        var br = new Set([103, 109, 115, 105, 121, 117, 100, 118]),
            ...
            tt = class extends Qe {
                ...
                skipBlockComment(t) {
                    ...
                    for (
                        this.state.pos = i + t.length, Ae.lastIndex = s + 2;
                        Ae.test(this.input) && Ae.lastIndex <= i;
                            ...
                            case 47:
                                switch (this.input.charCodeAt(this.state.pos + 1)) {
                                    case 42: {
                                        ...
                                        i !== void 0 &&
                                            (this.addComment(i), e == null || e.push(i));
                                        break;
                                    }
                                    case 47: {
                            ...
                            default:
                                if (mr(s)) ++this.state.pos;
                                    ...
                                    if (
                                        ...
                                        r !== void 0 &&
                                            (this.addComment(r), e == null || e.push(r));
                                    } else break e;
                ...
                readNumber(t) {
                    ...
                    if (l) {
                        ...
                        if (
                            (this.recordStrictModeErrors(p.StrictOctalLiteral, s),
                            !this.state.strict)
                        ) {
                            let x = d.indexOf("_");
            ...
            it = class {
                ...
                usePrivateName(t, e) {
                    ...
                    s
                        ...
                        : this.parser.raise(p.InvalidPrivateFieldResolution, e, {
                              identifierName: t,
                          });
                }
            },
                ...
                toAssignable(t, e = !1) {
                    ...
                    switch (
                        ...
                        case "AssignmentExpression":
                            (t.operator !== "=" &&
                                this.raise(p.MissingEqInAssignment, t.left.loc.end),
            ...
            class extends a {
                ...
                tsParseModifiers(
                    ...
                    let o = (h, c, u, f) => {
                            c === u &&
                                n[f] &&
                                this.raise(y.InvalidModifiersOrder, h, {
                                    orderedModifiers: [u, f],
                                });
                        },
                        l = (h, c, u, f) => {
                            ((n[u] && c === f) || (n[f] && c === u)) &&
                ...
                tsParsePropertyOrMethodSignature(e, s) {
                    if ((this.eat(17) && (e.optional = !0), this.match(10) || this.match(47))) {
                        ...
                        (i.kind &&
                            this.match(47) &&
                            this.raise(
                                y.AccessorCannotHaveTypeParameters,
                                this.state.curPosition()
                            ),
                ...
                tsParseInterfaceDeclaration(e, s = {}) {
                    ...
                    (this.expectContextual(129),
                        ...
                        w(this.state.type)
                            ...
                            : ((e.id = null),
                              this.raise(y.MissingInterfaceName, this.state.startLoc)),
                    ...
                    switch (s) {
                        case "abstract":
                            if (
                                ...
                                (this.match(80) || w(this.state.type))
                            )
                        ...
                        this.tsIsStartOfStaticBlocks()
                            ? (this.next(),
                              ...
                              this.tsHasSomeModifiers(s, r) &&
                                  this.raise(
                                      y.StaticBlockCannotHaveModifier,
                                      this.state.curPosition()
                                  ),
                ...
                pushClassMethod(e, s, i, r, n, o) {
                    ...
                    (h &&
                        (c === "get" || c === "set") &&
                        this.raise(y.DeclareAccessor, s, { kind: c }),
                ...
                parseObjPropValue(e, s, i, r, n, o, l) {
                    ...
                    return (
                        ...
                        super.parseObjPropValue(e, s, i, r, n, o, l)
                    );
                }
                parseFunctionParams(e, s) {
                    ...
                    switch (e.type) {
                        ...
                        case "AccessorProperty":
                            (($ = e.declare) != null || (e.declare = !1),
                                (Mt = e.definite) != null || (e.definite = !1),
                                (Ot = e.readonly) != null || (e.readonly = !1),
                                (Ft = e.typeAnnotation) != null || (e.typeAnnotation = void 0));
                        case "TSAbstractMethodDefinition":
                        case "MethodDefinition":
                            ((Bt = e.accessibility) != null || (e.accessibility = void 0),
                                (Rt = e.decorators) != null || (e.decorators = []),
                                (_t = e.override) != null || (e.override = !1),
                                (Ut = e.optional) != null || (e.optional = !1));
                            return;
                        case "ClassExpression":
                            (jt = e.id) != null || (e.id = null);
                        case "ClassDeclaration":
                            (($t = e.abstract) != null || (e.abstract = !1),
                                (Vt = e.declare) != null || (e.declare = !1),
                                (qt = e.decorators) != null || (e.decorators = []),
                                (zt = e.implements) != null || (e.implements = []),
                                (Ht = e.superTypeArguments) != null ||
                                    (e.superTypeArguments = void 0),
                                (Kt = e.typeParameters) != null || (e.typeParameters = void 0));
                            return;
                        case "TSTypeAliasDeclaration":
                        case "VariableDeclaration":
                            (Wt = e.declare) != null || (e.declare = !1);
                            return;
                        case "VariableDeclarator":
                            (Jt = e.definite) != null || (e.definite = !1);
                            return;
                        case "TSEnumDeclaration":
                            ((Xt = e.const) != null || (e.const = !1),
                                (Gt = e.declare) != null || (e.declare = !1));
                            return;
                        case "TSEnumMember":
                            (Yt = e.computed) != null || (e.computed = !1);
                            return;
                        case "TSImportType":
                            ((Qt = e.qualifier) != null || (e.qualifier = null),
                                (Zt = e.options) != null || (e.options = null));
                            return;
                        case "TSInterfaceDeclaration":
                            ((es = e.declare) != null || (e.declare = !1),
                                (ts = e.extends) != null || (e.extends = []));
                            return;
                        case "TSModuleDeclaration":
                            ((ss = e.declare) != null || (e.declare = !1),
                                (is = e.global) != null || (e.global = e.kind === "global"));
                            return;
                        case "TSTypeParameter":
                            ((rs = e.const) != null || (e.const = !1),
                                (as = e.in) != null || (e.in = !1),
                                (ns = e.out) != null || (e.out = !1));
                            return;
                    }
                }
            };
            ...
            Dr = (a) =>
                class extends a {
                    ...
                    chStartsBindingIdentifier(e, s) {
                        ...
                        return (
                            this.input.charCodeAt(i) === 37 && this.input.charCodeAt(i + 1) === 37
                        );
                    }
            ...
            if (a.has("pipelineOperator")) {
                ...
                if (s === "hack") {
                    ...
                    }
                    {
                        ...
                        if (
                            i === "#" &&
                            ((e = a.get("recordAndTuple")) == null ? void 0 : e.syntaxType) ===
                                "hash"
                        )
                            throw new Error(
            ...
            ht = class extends lt {
                checkProto(t, e, s, i) {
                    ...
                    return (r.type === "Identifier" ? r.name : r.value) === "__proto__"
                        ? e
                            ...
                            : (s &&
                                  (i
                                      ? i.doubleProtoLoc === null &&
                                        (i.doubleProtoLoc = r.loc.start)
                ...
                shouldExitDescending(t, e) {
                    return (
                        ...
                        this.offsetToSourcePos(t.start) === e
                    );
                }
                getExpression() {
                ...
                parseExprOp(t, e, s) {
                    if (this.isPrivateName(t)) {
                        ...
                        ((s >= Ce(58) || !this.prodParam.hasIn || !this.match(58)) &&
                ...
                parseUpdate(t, e, s) {
                    if (e) {
                        let n = t;
                        return (
                            this.checkLVal(n.argument, this.finishNode(n, "UpdateExpression")),
                            t
                        );
                    }
                        ...
                        if (t.arguments.length === 0 || t.arguments.length > 2)
                            ...
                            for (let s of t.arguments)
                                s.type === "SpreadElement" &&
                                    this.raise(p.ImportCallSpreadArgument, s);
                ...
                parseImportMetaPropertyOrPhaseCall(t) {
                    if ((this.next(), this.isContextual(105) || this.isContextual(97))) {
                        ...
                        return (
                            this.expectPlugin(
                                e ? "sourcePhaseImports" : "deferredImportEvaluation"
                            ),
                            this.next(),
                ...
                parseNewOrNewTarget() {
                    ...
                    if ((this.next(), this.match(16))) {
                        ...
                        return (
                            this.scope.allowNewTarget || this.raise(p.UnexpectedNewTarget, s),
                            s
                        );
                    }
...
`
                ...
                parsePropertyDefinition(t) {
                    ...
                    if (
                        (this.parsePropertyName(s, t), !o && !l && this.maybeAsyncOrAccessorProp(s))
                    ) {
                        let { key: h } = s,
                            c = h.name;
                        (c === "async" &&
                ...
                parseMethod(t, e, s, i, r, n, o = !1) {
                    (this.initFunction(t, s),
                        ...
                        this.prodParam.enter(we(s, t.generator)),
        ...
        var ct = class extends ht {
                        ...
                        case 107:
                            ...
                            return (
                                ...
                                this.allowsUsing()
                                    ? r ||
                                      this.raise(
                                          p.UnexpectedLexicalDeclaration,
                                          this.state.startLoc
                                      )
                ...
                assertModuleNodeAllowed(t) {
                    !(this.optionFlags & 8) &&
                        !this.inModule &&
                        this.raise(p.ImportOutsideModule, t);
                }
                ...
                parseFunction(t, e = 0) {
                    ...
                    (this.initFunction(t, n),
                        this.match(55) &&
                            (s &&
                                this.raise(
                                    p.GeneratorInSingleStatementContext,
                                    this.state.startLoc
                                ),
                            this.next(),
                            (t.generator = !0)),
                    ...
                    return (
                        ...
                        this.prodParam.enter(we(n, t.generator)),
                ...
                parseClassMemberWithIsStatic(t, e, s, i) {
                    ...
                    if (((e.static = i), this.parsePropertyNamePrefixOperator(e), this.eat(55))) {
                        ...
                        if (
                            (this.parseClassElementName(c), this.parsePostMemberNameModifiers(c), S)
                        ) {
                            this.pushClassPrivateMethod(t, n, !0, !1);
                            return;
                        }
                        (this.isNonstaticConstructor(r) &&
                            this.raise(p.ConstructorIsGenerator, r.key),
                ...
                parseImportAttributes() {
                    ...
                    do {
                        ...
                        if (
                            (e.has(i) &&
                                this.raise(
                                    p.ModuleAttributesWithDuplicateKeys,
                                    this.state.startLoc,
                                    { key: i }
                                ),
                            e.add(i),
...
`);
    ...
    function ua(a) {
        ...
        return (
            ...
            Me(t, { loc: { start: { line: i, column: r + 1 } }, cause: n })
        );
    }
    var Oe = ua;
    var fa = (a, t, e, s) => {
...
`;
    ...
    function Ia({ isExpression: a = !1, optionsCombinations: t }) {
        return (e, s = {}) => {
            ...
            e.includes("|>")
                ...
                : o && (r = r.map((c) => j([mi], c)));
            let l = a ? Be.parseExpression : Be.parse,
                h;
            try {
    ...
    var Ba = Y({ parse: (a) => _e(a), hasPragma: () => !0, hasIgnorePragma: () => !1 }),
        Ra = Y((a) => _e(a)),
        _a = Y((a) => _e(a, { allowEmpty: !0 })),
        Ua = Y({ parse: (a) => _e(a, { allowComments: !1 }), astFormat: "estree-json" });
    var ja = { ...vt, ...Dt };
    return wi($a);
});
