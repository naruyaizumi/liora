(function (f) {
    ...
    var He = (e, t) => {
            for (var r in t) Ve(e, r, { get: t[r], enumerable: !0 });
        },
        Ks = (e, t, r, s) => {
            if ((t && typeof t == "object") || typeof t == "function")
                for (let n of Ys(t))
                    !Gs.call(e, n) &&
                        n !== r &&
                        Ve(e, n, { get: () => t[n], enumerable: !(s = zs(t, n)) || s.enumerable });
            return e;
        };
    var Ws = (e) => Ks(Ve({}, "__esModule", { value: !0 }), e);
    ...
    var Pi = {};
    He(Pi, { languages: () => hs, parsers: () => Pr, printers: () => Ci });
    var js = (e, t, r, s) => {
            if (!(e && t == null))
                return t.replaceAll
                    ? t.replaceAll(r, s)
...
`,
    ...
    function cn(e) {
        ...
        if (
            !(
                s &&
                !(s.value.type === "TextNode" && (s.value.chars === "" || s.value.chars === "css"))
            )
        )
            return async (n) => {
    ...
    function dn(e, t, r) {
        ...
        switch (s.type) {
            ...
            case "BlockStatement":
                return wn(e)
                    ? [Tn(e, r), ts(e, t, r), es(e, t, r)]
                    : [En(e, r), R([ts(e, t, r), es(e, t, r), Nn(e, t, r)])];
            ...
            case "MustacheCommentStatement": {
                let y = St(s),
                    ...
                    P = t.originalText.charAt(v - 3) === "~",
                    w = s.value.includes("}}") ? "--" : "";
                return ["{{", C ? "~" : "", "!", w, s.value, w, P ? "~" : "", "}}"];
            }
            case "PathExpression":
                return Rn(s);
            case "BooleanLiteral":
    ...
    function En(e, t) {
        ...
        return (
            ...
            R([kn(r), Xe(e, t), s.length > 0 ? B([L, yt(L, s)]) : "", F, Sn(r)])
        );
    }
    function vn(e, t) {
    ...
    var Hn = (function () {
            var e = function (it, d, k, g) {
                ...
                De = {
                    ...
                    performAction: function (d, k, g, b, N, l, xt) {
                        var u = l.length - 1;
                        switch (N) {
                            case 1:
                                return l[u - 1];
                    ...
                    parse: function (d) {
                        ...
                        var Be = x.yylloc;
                        l.push(Be);
                        var Us = x.options && x.options.ranges;
                            ...
                            switch (M[0]) {
                                ...
                                case 2:
                                    ...
                                    (Z &&
                                        ...
                                        N.push(At.$),
                                        l.push(At._$),
                                        (Dr = xt[g[g.length - 2]][g[g.length - 1]]),
                                        g.push(Dr));
                                    break;
                                case 3:
                                    return !0;
    ...
    function zn(e, t, r) {
        ...
        for (var s = e ? "@" : "", n = [], i = 0, a = 0, o = t.length; a < o; a++) {
            var c = t[a].part,
                h = t[a].original !== c;
            if (
                ((s += (t[a].separator || "") + c), !h && (c === ".." || c === "." || c === "this"))
            ) {
...
`
    ...
    var uo = vs(Ne.FlushElement);
    var ho = vs(Ne.GetSymbol);
    var ri = !1,
        si = /["\x26\xa0]/u,
        Eo = new RegExp(si.source, "gu"),
        ni = /[&<>\xa0]/u,
        vo = new RegExp(ni.source, "gu");
    var dr = new Set([
        "area",
        "base",
        "br",
    ...
    var pt = Object.freeze({ line: 1, column: 0 }),
        oi = Object.freeze({ source: "(synthetic)", start: pt, end: pt }),
    ...
    var yr = class {
            ...
            matchFor(t, r) {
                ...
                return (ce(s), new br(s).first(r));
            }
            when(t, r, s) {
                return (this._whens.get(t, () => new xe()).add(r, s), this);
            }
            constructor() {
                this._whens = new xe();
            }
        ...
        D = class e {
            ...
            toSlice(t) {
                ...
                return (JSON.stringify(r), JSON.stringify(t), new kr({ loc: this, chars: t || r }));
            }
            get start() {
                return this.loc.start;
            }
...
`
    ...
    function Ae(e, t) {
        ...
        if (
            (c !== void 0 && ((r = Ds(c)), (s = _s(c))), r !== void 0 && (n = r(i, t)), n != null)
        ) {
        ...
        if (n === void 0) {
            let h = ci[i.type];
            for (let p = 0; p < h.length; p++) hi(e, c, t, h[p]);
            s !== void 0 && (n = s(i, t));
        }
        return n;
    }
            ...
            if (Array.isArray(o)) Os(e, o, r, s);
                ...
                c !== void 0 &&
                    (function (h, p, m, S) {
                        ...
                        if (Array.isArray(S)) {
                            if (S.length !== 1) throw S.length === 0 ? ws(m, h, p) : ui(m, h, p);
                            Ns(h, p, S[0]);
                        } else Ns(h, p, S);
                    })(a, s, o, c);
            }
    ...
    function T(...e) {
        if (e.length === 1) {
            let t = e[0];
            return t && typeof t == "object" ? D.forHbsLoc(hr(), t) : D.forHbsLoc(hr(), oi);
        }
        {
            let [t, r, s, n, i] = e,
                a = i ? new wt("", i) : hr();
    ...
    var mi = {
        ...
        element: function (e, t = {}) {
            ...
            let S = i == null ? void 0 : i.map((v) => (typeof v == "string" ? Cs(v) : v)),
                y = null;
            return (
                p ? (y = T(p)) : p === void 0 && (y = s || ii(r.original) ? null : T(null)),
                f.element({
                    path: r,
                    selfClosing: s || !1,
                    attributes: n || [],
        ...
        program: function (e, t, r) {
            return t && t.length ? Ps(e, t, !1, r) : xs(e, [], r);
        },
        blockItself: Ps,
        template: xs,
        loc: T,
        ...
        undefined: () => Pe("UndefinedLiteral", void 0),
        null: () => Pe("NullLiteral", null),
    };
    function pr(e) {
        return function (t, r) {
            return Pe(e, t, r);
            ...
            path({ head: e, tail: t, loc: r }) {
                return (function ({ head: s, tail: n, loc: i }) {
                    let a = {
                        ...
                        set original(o) {
                            let [c, ...h] = o.split(".");
                            ((this.head = mi.head(c, this.head.loc)), (this.tail = h));
                        },
                        loc: i,
                    };
                    return (
            ...
            BlockStatement(t) {
                ...
                if ((m = t.program.blockParams) != null && m.length) {
                    ...
                    let y = S.asString(),
                        v = y.indexOf("|") + 1,
                        C = y.indexOf("|", v);
                    for (let P of t.program.blockParams) {
                        let w, U;
                        ((w = v >= C ? -1 : y.indexOf(P, v)),
                            w === -1 || w + P.length > C
                                ? ((v = C), (U = this.source.spanFor(gr)))
                                : ((v = w),
                                  (U = S.sliceStartChars({ skipStart: v, chars: P.length })),
                                  (v += P.length)),
                            o.push(f.var({ name: P, loc: U })));
                    }
...
`
    ...
    function Rs(e, t = {}) {
        ...
        if ((p = t.plugins) != null && p.ast)
            for (let m of t.plugins.ast)
                fi(o, m(tr({}, t, { syntax: di }, { plugins: void 0 })).visitor);
        return o;
    }
    var gi = {
    ...
    var ki = (e) => {
        ...
        Ei = { mode: "codemod", plugins: { ast: [Si] } };
    function vi(e) {
        let t;
        try {
            t = Rs(e, Ei);
...
`);
    ...
    var Ni = { parse: vi, astFormat: "glimmer", locStart: St, locEnd: re };
    var Ci = { glimmer: us };
    return Ws(Pi);
});
