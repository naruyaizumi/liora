(function (f) {
        ...
        to = (e, t, r, n) => {
            if ((t && typeof t == "object") || typeof t == "function")
                for (let s of Za(t))
                    !eo.call(e, s) &&
                        s !== r &&
                        On(e, s, { get: () => t[s], enumerable: !(n = za(t, s)) || n.enumerable });
            return e;
        };
    var ro = (e) => to(On({}, "__esModule", { value: !0 }), e);
    var Xs = (e, t, r) => t.has(e) || Us("Cannot " + r);
    var mt = (e, t, r) => (Xs(e, t, "read from private field"), r ? r.call(e) : t.get(e)),
        Ys = (e, t, r) =>
            t.has(e)
                ? Us("Cannot add the same private member more than once")
                : t instanceof WeakSet
                  ? t.add(e)
                  : t.set(e, r),
        Hs = (e, t, r, n) => (
            Xs(e, t, "write to private field"),
            n ? n.call(e, r) : t.set(e, r),
            r
        );
    var Bm = {};
    xr(Bm, { languages: () => Sm, options: () => Ha, printers: () => gm });
    var Vs = [
        {
            name: "JavaScript",
            type: "programming",
    ...
    xr(js, {
        canAttachComment: () => Op,
        embed: () => oi,
        experimentalFeatures: () => Cm,
        getCommentChildNodes: () => _p,
        getVisitorKeys: () => br,
        handleComments: () => rs,
        insertPragma: () => di,
        isBlockComment: () => te,
    ...
    function* ao(e, t) {
        ...
        for (let n = 0; n < r.length; n++) {
            let s = r[n];
            for (let u of io(s, t)) (yield u, r.push(u));
        }
    }
    function Ks(e, { getVisitorKeys: t, predicate: r }) {
        for (let n of ao(e, { getVisitorKeys: t })) if (r(n)) return !0;
        return !1;
    }
    var Qs = () =>
...
` ||
    ...
    var _t = mo;
    function yo(e, t) {
        return t === !1 ? !1 : e.charAt(t) === "/" && e.charAt(t + 1) === "/" ? ru(e, t) : t;
    }
    var Mt = yo;
    function fo(e, t) {
        let r = null,
        ...
        return ((n = Mt(e, n)), (n = He(e, n)), n !== !1 && ee(e, n));
    }
    var vt = fo;
    function Do(e) {
    ...
    var O = Do;
    var nu = new Proxy(() => {}, { get: () => nu }),
        jt = nu;
    var gr = "'",
        su = '"';
    function Eo(e, t) {
        let r = t === !0 || t === gr ? gr : su,
            n = r === gr ? su : gr,
            s = 0,
            u = 0;
            ...
            n =
                ...
                (t.parser === "json5" && t.quoteProps === "preserve" && !t.singleQuote)
                    ...
                    : t.__isInHtmlAttribute
                      ? "'"
                      : Sr(r, t.singleQuote);
        return e.charAt(0) === n ? e : uu(r, n, !1);
    }
    var ut = Co;
    ...
    var To = 10;
    for (let e = 0; e <= To; e++) nr();
    function _n(e) {
        return nr(e);
    }
    function xo(e, t = "type") {
        _n(e);
        function r(n) {
            let s = n[t],
                u = e[s];
    ...
    var ae = So;
    var Bo = R(["Block", "CommentBlock", "MultiLine"]),
        te = Bo;
    var bo = R([
            "AnyTypeAnnotation",
            "ThisTypeAnnotation",
    ...
    var wr = R([
        ...
        wo = R(["Identifier", "ThisExpression", "Super", "PrivateName", "PrivateIdentifier"]),
    ...
    function Pt(e, t) {
        ...
        let r = le(e);
        if (r.length === 1) {
            if (Mn(e) && Pt(t)) return Rt(r[0]);
            if (Mo(e.callee)) return Mn(r[0]);
        } else if (
            (r.length === 2 || r.length === 3) &&
            (r[0].type === "TemplateLiteral" || K(r[0])) &&
            jo(e.callee)
        )
            return r[2] && !ye(r[2])
                ? !1
                : (r.length === 2 ? Rt(r[1]) : Oo(r[1]) && Q(r[1]).length <= 1) || Mn(r[1]);
        return !1;
    }
    var Fu = (e) => (t) => (
            (t == null ? void 0 : t.type) === "ChainExpression" && (t = t.expression),
            e(t)
        ),
        w = Fu(R(["CallExpression", "OptionalCallExpression"])),
        G = Fu(R(["MemberExpression", "OptionalMemberExpression"]));
    function Gn(e, t = 5) {
        return Cu(e, t) <= t;
    }
    function Cu(e, t) {
...
`)
    ...
    function _r(e, t) {
        return (
            ((e.type === "TemplateLiteral" && cu(e)) ||
                (e.type === "TaggedTemplateExpression" && cu(e.quasi))) &&
            !ee(t, j(e), { backwards: !0 })
        );
    }
    function Mr(e) {
        if (!d(e)) return !1;
        let t = v(!1, Ve(e, h.Dangling), -1);
        return t && !te(t);
    }
    function Au(e) {
        ...
        for (let r of e)
            if (Rt(r)) {
                ...
                for (let n of le(r)) if (Rt(n)) return !0;
            }
        return !1;
    }
    function vr(e) {
    ...
    function we(e, t = 2) {
        ...
        if (e.type === "ChainExpression" || e.type === "TSNonNullExpression")
            return we(e.expression, t);
        let r = (n) => we(n, t - 1);
        if (Nn(e)) return st(e.pattern ?? e.regex.pattern) <= 5;
        if (wr(e) || wo(e) || e.type === "ArgumentPlaceholder") return !0;
...
`)
        ...
        return G(e)
            ? we(e.object, t) && we(e.property, t)
            : (e.type === "UnaryExpression" && Jo.has(e.operator)) || e.type === "UpdateExpression"
              ? we(e.argument, t)
              : !1;
    }
    function du(e) {
    ...
    function pe(e, t) {
        switch (e.type) {
            ...
            case "TaggedTemplateExpression":
                return e.tag.type === "FunctionExpression" ? !1 : pe(e.tag, t);
            case "CallExpression":
            case "OptionalCallExpression":
                return e.callee.type === "FunctionExpression" ? !1 : pe(e.callee, t);
    ...
    function le(e) {
        ...
        let t = e.arguments;
        return (
            (e.type === "ImportExpression" || e.type === "TSImportType") &&
                ((t = [e.type === "ImportExpression" ? e.source : e.argument]),
                e.options && t.push(e.options)),
            jn.set(e, t),
            t
        );
    }
    function Gt(e, t) {
        ...
        r.type === "ImportExpression" || r.type === "TSImportType"
            ? (e.call((n) => t(n, 0), r.type === "ImportExpression" ? "source" : "argument"),
              r.options && e.call((n) => t(n, 1), "options"))
            : e.each(t, "arguments");
    }
    function qn(e, t) {
        let r = [];
        if (
            ...
            if (t === 0 || t === (e.options ? -2 : -1))
                return [...r, e.type === "ImportExpression" ? "source" : "argument"];
    ...
    var xe = R([
        ...
        Oe = R(["TSUnionType", "UnionTypeAnnotation"]),
        qt = R(["TSIntersectionType", "IntersectionTypeAnnotation"]),
    ...
    function Su(e, t) {
        ...
        if (
            ...
            e.openingElement.attributes.some(
                (s) => s.type === "JSXAttribute" && s.name.name === "jsx"
            )
        )
            for (let { type: s, expression: u } of t.children)
                s === "JSXExpressionContainer" && u.type === "TemplateLiteral" && Wt(u);
        (e.type === "JSXAttribute" &&
            e.name.name === "css" &&
            e.value.type === "JSXExpressionContainer" &&
            e.value.expression.type === "TemplateLiteral" &&
            Wt(t.value.expression),
            e.type === "JSXAttribute" &&
                ((n = e.value) == null ? void 0 : n.type) === "Literal" &&
                /["']|&quot;|&apos;/u.test(e.value.value) &&
                (t.value.value = X(!1, e.value.value, /["']|&quot;|&apos;/gu, '"')));
        ...
        if (
            ...
            for (let [u, i] of t.expression.arguments[0].properties.entries())
                switch (s[u].key.name) {
                    case "styles":
    ...
    var Ne = "string",
        ...
        Se = "label",
        Me = "break-parent",
        jr = new Set([it, $e, Ke, Qe, fe, _e, he, ze, Ze, Ge, oe, Se, Me]);
    function qo(e) {
...
Expected it to be ${n}.`;
    ...
    function Yo(e) {
        if ((e.type === fe && e.break) || (e.type === oe && e.hard) || e.type === Me) return !0;
    }
    function re(e) {
        return ku(e, Yo, !1);
    }
        ...
        switch (Be(e)) {
            ...
            case ge: {
                ...
                for (let r of e) {
                    ...
                    (typeof n == "string" && typeof v(!1, t, -1) == "string"
                        ? (t[t.length - 1] += n)
                        : t.push(n),
                        t.push(...s));
                }
...
`)
    ...
    function S(e, t = "", r = {}) {
        return (
            et(e),
            t !== "" && et(t),
            { type: he, breakContents: e, flatContents: t, groupId: r.groupId }
        );
    }
    function xt(e, t) {
    ...
    var je = { type: Ge },
        Ce = { type: Me };
    var Hn = { type: oe, hard: !0 },
        Ko = { type: oe, hard: !0, literal: !0 },
        x = { type: oe },
        E = { type: oe, soft: !0 },
        F = [Hn, Ce],
        Rr = [Ko, Ce],
...
`);
    ...
    var Vn = new WeakMap();
    function zo(e) {
        return (Vn.has(e) || Vn.set(e, Qo(e)), Vn.get(e));
    }
    var vu = zo;
    function ju(e, t) {
        let r = e.node;
...
`);
    ...
    var rs = {};
    xr(rs, { endOfLine: () => ip, ownLine: () => up, remaining: () => ap });
    function ep(e) {
    ...
    function $n(e, t) {
        ((e.comments ?? (e.comments = [])).push(t), (t.printed = !1), (t.nodeDescription = ep(e)));
    }
    function De(e, t) {
        ((t.leading = !0), (t.trailing = !1), $n(e, t));
    }
    function Pe(e, t, r) {
        ((t.leading = !1), (t.trailing = !1), r && (t.marker = r), $n(e, t));
    }
    function z(e, t) {
        ((t.leading = !1), (t.trailing = !0), $n(e, t));
    }
    function tp(e, t) {
        let r = null,
            n = t;
...
`
    ...
    function sp(e) {
        return (
            Kn.has(e) ||
                Kn.set(e, te(e) && e.value[0] === "*" && /@(?:type|satisfies)\b/u.test(e.value)),
            Kn.get(e)
        );
    }
    var Gr = sp;
    ...
    function ip(e) {
        return [op, Wu, Nu, Xu, zn, Zn, Ju, Gu, Uu, Ap, Tp, ts, Bp, es, Pp, kp, Lp, Hu].some((t) =>
            t(e)
        );
    }
    function ap(e) {
        return [Yu, zn, Zn, lp, Fp, qu, ts, Ep, Dp, es, bp].some((t) => t(e));
    }
    function It(e, t) {
    ...
    function zn({ comment: e, precedingNode: t, enclosingNode: r, followingNode: n, text: s }) {
        ...
        if (ke(s, P(e)) === ")") return (z(t, e), !0);
        if (t === r.consequent && n === r.alternate) {
            let i = ot(s, P(r.consequent));
            if (j(e) < i || r.alternate.type === "BlockStatement")
    ...
    function pp({ comment: e, enclosingNode: t, followingNode: r }) {
        return G(t) && (r == null ? void 0 : r.type) === "Identifier" ? (De(t, e), !0) : !1;
    }
    function cp({ comment: e, enclosingNode: t, followingNode: r, options: n }) {
    ...
    function Nu({
        ...
        return (!t || !i) &&
            ((r == null ? void 0 : r.type) === "ConditionalExpression" || Je(r)) &&
            n
            ? u.experimentalTernaries &&
              r.alternate === n &&
              !(te(e) && !ie(u.originalText, j(e), P(e)))
                ? (Pe(r, e), !0)
                : (De(n, e), !0)
            : !1;
    }
    function lp({ comment: e, precedingNode: t, enclosingNode: r }) {
        return Te(r) && r.shorthand && r.key === t && r.value.type === "AssignmentPattern"
            ? (z(r.value.left, e), !0)
            : !1;
    }
    var mp = new Set([
    ...
    function Gu({ comment: e, precedingNode: t, enclosingNode: r, followingNode: n }) {
        if (mp.has(r == null ? void 0 : r.type)) {
            if (O(r.decorators) && (n == null ? void 0 : n.type) !== "Decorator")
                return (z(v(!1, r.decorators, -1), e), !0);
            if (r.body && n === r.body) return (It(r.body, e), !0);
            if (n) {
                if (
                    r.superClass &&
                    n === r.superClass &&
    ...
    function Dp({ comment: e, precedingNode: t, enclosingNode: r, text: n }) {
        return ke(n, P(e)) !== "("
            ? !1
            : t && fp.has(r == null ? void 0 : r.type)
              ? (z(t, e), !0)
              : !1;
    }
    function Ep({ comment: e, enclosingNode: t, text: r }) {
        if ((t == null ? void 0 : t.type) !== "ArrowFunctionExpression") return !1;
        let n = ot(r, P(e));
        return n !== !1 && r.slice(n, n + 2) === "=>" ? (Pe(t, e), !0) : !1;
    }
    function Fp({ comment: e, enclosingNode: t, text: r }) {
        return ke(r, P(e)) !== ")"
            ? !1
            : t && ((Vu(t) && Q(t).length === 0) || (yt(t) && le(t).length === 0))
              ? (Pe(t, e), !0)
    ...
    function Uu({ comment: e, enclosingNode: t }) {
        return (t == null ? void 0 : t.type) === "LabeledStatement" ? (De(t, e), !0) : !1;
    }
    function es({ comment: e, enclosingNode: t }) {
    ...
    function Ap({ comment: e, precedingNode: t, enclosingNode: r }) {
        return w(r) && t && r.callee === t && r.arguments.length > 0
            ? (De(r.arguments[0], e), !0)
            : !1;
    }
    function dp({ comment: e, precedingNode: t, enclosingNode: r, followingNode: n }) {
        return Oe(r)
            ? (or(e) && ((n.prettierIgnore = !0), (e.unignore = !0)), t ? (z(t, e), !0) : !1)
            : (Oe(n) && or(e) && ((n.types[0].prettierIgnore = !0), (e.unignore = !0)), !1);
    }
    function Tp({ comment: e, enclosingNode: t }) {
        return Te(t) ? (De(t, e), !0) : !1;
    }
    function ts({ comment: e, enclosingNode: t, ast: r, isLastComment: n }) {
        var s;
    ...
    function xp({ comment: e, enclosingNode: t }) {
    ...
    function Xu({ comment: e, precedingNode: t, enclosingNode: r, text: n }) {
        ...
        return (s || u) && ee(n, P(e)) ? (z(t, e), !0) : !1;
    }
    function hp({ comment: e, enclosingNode: t }) {
        return (t == null ? void 0 : t.type) === "AssignmentPattern" ? (De(t, e), !0) : !1;
    }
    var gp = new Set([
            "VariableDeclarator",
    ...
    function Bp({ comment: e, enclosingNode: t, followingNode: r }) {
        return gp.has(t == null ? void 0 : t.type) && r && (Sp.has(r.type) || te(e))
            ? (De(r, e), !0)
            : !1;
    }
    function bp({ comment: e, enclosingNode: t, followingNode: r, text: n }) {
        return !r &&
    ...
    function Yu({ comment: e, enclosingNode: t, followingNode: r }) {
        if (or(e) && (t == null ? void 0 : t.type) === "TSMappedType" && r === t.key)
            return ((t.prettierIgnore = !0), (e.unignore = !0), !0);
    }
    function Hu({ comment: e, precedingNode: t, enclosingNode: r }) {
        if ((r == null ? void 0 : r.type) === "TSMappedType" && !t) return (Pe(r, e), !0);
    }
    function Pp({ comment: e, enclosingNode: t, followingNode: r }) {
        return !t || t.type !== "SwitchCase" || t.test || !r || r !== t.consequent[0]
            ? !1
            : (r.type === "BlockStatement" && At(e) ? It(r, e) : Pe(t, e), !0);
    }
    function kp({ comment: e, precedingNode: t, enclosingNode: r, followingNode: n }) {
        return Oe(t) &&
            (((r.type === "TSArrayType" || r.type === "ArrayTypeAnnotation") && !n) || qt(r))
            ? (z(v(!1, t.types, -1), e), !0)
            : !1;
    }
    function Ip({ comment: e, enclosingNode: t, precedingNode: r, followingNode: n }) {
        if (
            ((t == null ? void 0 : t.type) === "ObjectPattern" ||
                (t == null ? void 0 : t.type) === "ArrayPattern") &&
            (n == null ? void 0 : n.type) === "TSTypeAnnotation"
        )
            return (r ? z(r, e) : Pe(t, e), !0);
    }
    function Lp({ comment: e, precedingNode: t, enclosingNode: r, followingNode: n, text: s }) {
        return !n &&
            (r == null ? void 0 : r.type) === "UnaryExpression" &&
            ((t == null ? void 0 : t.type) === "LogicalExpression" ||
                (t == null ? void 0 : t.type) === "BinaryExpression") &&
            ie(s, j(r.argument), j(t.right)) &&
            Ru(e, s) &&
            !ie(s, j(t.right), j(e))
            ? (z(t.right, e), !0)
            : !1;
    ...
    function Mp(e, { parser: t }) {
        if (t === "flow" || t === "hermes" || t === "babel-flow")
            return ((e = X(!1, e, /[\s(]/gu, "")), e === "" || e === "/*" || e === "/*::");
    }
    function $u(e) {
        switch (e) {
            case "cr":
...
`;
    ...
    var Ie = Symbol("MODE_BREAK"),
        pt = Symbol("MODE_FLAT"),
        Xt = Symbol("cursor"),
        ss = Symbol("DOC_FILL_PRINTED_LENGTH");
    function Ku() {
        return { value: "", length: 0, queue: [] };
    }
    function vp(e, t) {
        return us(e, { type: "indent" }, t);
    }
    function jp(e, t, r) {
        return t === Number.NEGATIVE_INFINITY
            ...
            : t < 0
              ...
              : t
                ? t.type === "root"
                    ? { ...e, root: e }
                    : us(e, { type: typeof t == "string" ? "stringAlign" : "numberAlign", n: t }, r)
                : e;
    }
    function us(e, t, r) {
        ...
        for (; r >= 0; ) {
            ...
            switch (f) {
                ...
                case fe: {
                    ...
                    let y = m.break ? Ie : p,
                        C = m.expandedStates && y === Ie ? v(!1, m.expandedStates, -1) : m.contents;
                    a.push({ mode: y, doc: C });
                    break;
                }
                case he: {
                    let C =
                        (m.groupId ? s[m.groupId] || pt : p) === Ie
                            ? m.breakContents
                            : m.flatContents;
...
`,
                ...
                case it:
                    ...
                    break;
                case $e:
                    i.push({ ind: vp(y, t), mode: C, doc: c.contents });
                    break;
                case Ke:
                    i.push({ ind: jp(y, c.n, t), mode: C, doc: c.contents });
                    break;
                case Qe:
                    u -= is(a);
                    break;
                case fe:
                    switch (C) {
                        ...
                        case Ie: {
                            o = !1;
                            let A = { ind: y, mode: pt, doc: c.contents },
                                T = n - u,
                                B = p.length > 0;
                            if (!c.break && qr(A, i, T, B, r)) i.push(A);
                            else if (c.expandedStates) {
                                let g = v(!1, c.expandedStates, -1);
                                if (c.break) {
                                    ...
                                    for (let _ = 1; _ < c.expandedStates.length + 1; _++)
                                        if (_ >= c.expandedStates.length) {
                                            ...
                                            let M = c.expandedStates[_],
                                                J = { ind: y, mode: pt, doc: M };
                                            if (qr(J, i, T, B, r)) {
                                                i.push(J);
                                                break;
                                            }
                ...
                case _e: {
                    ...
                    let _ = B[T + 0],
                        M = B[T + 1],
                        J = { ind: y, mode: pt, doc: _ },
                        I = { ind: y, mode: Ie, doc: _ },
                        q = qr(J, [], A, p.length > 0, r, !0);
                    if (g === 1) {
                        q ? i.push(J) : i.push(I);
                        break;
                    }
                    let k = { ind: y, mode: pt, doc: M },
                        W = { ind: y, mode: Ie, doc: M };
                    if (g === 2) {
                        q ? i.push(k, J) : i.push(W, I);
                        break;
                    }
                    let ne = B[T + 2],
                        Z = { ind: y, mode: C, doc: { ...c, [ss]: T + 2 } };
                    qr({ ind: y, mode: pt, doc: [_, M, ne] }, [], A, p.length > 0, r, !0)
                        ? i.push(Z, k, J)
                        : q
                          ? i.push(Z, W, J)
                          : i.push(Z, W, I);
                ...
                case ze: {
                    ...
                    if (A === Ie) {
                        let T =
                            c.type === he ? c.breakContents : c.negate ? c.contents : D(c.contents);
                        T && i.push({ ind: y, mode: C, doc: T });
                    }
                    if (A === pt) {
                        let T =
                            c.type === he ? c.flatContents : c.negate ? D(c.contents) : c.contents;
                        T && i.push({ ind: y, mode: C, doc: T });
                    }
                    break;
                }
                case Ze:
                    ...
                    break;
                case Ge:
                    p.length > 0 && i.push({ ind: y, mode: C, doc: Hn });
                    break;
                case oe:
                    switch (C) {
                        case pt:
                        ...
                        case Ie:
                            if (p.length > 0) {
                                (i.push({ ind: y, mode: C, doc: c }, ...p.reverse()),
                                    (p.length = 0));
                                break;
                            }
                            c.literal
                                ? y.root
                                    ? (a.push(s, y.root.value), (u = y.root.length))
                                    : (a.push(s), (u = 0))
                                : ((u -= is(a)), a.push(s + y.value), (u = y.length));
                            break;
                    }
                    break;
                case Se:
        ...
        if (f !== -1) {
            ...
            let C = a.slice(0, f).join(""),
                c = a.slice(f + 1, y).join(""),
                A = a.slice(y + 1).join("");
...
`);
    ...
    function Wr(e, t, r) {
        let { node: n } = e;
        if (n.type === "TemplateLiteral" && qp(e)) {
            let p = Np(e, t, r);
            if (p) return p;
        }
        let u = "expressions";
...
`)
                ...
                let c = a[p],
                    A = n[u][p],
                    T = ie(t.originalText, P(m), j(n.quasis[p + 1]));
                if (!T) {
                    let g = as(c, { ...t, printWidth: Number.POSITIVE_INFINITY }).formatted;
                    g.includes(`
`)
                        ? (T = !0)
                        : (c = g);
...
`)
    ...
    function Zu(e, t, r) {
        let n = r("quasi"),
            { node: s } = e,
            u = "",
            i = Ve(s.quasi, h.Leading)[0];
        return (
            i &&
                (ie(t.originalText, P(s.typeArguments ?? s.typeParameters ?? s.tag), j(i))
                    ? (u = E)
                    : (u = " ")),
            at(n.label && { tagged: !0, ...n.label }, [
                r("tag"),
                r(s.typeArguments ? "typeArguments" : "typeParameters"),
                u,
                je,
                n,
            ])
        ...
        if (s.length > 1 || s.some((u) => u.length > 0)) {
            ...
            let i = [],
                a = u.map(
                    (y) =>
                        "${" +
                        as(y, { ...t, printWidth: Number.POSITIVE_INFINITY, endOfLine: "lf" })
                            .formatted +
                        "}"
                ),
...
`) && o.push({ hasLineBreak: !1, cells: [] }));
            ...
            let p = Math.max(s.length, ...o.map((y) => y.cells.length)),
                m = Array.from({ length: p }).fill(0),
                f = [{ cells: s }, ...o.filter((y) => y.cells.length > 0)];
            for (let { cells: y } of f.filter((C) => !C.hasLineBreak))
                for (let [C, c] of y.entries()) m[C] = Math.max(m[C], st(c));
            return (
                i.push(
                    je,
                    "`",
                        ...
                        b(
                            ...
                            f.map((y) =>
                                b(
                                    " | ",
                                    y.cells.map((C, c) =>
                                        y.hasLineBreak ? C : C + " ".repeat(m[c] - st(C))
                                    )
                                )
                            )
                        ),
    ...
    function Yt(e, t) {
        return e.map((r) => Gp(r, t), "expressions");
    }
    function Ur(e, t) {
        return ft(e, (r) =>
            typeof r == "string" ? (t ? X(!1, r, /(\\*)`/gu, "$1$1\\`") : os(r)) : r
        );
    }
    function os(e) {
        return X(!1, e, /([\\`]|\$\{)/gu, String.raw`\$1`);
    }
    ...
    function ei(e) {
        let t = (n) => n.type === "TemplateLiteral",
            r = (n, s) =>
                ...
                n.key.name === "styles" &&
                s === "value";
        return e.match(t, (n, s) => U(n) && s === "elements", r, ...cs) || e.match(t, r, ...cs);
    }
    function ti(e) {
        return e.match(
    ...
    function Xr({ node: e, parent: t }, r) {
        return ps(e, r) || (Wp(t) && ps(t, r)) || (t.type === "ExpressionStatement" && ps(t, r));
    }
    function Wp(e) {
        return (
    ...
    async function Up(e, t, r) {
        let { node: n } = r,
            ...
            u = 0,
            i = s.reduce(
                (m, f, y) => (y === 0 ? f : m + "@prettier-placeholder-" + u++ + "-id" + f),
                ""
            ),
    ...
    function Yp({ node: e, parent: t, grandparent: r }) {
        return (
            (r &&
                e.quasis &&
                ...
                return (
                    ...
                    (t.callee.type === "MemberExpression" &&
                        ((t.callee.object.type === "MemberExpression" &&
                            (Yr(t.callee.object.object) || ri(t.callee.object))) ||
                            (t.callee.object.type === "CallExpression" &&
                                Yr(t.callee.object.callee))))
                );
            case "Identifier":
                return t.name === "css";
            default:
    ...
    function Vp({ parent: e, grandparent: t }) {
        return (
    ...
    function $p(e) {
        if (Yp(e) || Hp(e) || Vp(e) || ei(e)) return Up;
    }
    var ni = $p;
...
`),
            ...
            let g = null;
            (B ? (g = Qp(y)) : (g = await e(f, { parser: "graphql" })),
                g
                    ? ((g = Ur(g, !1)), !p && A && i.push(""), i.push(g), !m && T && i.push(""))
                    : !p && !m && A && i.push(""),
                c && i.push(c));
        }
        return ["`", D([F, b(F, i)]), F, "`"];
    ...
    function zp({ node: e, parent: t }) {
        return (
            Xr({ node: e, parent: t }, "GraphQL") ||
            (t &&
                ((t.type === "TaggedTemplateExpression" &&
                    ((t.tag.type === "MemberExpression" &&
    ...
    async function ui(e, t, r, n, s) {
        let { node: u } = n,
            i = ls;
        ls = (ls + 1) >>> 0;
        let a = (B) => `PRETTIER_HTML_PLACEHOLDER_${B}_${i}_IN_JS`,
            o = u.quasis
                .map((B, g, _) => (g === _.length - 1 ? B.value.cooked : B.value.cooked + a(g)))
                .join(""),
            p = Yt(n, r),
                ...
                for (let M = 0; M < _.length; M++) {
                    ...
                    if (M % 2 === 0) {
                        J &&
                            ((J = os(J)),
                            s.__embeddedInHtml &&
                                (J = X(!1, J, /<\/(?=script\b)/giu, String.raw`<\/`)),
                            g.push(J));
                        continue;
                    }
                    let I = Number(J);
            ...
            c = /^\s/u.test(o) ? " " : "",
            A = /\s$/u.test(o) ? " " : "",
            T = s.htmlWhitespaceSensitivity === "ignore" ? F : c && A ? x : null;
        return T
            ? l(["`", D([T, l(C)]), T, "`"])
            : at({ hug: !1 }, l(["`", c, f > 1 ? D(l(C)) : l(C), A, "`"]));
    }
    function ec(e) {
        return (
            Xr(e, "HTML") ||
    ...
    var tc = ui.bind(void 0, "html"),
        rc = ui.bind(void 0, "angular");
    function nc(e) {
        if (ec(e)) return tc;
        if (ti(e)) return rc;
    }
    ...
    function oc(e) {
        let { node: t } = e;
        if (t.type !== "TemplateLiteral" || pc(t)) return;
        let r;
        for (let n of [ni, si, ii, ai])
            if (((r = n(e)), !!r))
                return t.quasis.length === 1 && t.quasis[0].value.raw.trim() === ""
                    ? "``"
                    : async (...s) => {
                          let u = await r(...s);
                          return u && at({ embed: !0, ...u.label }, u);
                      };
    }
    function pc({ quasis: e }) {
    ...
    function Ei(e) {
        let t = `
`;
        e = X(!1, e.replace(lc, "").replace(cc, ""), fc, "$1");
        let r = "";
        for (; r !== e; ) ((r = e), (e = X(!1, e, yc, `${t}$1 $2${t}`)));
        e = e.replace(pi, "").trimEnd();
        let n = Object.create(null),
            s = X(!1, e, ci, "").replace(pi, "").trimEnd(),
            u;
        for (; (u = ci.exec(e)); ) {
            let i = X(!1, u[2], mc, "");
...
`);
    ...
    function Ec(e) {
        ...
        let r = fi(e),
            { pragmas: n, comments: s } = Ei(r);
        return { shebang: t, text: e, pragmas: n, comments: s };
    }
    function di(e) {
        let { shebang: t, text: r, pragmas: n, comments: s } = Ec(e),
            u = Di(r),
            i = Fi({ pragmas: { [Ci]: "", ...n }, comments: s.trimStart() });
        return (
            (t
                ? `${t}
`
...
`) +
    ...
    function ms(e, t) {
        ...
        if (t.__isInHtmlInterpolation && !t.bracketSpacing && Tc(r) && yr(e)) return !0;
        if (Cc(r)) return !1;
        if (r.type === "Identifier") {
            ...
            if (r.name === "let") {
                let c =
                    (i = e.findAncestor((A) => A.type === "ForOfStatement")) == null
                        ? void 0
                        : i.left;
                if (c && pe(c, (A) => A === r)) return !0;
            }
            if (
                n === "object" &&
                r.name === "let" &&
        ...
        if (
            ...
            let c =
                (a = e.findAncestor((A) => A.type === "ExpressionStatement")) == null
                    ? void 0
                    : a.expression;
            if (c && pe(c, (A) => A === r)) return !0;
        }
        if (r.type === "ObjectExpression") {
            let c =
                (o = e.findAncestor((A) => A.type === "ArrowFunctionExpression")) == null
                    ? void 0
                    : o.body;
            if (
                c &&
        ...
        switch (r.type) {
            ...
            case "UnaryExpression":
                switch (s.type) {
                    case "UnaryExpression":
                        return (
                            r.operator === s.operator && (r.operator === "+" || r.operator === "-")
                        );
                    case "BindExpression":
                        return !0;
                    case "MemberExpression":
            ...
            case "BinaryExpression":
                if (s.type === "UpdateExpression" || (r.operator === "in" && Ac(e))) return !0;
                ...
                switch (s.type) {
                    ...
                    case "BinaryExpression": {
                        ...
                        let T = sr(c),
                            B = s.operator,
                            g = sr(B);
                        return g > T || (n === "right" && g === T) || (g === T && !ar(B, c))
                            ? !0
                            : g < T && c === "%"
                              ? B === "+" || B === "-"
                              : !!Tu(B);
            ...
            case "ConditionalTypeAnnotation":
                if (
                    (n === "extendsType" && Je(r) && s.type === r.type) ||
                    (n === "checkType" && Je(s))
                )
                    return !0;
            ...
            case "TSIntersectionType":
                if ((Oe(s) || qt(s)) && s.types.length > 1 && (!r.types || r.types.length > 1))
                    return !0;
            case "TSInferType":
            ...
            case "FunctionTypeAnnotation": {
                ...
                return (
                    ...
                    (n === "extendsType" &&
                        ...
                        ((m = r.returnType) == null ? void 0 : m.type) === "InferTypeAnnotation" &&
                        ((f = r.returnType) == null ? void 0 : f.typeParameter.bound)) ||
                    ...
                    (s.type === "FunctionTypeParam" &&
                        ...
                        Q(r).some((A) => {
                            var T;
                            return (
                                ((T = A.typeAnnotation) == null ? void 0 : T.type) ===
                ...
                return !(
                    ...
                    (n === "expressions" &&
                        ...
                        e.match(
                            void 0,
                            void 0,
                            (c, A) => (A === "init" || A === "update") && c.type === "ForStatement"
                        )) ||
                    (n === "value" &&
                        s.type === "Property" &&
                        e.match(
                            void 0,
                            void 0,
                            (c, A) => A === "properties" && c.type === "ObjectPattern"
                        )) ||
            ...
            case "ArrowFunctionExpression":
                switch (s.type) {
                    case "BinaryExpression":
                        return (
                            s.operator !== "|>" ||
                            ((y = r.extra) == null ? void 0 : y.parenthesized)
                        );
                    case "NewExpression":
                    case "CallExpression":
                    case "OptionalCallExpression":
    ...
    function dc(e) {
        return ur(
            ...
            (t) =>
                ...
                ur(t, (r) => r.type === "FunctionTypeAnnotation")
        );
    }
    function Tc(e) {
        return ue(e);
    ...
    function xi(e, t) {
        ...
        return r.type === "FunctionExpression" || r.type === "ClassExpression"
            ? n.type === "ExportDefaultDeclaration" || !ms(e, t)
            : !Jt(r) || (n.type !== "ExportDefaultDeclaration" && ms(e, t))
              ? !1
              : e.call(() => xi(e, t), ...Lr(r));
    }
    function xc(e) {
        return !!(
            ...
            (e.match(
                ...
                (e.match(
                    ...
                    (t, r) =>
                        (r === "callee" &&
                            ((t.type === "CallExpression" && !t.optional) ||
    ...
    function ys(e) {
        return e.type === "Identifier"
            ? !0
            : G(e)
              ? !e.computed && !e.optional && e.property.type === "Identifier" && ys(e.object)
              : !1;
    }
    function hc(e) {
        return (
            e.type === "ChainExpression" && (e = e.expression),
            ys(e) || (w(e) && !e.optional && ys(e.callee))
        );
    }
    var Le = ms;
    function gc(e, t) {
    ...
    function Bc(e, t) {
        ...
        if ((m = s.isBlockComment) == null ? void 0 : m.call(s, r)) {
            let f = ee(u, a(r)) ? (ee(u, i(r), { backwards: !0 }) ? F : x) : " ";
            n.push(f);
        } else n.push(F);
        let p = He(u, Ye(u, a(r)));
        return (p !== !1 && ee(u, p) && n.push(F), n);
    }
    function bc(e, t, r) {
        var p;
        let n = e.node,
        ...
        if (
            ...
            ee(i, a(n), { backwards: !0 })
        ) {
            let m = hi(i, a(n));
            return { doc: Yn([F, m ? F : "", s]), isBlock: o, hasLineSuffix: !0 };
        }
        return !o || (r != null && r.hasLineSuffix)
            ? { doc: [Yn([" ", s]), Ce], isBlock: o, hasLineSuffix: !0 }
            : { doc: [" ", s], isBlock: o, hasLineSuffix: !1 };
    }
    function N(e, t, r = {}) {
        let { node: n } = e;
        if (!O(n == null ? void 0 : n.comments)) return "";
        let { indent: s = !1, marker: u, filter: i = Sc } = r,
            a = [];
        if (
            (e.each(({ node: p }) => {
                p.leading || p.trailing || p.marker !== u || !i(p) || a.push(fs(e, t));
            }, "comments"),
            a.length === 0)
        )
            return "";
    ...
    function Ds(e, t) {
        ...
        return (
            e.each(() => {
                ...
                p ? u.push(Bc(e, t)) : m && ((a = bc(e, t, a)), i.push(a.doc));
            }, "comments"),
            { leading: u, trailing: i }
        );
    }
    function Ee(e, t, r) {
        let { leading: n, trailing: s } = Ds(e, r);
...
\r	`),
    ...
    function Pc(e, t, r) {
        var _, M, J, I, q;
        let { node: n } = e;
        if (n.type === "JSXElement" && Wc(n)) return [r("openingElement"), r("closingElement")];
        ...
        n.children = n.children.map((k) => (Uc(k) ? { type: "JSXText", value: " ", raw: " " } : k));
        let i = n.children.some(Y),
            a = n.children.filter((k) => k.type === "JSXExpressionContainer").length > 1,
            ...
            y = m ? x : S([f, E], " "),
            C =
                ((M = (_ = n.openingElement) == null ? void 0 : _.name) == null
                    ? void 0
                    : M.name) === "fbt",
            c = kc(e, t, r, y, C),
            A = n.children.some((k) => fr(k));
        for (let k = c.length - 2; k >= 0; k--) {
            let W = c[k] === "" && c[k + 1] === "",
                ne = c[k] === F && c[k + 1] === "" && c[k + 2] === F,
                Z = (c[k] === E || c[k] === F) && c[k + 1] === "" && c[k + 2] === y,
                lt = c[k] === y && c[k + 1] === "" && (c[k + 2] === E || c[k + 2] === F),
                L = c[k] === y && c[k + 1] === "" && c[k + 2] === y,
                se =
                    (c[k] === E && c[k + 1] === "" && c[k + 2] === F) ||
                    (c[k] === F && c[k + 1] === "" && c[k + 2] === E);
            (ne && A) || W || Z || L || se ? c.splice(k, 2) : lt && c.splice(k + 1, 2);
        }
        for (; c.length > 0 && As(v(!1, c, -1)); ) c.pop();
        for (; c.length > 1 && As(c[0]) && As(c[1]); ) (c.shift(), c.shift());
        let T = [""];
        for (let [k, W] of c.entries()) {
            ...
            (k % 2 === 0 ? T.push([T.pop(), W]) : T.push(W, ""), re(W) && (p = !0));
        }
        let B = A ? Nr(T) : l(T, { shouldBreak: !0 });
        if (
            ...
            n.children.includes(t.cursorNode)
                ...
                : ((I = t.nodeBeforeCursor) == null ? void 0 : I.type) === "JSXText" &&
                  ...
                  ? (B = [mr, B])
                  : ((q = t.nodeAfterCursor) == null ? void 0 : q.type) === "JSXText" &&
            ...
            e.each(({ node: p, next: m }) => {
                if (p.type === "JSXText") {
                    ...
                    if (fr(p)) {
                        ...
                        let C;
                        if ((v(!1, y, -1) === "" && (y.pop(), (C = y.pop())), y.length === 0))
                            return;
    ...
    function wc(e) {
        return (
            e.match(void 0, (t) => t.type === "ArrowFunctionExpression", w) &&
            (e.match(void 0, void 0, void 0, (t) => t.type === "JSXExpressionContainer") ||
                e.match(
                    void 0,
                    void 0,
                    void 0,
                    (t) => t.type === "ChainExpression",
                    (t) => t.type === "JSXExpressionContainer"
                ))
        );
    }
    function Oc(e, t, r) {
        ...
        if ((s.push(r("name")), n.value)) {
            ...
            if (K(n.value)) {
                let i = ae(n.value),
                    a = X(!1, X(!1, i.slice(1, -1), "&apos;", "'"), "&quot;", '"'),
                    o = Sr(a, t.jsxSingleQuote);
                ((a = o === '"' ? X(!1, a, '"', "&quot;") : X(!1, a, "'", "&apos;")),
                    (u = e.call(() => Ee(e, ve(o + a + o), t), "value")));
            } else u = r("value");
            s.push("=", u);
        }
        return s;
...
`)
    ...
    function vc(e, t, r) {
        return e.selfClosing ? [x, "/>"] : jc(e, t, r) ? [">"] : [E, ">"];
    }
    function jc(e, t, r) {
        let n = e.attributes.length > 0 && d(v(!1, e.attributes, -1), h.Trailing);
        return (
    ...
    function Rc(e, t, r) {
        ...
        let u = r("name");
        return (
            d(n.name, h.Leading | h.Line)
                ? s.push(D([F, u]), F)
                : d(n.name, h.Leading | h.Block)
                  ? s.push(" ", u)
                  : s.push(u),
            s.push(">"),
            s
    ...
    function qc(e, t, r) {
        ...
        return [
            ...
            e.call(
                ({ node: s }) => {
                    let u = ["...", r()];
                    return !d(s) || !ns(e) ? u : [D([E, Ee(e, u, t)]), E];
                },
    ...
    function $r(e, t, r) {
        ...
        let { node: n, parent: s, grandparent: u, key: i } = e,
            ...
            o =
                n.operator === "|>" &&
                ((M = e.root.extra) == null ? void 0 : M.__isUsingHackPipeline),
            p = ds(e, t, r, !1, a);
        if (a) return p;
        if (o) return l(p);
        if ((w(s) && s.callee === n) || s.type === "UnaryExpression" || (G(s) && !s.computed))
            return l([D([E, ...p]), E]);
        let m =
                s.type === "ReturnStatement" ||
                s.type === "ThrowStatement" ||
            ...
            f =
                ...
                Te(s),
            y = Fe(n.left) && ar(n.operator, n.left.operator);
        if (m || (Ht(n) && !y) || (!Ht(n) && f)) return l(p);
        if (p.length === 0) return "";
        let C = Y(n.right),
            c = p.findIndex((J) => typeof J != "string" && !Array.isArray(J) && J.type === fe),
            A = p.slice(0, c === -1 ? 1 : c + 1),
            T = p.slice(A.length, C ? -1 : void 0),
            B = Symbol("logicalChain-" + ++Yc),
            g = l([...A, D(T)], { id: B });
        if (!C) return g;
        let _ = v(!1, p, -1);
    ...
    function ds(e, t, r, n, s) {
        ...
        ar(u.operator, u.left.operator)
            ? (i = e.call((g) => ds(g, t, r, !0, s), "left"))
            : i.push(l(r("left")));
        let a = Ht(u),
            o =
                (u.operator === "|>" || u.type === "NGPipeExpression" || Hc(e, t)) &&
                !de(t.originalText, u.right),
            m = !d(u.right, h.Leading, Gr) && de(t.originalText, u.right),
            f = u.type === "NGPipeExpression" ? "|" : u.operator,
            y =
        ...
        if (a) C = [f, de(t.originalText, u.right) ? D([x, r("right"), y]) : [" ", r("right"), y]];
            ...
            let _ =
                f === "|>" && ((B = e.root.extra) == null ? void 0 : B.__isUsingHackPipeline)
                    ? e.call((M) => ds(M, t, r, !0, s), "right")
                    : r("right");
    ...
    function Ht(e) {
        return e.type !== "LogicalExpression"
            ? !1
            : !!(
                  (ue(e.right) && e.right.properties.length > 0) ||
    ...
    function Hc(e, t) {
        return (
            ...
            ki(e.node) &&
            !e.hasAncestor((r) => !ki(r) && r.type !== "JsExpressionRoot")
        );
    }
    function Li(e, t, r) {
        let { node: n } = e;
    ...
    function Vc(e) {
        let { node: t } = e;
        return (
            e.parent.body[1].key.name === "of" &&
            t.type === "NGMicrosyntaxKeyedExpression" &&
            t.key.name === "track" &&
            t.key.type === "NGMicrosyntaxKey"
        );
    }
    var $c = R(["CallExpression", "OptionalCallExpression", "AssignmentExpression"]);
    function Kc({ node: e }) {
        return ur(e, $c);
    }
    function Ts(e, t, r) {
    ...
    function Oi(e, t, r) {
        ...
        return [
            e.key === "declaration" && yu(s) ? F : i ? Ce : "",
            b(x, e.map(r, "decorators")),
            x,
        ];
    }
    function _i(e, t) {
    ...
    function Qc(e, t, r) {
        ...
        Gt(e, ({ node: f }, y) => {
            let C = r();
            (y === u || (me(f, t) ? ((i = !0), (C = [C, ",", F, F])) : (C = [C, ",", x])),
                a.push(C));
        });
        let o =
            !t.parser.startsWith("__ng_") &&
        ...
        if (
            n.type === "TSImportType" &&
            s.length === 1 &&
            ((s[0].type === "TSLiteralType" && K(s[0].literal)) || K(s[0])) &&
            !d(s[0])
        )
            return l(["(", ...a, S(o), ")"]);
        function p() {
            return l(["(", D([x, ...a]), o, x, ")"], { shouldBreak: !0 });
        }
        ...
        if (Zc(s)) {
            ...
            let y;
            try {
                y = r(qn(n, 0), { expandFirstArg: !0 });
            } catch (C) {
                if (C instanceof Dt) return p();
                throw C;
            }
            return re(y)
                ? [Ce, tt([["(", l(y, { shouldBreak: !0 }), ", ", ...f, ")"], p()])]
                : tt([
                      ["(", y, ", ", ...f, ")"],
                      ["(", l(y, { shouldBreak: !0 }), ", ", ...f, ")"],
                      p(),
        ...
        if (zc(s, a, t)) {
            ...
            let y;
            try {
                y = r(qn(n, -1), { expandLastArg: !0 });
            } catch (C) {
                if (C instanceof Dt) return p();
                throw C;
            }
            return re(y)
                ? [Ce, tt([["(", ...f, l(y, { shouldBreak: !0 }), ")"], p()])]
                : tt([["(", ...f, y, ")"], ["(", ...f, l(y, { shouldBreak: !0 }), ")"], p()]);
        }
        let m = ["(", D([E, ...a]), S(o), E, ")"];
    ...
    function Dr(e, t = !1) {
        return (
            (ue(e) && (e.properties.length > 0 || d(e))) ||
            (U(e) && (e.elements.length > 0 || d(e))) ||
            (e.type === "TSTypeAssertion" && Dr(e.expression)) ||
            (xe(e) && Dr(e.expression)) ||
            e.type === "FunctionExpression" ||
            (e.type === "ArrowFunctionExpression" &&
                ...
                (e.body.type === "BlockStatement" ||
                    (e.body.type === "ArrowFunctionExpression" && Dr(e.body, !0)) ||
                    ue(e.body) ||
                    U(e.body) ||
                    (!t && (w(e.body) || e.body.type === "ConditionalExpression")) ||
                    Y(e.body))) ||
            e.type === "DoExpression" ||
    ...
    function Zc(e) {
        ...
        let [t, r] = e;
        return t.type === "ModuleExpression" && rl(r)
            ? !0
            : !d(t) &&
    ...
    function ji(e) {
        ...
        return yt(e) && le(e).length > 1
            ? !1
            : Fe(e)
              ? we(e.left, 1) && we(e.right, 1)
              : Nn(e) || we(e);
    }
    function el(e) {
        return e.length === 2
    ...
    function tl(e) {
        return (
            ...
            (e.body.some((t) => t.type !== "EmptyStatement") || d(e, h.Dangling))
        );
    }
    function rl(e) {
        ...
        return Te(t)
            ? !t.computed &&
                  ((t.key.type === "Identifier" && t.key.name === "type") ||
                      (K(t.key) && t.key.value === "type")) &&
                  K(t.value) &&
                  t.value.value === "module"
            : !1;
    }
    var Lt = Qc;
    var nl = (e) => (
    ...
    function Ri(e, t, r) {
        ...
        let n = r("object"),
            s = hs(e, t, r),
            { node: u } = e,
            i = e.findAncestor((m) => !(G(m) || m.type === "TSNonNullExpression")),
            a = e.findAncestor(
                (m) => !(m.type === "ChainExpression" || m.type === "TSNonNullExpression")
            ),
            o =
                (i &&
                ...
                u.computed ||
                (u.object.type === "Identifier" && u.property.type === "Identifier" && !G(a)) ||
                ((a.type === "AssignmentExpression" || a.type === "VariableDeclarator") &&
                    (nl(u.object) || ((p = n.label) == null ? void 0 : p.memberChain)));
    ...
    function Ji(e, t, r) {
        ...
        let n =
                (e.parent.type === "ChainExpression" ? e.grandparent : e.parent).type ===
                "ExpressionStatement",
            s = [];
        function u(L) {
            let { originalText: se } = t,
                Ae = ot(se, P(L));
            return se.charAt(Ae) === ")" ? Ae !== !1 && vt(se, Ae + 1) : me(L, t);
        }
        function i() {
            let { node: L } = e;
            ...
            if (w(L) && (dt(L.callee) || w(L.callee))) {
                ...
                (s.unshift({
                    node: L,
                    hasTrailingEmptyLine: se,
                    printed: [Ee(e, [V(e), rt(e, t, r), Lt(e, t, r)], t), se ? F : ""],
                }),
                    e.call(i, "callee"));
            } else
                dt(L)
                    ? (s.unshift({
                          node: L,
                          needsParens: Le(e, t),
                          printed: Ee(e, G(L) ? hs(e, t, r) : Kr(e, t, r), t),
                      }),
                      e.call(i, "object"))
                    : L.type === "TSNonNullExpression"
                      ? (s.unshift({ node: L, printed: Ee(e, "!", t) }), e.call(i, "expression"))
                      : s.unshift({ node: L, printed: r() });
        }
        let { node: a } = e;
        (s.unshift({ node: a, printed: [V(e), rt(e, t, r), Lt(e, t, r)] }),
            a.callee && e.call(i, "callee"));
        let o = [],
            p = [s[0]],
            m = 1;
        for (
            ...
            (s[m].node.type === "TSNonNullExpression" ||
                w(s[m].node) ||
                (G(s[m].node) && s[m].node.computed && ye(s[m].node.property)));
            ++m
        )
            p.push(s[m]);
        if (!w(s[0].node))
            for (; m + 1 < s.length && dt(s[m].node) && dt(s[m + 1].node); ++m) p.push(s[m]);
        (o.push(p), (p = []));
        let f = !1;
        for (; m < s.length; ++m) {
            if (f && dt(s[m].node)) {
            ...
            ((w(s[m].node) || s[m].node.type === "ImportExpression") && (f = !0),
                p.push(s[m]),
                d(s[m].node, h.Trailing) && (o.push(p), (p = []), (f = !1)));
        }
        p.length > 0 && o.push(p);
        function y(L) {
        ...
        function c(L) {
            ...
            if (L[0].length === 1) {
                let nt = L[0][0].node;
                return (
                    nt.type === "ThisExpression" ||
                    (nt.type === "Identifier" && (y(nt.name) || (n && C(nt.name)) || se))
                );
            }
            let Ae = v(!1, L[0], -1).node;
            return G(Ae) && Ae.property.type === "Identifier" && (y(Ae.property.name) || se);
        }
        let A = o.length >= 2 && !d(o[1][0].node) && c(o);
        function T(L) {
            let se = L.map((Ae) => Ae.printed);
            return L.length > 0 && v(!1, L, -1).needsParens ? ["(", ...se, ")"] : se;
        }
        function B(L) {
        ...
        let g = o.map(T),
            ...
            J = o.flat(),
            I =
                J.slice(1, -1).some((L) => d(L.node, h.Leading)) ||
                J.slice(0, -1).some((L) => d(L.node, h.Trailing)) ||
                (o[M] && d(o[M][0].node, h.Leading));
        if (o.length <= M && !I && !o.some((L) => v(!1, L, -1).hasTrailingEmptyLine))
            return vr(e) ? _ : l(_);
        let q = v(!1, o[A ? 1 : 0], -1).node,
            k = !w(q) && u(q),
            W = [T(o[0]), A ? o.slice(1, 2).map(T) : "", k ? F : "", B(o.slice(A ? 2 : 1))],
            ne = s.map(({ node: L }) => L).filter(w);
        function Z() {
            let L = v(!1, v(!1, o, -1), -1).node,
                se = v(!1, g, -1);
        ...
        return (
            I ||
            (ne.length > 2 && ne.some((L) => !L.arguments.every((se) => we(se)))) ||
            g.slice(0, -1).some(re) ||
            Z()
                ? (lt = l(W))
                : (lt = [re(_) || k ? Ce : "", tt([_, W])]),
    ...
    function Qr(e, t, r) {
        ...
        if (o || sl(e) || Pt(n, e.parent)) {
            let f = [];
            if (
                (Gt(e, () => {
                    f.push(r());
                }),
                !(o && (m = f[0].label) != null && m.embed))
            )
                return [s ? "new " : "", Gi(e, r), i, rt(e, t, r), "(", b(", ", f), ")"];
        }
        if (
            !u &&
            !s &&
    ...
    function Gi(e, t) {
        let { node: r } = e;
        return r.type === "ImportExpression"
            ? `import${r.phase ? `.${r.phase}` : ""}`
            : t("callee");
    }
    function sl(e) {
        let { node: t } = e;
    ...
    function ul(e, t, r, n, s) {
        ...
        if (
            e.match(
                zr,
                Xi,
                (y) => !a || (y.type !== "ExpressionStatement" && y.type !== "VariableDeclaration")
            )
        )
            return a
        ...
        let m = Lu(n);
        if (al(u) || ll(u) || (gs(u) && m)) return "break-lhs";
        let f = yl(u, n, t);
        return e.call(() => il(e, t, r, f), s)
    ...
    var pl = R(["TSTypeAliasDeclaration", "TypeAlias"]);
    function cl(e) {
        var t;
        if (pl(e)) return (t = e.typeParameters) == null ? void 0 : t.params;
    }
    function ll(e) {
    ...
    var ml = R(["TSTypeReference", "GenericTypeAnnotation"]);
    function qi(e) {
        var t;
        if (ml(e)) return (t = e.typeArguments ?? e.typeParameters) == null ? void 0 : t.params;
    }
    function Yi(e, t, r, n = !1) {
        ...
        if (w(s)) {
            ...
            let o = le(s);
            return !(o.length === 0 || (o.length === 1 && ir(o[0], t))) || fl(s, r)
                ? !1
                : e.call(u, "callee");
        }
        return G(s)
    ...
    function yl(e, t, r) {
        return Te(e) ? ((t = Ut(t)), typeof t == "string" && st(t) < r.tabWidth + 3) : !1;
    }
    function fl(e, t) {
        let r = Dl(e);
        if (O(r)) {
    ...
    function Ue(e, t, r, n, s) {
        let u = e.node,
            ...
            a = s ? rt(e, t, r) : "";
        if (i.length === 0)
            return [a, "(", N(e, t, { filter: (c) => ke(t.originalText, P(c)) === ")" }), ")"];
        let { parent: o } = e,
            p = Pt(o),
            m = Ss(u),
            f = [];
        if (
            (hu(e, (c, A) => {
                ...
                (T && u.rest && f.push("..."),
                    ...
                    !T &&
                        (f.push(","),
                        p || m ? f.push(" ") : me(i[A], t) ? f.push(F, F) : f.push(x)));
            }),
            n && !Cl(e))
        ) {
        ...
        return m && y
            ...
            : p
              ...
              : (Or(o) ||
                  ...
                  Nt(i[0].typeAnnotation) &&
                  !u.rest
                ? t.arrowParens === "always" || u.type === "HookTypeAnnotation"
                    ? ["(", ...f, ")"]
                    : f
                : [a, "(", D([E, ...f]), S(!xu(u) && ce(t, "all") ? "," : ""), E, ")"];
    }
    function Ss(e) {
        if (!e) return !1;
        let t = Q(e);
            ...
            (r.type === "ObjectPattern" ||
                ...
                (r.type === "AssignmentPattern" &&
                    ...
                    (r.right.type === "Identifier" ||
                        (ue(r.right) && r.right.properties.length === 0) ||
    ...
    function Tl(e) {
        ...
        let r = t.find((n) => dl(n));
        return r ? t.every((n) => n === r || Al(n)) : !1;
    }
    function Bs(e) {
        return Nt(e) || Re(e) ? !0 : Oe(e) ? Tl(e) : !1;
    }
    function Vi(e, t, r) {
        let n = t.semi ? ";" : "",
            { node: s } = e,
    ...
    function H(e, t, r = "typeAnnotation") {
        ...
        if (n.type === "TSTypeAnnotation" || n.type === "TypeAnnotation") {
            let u = e.call($i, r);
            ((u === "=>" || (u === ":" && d(n, h.Leading))) && (s = !0), hl.add(n));
        }
        return s ? [" ", t(r)] : t(r);
    }
    var $i = (e) =>
    ...
    function cn({ node: e }, t) {
        let r = e.type === "TSTypeQuery" ? "exprName" : "argument",
            n =
                e.type === "TypeofTypeAnnotation" || e.typeArguments
                    ? "typeArguments"
                    : "typeParameters";
    ...
    function V(e) {
        ...
        return !t.optional || (t.type === "Identifier" && t === e.parent.key)
            ? ""
            : w(t) || (G(t) && t.computed) || t.type === "OptionalIndexedAccessType"
              ? "?."
              : "?";
    }
    function mn(e) {
    ...
    function $(e) {
        let { node: t } = e;
        return t.declare || (gl.has(t.type) && e.parent.type !== "DeclareExportDeclaration")
            ? "declare "
            : "";
    }
    var Sl = new Set([
    ...
    function Vt({ node: e }) {
        return e.abstract || Sl.has(e.type) ? "abstract " : "";
    }
    function rt(e, t, r) {
        let n = e.node;
    ...
    function Bl(e, t, r, n) {
        let { node: s } = e,
            u = s.inexact ? "..." : "";
        return d(s, h.Dangling) ? l([r, u, N(e, t, { indent: !0 }), E, n]) : [r, u, n];
    }
    function Kt(e, t, r) {
        let { node: n } = e,
            s = [],
            ...
            a =
                n.type === "TupleTypeAnnotation" && n.types
                    ...
                    : n.type === "TSTupleType" || n.type === "TupleTypeAnnotation"
                      ...
                      : "elements",
            o = n[a];
        if (o.length === 0) s.push(Bl(e, t, u, i));
        else {
            let p = v(!1, o, -1),
                m = (p == null ? void 0 : p.type) !== "RestElement" && !n.inexact,
                f = p === null,
                y = Symbol("array"),
                C =
                    !t.__inJestEach &&
                    ...
                    o.every((T, B, g) => {
                        ...
                        if (!U(T) && !ue(T)) return !1;
                        let M = g[B + 1];
                        if (M && _ !== M.type) return !1;
                        let J = U(T) ? "elements" : "properties";
                        return T[J] && T[J].length > 1;
                    }),
                c = xs(n, t),
                A = m ? (f ? "," : ce(t) ? (c ? S(",", "", { groupId: y }) : S(",")) : "") : "";
            s.push(
                l([u, D([E, c ? Pl(e, t, r, A) : [bl(e, t, r, a, n.inexact), A], N(e, t)]), E, i], {
                    shouldBreak: C,
                    id: y,
                })
            );
    ...
    function xs(e, t) {
        return (
            ...
            e.elements.every(
                (r) =>
                    r &&
                    (ye(r) || (Jn(r) && !d(r.argument))) &&
                    !d(r, h.Trailing | h.Line, (n) => !ee(t.originalText, j(n), { backwards: !0 }))
            )
        );
    }
    ...
    function Pl(e, t, r, n) {
        ...
        return (
            e.each(({ isLast: u, next: i }) => {
                (s.push([r(), u ? n : ","]),
                    u || s.push(Ki(e, t) ? [F, F] : d(i, h.Leading | h.Line) ? F : x));
            }, "elements"),
            Nr(s)
        );
    }
    ...
    function zi(e, t) {
        return t.parser === "json" ||
            t.parser === "jsonc" ||
            !K(e.key) ||
            ut(ae(e.key), t).slice(1, -1) !== e.key.value
            ? !1
            : !!(
                  (Qi(e.key.value) &&
                      !(
                          (t.parser === "babel-ts" && e.type === "ClassProperty") ||
                          ((t.parser === "typescript" || t.parser === "oxc-ts") &&
                              e.type === "PropertyDefinition")
                      )) ||
                  (Zi(e.key.value) &&
    ...
    function wl(e, t) {
        ...
        return (
            ...
            (t.parser === "json" ||
                t.parser === "jsonc" ||
                (t.quoteProps === "consistent" && fn.get(e.parent)))
        );
    }
    function Ct(e, t, r) {
        let { node: n } = e;
        ...
        return zi(n, t) &&
            (t.quoteProps === "as-needed" || (t.quoteProps === "consistent" && !fn.get(s)))
            ? e.call((i) => Ee(i, /^\d/u.test(u.value) ? Ft(u.value) : u.value, t), "key")
            : r("key");
    }
    function Dn(e, t, r) {
        let { node: n } = e;
    ...
    var Ol = ({ node: e, key: t, parent: r }) =>
        ...
        (r.type === "ObjectMethod" ||
            ...
            r.type === "TSAbstractMethodDefinition" ||
            r.type === "TSDeclareMethod" ||
            (r.type === "Property" && bt(r)));
    function En(e, t, r, n) {
        if (Ol(e)) return Fn(e, t, r);
        let { node: s } = e,
            u = !1;
        if (
            ...
            w(m) &&
                (le(m).length > 1 ||
                    Q(s).every((f) => f.type === "Identifier" && !f.typeAnnotation)) &&
                (u = !0);
        }
        let i = [
                $(e),
            ...
            p = ct(s, o);
        return (
            i.push(rt(e, t, r), l([p ? l(a) : a, o]), s.body ? " " : "", r("body")),
            t.semi && (s.declare || !s.body) && i.push(";"),
            i
        );
    }
    function Er(e, t, r) {
        ...
        return (
            !s || s === "init" || s === "method" || s === "constructor"
                ...
                : (jt.ok(s === "get" || s === "set"), i.push(s, " ")),
            u.generator && i.push("*"),
            i.push(Ct(e, t, r), n.optional ? "?" : "", n === u ? Fn(e, t, r) : r("value")),
            i
        );
    }
    function Fn(e, t, r) {
        let { node: n } = e,
            ...
            i = Hi(n),
            a = ct(n, u),
            o = [rt(e, t, r), l([i ? l(s, { shouldBreak: !0 }) : a ? l(s) : s, u])];
    ...
    function ea(e, t, r) {
        ...
        let i = d(n, h.Dangling),
            a = s && i && d(n, h.Last | h.Line);
    ...
    function Ml(e, t) {
        if (
            de(e.originalText, t) ||
            (d(t, h.Leading, (r) => ie(e.originalText, j(r), P(r))) && !Y(t))
        )
            return !0;
        if (Jt(t)) {
            let r = t,
                n;
            for (; (n = mu(r)); ) if (((r = n), de(e.originalText, r))) return !0;
        }
        return !1;
    }
    var Ps = new WeakMap();
        ...
        return (
            Ps.has(e) ||
                Ps.set(
                    e,
                    e.type === "ConditionalExpression" &&
                        !pe(e, (t) => t.type === "ObjectExpression")
                ),
            Ps.get(e)
        );
    }
    var vl = (e) => e.type === "SequenceExpression";
    function sa(e, t, r, n = {}) {
        let s = [],
            u,
            i = [],
        ...
        (function B() {
            ...
            if (s.length === 0) s.push(_);
                ...
                let { leading: M, trailing: J } = Ds(e, t);
                (s.push([M, _]), i.unshift(J));
            }
            (o &&
                (a ||
                    (a =
                        (g.returnType && Q(g).length > 0) ||
                        g.typeParameters ||
                        Q(g).some((M) => M.type !== "Identifier"))),
                !o || g.body.type !== "ArrowFunctionExpression"
                    ? ((u = r("body", n)), (p = g.body))
                    : e.call(B, "body"));
        })();
        let m = !de(t.originalText, p) && (vl(p) || Rl(p, u, t) || (!a && na(p))),
            f = e.key === "callee" && yt(e.parent),
            y = Symbol("arrow-chain"),
            C = Jl(e, n, { signatureDocs: s, shouldBreak: a }),
            c = !1,
            A = !1,
            T = !1;
        return (
            o &&
                (f || n.assignmentLayout) &&
                ((A = !0),
                (T = !d(e.node, h.Leading & h.Line)),
                (c = n.assignmentLayout === "chain-tail-arrow-chain" || (f && !m))),
            (u = Nl(e, t, n, {
                bodyDoc: u,
                bodyComments: i,
                functionBody: p,
            ...
            l([
                l(A ? D([T ? E : "", C]) : C, { shouldBreak: c, id: y }),
                " =>",
                o ? xt(u, { groupId: y }) : l(u),
                o && f ? S(E, "", { groupId: y }) : "",
            ])
        );
    }
    ...
    function Jl(e, t, { signatureDocs: r, shouldBreak: n }) {
        if (r.length === 1) return r[0];
        let { parent: s, key: u } = e;
        return (u !== "callee" && yt(s)) || Fe(s)
            ? l([r[0], " =>", D([x, b([" =>", x], r.slice(1))])], { shouldBreak: n })
            : (u === "callee" && yt(s)) || t.assignmentLayout
              ? l(b([" =>", x], r), { shouldBreak: n })
              : l(D(b([" =>", x], r)), { shouldBreak: n });
    }
    function Nl(
        e,
        t,
    ...
    function Fr(e, t, r, n) {
        let { node: s } = e,
            u = [],
            i = ua(!1, s[n], (a) => a.type !== "EmptyStatement");
        return (
            e.each(({ node: a }) => {
                a.type !== "EmptyStatement" &&
                    (u.push(r()), a !== i && (u.push(F), me(a, t) && u.push(F)));
            }, n),
            u
        );
    }
    ...
    function ql(e, t, r) {
        ...
        return (
            s &&
                (a.push(Fr(e, t, r, "directives")),
                (u || i) && (a.push(F), me(v(!1, n.directives, -1), t) && a.push(F))),
            u && a.push(Fr(e, t, r, "body")),
            i && a.push(N(e, t)),
            a
        );
    }
    ...
    function wt(e, t, r, n) {
        ...
        let u = Pt(e.grandparent),
            i = e.match(
                (p) => !(p[n].length === 1 && Re(p[n][0])),
                void 0,
                (p, m) => m === "typeAnnotation",
                (p) => p.type === "Identifier",
                gs
            );
        if (
            ...
            (!i &&
                (u ||
                    (s[n].length === 1 &&
                        (s[n][0].type === "NullableTypeAnnotation" || Bs(s[n][0])))))
        )
            return ["<", b(", ", e.map(r, n)), Xl(e, t), ">"];
        let o =
            s.type === "TSTypeParameterInstantiation"
                ? ""
                : Ul(e, t, n)
    ...
    function Tn(e, t, r) {
        let { node: n } = e,
            s = [n.const ? "const " : ""],
            u = n.type === "TSTypeParameter" ? r("name") : n.name;
        if (
            (n.variance && s.push(r("variance")),
            n.in && s.push("in "),
            n.out && s.push("out "),
            s.push(u),
            n.bound && (n.usesExtendsBound && s.push(" extends "), s.push(H(e, r, "bound"))),
            n.constraint)
        ) {
    ...
    function xn(e, t, r) {
        ...
        if ((n.id && i.push(" ", r("id")), i.push(r("typeParameters")), n.superClass)) {
            let m = [
                    Hl(e, t, r),
                    r(n.superTypeArguments ? "superTypeArguments" : "superTypeParameters"),
                ],
                f = e.call((y) => ["extends ", Ee(y, m, t)], "superClass");
            u ? a.push(x, l(f)) : a.push(" ", f);
        } else a.push(ks(e, t, r, "extends"));
        a.push(ks(e, t, r, "mixins"), ks(e, t, r, "implements"));
        let o;
        if (u) {
            let m;
        ...
        let p = n.body;
        return (
            u && O(p.body) ? s.push(S(F, " ", { groupId: o })) : s.push(" "),
            s.push(r("body")),
            s
        );
    }
    ...
    function pa(e) {
        return e.typeParameters && !d(e.typeParameters, h.Trailing | h.Line) && !Yl(e);
    }
    function ks(e, t, r, n) {
        let { node: s } = e;
        if (!O(s[n])) return "";
        ...
        return [
            pa(s) ? S(" ", x, { groupId: Cr(s.typeParameters) }) : x,
            u,
            u && F,
            n,
            l(D([x, b([",", x], e.map(r, n))])),
    ...
    function hn(e, t, r) {
        let { node: n } = e,
            s = [];
        return (
            O(n.decorators) && s.push(Ts(e, t, r)),
            s.push($t(n)),
    ...
    function gn(e, t, r) {
        ...
        (O(n.decorators) && s.push(Ts(e, t, r)),
            ...
            (n.type === "ClassAccessorProperty" ||
                ...
                s.push("accessor "),
            s.push(Ct(e, t, r), V(e), mn(e), H(e, r)));
        let i =
            n.type === "TSAbstractPropertyDefinition" || n.type === "TSAbstractAccessorProperty";
    ...
    function ca(e, t, r) {
        ...
        return (
            e.each(({ node: u, next: i, isLast: a }) => {
                (s.push(r()),
                    !t.semi && ia(u) && Vl(u, i) && s.push(";"),
                    a || (s.push(F), me(u, t) && s.push(F)));
            }, "body"),
            d(n, h.Dangling) && s.push(N(e, t)),
            ["{", s.length > 0 ? [D([F, s]), F] : "", "}"]
        );
    }
    function Vl(e, t) {
    ...
    function ya(e, t) {
        if (t.semi || Ls(e, t) || ws(e, t)) return !1;
        let { node: r, key: n, parent: s } = e;
        return !!(
    ...
    function fa(e, t) {
        ...
        return Le(e, t) ? !0 : Jt(r) ? e.call(() => fa(e, t), ...Lr(r)) : !1;
    }
    ...
    function Da(e, t, r) {
        let n = [r("expression")];
        if (ws(e, t)) {
            let s = Is(e.node.expression);
            (la(s) || ma(s)) && n.push(";");
        } else Ls(e, t) || (t.semi && n.push(";"));
        return n;
    }
    function Ea(e, t, r) {
    ...
    function Bn(e, t, r) {
        let { node: n } = e,
            s = [wi(e, t, r), $(e), "export", Ta(n) ? " default" : ""],
            { declaration: u, exported: i } = n;
        return (
            d(n, h.Dangling) && (s.push(" ", N(e, t)), Mr(n) && s.push(F)),
            u
    ...
    function Zl(e, t) {
        return t.semi && (!e.declaration || (Ta(e) && !zl(e.declaration))) ? ";" : "";
    }
    function Os(e, t = !0) {
        return e && e !== "value" ? `${t ? " " : ""}${e}${t ? "" : " "}` : "";
    }
    function _s(e, t) {
        return Os(e.importKind, t);
    }
    function em(e) {
        return Os(e.exportKind);
    }
    function xa(e, t, r) {
        let { node: n } = e;
        if (!n.source) return "";
    ...
    function ga(e, t) {
        return e.type !== "ImportDeclaration" || O(e.specifiers) || e.importKind === "type"
            ? !0
            : Ar(t, j(e), j(e.source)).trimEnd().endsWith("from");
    }
    function tm(e, t) {
        var n, s;
        ...
        let r = Ar(
            t,
            P(e.source),
            (s = e.attributes) != null && s[0] ? j(e.attributes[0]) : P(e)
        ).trimStart();
    ...
    function Ba(e, t, r) {
        ...
        return (
            ...
            p && !rm(n) && (f = r(a)),
            [
                Os(s === "ImportSpecifier" ? n.importKind : n.exportKind, !1),
                m,
                m && f ? " as " : "",
                f,
            ]
    ...
    function rm(e) {
        ...
        if (t.type !== r.type || !au(t, r)) return !1;
    ...
    function gt(e, t, r) {
            ...
            y =
                ...
                (s.type === "ObjectPattern" &&
                    ...
                    s.properties.some(
                        (I) =>
                            I.value &&
                            (I.value.type === "ObjectPattern" || I.value.type === "ArrayPattern")
                    )) ||
                (s.type !== "ObjectPattern" &&
                    t.objectWrap === "preserve" &&
                    o.length > 0 &&
                    ie(t.originalText, j(s), o[0].loc)),
            C = f
                ? ";"
            ...
            B = o.map((I) => {
                ...
                return (
                    ...
                    (I.node.type === "TSPropertySignature" ||
                        ...
                        d(I.node, h.PrettierIgnore) &&
                        T.shift(),
                    me(I.node, t) && T.push(F),
                    q
                );
            });
        if (s.inexact || s.hasUnknownMembers) {
            ...
            if (d(s, h.Dangling)) {
                let q = d(s, h.Line);
                I = [N(e, t), q || ee(t.originalText, P(v(!1, Ve(s), -1))) ? F : x, "..."];
            } else I = ["..."];
            B.push([...T, ...I]);
        }
        let g = (J = v(!1, o, -1)) == null ? void 0 : J.node,
            _ = !(
                s.inexact ||
                s.hasUnknownMembers ||
                (g &&
                    (g.type === "RestElement" ||
                        ((g.type === "TSPropertySignature" ||
                            ...
                            g.type === "TSIndexSignature") &&
                            d(g, h.PrettierIgnore)))) ||
                e.match(void 0, (I, q) => I.type === "TSImportType" && q === "options")
            ),
            M;
        if (B.length === 0) {
            if (!d(s, h.Dangling)) return [c, A, H(e, r)];
            M = l([c, N(e, t, { indent: !0 }), E, A, V(e), H(e, r)]);
        } else
            M = [
                f && O(s.properties) ? oa(p) : "",
                c,
                D([t.bracketSpacing ? x : E, ...B]),
                S(_ && (C !== "," || ce(t)) ? C : ""),
                t.bracketSpacing ? x : E,
                A,
                V(e),
        ...
        return e.match((I) => I.type === "ObjectPattern" && !O(I.decorators), Ms) ||
            (Re(s) &&
                (e.match(
                    void 0,
                    (I, q) => q === "typeAnnotation",
                    (I, q) => q === "typeAnnotation",
                    Ms
                ) ||
                    e.match(
                        void 0,
                        (I, q) => I.type === "FunctionTypeParam" && q === "typeAnnotation",
                        Ms
                    ))) ||
            (!y &&
                e.match(
    ...
    function Ms(e, t) {
        return (t === "params" || t === "parameters" || t === "this" || t === "rest") && Ss(e);
    }
    function nm(e) {
        let t = [e];
    ...
    function im(e) {
        ...
        for (let s = 0; !r; s++) {
            ...
            (u.type === "NewExpression" && u.callee === n) || (xe(u) && u.expression === n)
                ? ((r = e.getParentNode(s + 1)), (n = u))
                : (r = u);
        }
        return n === t ? !1 : r[um.get(r.type)] === n;
    }
    function ba(e, t, r) {
        let { node: n } = e,
            s = n.type === "ConditionalExpression",
            ...
            f = !1,
            { parent: y } = e,
            C = y.type === n.type && a.some((W) => y[W] === n),
            c = y.type === n.type && !C,
            A,
            T,
            B = 0;
        do ((T = A || n), (A = e.getParentNode(B)), B++);
        while (A && A.type === n.type && a.every((W) => A[W] !== T));
        let g = A || y,
            _ = T;
        if (s && (Y(n[a[0]]) || Y(o) || Y(p) || nm(_))) {
            ((f = !0), (c = !0));
            let W = (Z) => [S("("), D([E, Z]), E, S(")")],
                ne = (Z) =>
                    Z.type === "NullLiteral" ||
            ...
            m.push(
                ...
                ne(o) ? r(u) : W(r(u)),
                " : ",
                p.type === n.type || ne(p) ? r(i) : W(r(i))
            );
        } else {
            let W = (Z) => (t.useTabs ? D(r(Z)) : be(2, r(Z))),
                ne = [
                    x,
                    "? ",
                    o.type === n.type ? S("", "(") : "",
            ...
            m.push(
                y.type !== n.type || y[i] === n || C
                    ? ne
                    : t.useTabs
                      ? Jr(D(ne))
                      : be(Math.max(0, t.tabWidth - 2), ne)
            );
        }
        let M = [u, i, ...a].some((W) =>
                d(n[W], (ne) => te(ne) && ie(t.originalText, j(ne), P(ne)))
            ),
            J = (W) => (y === g ? l(W, { shouldBreak: M }) : M ? [W, Ce] : W),
            I = !f && (G(y) || (y.type === "NGPipeExpression" && y.left === n)) && !y.computed,
            q = im(e),
            k = J([sm(e, t, r), c ? m : D(m), s && I && !q ? E : ""]);
    ...
    function om(e, t, r, n) {
        return [...e.map((u) => Ve(u)), Ve(t), Ve(r)]
            .flat()
            .some((u) => te(u) && ie(n.originalText, j(u), P(u)));
    }
    var pm = new Map([
        ["AssignmentExpression", "right"],
        ["VariableDeclarator", "init"],
    ...
    function cm(e) {
        ...
        return n === t ? !1 : r[pm.get(r.type)] === n;
    }
    var vs = (e) => [S("("), D([E, e]), E, S(")")];
    function zt(e, t, r, n) {
        ...
        let { node: s } = e,
            ...
            { parent: C } = e,
            c = C.type === s.type,
            A = c && p.some((Xe) => C[Xe] === s),
            T = c && C[o] === s,
            B = m.type === s.type,
            g = f.type === s.type,
            _ = g || T,
            M = t.tabWidth > 2 || t.useTabs,
            J,
            I,
            q = 0;
        do ((I = J || s), (J = e.getParentNode(q)), q++);
        ...
        let k = J || C,
            W =
                ...
                (C.type === "AssignmentExpression" ||
                    ...
                    C.type === "Property"),
            ne = (C.type === "ReturnStatement" || C.type === "ThrowStatement") && !(B || g),
            Z = u && k.type === "JSXExpressionContainer" && e.grandparent.type !== "JSXAttribute",
            lt = cm(e),
            L = am(s, C),
            se = i && Le(e, t),
            Ae = M ? (t.useTabs ? "	" : " ".repeat(t.tabWidth - 1)) : "",
            Ot = om(y, m, f, t) || B || g,
            nt =
                !_ &&
                !c &&
                !i &&
                (Z
                    ? m.type === "NullLiteral" || (m.type === "Literal" && m.value === null)
                    : ir(m, t) && Gn(s.test, 3)),
            Js = _ || T || (i && !c) || (c && u && Gn(s.test, 1)) || nt,
            Ns = [];
        !B &&
            d(m, h.Dangling) &&
            e.call((Xe) => {
        ...
        (d(s.test, h.Dangling) &&
            ...
            d(s, h.Dangling) && er.push(N(e, t)));
        let Gs = Symbol("test"),
            Va = Symbol("consequent"),
            dr = Symbol("test-and-consequent"),
            $a = u
                ? [vs(r("test")), s.test.type === "ConditionalExpression" ? Ce : ""]
                : [
                      r("checkType"),
                      " ",
                      "extends",
            ...
            qs = l([$a, " ?"], { id: Gs }),
            Ka = r(a),
            Tr = D([B || (Z && (Y(m) || c || _)) ? F : x, Ns, Ka]),
            Qa = Js
                ? l([qs, _ ? Tr : S(Tr, l(Tr, { id: Va }), { groupId: Gs })], { id: dr })
                : [qs, Tr],
            wn = r(o),
            Ws = nt ? S(wn, Jr(vs(wn)), { groupId: dr }) : wn,
            tr = [
                Qa,
                er.length > 0 ? [D([F, er]), F] : g ? F : nt ? S(x, " ", { groupId: dr }) : x,
                ":",
                g
                    ? " "
                    : M
                      ? Js
                          ? S(Ae, S(_ || nt ? " " : Ae, " "), { groupId: dr })
                          : S(Ae, " ")
                      : " ",
                g ? Ws : l([D(Ws), Z && !nt ? E : ""]),
                L && !lt ? E : "",
    ...
    function Pa(e, t, r, n) {
        ...
        switch (s.type) {
            ...
            case "ChainExpression":
                return r("expression");
            case "ParenthesizedExpression":
                return !d(s.expression) && (ue(s.expression) || U(s.expression))
                    ? ["(", r("expression"), ")"]
                    : l(["(", D([E, r("expression")]), E, ")"]);
            case "AssignmentExpression":
                return Wi(e, t, r);
            case "VariableDeclarator":
                return Ui(e, t, r);
            ...
            case "SequenceExpression": {
                ...
                return ((a.type === "ReturnStatement" || a.type === "ThrowStatement") &&
                    e.key === "argument") ||
                    (a.type === "ArrowFunctionExpression" && e.key === "body")
                    ? l(S([D([E, o]), E], o))
                    : l(o);
            }
            case "ThisExpression":
            ...
            case "IfStatement": {
                let a = Et(s.consequent, r("consequent")),
                    o = l(["if (", l([D([E, r("test")]), E]), ")", a]);
                if ((i.push(o), s.alternate)) {
                    let p = d(s.consequent, h.Trailing | h.Line) || Mr(s),
                        m = s.consequent.type === "BlockStatement" && !p;
                    (i.push(m ? " " : F),
                        d(s, h.Dangling) && i.push(N(e, t), p ? F : " "),
                        i.push(
                            "else",
                            l(Et(s.alternate, r("alternate"), s.alternate.type === "IfStatement"))
                        ));
                }
                return i;
            }
            case "ForStatement": {
                ...
                return !s.init && !s.test && !s.update
                    ...
                    : [
                          ...
                          l([
                              "for (",
                              l([D([E, r("init"), ";", x, r("test"), ";", x, r("update")]), E]),
                              ")",
                              a,
                          ]),
                      ];
            ...
            case "CatchClause":
                if (s.param) {
                    let a = d(
                            ...
                            (p) =>
                                !te(p) ||
                                (p.leading && ee(t.originalText, P(p))) ||
                                (p.trailing && ee(t.originalText, j(p), { backwards: !0 }))
                        ),
                        o = r("param");
    ...
    function lm(e, t, r) {
        ...
        if ((n.rest && (s = [...s, n.rest]), s.length === 0))
            return ["(", N(e, t, { filter: (i) => ke(t.originalText, P(i)) === ")" }), ")"];
        let u = [];
        return (
            ym(e, (i, a) => {
                let o = a === s.length - 1;
                (o && n.rest && u.push("..."),
                    u.push(r()),
                    !o && (u.push(","), me(s[a], t) ? u.push(F, F) : u.push(x)));
            }),
            ["(", D([E, ...u]), S(ce(t, "all") && !mm(n, s) ? "," : ""), E, ")"]
        );
    }
    function mm(e, t) {
        var r;
        return e.rest || ((r = v(!1, t, -1)) == null ? void 0 : r.type) === "RestElement";
    }
    function ym(e, t) {
        let { node: r } = e,
            n = 0,
    ...
    function La(e, t, r) {
        let { node: n } = e,
            s = [];
        return (
            n.name && s.push(r("name"), n.optional ? "?: " : ": "),
            s.push(r("typeAnnotation")),
            s
        );
    }
    function Pn(e, t, r) {
    ...
    function Ln(e, t, r) {
        ...
        return (
            O(n.extends) &&
                i.push(
                    a ? S(" ", x, { groupId: Cr(n.typeParameters) }) : x,
                    "extends ",
                    (n.extends.length === 1 ? du : D)(b([",", x], e.map(r, "extends")))
                ),
            d(n.id, h.Trailing) || O(n.extends)
                ? a
                    ? s.push(l([...u, D(i)]))
                    : s.push(l(D([...u, ...i])))
                : s.push(...u, ...i),
    ...
    function Ra(e, t, r) {
        ...
        return l(
            [
                ...
                D([
                    t.bracketSpacing ? x : E,
                    d(n, h.Dangling) ? l([N(e, t), F]) : "",
                    l([
                        n.readonly ? [va(n.readonly, "readonly"), " "] : "",
                        "[",
                        r("key"),
                        " in ",
                        r("constraint"),
    ...
    function Ja(e, t, r) {
        ...
        switch (n.type) {
            ...
            case "EnumSymbolBody":
                return [
                    n.type === "EnumSymbolBody" || n.explicitType
                        ? `of ${n.type.slice(4, -4).toLowerCase()} `
                        : "",
                    Pn(e, t, r),
                ];
    ...
    function Na(e, t, r) {
        ...
        switch (n.type) {
            case "TSThisType":
                return "this";
            case "TSTypeAssertion": {
                let a = !(U(n.expression) || ue(n.expression)),
                    o = l(["<", D([E, r("typeAnnotation")]), E, ">"]),
                    p = [S("("), D([E, r("expression")]), E, S(")")];
                return a
                    ? tt([
                          [o, r("expression")],
                          [o, l(p, { shouldBreak: !0 })],
            ...
            case "TSTypeQuery":
                return cn(e, r);
            case "TSIndexSignature": {
                let a = n.parameters.length > 1 ? S(ce(t) ? "," : "") : "",
                    o = l([D([E, b([", ", E], e.map(r, "parameters"))]), a, E]),
            ...
            case "TSImportType":
                return [
                    ...
                    wt(e, t, r, n.typeArguments ? "typeArguments" : "typeParameters"),
                ];
            case "TSLiteralType":
                return r("literal");
            ...
            case "TSModuleDeclaration": {
                ...
                return (
                    o ? u.push(".") : (u.push($(e)), n.kind !== "global" && u.push(n.kind, " ")),
                    u.push(r("id")),
    ...
    var Rs = {};
    xr(Rs, { getVisitorKeys: () => Ua, massageAstNode: () => Ya, print: () => Tm });
    var Am = {
            JsonRoot: ["node"],
            ArrayExpression: ["elements"],
            ObjectExpression: ["properties"],
    ...
    var St = "JavaScript",
        ...
        Ha = hm;
    var gm = { estree: js, "estree-json": Rs },
        Sm = [...Vs, ...qa];
    return ro(Bm);
});
