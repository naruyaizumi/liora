...
var xr = (e, t) => {
    for (var r in t) za(e, r, { get: t[r], enumerable: !0 });
};
    ...
    Ys = (e, t, r) =>
        t.has(e)
            ...
            : t instanceof WeakSet
              ? t.add(e)
              : t.set(e, r),
    Hs = (e, t, r, n) => (Xs(e, t, "write to private field"), n ? n.call(e, r) : t.set(e, r), r);
var Rs = {};
...
xr(vs, {
    canAttachComment: () => kp,
    embed: () => oi,
    experimentalFeatures: () => fm,
    getCommentChildNodes: () => Ip,
    getVisitorKeys: () => br,
    handleComments: () => ts,
    insertPragma: () => di,
    isBlockComment: () => te,
...
function Ks(e, { getVisitorKeys: t, predicate: r }) {
    for (let n of no(e, { getVisitorKeys: t })) if (r(n)) return !0;
    return !1;
}
var Qs = () =>
...
function Rn(e) {
    return (
        e.type === "UnaryExpression" && (e.operator === "+" || e.operator === "-") && ye(e.argument)
    );
}
function K(e) {
    return !!(
...
var wr = R([
    ...
    Po = R(["Identifier", "ThisExpression", "Super", "PrivateName", "PrivateIdentifier"]),
...
function Pt(e, t) {
    ...
    if (r.length === 1) {
        ...
        return r[2] && !ye(r[2])
            ? !1
            : (r.length === 2 ? Rt(r[1]) : ko(r[1]) && Q(r[1]).length <= 1) || _n(r[1]);
    return !1;
}
var Fu = (e) => (t) => (
...
function Cu(e, t) {
    ...
    for (let n in e) {
        let s = e[n];
        if (
            (s && typeof s == "object" && typeof s.type == "string" && (r++, (r += Cu(s, t - r))),
            r > t)
        )
            return r;
    }
...
function we(e, t = 2) {
    ...
    if (wr(e) || Po(e) || e.type === "ArgumentPlaceholder") return !0;
...
`)
    ...
    return G(e)
        ...
        : (e.type === "UnaryExpression" && Mo.has(e.operator)) || e.type === "UpdateExpression"
          ? we(e.argument, t)
          : !1;
}
function du(e) {
...
function Su(e, t) {
    ...
    if (
        ...
        e.openingElement.attributes.some((s) => s.type === "JSXAttribute" && s.name.name === "jsx")
    )
...
var je = { type: Ge },
    Ce = { type: Me };
var Yn = { type: oe, hard: !0 },
    Yo = { type: oe, hard: !0, literal: !0 },
    x = { type: oe },
    E = { type: oe, soft: !0 },
    F = [Yn, Ce],
    Rr = [Yo, Ce],
...
function De(e, t) {
    ((t.leading = !0), (t.trailing = !1), Vn(e, t));
}
function Pe(e, t, r) {
    ((t.leading = !1), (t.trailing = !1), r && (t.marker = r), Vn(e, t));
}
function z(e, t) {
    ((t.leading = !1), (t.trailing = !0), Vn(e, t));
}
function Qo(e, t) {
    let r = null,
        n = t;
...
function ep(e) {
    return (
        $n.has(e) ||
            $n.set(e, te(e) && e.value[0] === "*" && /@(?:type|satisfies)\b/u.test(e.value)),
        $n.get(e)
    );
}
var Gr = ep;
...
function tp(e) {
    return [Yu, Nu, Wu, fp, up, Qn, zn, Ju, Gu, Cp, Ep, es, Xu, Ap, qu, Uu, Zn, ip, Bp, Hu].some(
        (t) => t(e)
    );
}
function rp(e) {
    return [sp, Wu, Nu, Xu, Qn, zn, Ju, Gu, Uu, Dp, Fp, es, xp, Zn, gp, Sp, bp, Hu].some((t) =>
        t(e)
    );
}
function np(e) {
...
function lp({ comment: e, precedingNode: t, enclosingNode: r, text: n }) {
    return ke(n, P(e)) !== "(" ? !1 : t && cp.has(r == null ? void 0 : r.type) ? (z(t, e), !0) : !1;
}
...
function Dp({ comment: e, precedingNode: t, enclosingNode: r }) {
    return w(r) && t && r.callee === t && r.arguments.length > 0 ? (De(r.arguments[0], e), !0) : !1;
}
...
function xp({ comment: e, enclosingNode: t, followingNode: r }) {
    return dp.has(t == null ? void 0 : t.type) && r && (Tp.has(r.type) || te(e))
        ? (De(r, e), !0)
        : !1;
}
...
var Ie = Symbol("MODE_BREAK"),
    pt = Symbol("MODE_FLAT"),
    Xt = Symbol("cursor"),
    ns = Symbol("DOC_FILL_PRINTED_LENGTH");
function Ku() {
    ...
    return t === Number.NEGATIVE_INFINITY
        ...
        : t < 0
          ...
          : t
            ? t.type === "root"
                ? { ...e, root: e }
                : ss(e, { type: typeof t == "string" ? "stringAlign" : "numberAlign", n: t }, r)
            : e;
}
function ss(e, t, r) {
...
function qr(e, t, r, n, s, u) {
    ...
    for (; r >= 0; ) {
        ...
        switch (f) {
            ...
            case he: {
                let C =
                    (m.groupId ? s[m.groupId] || pt : p) === Ie ? m.breakContents : m.flatContents;
                    ...
                    case Ie:
                        ...
                        c.literal
                            ? y.root
                                ...
                                : (a.push(s), (u = 0))
                            : ((u -= us(a)), a.push(s + y.value), (u = y.length));
                        break;
                }
                break;
            case Se:
    ...
    if (s.length > 1 || s.some((u) => u.length > 0)) {
        ...
        let i = [],
            a = u.map(
                (y) =>
                    "${" +
                    is(y, { ...t, printWidth: Number.POSITIVE_INFINITY, endOfLine: "lf" })
                        .formatted +
                    "}"
            ),
...
function Ur(e, t) {
    return ft(e, (r) => (typeof r == "string" ? (t ? X(!1, r, /(\\*)`/gu, "$1$1\\`") : as(r)) : r));
}
function as(e) {
            ...
            return (
                ...
                (t.callee.type === "MemberExpression" &&
                    ((t.callee.object.type === "MemberExpression" &&
                        ...
                        (t.callee.object.type === "CallExpression" && Yr(t.callee.object.callee))))
            );
        case "Identifier":
            return t.name === "css";
        default:
...
`),
        ...
        let g = null;
        (B ? (g = Hp(y)) : (g = await e(f, { parser: "graphql" })),
            g
        ...
        C = ft(y, (B) => {
            ...
            for (let M = 0; M < _.length; M++) {
                ...
                if (M % 2 === 0) {
                    J &&
                        ((J = as(J)),
                        s.__embeddedInHtml && (J = X(!1, J, /<\/(?=script\b)/giu, String.raw`<\/`)),
                        g.push(J));
                    continue;
                }
                let I = Number(J);
...
function Ei(e) {
    let t = `
`;
    e = X(!1, e.replace(ac, "").replace(ic, ""), cc, "$1");
    let r = "";
    for (; r !== e; ) ((r = e), (e = X(!1, e, pc, `${t}$1 $2${t}`)));
...
function di(e) {
    let { shebang: t, text: r, pragmas: n, comments: s } = mc(e),
        u = Di(r),
...
function ls(e, t) {
    ...
    if (t.__isInHtmlInterpolation && !t.bracketSpacing && Fc(r) && yr(e)) return !0;
    if (fc(r)) return !1;
    if (r.type === "Identifier") {
        ...
        if (r.name === "let") {
            let c =
                (i = e.findAncestor((A) => A.type === "ForOfStatement")) == null ? void 0 : i.left;
    ...
    switch (r.type) {
        ...
        case "BinaryExpression":
            if (s.type === "UpdateExpression" || (r.operator === "in" && Dc(e))) return !0;
        ...
        case "ArrowFunctionExpression":
            switch (s.type) {
                case "BinaryExpression":
                    return (
                        s.operator !== "|>" || ((y = r.extra) == null ? void 0 : y.parenthesized)
                    );
                case "NewExpression":
                case "CallExpression":
                case "OptionalCallExpression":
...
function Ec(e) {
    return ur(
        e,
        (t) =>
            t.type === "ObjectTypeAnnotation" && ur(t, (r) => r.type === "FunctionTypeAnnotation")
    );
}
function Fc(e) {
    return ue(e);
...
function xi(e, t) {
    ...
    return r.type === "FunctionExpression" || r.type === "ClassExpression"
        ? n.type === "ExportDefaultDeclaration" || !ls(e, t)
        : !Jt(r) || (n.type !== "ExportDefaultDeclaration" && ls(e, t))
          ? !1
          : e.call(() => xi(e, t), ...Lr(r));
}
function Cc(e) {
...
function ms(e) {
    return e.type === "Identifier"
        ? !0
        : G(e)
          ? !e.computed && !e.optional && e.property.type === "Identifier" && ms(e.object)
          : !1;
}
function Ac(e) {
    return (
        e.type === "ChainExpression" && (e = e.expression),
        ms(e) || (w(e) && !e.optional && ms(e.callee))
    );
}
var Le = ls;
function dc(e, t) {
...
function hc(e, t, r) {
    ...
    if (
        ...
        let m = hi(i, a(n));
        return { doc: Xn([F, m ? F : "", s]), isBlock: o, hasLineSuffix: !0 };
    }
    return !o || (r != null && r.hasLineSuffix)
        ? { doc: [Xn([" ", s]), Ce], isBlock: o, hasLineSuffix: !0 }
        : { doc: [" ", s], isBlock: o, hasLineSuffix: !1 };
}
function N(e, t, r = {}) {
    let { node: n } = e;
    if (!O(n == null ? void 0 : n.comments)) return "";
    let { indent: s = !1, marker: u, filter: i = Tc } = r,
        a = [];
    if (
        (e.each(({ node: p }) => {
...
function gc(e, t, r) {
    ...
    let i = n.children.some(Y),
        ...
        y = m ? x : S([f, E], " "),
        C =
            ((M = (_ = n.openingElement) == null ? void 0 : _.name) == null ? void 0 : M.name) ===
            "fbt",
        c = Sc(e, t, r, y, C),
    ...
    for (; c.length > 0 && Cs(v(!1, c, -1)); ) c.pop();
        ...
        e.each(({ node: p, next: m }) => {
            if (p.type === "JSXText") {
                ...
                if (fr(p)) {
                    ...
                    let C;
                    if ((v(!1, y, -1) === "" && (y.pop(), (C = y.pop())), y.length === 0)) return;
...
function $r(e, t, r) {
    ...
    let { node: n, parent: s, grandparent: u, key: i } = e,
        ...
        o = n.operator === "|>" && ((M = e.root.extra) == null ? void 0 : M.__isUsingHackPipeline),
        p = As(e, t, r, !1, a);
    if (a) return p;
    if (o) return l(p);
...
function As(e, t, r, n, s) {
    ...
    ar(u.operator, u.left.operator)
        ? (i = e.call((g) => As(g, t, r, !0, s), "left"))
        : i.push(l(r("left")));
    let a = Ht(u),
        o =
            (u.operator === "|>" || u.type === "NGPipeExpression" || Wc(e, t)) &&
...
function Hc(e, t, r) {
    ...
    Gt(e, ({ node: f }, y) => {
        let C = r();
        (y === u || (me(f, t) ? ((i = !0), (C = [C, ",", F, F])) : (C = [C, ",", x])), a.push(C));
    });
    let o =
...
function $c(e) {
    ...
    let [t, r] = e;
    return t.type === "ModuleExpression" && zc(r)
        ? !0
        : !d(t) &&
...
function Kc(e) {
    return e.length === 2 ? vi(e, 0) : e.length === 3 ? e[0].type === "Identifier" && vi(e, 1) : !1;
}
function vi(e, t) {
    let r = e[t],
        n = e[t + 1];
    ...
    let n = r("object"),
        ...
        o =
            ...
            ((a.type === "AssignmentExpression" || a.type === "VariableDeclarator") &&
                (Zc(u.object) || ((p = n.label) == null ? void 0 : p.memberChain)));
        ...
        if (w(L) && (dt(L.callee) || w(L.callee))) {
            ...
            dt(L)
                ? (s.unshift({
                      node: L,
                      needsParens: Le(e, t),
                      printed: Ee(e, G(L) ? xs(e, t, r) : Kr(e, t, r), t),
                  }),
                  e.call(i, "object"))
...
function Yi(e, t, r, n = !1) {
    ...
    if (w(s)) {
        ...
        let o = le(s);
        return !(o.length === 0 || (o.length === 1 && ir(o[0], t))) || cl(s, r)
            ? !1
            : e.call(u, "callee");
    }
    return G(s)
...
function cl(e, t) {
    ...
    if (O(r)) {
        ...
        if (r.length === 1) {
            let s = r[0];
            if (Oe(s) || qt(s) || s.type === "TSTypeLiteral" || s.type === "ObjectTypeAnnotation")
                return !0;
        }
...
function Ue(e, t, r, n, s) {
    ...
    if (
        (hu(e, (c, A) => {
            ...
            (T && u.rest && f.push("..."),
                f.push(r()),
                !T && (f.push(","), p || m ? f.push(" ") : me(i[A], t) ? f.push(F, F) : f.push(x)));
        }),
        n && !fl(e))
    ) {
...
function fl(e) {
    return e.match(
        ...
        (t) =>
            t.type !== "VariableDeclaration" || (t.kind === "const" && t.declarations.length === 1)
    );
}
function Hi(e) {
    let t = Q(e);
...
var Dl = R(["VoidTypeAnnotation", "TSVoidKeyword", "NullLiteralTypeAnnotation", "TSNullKeyword"]),
    El = R(["ObjectTypeAnnotation", "TSTypeLiteral", "GenericTypeAnnotation", "TSTypeReference"]);
function Fl(e) {
    let { types: t } = e;
    if (t.some((n) => d(n))) return !1;
    let r = t.find((n) => El(n));
    return r ? t.every((n) => n === r || Dl(n)) : !1;
}
function Ss(e) {
    return Nt(e) || Re(e) ? !0 : Oe(e) ? Fl(e) : !1;
}
function Vi(e, t, r) {
    let n = t.semi ? ";" : "",
        { node: s } = e,
...
function H(e, t, r = "typeAnnotation") {
    ...
    if (n.type === "TSTypeAnnotation" || n.type === "TypeAnnotation") {
        let u = e.call($i, r);
        ((u === "=>" || (u === ":" && d(n, h.Leading))) && (s = !0), Al.add(n));
    }
    return s ? [" ", t(r)] : t(r);
}
var $i = (e) =>
...
function $(e) {
    let { node: t } = e;
    return t.declare || (dl.has(t.type) && e.parent.type !== "DeclareExportDeclaration")
        ? "declare "
        : "";
}
var Tl = new Set([
...
function Kt(e, t, r) {
    ...
    if (o.length === 0) s.push(xl(e, t, u, i));
        ...
        s.push(
            l([u, D([E, c ? gl(e, t, r, A) : [hl(e, t, r, a, n.inexact), A], N(e, t)]), E, i], {
                shouldBreak: C,
                id: y,
            })
        );
...
function En(e, t, r, n) {
    ...
    if (
        ...
        let { parent: m } = e;
        w(m) &&
            (le(m).length > 1 || Q(s).every((f) => f.type === "Identifier" && !f.typeAnnotation)) &&
            (u = !0);
    }
    let i = [
            $(e),
...
function Ll(e, t) {
    if (de(e.originalText, t) || (d(t, h.Leading, (r) => ie(e.originalText, j(r), P(r))) && !Y(t)))
        return !0;
    if (Jt(t)) {
        let r = t,
            n;
...
function na(e) {
    return (
        bs.has(e) ||
            bs.set(
                e,
                e.type === "ConditionalExpression" && !pe(e, (t) => t.type === "ObjectExpression")
            ),
        bs.get(e)
    );
}
...
function sa(e, t, r, n = {}) {
    ...
    let m = !de(t.originalText, p) && (wl(p) || _l(p, u, t) || (!a && na(p))),
        f = e.key === "callee" && yt(e.parent),
        y = Symbol("arrow-chain"),
        C = Ml(e, n, { signatureDocs: s, shouldBreak: a }),
        c = !1,
        A = !1,
        T = !1;
    return (
...
function wt(e, t, r, n) {
    ...
    if (
        ...
        (!i &&
            (u ||
                (s[n].length === 1 && (s[n][0].type === "NullableTypeAnnotation" || Ss(s[n][0])))))
    )
        return ["<", b(", ", e.map(r, n)), Gl(e, t), ">"];
    let o =
        s.type === "TSTypeParameterInstantiation" ? "" : Nl(e, t, n) ? "," : ce(t) ? S(",") : "";
...
function hn(e, t, r) {
    let { node: n } = e,
        s = [];
    return (
        O(n.decorators) && s.push(ds(e, t, r)),
        s.push($t(n)),
...
function ya(e, t) {
    if (t.semi || Is(e, t) || Ls(e, t)) return !1;
    let { node: r, key: n, parent: s } = e;
    return !!(
...
function Ba(e, t, r) {
    ...
    return (
        s === "ExportNamespaceSpecifier" || s === "ImportNamespaceSpecifier"
            ...
            : o && (m = r(i)),
        p && !zl(n) && (f = r(a)),
        [ws(s === "ImportSpecifier" ? n.importKind : n.exportKind, !1), m, m && f ? " as " : "", f]
    );
}
function zl(e) {
...
function gt(e, t, r) {
    ...
    let { parent: p, key: m } = e,
        ...
        C = f ? ";" : s.type === "TSInterfaceBody" || s.type === "TSTypeLiteral" ? S(n, ";") : ",",
        c = s.exact ? "{|" : "{",
        A = s.exact ? "|}" : "}",
        T = [],
        B = o.map((I) => {
...
function rm(e) {
    ...
    return n === t ? !1 : r[tm.get(r.type)] === n;
}
function ba(e, t, r) {
    let { node: n } = e,
        s = n.type === "ConditionalExpression",
    ...
    let M = [u, i, ...a].some((W) => d(n[W], (ne) => te(ne) && ie(t.originalText, j(ne), P(ne)))),
        J = (W) => (y === g ? l(W, { shouldBreak: M }) : M ? [W, Ce] : W),
        I = !f && (G(y) || (y.type === "NGPipeExpression" && y.left === n)) && !y.computed,
        q = rm(e),
        k = J([em(e, t, r), c ? m : D(m), s && I && !q ? E : ""]);
...
function zt(e, t, r, n) {
    ...
    let Gs = Symbol("test"),
        ...
        $a = u
            ? [Ms(r("test")), s.test.type === "ConditionalExpression" ? Ce : ""]
            : [
                  r("checkType"),
                  " ",
                  "extends",
        ...
        Qa = Js
            ...
            : [qs, Tr],
        wn = r(o),
        Ws = nt ? S(wn, Jr(Ms(wn)), { groupId: dr }) : wn,
        tr = [
            Qa,
