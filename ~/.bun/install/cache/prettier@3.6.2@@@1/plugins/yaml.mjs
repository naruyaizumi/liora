...
var te = (t, e) => () => (e || t((e = { exports: {} }).exports, e), e.exports),
    yr = (t, e) => {
        for (var n in e) Nt(t, n, { get: e[n], enumerable: !0 });
    },
    Ki = (t, e, n, r) => {
        if ((e && typeof e == "object") || typeof e == "function")
            for (let s of Bi(e))
                !qi.call(t, s) &&
                    s !== n &&
                    Nt(t, s, { get: () => e[s], enumerable: !(r = $i(e, s)) || r.enumerable });
        return t;
    };
var cn = (t, e, n) => (
    (n = t != null ? Yi(Fi(t)) : {}),
    Ki(e || !t || !t.__esModule ? Nt(n, "default", { value: t, enumerable: !0 }) : n, t)
);
var ln = (t, e, n) => Ui(t, typeof e != "symbol" ? e + "" : e, n),
    fn = (t, e, n) => e.has(t) || dr("Cannot " + n);
    ...
    Ot = (t, e, n) =>
        e.has(t)
            ...
            : e instanceof WeakSet
              ? e.add(t)
              : e.set(t, n),
    un = (t, e, n, r) => (fn(t, e, "write to private field"), r ? r.call(t, n) : e.set(t, n), n),
    Xe = (t, e, n) => (fn(t, e, "access private method"), n);
var oe = te(($) => {
    "use strict";
...
`)
            ...
            get jsonLike() {
                return (
                    [pt.FLOW_MAP, pt.FLOW_SEQ, pt.QUOTE_DOUBLE, pt.QUOTE_SINGLE].indexOf(
                        this.type
                    ) !== -1
                );
            }
...
` ||
                    ...
                    let d = r(
                        { atLineStart: f, inCollection: !0, indent: a, lineStart: i, parent: this },
                        c
                    );
                    if (!d) return c;
                    if (
...
`
        ...
        Yn = class extends u.Node {
            ...
            prevNodeIsJsonLike(e = this.items.length) {
                ...
                return (
                    !!n &&
                    (n.jsonLike || (n.type === u.Type.COMMENT && this.prevNodeIsJsonLike(e - 1)))
                );
            }
            parse(e, n) {
                this.context = e;
...
` + n.replace(/^/gm, `${e || ""}#`)
    ...
    var os = (t) => t == null || (typeof t == "object" && t[Symbol.iterator]().next().done),
        W = class t extends j {
            constructor(e) {
                ...
                let y = !1,
                    ...
                    g = this.items.reduce((M, A, C) => {
                        ...
                        (A &&
                            ...
                            A.commentBefore &&
                                A.commentBefore.match(/^.*$/gm).forEach((Di) => {
...
`) &&
                ...
                if (g.length === 0) w = r.start + r.end;
                    ...
                    if (
                        h ||
                        C.reduce((L, R) => L + R.length + 2, 2) > t.maxFlowStringSingleLineLength
                    ) {
                        w = M;
                        for (let L of C)
                            w += L
...
` && (L = ""),
    ...
    var dt = class extends W {
        ...
        Io = { trueStr: "true", falseStr: "false" },
        vo = { asBigInt: !1 },
        _o = { nullStr: "null" },
        Ne = {
...
${e}${t.slice(L + 1, R)}`));
    ...
    var Kn = ({ indentAtStart: t }) => (t ? Object.assign({ indentAtStart: t }, Ne.fold) : Ne.fold),
        Ut = (t) => /^(%|---|\.\.\.)/m.test(t);
    function Ro(t, e, n) {
        if (!e || e < 0) return !1;
        let r = e - n,
            ...
            c =
                e === p.Type.BLOCK_FOLDED
                    ...
                    : e === p.Type.BLOCK_LITERAL
                      ? !0
                      : !Ro(n, Ne.fold.lineWidth, o.length),
            l = c ? "|" : ">";
        if (!n)
            return (
                l +
...
` + s)
    ...
    function Ko(t, e) {
        let n = { before: [], after: [] },
            r = !1,
            s = !1,
            i = Uo(e.context.parent) ? e.context.parent.props.concat(e.props) : e.props;
...
${a}`
    ...
    function jo(t, e) {
        ...
        let { comments: n, items: r } = e.type === p.Type.FLOW_MAP ? Ho(t, e) : Go(t, e),
            s = new dt();
        ((s.items = r), ms(s, n));
        let i = !1;
        for (let o = 0; o < r.length; ++o) {
            let { key: a } = r[o];
            if ((a instanceof W && (i = !0), t.schema.merge && a && a.value === as)) {
                r[o] = new Ft(r[o]);
...
`
    ...
    function Jo(t, e) {
        ...
        let { comments: n, items: r } = e.type === p.Type.FLOW_SEQ ? zo(t, e) : Xo(t, e),
            s = new le();
        if (
            ((s.items = r),
            ms(s, n),
...
`
                ...
                (us(t.errors, f), n.push({ comment: f.comment, before: r.length }));
            else {
                if (a) {
...
${i.comment}`
    ...
    var ea = { default: !1, tag: "tag:yaml.org,2002:pairs", resolve: gs, createNode: ds },
...
var zn = te((Ps) => {
    ...
    var Wt = {
        ...
        Xn = (t, e, n) => (E.intOptions.asBigInt ? BigInt(t) : parseInt(e, n));
    function ws(t, e, n) {
        let { value: r } = t;
    ...
    var bs = {
        ...
        ga = Jn.concat([bs, Ns, Os, As, Ls, Ts, Ms, Cs]),
        Es = (t) => typeof t == "bigint" || Number.isInteger(t),
        ...
        ks = [
            ...
            },
            {
                ...
                stringify: ({ value: t }) => (Es(t) ? t.toString() : JSON.stringify(t)),
            },
            {
                identify: (t) => typeof t == "number",
                default: !0,
    ...
    var Ss = ({ value: t }) => (t ? E.boolOptions.trueStr : E.boolOptions.falseStr),
        yt = (t) => typeof t == "bigint" || Number.isInteger(t);
    function Vt(t, e, n) {
        let r = e.replace(/_/g, "");
    ...
    var da = Jn.concat(
        ...
        ya = { core: ga, failsafe: Jn, json: ks, yaml11: da },
        Ea = {
            binary: D.binary,
            bool: Ns,
            float: Cs,
...
var Rs = te((Xt) => {
    ...
    function Ta(t, e, { anchors: n, doc: r }) {
        ...
        return (
            i && ((n[i] = t), s.push(`&${i}`)),
            t.tag ? s.push(vs(r, t.tag)) : e.default || s.push(vs(r, e.tag)),
            s.join(" ")
        );
    }
    function Gt(t, e, n, r) {
...
var Me = "string",
    ...
    nt = "indent-if-break",
    Ie = "line-suffix",
    rt = "line-suffix-boundary",
    Z = "line",
    st = "label",
    ve = "break-parent",
    Lt = new Set([Ze, et, Ce, tt, ke, Pe, ge, nt, Ie, rt, Z, st, ve]);
var ji = (t, e, n) => {
        if (!(t && e == null))
...
var Mt = { type: ve };
var Xi = { type: Z, hard: !0 },
    zi = { type: Z, hard: !0, literal: !0 },
    ne = { type: Z },
    Ct = { type: Z, soft: !0 },
    N = [Xi, Mt],
    it = [zi, Mt];
...
function eo(t, e) {
    ...
    ((n = En(t, n, { backwards: !0 })),
        (n = Sn(t, n, { backwards: !0 })),
        (n = En(t, n, { backwards: !0 })));
    let r = Sn(t, n, { backwards: !0 });
    return n !== r;
}
var Or = eo;
...
function lt(t) {
    ...
    return ((ct = lt.prototype = t ?? Object.create(null)), new lt());
}
var to = 10;
...
function qr(t) {
    ...
    if (e.type === "documentBody") {
        let n = t.parent.head;
        return I(n) && Br(x(!1, n.endComments, -1));
    }
...
function vt(t, e) {
    let { node: n, root: r } = t,
        s;
    return (
        An.has(r) ? (s = An.get(r)) : ((s = new Set()), An.set(r, s)),
        !s.has(n.position.end.line) && (s.add(n.position.end.line), Fr(n, e) && !Ln(t.parent))
            ? Ct
            : ""
    );
}
...
function ao(t, e, n) {
    ...
    (r.indent !== null && o.push(r.indent.toString()),
        ...
        On(r) && o.push(" ", n("indicatorComment")));
    let a = Vr(r, { parentIndent: s, isLastDescendant: i, options: e }),
        c = [];
    for (let [l, f] of a.entries())
        (l === 0 && c.push(N),
            c.push(Tt(P(ne, f))),
            l !== a.length - 1
                ? c.push(f.length === 0 ? N : wr(it))
                : r.chomping === "keep" && i && c.push(dn(f.length === 0 ? N : it)));
    return (
        r.indent === null ? o.push(br(v(e.tabWidth, c))) : o.push(dn(v(r.indent - 1 + s, c))),
        o
    );
}
var jr = ao;
        ...
        ({ isLast: r, node: s, next: i }) => [
            ...
            r
                ...
                : [
                      ",",
                      ne,
                      s.position.start.line !== i.position.start.line ? vt(t, e.originalText) : "",
                  ],
        ],
        "children"
    );
...
function lo(t, e, n) {
    ...
    o.content.children.length === 0
        ...
        : ee(o.content) ||
            ...
            (s.type === "mapping" && V(i.content) && ft(o.content)) ||
    ...
    return Tn(i.content, e) && !ee(i.content) && !ie(i.content) && !I(i)
        ? yn([[l, w]])
        : yn([[y, at(h, w, { groupId: d })]]);
}
function Tn(t, e) {
    if (!t) return !0;
    switch (t.type) {
...
function ho(t, e, n) {
    ...
    return (
        ...
        ie(r) &&
            s.push([r.middleComments.length === 1 ? "" : N, P(N, t.map(n, "middleComments")), N]),
        qr(t)
            ? s.push(
                  Er(e.originalText.slice(r.position.start.offset, r.position.end.offset).trimEnd())
              )
            : s.push(Re(go(t, e, n))),
        V(r) &&
            ...
            s.push(
                Nr([
                    ...
                    t.parent.type === "mappingKey" && t.getParentNode(2).type === "mapping" && ft(r)
                        ? ""
                        : Mt,
                    n("trailingComment"),
                ])
            ...
            s.push(
                v(r.type === "sequenceItem" ? 2 : 0, [
                    ...
                    P(
                        N,
                        t.map(
                            ({ node: c }) => [Or(e.originalText, xe(c)) ? N : "", n()],
                            "endComments"
                        )
                    ),
                ])
...
function go(t, e, n) {
    ...
    switch (r.type) {
        ...
        case "quoteSingle": {
            ...
            if (o.includes(s))
                return [i, ut(r.type, r.type === "quoteSingle" ? At(!1, o, "''", s) : o, e), i];
...
var mr = cn(tr(), 1);
var H = cn(Bs(), 1),
    sf = H.default.findPair,
    of = H.default.toJSON,
    af = H.default.parseMap,
    cf = H.default.parseSeq,
    lf = H.default.stringifyNumber,
    ff = H.default.stringifyString,
    uf = H.default.Type,
    pf = H.default.YAMLError,
    mf = H.default.YAMLReferenceError,
    Fs = H.default.YAMLSemanticError,
    hf = H.default.YAMLSyntaxError,
    gf = H.default.YAMLWarning;
function B(t, e = null) {
    ...
    switch (t.type) {
        case "DOCUMENT":
            for (let e = t.contents.length - 1; e >= 0; e--)
                t.contents[e].type === "BLANK_LINE" ? t.contents.splice(e, 1) : wt(t.contents[e]);
...
function oi(t, e, n) {
    let r = t.cstNode,
        ...
        { position: l, documentEndPoint: f } = Va(r, c, e);
    return (
        e.comments.push(...s, ...i),
        {
...
function ci(t, e) {
    let n = t.cstNode,
        { directives: r, comments: s, endComments: i } = ja(n, e),
        { position: o, endMarkerPoint: a } = Wa(n, r, e);
    return (
        e.comments.push(...s, ...i),
        {
...
function Je(t, e, n, r, s) {
    ...
    return n(
        ...
        a || sr(nr(c.position.start), null),
        c || ir(nr(a.position.end), null)
    );
}
function ui(t, e) {
...
function pr(t) {
    ...
    let n = ur(t.position, Ga, Ha, za),
        r = ur(t.position, Ja, Xa, Za);
    "endComments" in t &&
...
function _i(t) {
    let e = mr.default.parseCST(t),
        n = new Pi(e, t);
    n.setOrigRanges();
    let r = e.map((i) => new mr.default.Document({ merge: !1, keepCstNodes: !0 }).parse(i));
    for (let i of r)
