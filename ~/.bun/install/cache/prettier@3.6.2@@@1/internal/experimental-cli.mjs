...
var init_constants = __esm({
    "node_modules/tiny-colors/dist/constants.js"() {
        ...
        ENABLED =
            ...
            (ENV.COLOR === "1" ||
                !((_a3 = globalThis.process) == null ? void 0 : _a3.stdout) ||
                ((_c = (_b = globalThis.process) == null ? void 0 : _b.stdout) == null
                    ? void 0
                    : _c.isTTY) === true);
    },
});
...
var getAliasesMap,
    ...
    getAliasedSet,
    getAliasedDefaults,
    getAliasedIncompatibles,
    setAliased,
    parseDoubleHyphen,
    parseWithRegExp,
    parseCharSeparator,
    parseEqualsSeparator,
    parseImplicitSeparator,
    parseProto,
    parseOption,
    parseOptionNegation,
    parseValue,
...
var init_dist5 = __esm({
    "node_modules/tiny-parse-argv/dist/index.js"() {
        ...
        getAliasedDefaults = (aliases, defaults = {}) => {
            ...
            for (const key2 in defaults) {
                ...
                for (const key3 of keys) {
                    if (key3 in defaultsAliased) continue;
            ...
            for (const source2 in incompatibles) {
                ...
                for (const source3 of sources) {
                    for (const target of targets) {
                        const sourceSet =
                            incompatiblesAliased[source3] ||
                            (incompatiblesAliased[source3] = /* @__PURE__ */ new Set());
                        const targetSet =
                            incompatiblesAliased[target] ||
                            (incompatiblesAliased[target] = /* @__PURE__ */ new Set());
        ...
        parseCharSeparator = (argv) => {
            ...
            return parseWithRegExp(argv, re, (_, chars2) =>
                chars2.split("").map((char) => `-${char}`)
            );
        };
        ...
        parseArgv = (argv, options = {}) => {
            ...
            const args = parseCharSeparator(
                parseImplicitSeparator(parseEqualsSeparator(parseProto(parse8)))
            );
            let optionPrev = "";
            let optionEagerPrev = "";
            ...
            const parsedWithDefaultsAndBooleans = {
                ...zip(booleans, false),
                ...parsedWithDefaults,
            };
            if (onUnknown) {
                const unknowns = Object.keys(parsedWithDefaults).filter(
                    (key2) => key2 !== "_" && key2 !== "--" && !known.has(key2)
                );
                if (unknowns.length) {
                    onUnknown(unknowns);
                }
    ...
    "node_modules/tiny-updater/dist/utils.js"() {
        ...
        Utils = {
            ...
            notify: (name, version, latest) => {
                var _a4, _b2;
                if (
                    !((_b2 = (_a4 = globalThis.process) == null ? void 0 : _a4.stdout) == null
                        ? void 0
                        : _b2.isTTY)
                )
                    return;
            ...
            constructor() {
                ...
                this.get = (name) => {
                    try {
                        ...
                        if (!utils_default.isNumber(record.timestampFetch)) return;
                        if (!utils_default.isNumber(record.timestampNotification)) return;
                        if (!utils_default.isString(record.version)) return;
                        return record;
                    } catch {
                        return;
                    }
    ...
    "node_modules/tiny-updater/dist/index.js"() {
        ...
        updater = async ({ name, version, ttl = 0 }) => {
            ...
            const latest = isFresh
                ? await utils_default.getLatestVersion(name).catch(utils_default.noop)
                : record == null
                  ? void 0
                  : record.version;
            ...
            if (isFresh) {
                const record2 = {
                    timestampFetch: timestamp2,
                    timestampNotification: timestamp2,
                    version: latest,
                };
...
var init_dist7 = __esm({
    "node_modules/fast-string-truncated-width/dist/index.js"() {
        ...
        getStringTruncatedWidth = (input, truncationOptions = {}, widthOptions = {}) => {
            ...
            const ELLIPSIS_WIDTH2 =
                (truncationOptions == null ? void 0 : truncationOptions.ellipsisWidth) ??
                (ELLIPSIS2
                    ? getStringTruncatedWidth(ELLIPSIS2, NO_TRUNCATION, widthOptions).width
                    : 0);
            ...
            outer: while (true) {
                if (unmatchedEnd > unmatchedStart || (index >= length && index > indexPrev)) {
                    const unmatched =
                        input.slice(unmatchedStart, unmatchedEnd) || input.slice(indexPrev, index);
                    lengthExtra = 0;
                ...
                if (LATIN_RE.test(input)) {
                    ...
                    if (width + widthExtra > truncationLimit) {
                        truncationIndex = Math.min(
                            truncationIndex,
                            index + Math.floor((truncationLimit - width) / REGULAR_WIDTH)
                        );
                    }
                    if (width + widthExtra > LIMIT) {
                        truncationEnabled = true;
                ...
                if (CONTROL_RE.test(input)) {
                    ...
                    if (width + widthExtra > truncationLimit) {
                        truncationIndex = Math.min(
                            truncationIndex,
                            index + Math.floor((truncationLimit - width) / CONTROL_WIDTH)
                        );
                    }
                    if (width + widthExtra > LIMIT) {
                        truncationEnabled = true;
                ...
                if (TAB_RE.test(input)) {
                    ...
                    if (width + widthExtra > truncationLimit) {
                        truncationIndex = Math.min(
                            truncationIndex,
                            index + Math.floor((truncationLimit - width) / TAB_WIDTH)
                        );
                    }
                    if (width + widthExtra > LIMIT) {
                        truncationEnabled = true;
...
var init_dist10 = __esm({
    "node_modules/tiny-levenshtein/dist/index.js"() {
        ...
        levenshtein = (a, b) => {
            ...
            const Buffer3 =
                maxDistance < 255 ? Uint8Array : maxDistance < 65535 ? Uint16Array : Uint32Array;
            ...
            for (let i = 1; i <= aLength; i++) {
                for (let j = 1; j <= bLength; j++) {
                    const cost =
                        a.charCodeAt(start + i - 1) === b.charCodeAt(start + j - 1) ? 0 : 1;
...
var init_utils6 = __esm({
    "node_modules/tiny-bin/dist/utils.js"() {
        ...
        camelCase = /* @__PURE__ */ (() => {
            ...
            return (str2) => {
                return str2
                    ...
                    .toLowerCase()
                    .replace(prefixRe, "")
                    .replace(upperDigitRe, toUpperCase)
                    .replace(upperDividerRe, toUpperCase)
                    .replace(dividerRe, "");
            };
        })();
        castArray2 = (value) => {
        ...
        pushBack = (map2, key2) => {
            ...
            if (isUndefined2(value)) return map2;
            map2.delete(key2);
            map2.set(key2, value);
            return map2;
        };
    ...
    "node_modules/tiny-bin/dist/objects/logger.js"() {
        ...
        Logger = class extends addon_default {
            ...
            print(message = "") {
                ...
                this.handler(
                    colorize(`${this.indentation.repeat(this.indentationLevel)}${message}`)
                );
            }
            table(rows, mode = "line") {
                const rowsLengths = rows.map((row) => row.map((cell) => dist_default8(cell)));
                const maxLengths = rowsLengths[0].map((_, j) =>
                    Math.max(...rowsLengths.map((_2, i) => rowsLengths[i][j]))
                );
                        ...
                        const line2 = row
                            .map((value, j) => {
                                const paddingLength =
                                    j === row.length - 1
                                        ? 0
                                        : Math.max(0, 1 + maxLengths[j] - rowsLengths[i][j]);
...
var init_metadata = __esm({
    "node_modules/tiny-bin/dist/objects/metadata.js"() {
        ...
        Metadata = class extends addon_default {
            ...
            print() {
                this.stdout.print(
                    `${dist_default4.cyan(this.name)} ${dist_default4.dim(this.version)}`
                );
                this.stdout.print();
            }
        };
    ...
    "node_modules/tiny-bin/dist/objects/commands.js"() {
        ...
        Commands = class extends collection_default {
            ...
            print(mode) {
                ...
                const withoutOther = (section) =>
                    section.toLowerCase() !== "other" ? section : "";
                const commandsBySection = pushBack(
                    groupBy(commandsVisible, (command) =>
                        withoutOther(command.section.toLowerCase())
                    ),
                    ""
                );
                commandsBySection.forEach((commands2, section) => {
                    if (!commands2.length) return;
                    const title = section
                        ? `${section.toUpperCase()} COMMANDS`
                        : commandsBySection.size > 1
                          ? "OTHER COMMANDS"
                          : "COMMANDS";
                    const table = commands2.map((command) => {
                        ...
                        return [
                            [
                                ...
                                ...command.arguments
                                    .getAll()
                                    .map((arg) => dist_default4.yellow(arg.name)),
                            ].join(" "),
                            command.description,
                        ].map(withDeprecated);
                    });
    ...
    "node_modules/tiny-bin/dist/objects/arguments.js"() {
        ...
        Arguments = class extends collection_default {
            ...
            print(mode) {
                ...
                const table = args.map((arg) => [dist_default4.yellow(arg.name), arg.description]);
    ...
    "node_modules/tiny-bin/dist/objects/options.js"() {
        ...
        Options = class extends collection_default {
            ...
            print(mode) {
                ...
                const withoutOther = (section) =>
                    section.toLowerCase() !== "other" ? section : "";
                const optionsBySection = pushBack(
                    groupBy(optionsVisible, (option) => withoutOther(option.section.toLowerCase())),
                    ""
                );
                optionsBySection.forEach((options2, section) => {
                    if (!options2.length) return;
                    const title = section
                        ? `${section.toUpperCase()} OPTIONS`
                        : optionsBySection.size > 1
                          ? "OTHER OPTIONS"
                          : "OPTIONS";
                        ...
                        return [
                            [
                                [
                                    ...option.data.longs
                                        .sort()
                                        .map((long) => dist_default4.green(`--${long}`)),
                                    ...option.data.shorts
                                        .sort()
                                        .map((short) => dist_default4.green(`-${short}`)),
                                ].join(", "),
                                [
                                    ...option.data.args
                                        .sort()
                                        .map((arg) => dist_default4.blue(`<${arg}>`)),
                                ].join(" "),
                            ].join(" "),
                            option.description,
                        ].map(withDeprecated);
            ...
            print(command) {
                this.stdout.group("USAGE", () => {
                    if (this.usages.size) {
                        ...
                        const commands =
                            isCommandDefault && !command.handler
                                ? dist_default4.magenta("[command]")
                                : "";
        ...
        CommandDefault = class extends command_default {
            ...
            async run(options, argv) {
                ...
                if (options["help"] || name === "help") {
                    ...
                    const options2 = [
                        ...this.bin.command.options.getAll(),
                        ...command.options.getAll(),
                    ];
                    const minArgs = command.arguments.getAll().filter((arg) => arg.required).length;
                    const maxArgs = sum(
                        command.arguments.getAll().map((arg) => (arg.variadic ? Infinity : 1))
                    );
                    const parseArgvOptions = {
                        ...
                        onIncompatible: (options3) => {
                            this.bin.fail(
                                `Incompatible options: "${options3[0][0]}" and "${options3[0][1]}" cannot be used together`
                            );
                        },
                        onInvalid: (options3) => {
                        ...
                        onUnknown: (options3) => {
                            const closest = getClosest(
                                parseArgvOptions.known,
                                options3[0],
                                3,
                                true
                            );
                            this.bin.fail(
                                `Unknown option: "${options3[0]}"${closest ? `. Did you mean "${closest}"?` : ""}`
                            );
                        },
                    };
                    options2.forEach((option) => {
                        ...
                        if (option.incompatible) {
                            const incompatible =
                                (_a4 = parseArgvOptions.incompatible)[
                                    (_b2 = option.data.alls[0])
                                ] || (_a4[_b2] = []);
                    ...
                    options2.forEach((option) => {
                        ...
                        values.forEach((value2) => {
                            if (enums.includes(value2)) return;
                            this.bin.fail(
                                `Invalid value for "${option.data.alls[0]}" option, received "${value2}" but only ${enums.map((e) => `"${e}"`).join(", ")} are supported`
                            );
                        });
                    });
                    options2.forEach((option) => {
                        ...
                        this.bin.fail(
                            `Expected 1 value for "${option.data.alls[0]}" option, but received "${value.length}" values`
                        );
                    });
                    Object.keys(parsed).forEach((key2) => {
                        const camelKey = camelCase(key2);
                        if (camelKey === key2) return;
                    ...
                    if (actualArgs < minArgs || actualArgs > maxArgs) {
                        if (minArgs === maxArgs) {
                            this.bin.fail(
                                `Expected ${minArgs} arguments, but received ${actualArgs} arguments`
                            );
                        } else {
                            this.bin.fail(
                                `Expected between ${minArgs} and ${maxArgs} arguments, but received ${actualArgs} arguments`
                            );
                        }
                    }
                    if (isDefault) {
    ...
    "node_modules/tiny-bin/dist/objects/argument.js"() {
        ...
        Argument = class extends addon_default {
            ...
            parse(name) {
                ...
                if (!match2) this.bin.fail(`Invalid argument: "${name}"`);
    ...
    "node_modules/tiny-bin/dist/objects/command_help.js"() {
        ...
        CommandHelp = class extends command_default {
            ...
            async run(options, argv) {
                ...
                const name =
                    arg1 === "help"
                        ? arg2 || (options["help"] ? arg1 : "")
                        : hasCustomCommands
                          ? arg1
                          : "";
                if (name) {
                    const command = this.bin.commands.getByIdOrFail(name);
                    const mode = this.getPrintMode([
                        command.arguments,
                        command.options,
                        this.bin.command.options,
                    ]);
                    this.stdout.indent();
                    this.stdout.print();
        ...
        Option = class extends addon_default {
            ...
            parse(name, forceType) {
                ...
                if (!longs.length && !shorts.length)
                    this.bin.fail(
                        `Option must define at least a longhand or a shorthand: "${name}"`
                    );
                if (args.length > 1)
    ...
    "node_modules/tiny-bin/dist/objects/bin.js"() {
        ...
        Bin = class {
            ...
            constructor(options) {
                ...
                this.command.options.register(
                    new option_default(this, {
                        name: "--help",
                        description: "Display help for the command",
                    })
                );
    ...
    "node_modules/tiny-bin/dist/objects/chainable_bin_local.js"() {
        ...
        ChainableBinAfterCustomCommand = class extends addon_default {
            ...
            command(name, description, options = {}) {
                return new chainable_bin_global_default(this.bin).command(
                    name,
                    description,
                    options
                );
...
function formatList(array, type2 = "and") {
    return array.length < 3
        ? array.join(` ${type2} `)
        : `${array.slice(0, -1).join(", ")}, ${type2} ${array[array.length - 1]}`;
}
...
function isErrorStackTraceLimitWritable() {
    ...
    return own.call(desc, "writable") && desc.writable !== void 0
        ? desc.writable
        : desc.set !== void 0;
}
...
function resolvePackageTargetString(
        ...
        if (internal && !target.startsWith("../") && !target.startsWith("/")) {
            ...
            if (!isURL) {
                const exportTarget = pattern
                    ? RegExpPrototypeSymbolReplace.call(patternRegEx, target, () => subpath)
                    : target + subpath;
    ...
    if (pattern) {
        return new URL2(
            RegExpPrototypeSymbolReplace.call(patternRegEx, resolved.href, () => subpath)
        );
    }
...
function packageExportsResolve(packageJsonUrl, packageSubpath, packageConfig, base, conditions) {
    ...
    if (
        own2.call(exports, packageSubpath) &&
    ...
    while (++i < keys.length) {
        ...
        if (patternIndex !== -1 && packageSubpath.startsWith(key2.slice(0, patternIndex))) {
            ...
            if (
                packageSubpath.length >= key2.length &&
                packageSubpath.endsWith(patternTrailer) &&
                patternKeyCompare(bestMatch, key2) === 1 &&
                key2.lastIndexOf("*") === patternIndex
            ) {
                bestMatch = key2;
...
var RegExpPrototypeSymbolReplace,
    ERR_NETWORK_IMPORT_DISALLOWED,
    ERR_INVALID_MODULE_SPECIFIER,
    ...
    "node_modules/lomemo/dist/index.js"() {
        memoize = (fn, resolver) => {
            const memoized = function (...args) {
                ...
                if (cached !== void 0 || cache3.has(key2)) return cached;
...
var init_dist18 = __esm({
    "node_modules/tiny-readdir/dist/index.js"() {
        ...
        readdir = (rootPath, options) => {
            ...
            const ignores = castArray3(ignore).map((ignore2) =>
                isFunction(ignore2) ? ignore2 : (targetPath) => ignore2.test(targetPath)
            );
            ...
            const resultEmpty = {
                directories: [],
                directoriesNames: /* @__PURE__ */ new Set(),
                directoriesNamesToPaths: {},
                files: [],
                filesNames: /* @__PURE__ */ new Set(),
                filesNamesToPaths: {},
                symlinks: [],
                symlinksNames: /* @__PURE__ */ new Set(),
            ...
            const handleDirectory = (dirmap, subPath, name, depth) => {
                ...
                directoriesNamesToPaths.propertyIsEnumerable(name) ||
                    (directoriesNamesToPaths[name] = []);
            ...
            const handleSymlink = (dirmap, subPath, name, depth) => {
                ...
                symlinksNamesToPaths.propertyIsEnumerable(name) ||
                    (symlinksNamesToPaths[name] = []);
...
var init_utils9 = __esm({
    "node_modules/grammex/dist/utils.js"() {
        ...
        isFunctionStrictlyNullaryOrUnary = (() => {
            ...
            const re =
                /(?:^\(\s*(?:[^,.()]|\.(?!\.\.))*\s*\)\s*=>|^\s*[a-zA-Z$_][a-zA-Z0-9$_]*\s*=>)/;
            return (value) => {
    ...
    "node_modules/grammex/dist/index.js"() {
            ...
            return (state) => {
                ...
                if (indexEnd > indexStart) {
                    if (!isUndefined3(handler) && !state.options.silent) {
                        ...
                        const output = isFunction2(handler)
                            ? handler(target2, input, `${indexStart}`)
                            : handler;
        ...
        regex = (target, handler) => {
            if (isRegExpStatic(target)) {
                ...
                if (
                    isRegExpCapturing(target) &&
                    isFunction2(handler) &&
                    !isFunctionStrictlyNullaryOrUnary(handler)
                ) {
        ...
        regexNonCapturing = (re, handler) => {
            return (state) => {
                ...
                if (matched) {
                    ...
                    if (!isUndefined3(handler) && !state.options.silent) {
                        const output = isFunction2(handler)
                            ? handler(input.slice(indexStart, indexEnd), input, `${indexStart}`)
                            : handler;
                        if (!isUndefined3(output)) {
                            state.output.push(output);
                        }
        ...
        string = (target, handler) => {
            return (state) => {
                ...
                if (matched) {
                    if (!isUndefined3(handler) && !state.options.silent) {
                        const output = isFunction2(handler)
                            ? handler(target, input, `${indexStart}`)
                            : handler;
                        if (!isUndefined3(output)) {
                            state.output.push(output);
                        }
...
var init_range = __esm({
    "node_modules/zeptomatch/dist/range.js"() {
        ...
        makeRangePaddedInt = (start, end, paddingLength) => {
            return makeRangeInt(start, end).map((int2) =>
                String(int2).padStart(paddingLength, "0")
            );
        };
...
var init_grammar = __esm({
    "node_modules/zeptomatch/dist/convert/grammar.js"() {
        ...
        RangeOpen = match("{", "(?:");
        RangeClose = match("}", ")");
        RangeNumeric = match(/(\d+)\.\.(\d+)/, (_, $1, $2) =>
            makeRangePaddedInt(+$1, +$2, Math.min($1.length, $2.length)).join("|")
        );
        RangeAlphaLower = match(/([a-z]+)\.\.([a-z]+)/, (_, $1, $2) =>
            makeRangeAlpha($1, $2).join("|")
        );
        RangeAlphaUpper = match(/([A-Z]+)\.\.([A-Z]+)/, (_, $1, $2) =>
...
var init_grammar2 = __esm({
    "node_modules/zeptomatch/dist/normalize/grammar.js"() {
        ...
        Grammar2 = star(
            or([Escaped2, StarStarStar, StarStarNoLeft, StarStarNoRight, Passthrough2])
        );
...
var init_explode_start = __esm({
    "node_modules/zeptomatch-explode/dist/explode_start.js"() {
        SIMPLE_RE =
            /(\/?)([ a-zA-Z0-9._-]*)(?:\{([ a-zA-Z0-9._-]+(?:,[ a-zA-Z0-9._-]+)*)\})?([ a-zA-Z0-9._-]*)(\/(?=.))/gsy;
        explodeStart = (glob) => {
            let index = 0;
            ...
            while (index < length) {
                ...
                const values = multiple
                    ? multiple.split(",").map((value) => `${slash}${prefix}${value}${suffix}`)
                    : [`${slash}${prefix}${suffix}`];
                statics = statics.length
                    ? statics.flatMap((prefix2) => values.map((value) => `${prefix2}/${value}`))
                    : values;
        ...
        explodeEnd = (glob) => {
            ...
            if (match2) {
                ...
                if (prefix || multiple || suffix) {
                    ...
                    const statics = multiple
                        ? multiple.split(",").map((value) => `${prefix}${value}${suffix}`)
                        : [`${prefix}${suffix}`];
    ...
    "node_modules/tiny-readdir-glob/dist/utils.js"() {
        ...
        ignoreCompile = (rootPath, ignore) => {
            ...
            return castArray4(ignore).map((ignore2) => {
                if (!isString2(ignore2)) return ignore2;
...
var init_dist24 = __esm({
    "node_modules/tiny-readdir-glob/dist/index.js"() {
        ...
        readdirGlob = async (glob, options) => {
            ...
            const ignore = [
                ...castArray4((options == null ? void 0 : options.ignore) ?? []),
                ...globsNegative,
            ];
            ...
            const directoriesFoundNamesToPaths = uniqMergeConcat(
                bucketDirectoriesFoundNamesToPaths
            );
...
async function getTargetsPaths(rootPath, globs, withNodeModules) {
    ...
    for (const glob of globs) {
        ...
        if (fileStats == null ? void 0 : fileStats.isFile()) {
            ...
            targetFilesNamesToPaths.propertyIsEnumerable(fileName) ||
    ...
    const directoriesResults = await Promise.all(
        targetDirectories.map((targetPath) => getDirectoryPaths(targetPath, withNodeModules))
    );
    const directoriesResultsFiles = directoriesResults.map((result) => result.files);
    const directoriesResultsFilesFoundNames = directoriesResults.map((result) => [
        ...result.filesNames,
    ]);
    const foundFiles = uniqChunks(globResultFiles, ...directoriesResultsFiles);
    const foundFilesNames = uniqChunks(
        globResultFilesFoundNames,
        ...directoriesResultsFilesFoundNames
    );
    ...
    for (const fileName in targetFilesNamesToPaths) {
        ...
        const next = Array.isArray(prev)
            ? prev.concat(targetFilesNamesToPaths[fileName])
            : targetFilesNamesToPaths[fileName];
...
async function normalizeOptions(options, targets) {
    ...
    const targetsStatic =
        "--" in options && Array.isArray(options["--"])
            ? options["--"].filter(isString3).map(dist_default22)
            : [];
    ...
    const configPath =
        "configPath" in options && isString3(options.configPath) ? [options.configPath] : void 0;
    const editorConfig = "editorconfig" in options ? !!options.editorconfig : true;
    const ignore = "ignore" in options ? !!options.ignore : true;
    const ignorePath =
        "ignorePath" in options &&
        isArray3(options.ignorePath) &&
        options.ignorePath.every(isString3)
            ? options.ignorePath
            : void 0;
    ...
    const cacheLocation =
        "cacheLocation" in options && isString3(options.cacheLocation)
            ? options.cacheLocation
            : void 0;
    const errorOnUnmatchedPattern =
        "errorOnUnmatchedPattern" in options ? !!options.errorOnUnmatchedPattern : true;
    const ignoreUnknown =
        "ignoreUnknown" in options && isBoolean2(options.ignoreUnknown)
            ? !!options.ignoreUnknown
            : globs.some(dist_default19);
    ...
    const parallelWorkers =
        ("parallelWorkers" in options && Math.round(Number(options.parallelWorkers))) || 0;
    const stdinFilepath =
        "stdinFilepath" in options && isString3(options.stdinFilepath)
...
function normalizePrettierOptions(options, folderPath) {
    ...
    if ("overrides" in options && isArray3(options.overrides)) {
        ...
        for (let i = 0, l = overridesRaw.length; i < l; i++) {
            ...
            if (
                !isString3(overrideRaw.files) &&
                (!isArray3(overrideRaw.files) || !overrideRaw.files.every(isString3))
            )
                continue;
            ...
            const filesNegative =
                "filesNegative" in overrideRaw &&
                (isString3(overrideRaw.filesNegative) ||
                    (isArray3(overrideRaw.filesNegative) &&
                        overrideRaw.filesNegative.every(isString3)))
                    ? castArray5(overrideRaw.filesNegative)
                    : [];
...
var require_is_binary_path = __commonJS({
    "node_modules/is-binary-path/index.js"(exports, module) {
        ...
        module.exports = (filePath) =>
            extensions.has(path17.extname(filePath).slice(1).toLowerCase());
    },
});
    ...
    "node_modules/@prettier/cli/dist/cache.js"() {
        ...
        Cache = class {
            constructor(version, rootPath, options, logger) {
                ...
                this.storePath =
                    options.cacheLocation ||
                    path10.join(getCachePath(rootPath), `${sha1hex(rootPath)}.json`);
            ...
            get(filePath) {
                ...
                try {
                    const file =
                        (_b2 = (_a4 = this.store[this.version]) == null ? void 0 : _a4.files) ==
                        null
                            ? void 0
                            : _b2[fileRelativePath];
                    if (!file || !isArray3(file) || file.length !== 2) return { save };
                    const [hash, formatted] = file;
                    if (!isString3(hash) || !isBoolean2(formatted)) return { save };
            ...
            async has(filePath, isIgnored) {
                ...
                const fileRelativePath = fastRelativePath(this.rootPath, filePath);
                const file =
                    (_b3 = (_a5 = this.store[this.version]) == null ? void 0 : _a5.files) == null
                        ? void 0
                        : _b3[fileRelativePath];
...
var init_utils13 = __esm({
    "node_modules/ini-simple-parser/dist/utils.js"() {
        inferBoolean = (value) => {
            if (!isString4(value) || !value.length) return value;
        ...
        stripComments = (value) => {
            ...
            const commentIndex =
                comment1Index >= 0
                    ? comment2Index >= 0
                        ? Math.min(comment1Index, comment2Index)
                        : comment1Index
                    : comment2Index;
...
var init_range2 = __esm({
    "node_modules/tiny-editorconfig/node_modules/zeptomatch/dist/range.js"() {
        ...
        makeRangeInt2 = (start, end) => {
            if (end < start) return makeRangeInt2(end, start);
            const range = [];
            while (start <= end) {
                range.push(start++);
            }
        ...
        makeRangePaddedInt2 = (start, end, paddingLength) => {
            return makeRangeInt2(start, end).map((int2) =>
                String(int2).padStart(paddingLength, "0")
            );
        };
...
var init_grammar3 = __esm({
    "node_modules/tiny-editorconfig/node_modules/zeptomatch/dist/convert/grammar.js"() {
        ...
        init_utils15();
        FastPathAll = match(/^\*\*\/\*$/, ".*");
        FastPathSimple = match(
            /^\*\*\/(\*)?([ a-zA-Z0-9._-]+)$/,
            (_, $1, $2) => `.*${$1 ? "" : "(?:^|/)"}${$2.replaceAll(".", "\\.")}`
        );
        FastPathSimples = match(
            /^\*\*\/(\*)?([ a-zA-Z0-9._-]*)\{([ a-zA-Z0-9._-]+(?:,[ a-zA-Z0-9._-]+)*)\}$/,
            (_, $1, $2, $3) =>
                `.*${$1 ? "" : "(?:^|/)"}${$2.replaceAll(".", "\\.")}(?:${$3.replaceAll(",", "|").replaceAll(".", "\\.")})`
        );
        ...
        RangeOpen2 = match("{", "(?:");
        RangeClose2 = match("}", ")");
        RangeNumeric2 = match(/(\d+)\.\.(\d+)/, (_, $1, $2) =>
            makeRangePaddedInt2(+$1, +$2, Math.min($1.length, $2.length)).join("|")
        );
        RangeAlphaLower2 = match(/([a-z]+)\.\.([a-z]+)/, (_, $1, $2) =>
            makeRangeAlpha2($1, $2).join("|")
        );
        RangeAlphaUpper2 = match(/([A-Z]+)\.\.([A-Z]+)/, (_, $1, $2) =>
            makeRangeAlpha2($1.toLowerCase(), $2.toLowerCase()).join("|").toUpperCase()
        );
...
var init_grammar4 = __esm({
    "node_modules/tiny-editorconfig/node_modules/zeptomatch/dist/normalize/grammar.js"() {
        ...
        Grammar4 = star(
            or([Escaped4, StarStarStar2, StarStarNoLeft2, StarStarNoRight2, Passthrough4])
        );
    ...
    "node_modules/tiny-editorconfig/dist/extend.js"() {
        ...
        extend = (target, source2) => {
            for (const prop in source2) {
                ...
                if (isUndefined5(value)) continue;
                target[prop] = value;
            }
            return target;
        };
        ...
        resolve3 = (configs, filePath) => {
            ...
            for (let i = 0, l = configs.length; i < l; i++) {
                ...
                for (const override in overrides) {
                    const glob = `**/${override}`;
                    if (override !== "*" && !dist_default25(glob, filePath)) continue;
    ...
    "node_modules/@prettier/cli/dist/config_editorconfig.js"() {
        ...
        getEditorConfigsMap = async (foldersPaths, filesNames) => {
            const configs = await Promise.all(
                foldersPaths.map((folderPath) => getEditorConfig(folderPath, filesNames))
            );
        ...
        getEditorConfigsUp = dist_default13(async (folderPath, filesNames) => {
            ...
            const configsUp =
                folderPath !== folderPathUp
                    ? await getEditorConfigsUp(folderPathUp, filesNames)
                    : [];
        ...
        matcher = (glob, caseSensitive) => {
            ...
            if (STATIC_RE.test(glob)) {
                if (caseSensitive) {
                    ...
                    return (segment) =>
                        segment.length === globLength && segment.toLowerCase() === globLowerCase;
                }
            }
            ...
            for (let ti = 0, tl = tiers.length; ti < tl; ti++) {
                ...
                for (let gi = 0, gl = globs.length; gi < gl; gi++) {
                    ...
                    content = content.startsWith("/")
                        ? content.slice(1)
                        : content.startsWith("**/") || content.slice(0, -1).includes("/")
                          ? content
                          : `**/${content}`;
                    ...
                    for (let si = 0, sl = segments.length; si < sl; si++) {
                        ...
                        if (nodeExisting) {
                            if (
                                (tier === nodeExisting.tier && strength >= nodeExisting.strength) ||
                                (tier > nodeExisting.tier &&
                                    (nodeExisting.strength < 0 || nodeExisting.negative))
                            ) {
        ...
        matcher2 = (ignore, options = {}) => {
            ...
            return (fileRelativePath) => {
                ...
                while (segmentIndex < length) {
                    ...
                    const cachedResult =
                        cacheable && cached && cached[0] === segment ? cached[1] : void 0;
...
var getIgnoreContent,
    getIgnoresContent,
    getIgnoresContentMap,
    getIgnoreBy,
    getIgnoreBys,
    getIgnores,
    getIgnoresUp,
...
var init_config_ignore = __esm({
    "node_modules/@prettier/cli/dist/config_ignore.js"() {
        ...
        getIgnoreContent = (folderPath, fileName) => {
            const filePath = fastJoinedPath(folderPath, fileName);
            if (!known_default.hasFilePath(filePath)) return;
        ...
        getIgnoresContent = dist_default13(async (folderPath, filesNames) => {
            const contentsRaw = await Promise.all(
                filesNames.map((fileName) => getIgnoreContent(folderPath, fileName))
            );
        ...
        getIgnoresContentMap = async (foldersPaths, filesNames) => {
            const contents = await Promise.all(
                foldersPaths.map((folderPath) => getIgnoresContent(folderPath, filesNames))
            );
        ...
        getIgnoreBys = (foldersPaths, filesContents) => {
            ...
            const ignores = foldersPaths.map((folderPath, index) =>
                getIgnoreBy(folderPath, filesContents[index])
            );
        ...
        getIgnores = dist_default13(async (folderPath, filesNames) => {
            ...
            if (!(contents == null ? void 0 : contents.length)) return;
        ...
        getIgnoresUp = dist_default13(async (folderPath, filesNames) => {
            ...
            const ignoreUp =
                folderPath !== folderPathUp ? await getIgnoresUp(folderPathUp, filesNames) : void 0;
...
function getStringEnd(str2, seek) {
    let first = str2[seek];
    let target =
        first === str2[seek + 1] && str2[seek + 1] === str2[seek + 2]
            ? str2.slice(seek, seek + 3)
            : first;
    seek += target.length - 1;
    do seek = str2.indexOf(target, ++seek);
    while (
        seek > -1 &&
        first !== "'" &&
        str2[seek - 1] === "\\" &&
        (str2[seek - 2] !== "\\" || str2[seek - 3] === "\\")
    );
    if (seek > -1) {
        seek += target.length;
        if (target.length > 1) {
            if (str2[seek] === first) seek++;
            if (str2[seek] === first) seek++;
        }
    }
    return seek;
...
var init_date = __esm({
    "node_modules/smol-toml/dist/date.js"() {
        ...
        _TomlDate = class _TomlDate extends Date {
            ...
            isLocal() {
                return (
                    !__privateGet(this, _hasDate) ||
                    !__privateGet(this, _hasTime) ||
            ...
            toISOString() {
                ...
                if (__privateGet(this, _offset) === null) return iso.slice(0, -1);
                if (__privateGet(this, _offset) === "Z") return iso;
                let offset =
                    +__privateGet(this, _offset).slice(1, 3) * 60 +
                    +__privateGet(this, _offset).slice(4, 6);
...
function extractValue(str2, ptr, end, depth = -1) {
    ...
    if (c2 === "[" || c2 === "{") {
        let [value, endPtr2] =
            c2 === "[" ? parseArray(str2, ptr, depth) : parseInlineTable(str2, ptr, depth);
    ...
    return [parseValue2(slice[0], str2, ptr), endPtr];
}
...
function parseArray(str2, ptr, depth = -1) {
    ...
    while ((c2 = str2[ptr++]) !== "]" && c2) {
        ...
        } else if (c2 === "#") ptr = skipComment(str2, ptr);
        else if (c2 !== " " && c2 !== "	" && c2 !== "\n" && c2 !== "\r") {
...
function peekTable(key2, table, meta, type2) {
    ...
    for (let i = 0; i < key2.length; i++) {
        ...
        if (
            (hasOwn = Object.hasOwn(t, k)) &&
            ((_a4 = m[k]) == null ? void 0 : _a4.t) === 0 &&
            ((_b2 = m[k]) == null ? void 0 : _b2.d)
        ) {
            return null;
        }
        if (!hasOwn) {
    ...
    if (state.tag === null) {
        ...
        if (_hasOwnProperty$1.call(state.typeMap[state.kind || "fallback"], state.tag)) {
            ...
            for (
                ...
                if (
                    state.tag.slice(0, typeList[typeIndex].tag.length) === typeList[typeIndex].tag
                ) {
...
function isNsCharOrWhitespace(c2) {
    return (
        isPrintable(c2) && c2 !== CHAR_BOM && c2 !== CHAR_CARRIAGE_RETURN && c2 !== CHAR_LINE_FEED
    );
}
...
function codePointAt(string2, pos2) {
    var first = string2.charCodeAt(pos2),
        second;
...
function chooseScalarStyle(
    ...
    var plain =
        isPlainSafeFirst(codePointAt(string2, 0)) &&
        isPlainSafeLast(codePointAt(string2, string2.length - 1));
    ...
    state.dump = (function () {
        ...
        if (!state.noCompatMode) {
            if (
                ...
                DEPRECATED_BASE60_SYNTAX.test(string2)
            ) {
                return state.quotingType === QUOTING_TYPE_DOUBLE
                    ? '"' + string2 + '"'
                    : "'" + string2 + "'";
        ...
        switch (
            ...
            case STYLE_LITERAL:
                return (
                    "|" +
                    blockHeader(string2, state.indent) +
            ...
            case STYLE_FOLDED:
                return (
                    ">" +
                    blockHeader(string2, state.indent) +
                    dropEndingNewline(indentString(foldString(string2, lineWidth), indent))
                );
            case STYLE_DOUBLE:
...
function foldString(string2, width) {
    ...
    while ((match2 = lineRe.exec(string2))) {
        ...
        result +=
            prefix +
            (!prevMoreIndented && !moreIndented && line2 !== "" ? "\n" : "") +
...
var Loaders,
    ...
    getPrettierConfig,
    getPrettierConfigs,
    getPrettierConfigsMap,
    getPrettierConfigsUp,
    ...
    "node_modules/@prettier/cli/dist/config_prettier.js"() {
        ...
        Loaders = {
            ...
            json5: async (filePath) => {
                const fileContent = fs11.readFileSync(filePath, "utf8");
                const JSON52 = (await Promise.resolve().then(() => (init_dist32(), dist_exports2)))
                    .default;
            ...
            package: async (filePath) => {
                ...
                if (!fileBuffer.includes("prettier")) return;
            ...
            yaml: async (filePath) => {
                const yaml = (await Promise.resolve().then(() => (init_js_yaml(), js_yaml_exports)))
                    .default;
                const fileContent = fs11.readFileSync(filePath, "utf8");
        ...
        getPrettierConfig = (folderPath, fileName) => {
            ...
            const normalize = (config) =>
                isObject2(config)
                    ? { ...config, ...normalizePrettierOptions(config, folderPath) }
                    : void 0;
            return loader2(filePath).then(normalize).catch(noop2);
        };
        getPrettierConfigs = dist_default13(async (folderPath, filesNames) => {
            const configsRaw = await Promise.all(
                filesNames.map((fileName) => getPrettierConfig(folderPath, fileName))
            );
        ...
        getPrettierConfigsMap = async (foldersPaths, filesNames) => {
            const configs = await Promise.all(
                foldersPaths.map((folderPath) => getPrettierConfigs(folderPath, filesNames))
            );
            const map2 = zipObjectUnless(foldersPaths, configs, isUndefined4);
            return map2;
        };
        getPrettierConfigsUp = dist_default13(async (folderPath, filesNames) => {
            var _a4;
            const config =
                (_a4 = await getPrettierConfigs(folderPath, filesNames)) == null ? void 0 : _a4[0];
            const folderPathUp = path13.dirname(folderPath);
            const configsUp =
                folderPath !== folderPathUp
                    ? await getPrettierConfigsUp(folderPathUp, filesNames)
                    : [];
            const configs = config ? [...configsUp, config] : configsUp;
            return configs;
        });
            ...
            for (let ci = 0, cl = configs.length; ci < cl; ci++) {
                ...
                if (overrides) {
                    for (let oi = 0, ol = overrides.length; oi < ol; oi++) {
                        ...
                        if (!dist_default18(override.filesPositive, filePathRelative)) continue;
                        if (dist_default18(override.filesNegative, filePathRelative)) continue;
    ...
    "node_modules/dettle/dist/debounce.js"() {
        debounce = (fn, wait = 1, options) => {
            ...
            const maxWait = Math.max(
                (options == null ? void 0 : options.maxWait) ?? Infinity,
                wait
            );
            let args;
            let timeout;
            ...
            const onLeading = (timestamp2) => {
                timestampInvoke = timestamp2;
                if (leading) return invoke(timestamp2);
            };
            const onTrailing = (timestamp2) => {
                if (trailing && args) return invoke(timestamp2);
                args = void 0;
            };
            const onTimeout = () => {
                timeout = void 0;
                const [timestamp2, isInvoking] = getInstantData();
                if (isInvoking) return onTrailing(timestamp2);
            ...
            const debounced = (...argsLatest) => {
                ...
                if (isInvoking) {
                    if (!hadTimeout) return onLeading(timestamp2);
...
var init_dist38 = __esm({
    "node_modules/ansi-truncate/dist/index.js"() {
        ...
        truncate = (input, width, options) => {
            ...
            const ellipsisWidth =
                (options == null ? void 0 : options.ellipsisWidth) ??
                (ellipsis === ELLIPSIS ? ELLIPSIS_WIDTH : void 0);
            const { index, ellipsed, truncated } = dist_default7(input, {
                limit,
                ellipsis,
                ellipsisWidth,
            });
...
var init_utils17 = __esm({
    "node_modules/tiny-spinner/dist/utils.js"() {
        ...
        isTTY = () => {
            var _a4, _b2;
            return !!((_b2 = (_a4 = globalThis.process) == null ? void 0 : _a4.stdout) == null
                ? void 0
                : _b2.isTTY);
        };
        writeLine = (line2) => {
            ...
            if (process19) {
                const isTerminal = /(\r?\n|\r)$/.test(line2);
                (_b2 = (_a4 = process19.stdout) == null ? void 0 : _a4.cursorTo) == null
                    ? void 0
                    : _b2.call(_a4, 0);
                (_d = (_c2 = process19.stdout) == null ? void 0 : _c2.write) == null
                    ? void 0
                    : _d.call(_c2, line2.trim());
                (_f = (_e = process19.stdout) == null ? void 0 : _e.clearLine) == null
                    ? void 0
                    : _f.call(_e, 1);
                (_h = (_g = process19.stdout) == null ? void 0 : _g.write) == null
                    ? void 0
                    : _h.call(_g, isTerminal ? "\r\n" : "");
            } else {
                console.log(line2);
            }
        };
                ...
                return function attempt3(...args) {
                    return retryify_queue_default.schedule().then((cleanup) => {
                        ...
                        const onReject = (error) => {
                            cleanup();
                            if (Date.now() >= timestamp2) throw error;
                            if (isRetriableError(error)) {
                                const delay = Math.round(100 * Math.random());
                                const delayPromise = new Promise((resolve4) =>
            ...
            return function retrified(timestamp2) {
                return function attempt3(...args) {
                    try {
                        ...
                        if (Date.now() > timestamp2) throw error;
                        if (isRetriableError(error)) return attempt3.apply(void 0, args);
                        throw error;
                    }
                };
            };
    ...
    "node_modules/stubborn-fs/dist/index.js"() {
        ...
        FS = {
            ...
            retry: {
                ...
                readFile: retryifyAsync(
                    promisify(fs12.readFile),
                    handlers_default.isRetriableError
                ),
                ...
                writeFile: retryifyAsync(
                    promisify(fs12.writeFile),
                    handlers_default.isRetriableError
                ),
                /* SYNC */
    ...
    "node_modules/atomically/dist/utils/temp.js"() {
        ...
        Temp = {
            ...
            get: (filePath, creator, purge2 = true) => {
                ...
                if (tempPath in Temp.store) return Temp.get(filePath, creator, purge2);
...
function readFile(filePath, options = DEFAULT_READ_OPTIONS) {
    if (isString6(options)) return readFile(filePath, { encoding: options });
...
function writeFile(filePath, data, options, callback) {
    if (isFunction4(options)) return writeFile(filePath, data, DEFAULT_WRITE_OPTIONS, options);
...
async function writeFileAsync(filePath, data, options = DEFAULT_WRITE_OPTIONS) {
    if (isString6(options)) return writeFileAsync(filePath, data, { encoding: options });
    const timeout = Date.now() + ((options.timeout ?? DEFAULT_TIMEOUT_ASYNC) || -1);
    ...
    try {
        ...
        [tempPath, tempDisposer] = temp_default.get(
            filePath,
            options.tmpCreate || temp_default.create,
            !(options.tmpPurge === false)
        );
        ...
        fd = await dist_default36.retry.open(timeout)(
            tempPath,
            "w",
        ...
        if (isString6(data)) {
            await dist_default36.retry.write(timeout)(
                fd,
                data,
                0,
        ...
        if (
            options.chown &&
            (options.chown.uid !== DEFAULT_USER_UID || options.chown.gid !== DEFAULT_USER_GID)
        ) {
        ...
        if (fd) await dist_default36.attempt.close(fd);
...
function makeCached(options, cache3, prettier) {
    return {
        ...
        async checkWithPath(
            ...
            if (isBoolean2(data == null ? void 0 : data.formatted)) return data.formatted;
            const fileContent =
                ((_a4 = data == null ? void 0 : data.content) == null ? void 0 : _a4.toString()) ??
                (await readFile(filePath, "utf8"));
            const formatted = await prettier.check(
                filePath,
                fileContent,
                formatOptions,
                contextOptions,
        ...
        async formatWithPath(
            ...
            const fileContent =
                ((_a4 = data == null ? void 0 : data.content) == null ? void 0 : _a4.toString()) ??
                (await readFile(filePath, "utf8"));
            if (data == null ? void 0 : data.formatted) return fileContent;
        ...
        async writeWithPath(
            ...
            var _a4;
            const data = await cache3.get(filePath);
            if (data == null ? void 0 : data.formatted) return true;
            const fileContent =
                ((_a4 = data == null ? void 0 : data.content) == null ? void 0 : _a4.toString()) ??
                (await readFile(filePath, "utf8"));
            const fileContentFormatted = await prettier.format(
    ...
    "node_modules/webworker-shim/dist/node.js"() {
        ...
        WorkerShim = class extends EventTarget {
            ...
            constructor(url3, options) {
                ...
                const setup = encodeURIComponent(
                    'import {parentPort} from "node:worker_threads";globalThis.self = globalThis;globalThis.addEventListener = parentPort.on.bind ( parentPort );globalThis.postMessage = parentPort.postMessage.bind ( parentPort );'
                );
    ...
    "node_modules/worktank/dist/worker/frontend.js"() {
        ...
        WorkerFrontend = class {
            ...
            constructor(name, bootloader, onClose, onError, onMessage) {
                ...
                const backend = backend_compiled_default.replace(
    ...
    "node_modules/worktank/dist/worker/index.js"() {
        ...
        Worker2 = class {
            ...
            constructor(name, bootloader) {
                ...
                this.exec = (task) => {
                    if (this.terminated) throw new error_default(this.name, "Terminated");
                    if (this.task || this.busy) throw new error_default(this.name, "Busy");
                    this.task = task;
                    this.tick();
                };
                this.reject = (error) => {
                ...
                this.worker = new frontend_default(
                    this.name,
                    this.bootloader,
                    this.onClose,
                    this.onError,
...
${ready}
                        ...
                        const registerEnv = `WorkTankWorkerBackend.registerEnv ( ${JSON.stringify(env)} );`;
                        const serializedMethods = `{ ${Object.keys(methods)
                            .map((name) => `${name}: ${methods[name].toString()}`)
                            .join(",")} }`;
...
${ready}`;
                ...
                this.cleanup = () => {
                    ...
                    for (const worker of this.workersIdle) {
                        if (
                            worker.ready &&
                            !worker.busy &&
                            worker.timestamp < autoterminateTimestamp
                        ) {
                            worker.terminate();
                ...
                this.exec = (method, args, options2) => {
                    ...
                    const timeout =
                        (options2 == null ? void 0 : options2.timeout) ?? this.autoAbort;
                ...
                this.resize = (size) => {
                    ...
                    if (this.autoInstantiate) {
                        const missingNr = Math.max(
                            0,
                            this.size - this.workersBusy.size - this.workersIdle.size
                        );
                ...
                this.env = {
                    ...((_c2 = globalThis.process) == null ? void 0 : _c2.env),
                    ...options.worker.env,
                };
...
function makeParallel(options) {
    ...
    return {
        async check(
            ...
            return pool.exec("check", [
                filePath,
                fileContent,
                await resolve2(formatOptions),
                contextOptions,
                pluginsDefaultOptions,
                pluginsCustomOptions,
            ]);
        ...
        async checkWithPath(
            ...
            return pool.exec("checkWithPath", [
                filePath,
                await resolve2(formatOptions),
                contextOptions,
                pluginsDefaultOptions,
        ...
        async formatWithPath(
            ...
            return pool.exec("formatWithPath", [
                filePath,
                await resolve2(formatOptions),
                contextOptions,
                pluginsDefaultOptions,
        ...
        async writeWithPath(
            ...
            return pool.exec("writeWithPath", [
                filePath,
                await resolve2(formatOptions),
                contextOptions,
                pluginsDefaultOptions,
...
async function makePrettier(options, cache3) {
    if (options.parallel) {
        const { makeParallel: makeParallel2 } = await Promise.resolve().then(
            () => (init_prettier_parallel(), prettier_parallel_exports)
        );
        ...
        const { makeLazy: makeLazy2 } = await Promise.resolve().then(
            () => (init_prettier_lazy(), prettier_lazy_exports)
        );
        if (options.cache && cache3) {
...
async function runGlobs(options, pluginsDefaultOptions, pluginsCustomOptions) {
    ...
    const [
        ...
        filesFoundPaths,
        foldersFoundPaths,
    ] = await getTargetsPaths(rootPath, options.globs, options.withNodeModules);
    ...
    const [foldersPathsTargets, foldersExtraPaths] = getExpandedFoldersPaths(
        foldersFoundPaths,
        projectPath
    );
    ...
    const editorConfigNames = options.editorConfig
        ? [".editorconfig"].filter(known_default.hasFileName)
        : [];
    const ignoreNames = options.ignore
        ? [".gitignore", ".prettierignore"].filter(known_default.hasFileName)
        : [];
    const prettierConfigNames = options.config
        ? without2(Object.keys(File2Loader), ["default"]).filter(known_default.hasFileName)
        : [];
    const fileNames2parentPaths = (names) =>
        names.flatMap((name) => {
            var _a4;
            return (
                ((_a4 = filesNamesToPaths[name]) == null ? void 0 : _a4.map(path16.dirname)) || []
            );
        });
    const editorConfigPaths = uniq3([
        ...fileNames2parentPaths(editorConfigNames),
        rootPath,
        ...foldersExtraPaths,
    ]);
    const ignorePaths = uniq3([
        ...fileNames2parentPaths(ignoreNames),
        rootPath,
        ...foldersExtraPaths,
    ]);
    const prettierConfigPaths = uniq3([
        ...fileNames2parentPaths(prettierConfigNames),
        rootPath,
        ...foldersExtraPaths,
    ]);
    const editorConfigs = options.editorConfig
        ? await getEditorConfigsMap(editorConfigPaths, editorConfigNames)
        : {};
    const ignoreContents = options.ignore
        ? await getIgnoresContentMap(ignorePaths, ignoreNames)
        : {};
    const prettierConfigs = options.config
        ? await getPrettierConfigsMap(prettierConfigPaths, prettierConfigNames)
        : {};
    const ignoreManualFilesNames = options.ignore ? options.ignorePath || [] : [];
    const ignoreManualFilesPaths = ignoreManualFilesNames.map((fileName) =>
        path16.resolve(fileName)
    );
    const ignoreManualFilesContents = await Promise.all(
        ignoreManualFilesPaths.map((filePath) => fs13.readFile(filePath, "utf8").catch(() => ""))
    );
    const ignoreManualFoldersPaths = ignoreManualFilesPaths.map(path16.dirname);
    const ignoreManual = getIgnoreBys(
        ignoreManualFoldersPaths,
        ignoreManualFilesContents.map(castArray5)
    );
    const prettierManualFilesNames = options.configPath || [];
    const prettierManualFilesPaths = prettierManualFilesNames.map((fileName) =>
        path16.resolve(fileName)
    );
    const prettierManualFilesContents = await Promise.all(
        prettierManualFilesPaths.map((filePath) => fs13.readFile(filePath, "utf8"))
    );
    const prettierManualConfigs = await Promise.all(prettierManualFilesPaths.map(Loaders.auto));
    const prettierManualConfig = prettierManualConfigs.length
        ? Object.assign({}, ...prettierManualConfigs)
        : void 0;
    const cliContextConfig = options.contextOptions;
    const cliFormatConfig = options.formatOptions;
    const cacheVersion = dist_default23({
        prettierVersion,
        cliVersion,
        pluginsNames,
        pluginsVersions,
    ...
    const shouldCache =
        options.cache &&
        !options.dump &&
        !pluginsVersionsMissing.length &&
        isUndefined4(cliContextConfig.cursorOffset);
    const cache3 = shouldCache
        ? new cache_default(cacheVersion, projectPath, options, stdout)
        : void 0;
    ...
    const filesResults = await Promise.allSettled(
        filesPathsTargets.map(async (filePath) => {
            const isIgnored = () =>
                ignoreManual ? ignoreManual(filePath) : getIgnoreResolved(filePath, ignoreNames);
            ...
            const getFormatOptions = async () => {
                const editorConfig = options.editorConfig
                    ? getEditorConfigFormatOptions(
                          await getEditorConfigResolved(filePath, editorConfigNames)
                      )
                    : {};
            ...
            try {
                if (options.check || options.list) {
                    return await prettier.checkWithPath(
                        filePath,
                        getFormatOptions,
                        cliContextConfig,
                        pluginsDefaultOptions,
                    ...
                    return await prettier.writeWithPath(
                        filePath,
                        getFormatOptions,
                        cliContextConfig,
                        pluginsDefaultOptions,
                    ...
                    return await prettier.formatWithPath(
                        filePath,
                        getFormatOptions,
                        cliContextConfig,
                        pluginsDefaultOptions,
        ...
        if (fileResult.status === "fulfilled") {
            if (isUndefined4(fileResult.value)) {
                ...
                if (fileResult.value) {
                    ...
                    const fileNameToDisplay = normalizePathSeparatorsToPosix(
                        fastRelativePath(rootPath, filePath)
                    );
                    if (options.check) {
    ...
    stdout.prefixed.debug(() =>
        pathsUnknown
            .map((filePath) => normalizePathSeparatorsToPosix(fastRelativePath(rootPath, filePath)))
            .join("\n")
    );
    ...
    if (totalUnformatted) {
        if (options.check) {
            stderr.prefixed.warn(
                `Code style issues found in ${totalUnformatted} ${pluralize("file", totalUnformatted)}. Run Prettier with --write to fix.`
            );
        }
    }
    ...
    process18.exitCode =
        (!totalMatched && !totalIgnored && options.errorOnUnmatchedPattern) ||
        totalErrored ||
        (totalUnformatted && !options.write)
            ? 1
            : 0;
}
...
var toSpaceCase = (value) => {
    return value
        .replace(splitRe, (_, $1, $2, $3, $4) =>
            $4
                ? " "
                : $3 && $2.length > 1
                  ? `${$1} ${$2.slice(0, -1)} ${$2.slice(-1)}`
                  : `${$1} ${$2}`
        )
        .toLowerCase()
        .trim();
...
init_utils12();
var makeBin = () => {
    return dist_default11("prettier", "An opinionated code formatter")
        .autoExit(true)
        .autoUpdateNotifier(false)
        .colors(true)
        .package("prettier", PRETTIER_VERSION)
        .usage(
            `${dist_default4.cyan("prettier")} ${dist_default4.yellow("[file/dir/glob...]")} ${dist_default4.green("[options]")}`
        )
        .usage(
            `${dist_default4.cyan("prettier")} ${dist_default4.yellow('"src/**/*.js"')} ${dist_default4.green("--check")}`
        )
        .usage(
            `${dist_default4.cyan("prettier")} ${dist_default4.yellow('"src/**/*.js"')} ${dist_default4.green("-l")} ${dist_default4.green("--no-cache")}`
        )
        .usage(
            `${dist_default4.cyan("prettier")} ${dist_default4.yellow('"src/**/*.js"')} ${dist_default4.green("--write")} ${dist_default4.green("--no-parallel")}`
        )
        .usage(
            `${dist_default4.cyan("prettier")} ${dist_default4.yellow("./path/to/target/file.js")} ${dist_default4.green("--cache-location")} ${dist_default4.blue("./path/to/cache/file.json")}`
        )
        .option(
            "--check, -c",
...
Defaults to "false"`,
        ...
        .action(async (options, files) => {
            const { run: run2 } = await Promise.resolve().then(
                () => (init_dist44(), dist_exports4)
            );
...
${descriptionDefault}`.trim();
                pluginsDefaultOptions[option] = initial;
                bin2 = bin2.option(`--${to_kebab_case_default(option)}`, description, {
                    deprecated,
                    section,
                });
...
var makeWarnedPluggableBin = async () => {
    ...
    if (isBoolean2(args["find-config-path"])) {
        exit_default(
            'The "--find-config-path" is not currently supported, please open an issue on GitHub if you need it'
        );
    }
    if (args["config-precedence"]) {
        exit_default(
            'The "config-precedence" option is not currently supported, please open an issue on GitHub if you need it'
        );
    }
    if (args["file-info"]) {
        exit_default(
