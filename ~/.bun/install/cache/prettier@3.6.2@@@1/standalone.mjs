    ...
    hu = (e, t, r, n) => {
        if ((t && typeof t == "object") || typeof t == "function")
            for (let u of du(t))
                !Eu.call(e, u) &&
                    u !== r &&
                    pt(e, u, { get: () => t[u], enumerable: !(n = pu(t, u)) || n.enumerable });
        return e;
    };
var gu = (e, t, r) => (
    (r = e != null ? Fu(mu(e)) : {}),
    hu(t || !e || !e.__esModule ? pt(r, "default", { value: e, enumerable: !0 }) : r, e)
);
...
var W = "string",
    ...
    S = "label",
    w = "break-parent",
    Ue = new Set([j, N, O, P, B, k, _, v, L, I, g, S, w]);
var Bu = (e, t, r) => {
        if (!(e && t == null))
...
function Ke(e, t, r, n, u, o) {
    ...
    for (; r >= 0; ) {
        ...
        switch (p) {
            ...
            case _: {
                let F =
                    (D.groupId ? u[D.groupId] || H : c) === R ? D.breakContents : D.flatContents;
...
`,
            ...
            case k: {
                ...
                let Be = { ind: l, mode: H, doc: x },
                    lt = { ind: l, mode: R, doc: x };
                if (E === 2) {
                    ue ? i.push(Be, A) : i.push(lt, $);
                    break;
                }
                let lu = C[m + 2],
                    Ft = { ind: l, mode: F, doc: { ...f, [_t]: m + 2 } };
                Ke({ ind: l, mode: H, doc: [h, x, lu] }, [], d, c.length > 0, r, !0)
                    ? i.push(Ft, Be, A)
                    : ue
                      ? i.push(Ft, lt, A)
                      : i.push(Ft, lt, $);
...
function Xe(e, t) {
    ...
    if (!n) return [];
    let s = ((r == null ? void 0 : r(e, t)) ?? [...Ce(e, { getVisitorKeys: J(u) })]).flatMap((a) =>
        n(a) ? [a] : Xe(a, t)
    );
...
function jr(e, t) {
    ...
    for (i = r; i > 0; --i) {
        ...
        if (((a = (s = t.printer).isGap) == null ? void 0 : a.call(s, l, t)) ?? /^[\s(]*$/u.test(l))
            o = t.locStart(c);
        else break;
    }
...
function Hu(e, t) {
    ...
    if ((D = u.isBlockComment) == null ? void 0 : D.call(u, r)) {
        let p = G(o, s(r)) ? (G(o, i(r), { backwards: !0 }) ? z : Me) : " ";
        n.push(p);
    } else n.push(z);
    let c = U(o, T(o, s(r)));
        ...
        if (u.parsers) {
            for (let o of u.parsers)
                if (!n.has(o)) {
                    n.add(o);
                    let i = r.find(
                            (a) => a.parsers && Object.prototype.hasOwnProperty.call(a.parsers, o)
                        ),
                        s = u.name;
...
var an = (e, t, { descriptor: r }) => {
    ...
    return (
        t && n.push(`we now treat it as ${V.blue(typeof t == "string" ? r.key(t) : r.pair(t))}`),
        n.join("; ") + "."
    );
};
                    ...
                    if (d !== !1)
                        if (d === !0)
                            this._hasDeprecationWarned(i) ||
                                this._utils.logger.warn(this._deprecatedHandler(i, f, this._utils));
                        else
    ...
    _applyRequiredCheck(t) {
        for (let r of Object.keys(this._utils.schemas))
            if (this._identifyMissing(r, t) && this._identifyRequired(r))
                throw this._invalidHandler(r, Ze, this._utils);
    }
...
function lo(
    ...
    let s = u
        ...
        c = new Dt(a, { logger: r, unknown: s, descriptor: i }),
        D = r !== !1;
...
function Fo(e, { isCLI: t, FlagSchema: r }) {
    ...
    for (let u of e)
        (n.push(po(u, { isCLI: t, optionInfos: e, FlagSchema: r })),
            u.alias && t && n.push(tt.create({ name: u.alias, sourceName: u.name })));
    return n;
}
...
async function Eo(e, t = {}) {
    ...
    let n = Qe({ plugins: e.plugins, showDeprecated: !0 }).options,
        u = {
            ...Nn,
            ...Object.fromEntries(
    ...
    let c = s.defaultOptions
            ? Object.fromEntries(Object.entries(s.defaultOptions).filter(([, l]) => l !== void 0))
            : {},
        D = { ...u, ...c };
