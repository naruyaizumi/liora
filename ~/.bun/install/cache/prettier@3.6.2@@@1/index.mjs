        ...
        var fillNumbers = (start, end, step = 1, options8 = {}) => {
            ...
            if (options8.toRegex === true) {
                return step > 1
                    ...
                    : toRegex(range, null, { wrap: false, ...options8 });
            }
            return range;
        };
        ...
        var parse7 = (input, options8 = {}) => {
            ...
            while (index < length) {
                ...
                if (value === CHAR_BACKSLASH) {
                    push2({
                        type: "text",
                        value: (options8.keepEscaping ? value : "") + advance(),
                    });
                    continue;
                }
...
var require_picomatch = __commonJS({
    "node_modules/micromatch/node_modules/picomatch/lib/picomatch.js"(exports, module) {
        ...
        var picomatch = (glob, options8, returnState = false) => {
            ...
            const regex = isState
                ? picomatch.compileRe(glob, options8)
                : picomatch.makeRe(glob, options8, false, true);
            ...
            const matcher = (input, returnObject = false) => {
                const { isMatch, match, output } = picomatch.test(input, regex, options8, {
                    glob,
                    posix,
                });
    ...
    "node_modules/fast-glob/out/utils/pattern.js"(exports) {
        ...
        function getPatternParts(pattern, options8) {
            let { parts } = micromatch2.scan(
                pattern,
                Object.assign(Object.assign({}, options8), { parts: true })
            );
            if (parts.length === 0) {
                parts = [pattern];
            }
...
var require_tasks = __commonJS({
    "node_modules/fast-glob/out/managers/tasks.js"(exports) {
        ...
        function convertPatternsToTasks(positive, negative, dynamic) {
            ...
            tasks.push(
                ...convertPatternGroupsToTasks(outsideCurrentDirectoryGroup, negative, dynamic)
            );
            if ("." in insideCurrentDirectoryGroup) {
                ...
                tasks.push(
                    ...convertPatternGroupsToTasks(insideCurrentDirectoryGroup, negative, dynamic)
                );
            }
            return tasks;
        }
        ...
        function readdir(directory, settings, callback) {
            settings.fs.readdir(directory, (readdirError, names) => {
                ...
                const tasks = names.map((name) => {
                    const path14 = common.joinPathSegments(
                        directory,
                        name,
                        settings.pathSegmentSeparator
                    );
        ...
        var ReaderStream = class extends reader_1.default {
            ...
            static(patterns, options8) {
                ...
                stream._write = (index, _enc, done) => {
                    return this._getEntry(filepaths[index], patterns[index], options8)
                        .then((entry) => {
        ...
        var ProviderStream = class extends provider_1.default {
            ...
            read(task) {
                ...
                source2
                    ...
                    .on("data", (entry) => destination.emit("data", options8.transform(entry)))
...
var require_out4 = __commonJS({
    "node_modules/fast-glob/out/index.js"(exports, module) {
        ...
        function assertPatternsInput(input) {
            ...
            const isValidSource = source2.every(
...
var require_re = __commonJS({
    "node_modules/semver/internal/re.js"(exports, module) {
        "use strict";
        var { MAX_SAFE_COMPONENT_LENGTH, MAX_SAFE_BUILD_LENGTH, MAX_LENGTH } = require_constants4();
        ...
        var SemVer = class _SemVer {
            constructor(version, options8) {
                ...
                if (version instanceof _SemVer) {
                    if (
                        version.loose === !!options8.loose &&
                        version.includePrerelease === !!options8.includePrerelease
                    ) {
                        return version;
                    } else {
...
var require_pseudomap = __commonJS({
    "node_modules/pseudomap/pseudomap.js"(exports, module) {
        ...
        function find(data, k) {
            for (
                var i = 0, s = "_" + k, key2 = s;
                hasOwnProperty3.call(data, key2);
                key2 = s + i++
            ) {
                if (same(data[key2].key, k)) return data[key2];
            }
        }
...
var require_lru_cache = __commonJS({
    "node_modules/editorconfig/node_modules/lru-cache/index.js"(exports, module) {
        ...
        var hasSymbol =
            typeof Symbol === "function" && process.env._nodeLRUCacheForceNoSymbol !== "1";
        var makeSymbol;
        if (hasSymbol) {
...
var require_fnmatch = __commonJS({
    "node_modules/editorconfig/src/lib/fnmatch.js"(exports, module) {
        ...
        function braceExpand(pattern, options8) {
            ...
            if (numset) {
                var suf = braceExpand(pattern.substr(numset[0].length), options8),
                    start = +numset[1],
                    end = +numset[2],
                    inc = start > end ? -1 : 1,
                    set = [];
        ...
        function makeRe() {
            ...
            var options8 = this.options;
            var twoStar = options8.noglobstar ? star : options8.dot ? twoStarDot : twoStarNoDot,
                flags = options8.nocase ? "i" : "";
            var re = set
        ...
        Minimatch.prototype.matchOne = function (file, pattern, partial) {
            ...
            for (
                ...
                if (p === GLOBSTAR) {
                    if (options8.debug) console.error("GLOBSTAR", [pattern, p, f]);
                    var fr = fi,
                        pr = pi + 1;
                    if (pr === pl) {
                        if (options8.debug) console.error("** at the end");
                        for (; fi < fl; fi++) {
                            if (
                                file[fi] === "." ||
                                file[fi] === ".." ||
                                (!options8.dot && file[fi].charAt(0) === ".")
                            )
                                return false;
                        }
                        return true;
                    ...
                    WHILE: while (fr < fl) {
                        ...
                        if (this.matchOne(file.slice(fr), pattern.slice(pr), partial)) {
                            ...
                            if (
                                swallowee === "." ||
                                swallowee === ".." ||
                                (!options8.dot && swallowee.charAt(0) === ".")
                            ) {
                                if (options8.debug)
    ...
    "node_modules/@babel/code-frame/lib/index.js"(exports) {
        ...
        var tokenize2;
        {
            ...
            const getTokenType = function (token2, offset, text) {
                if (token2.type === "name") {
                    if (
                        helperValidatorIdentifier.isKeyword(token2.value) ||
                        helperValidatorIdentifier.isStrictReservedWord(token2.value, true) ||
                        sometimesKeywords.has(token2.value)
                    ) {
                        return "keyword";
                    }
                    if (
                        JSX_TAG.test(token2.value) &&
        ...
        function highlight(text) {
            ...
            let highlighted = "";
            for (const { type, value } of tokenize2(text)) {
                if (type in defs) {
                    highlighted += value
                        .split(NEWLINE$1)
    ...
    "node_modules/ignore/index.js"(exports, module) {
        ...
        var Ignore = class {
            ...
            _t(path14, cache3, checkUnignored, slices) {
                ...
                return (cache3[path14] = parent.ignored
                    ? parent
                    : this._rules.test(path14, checkUnignored, MODE_IGNORE));
            }
            ignores(path14) {
        ...
        var isPathValid = (path14) =>
            checkPath(path14 && checkPath.convert(path14), path14, RETURN_FALSE);
        var setupWindows = () => {
            const makePosix = (str) =>
                /^\\\\\?\\/.test(str) || /["<>|\u0000-\u001F]+/u.test(str)
                    ? str
            ...
            checkPath.isNotRelative = (path14) =>
                REGEX_TEST_WINDOWS_PATH_ABSOLUTE.test(path14) || isNotRelative(path14);
        };
        if (
...
var Diff = class {
        ...
        const execEditLength = () => {
            for (
                ...
                if (basePath.oldPos + 1 >= oldLen && newPos + 1 >= newLen) {
                    return (
                        done(this.buildValues(basePath.lastComponent, newTokens, oldTokens)) || true
                    );
                } else {
    ...
    extractCommon(basePath, newTokens, oldTokens, diagonalPath, options8) {
        ...
        while (
            newPos + 1 < newLen &&
            oldPos + 1 < oldLen &&
            this.equals(oldTokens[oldPos + 1], newTokens[newPos + 1], options8)
        ) {
            newPos++;
            oldPos++;
            commonCount++;
    ...
    equals(left, right, options8) {
        if (options8.comparator) {
            ...
            return (
                left === right ||
                (!!options8.ignoreCase && left.toLowerCase() === right.toLowerCase())
            );
        }
    }
    removeEmpty(array2) {
...
function createTwoFilesPatch(
    ...
    if (!(options8 === null || options8 === void 0 ? void 0 : options8.callback)) {
        ...
        structuredPatch(
            ...
            oldHeader,
            newHeader,
            Object.assign(Object.assign({}, options8), {
                callback: (patchObj) => {
                    if (!patchObj) {
                        callback(void 0);
                    } else {
...
var apiDescriptor = {
    ...
    value(value) {
        ...
        return keys.length === 0
            ? "{}"
            : `{ ${keys.map((key2) => `${apiDescriptor.key(key2)}: ${apiDescriptor.value(value[key2])}`).join(", ")} }`;
    },
...
var commonDeprecatedHandler = (keyOrPair, redirectTo, { descriptor }) => {
    ...
    if (redirectTo) {
        messages2.push(
            `we now treat it as ${import_picocolors.default.blue(typeof redirectTo === "string" ? descriptor.key(redirectTo) : descriptor.pair(redirectTo))}`
        );
    }
...
var commonInvalidHandler = (key2, value, utils) => {
    ...
    if (list) {
        descriptions.push(
            [getDescription(key2, value, list.title, utils.descriptor)]
                .concat(
...
function getListDescription({ text, list }, printWidth) {
    ...
    if (list) {
        descriptions.push(
            [`- ${import_picocolors2.default.blue(list.title)}:`]
                .concat(
                    list.values.map((valueDescription) =>
                        getListDescription(
                            valueDescription,
...
var levenUnknownHandler = (key2, value, { descriptor, logger, schemas }) => {
    ...
    const suggestion = Object.keys(schemas)
        .sort()
        .find((knownKey) => leven(key2, knownKey) < 3);
    if (suggestion) {
        messages2.push(
            `Did you mean ${import_picocolors3.default.blue(descriptor.key(suggestion))}?`
        );
    }
...
function normalizeRedirectResult(result, value) {
    const redirect = normalizeForwardResult(
        typeof result === "object" && "redirect" in result ? result.redirect : result,
        value
    );
...
var IntegerSchema = class extends NumberSchema {
    ...
    validate(value, utils) {
        return (
            utils.normalizeValidateResult(super.validate(value, utils), value) === true &&
            isInt(value)
        );
    }
};
...
var Normalizer = class {
    ...
    _applyNormalization(options8, newOptions) {
        ...
        for (const key2 of knownKeys) {
                ...
                if (deprecatedResult === true) {
                    if (!this._hasDeprecationWarned(key2)) {
                        this._utils.logger.warn(
                            this._deprecatedHandler(key2, redirectTo, this._utils)
                        );
                    }
                } else {
            ...
            if ("remain" in redirectResult) {
                ...
                newOptions[key2] =
                    key2 in newOptions
                        ? schema.overlap(newOptions[key2], remainingValue, this._utils)
                        : remainingValue;
    ...
    _partitionOptionKeys(options8) {
        const [knownKeys, unknownKeys] = partition(
            Object.keys(options8).filter((key2) => !this._identifyMissing(key2, options8)),
            (key2) => key2 in this._utils.schemas
        );
...
async function findInDirectory(
    nameOrNames,
    { typeCheck, cwd, allowSymlinks = true, filter: filter2 }
) {
    ...
    for (const name of names) {
        ...
        if (
            ...
            (!filter2 || (await filter2({ name, path: fileOrDirectory, stats })))
        ) {
...
var Searcher = class {
  ...
  */
    constructor(
        nameOrNames,
        { allowSymlinks, filter: filter2, stopDirectory, cache: cache3 } = {}
    ) {
    ...
    */
        ...
        __privateSet(this, _searchWithoutCache, (directory) =>
            this.findInDirectory(nameOrNames, { cwd: directory, filter: filter2, allowSymlinks })
        );
    }
    /**
    ...
    */
    async search(startDirectory, options8) {
        for (const directory of iterate_directory_up_default(
            ...
            const result = await __privateMethod(this, _Searcher_instances, search_fn).call(
                this,
                directory,
                (options8 == null ? void 0 : options8.cache) ?? __privateGet(this, _cache)
            );
            if (result) {
                return result;
            }
...
function loadEditorconfig(file, { shouldCache }) {
    ...
    if (!shouldCache || !editorconfigCache.has(file)) {
        editorconfigCache.set(file, loadEditorconfigInternal(file, { shouldCache }));
    }
...
var _JSONError = class _JSONError extends Error {
    ...
    get message() {
        __privateGet(this, _message) ??
            __privateSet(
                this,
                _message,
                `${addCodePointToUnexpectedToken(__privateGet(this, _jsonParseError).message)}${__privateGet(this, _input) === "" ? " while parsing empty string" : ""}`
            );
        const { codeFrame } = this;
        return `${__privateGet(this, _message)}${this.fileName ? ` in ${this.fileName}` : ""}${
            codeFrame
                ? `
...
`
    ...
    get codeFrame() {
        __privateGet(this, _codeFrame) ??
            __privateSet(
                this,
                _codeFrame,
                __privateMethod(this, _JSONError_instances, getCodeFrame_fn).call(
                    this,
                    /* highlightCode */
                    true
                )
    ...
    get rawCodeFrame() {
        __privateGet(this, _rawCodeFrame) ??
            __privateSet(
                this,
                _rawCodeFrame,
                __privateMethod(this, _JSONError_instances, getCodeFrame_fn).call(
...
var addCodePointToUnexpectedToken = (message) =>
    message.replace(
...
function extractValue(str, ptr, end, depth = -1) {
    ...
    if (c2 === "[" || c2 === "{") {
        let [value, endPtr2] =
            c2 === "[" ? parseArray(str, ptr, depth) : parseInlineTable(str, ptr, depth);
...
function peekTable(key2, table, meta, type) {
    ...
    for (let i = 0; i < key2.length; i++) {
        ...
        if (
            (hasOwn = Object.hasOwn(t, k)) &&
            ((_a = m[k]) == null ? void 0 : _a.t) === 0 &&
            ((_b = m[k]) == null ? void 0 : _b.d)
        ) {
            return null;
        }
        if (!hasOwn) {
...
var loadConfigFromPackageJson = process.versions.bun
...
function formatList(array2, type = "and") {
    return array2.length < 3
        ? array2.join(` ${type} `)
        : `${array2.slice(0, -1).join(", ")}, ${type} ${array2[array2.length - 1]}`;
}
...
var invalidSegmentRegEx =
    /(^|\\|\/)((\.|%2e)(\.|%2e)?|(n|%6e|%4e)(o|%6f|%4f)(d|%64|%44)(e|%65|%45)(_|%5f)(m|%6d|%4d)(o|%6f|%4f)(d|%64|%44)(u|%75|%55)(l|%6c|%4c)(e|%65|%45)(s|%73|%53))?(\\|\/|$)/i;
var deprecatedInvalidSegmentRegEx =
    /(^|\\|\/)((\.|%2e)(\.|%2e)?|(n|%6e|%4e)(o|%6f|%4f)(d|%64|%44)(e|%65|%45)(_|%5f)(m|%6d|%4d)(o|%6f|%4f)(d|%64|%44)(u|%75|%55)(l|%6c|%4c)(e|%65|%45)(s|%73|%53))(\\|\/|$)/i;
...
function defaultResolve(specifier, context = {}) {
    ...
    try {
        parsed = shouldBeTreatedAsRelativeOrAbsolutePath(specifier)
            ? new URL2(specifier, parsedParentURL)
            : new URL2(specifier);
    ...
    if (Array.isArray(merged.plugins)) {
        merged.plugins = merged.plugins.map((value) =>
            typeof value === "string" && value.startsWith(".")
                ? path10.resolve(path10.dirname(result.configFile), value)
                : value
        );
    }
    return merged;
...
async function resolveConfigFile(fileUrlOrPath) {
    const directory = fileUrlOrPath
        ? path10.dirname(path10.resolve(toPath(fileUrlOrPath)))
        : void 0;
...
function pathMatchesGlobs(filePath, patterns, excludedPatterns) {
    ...
    const [withSlashes, withoutSlashes] = partition_default(patternList, (pattern) =>
        pattern.includes("/")
    );
    return (
        import_micromatch.default.isMatch(filePath, withoutSlashes, {
...
function cleanDocFn(doc2) {
    switch (get_doc_type_default(doc2)) {
        ...
        case DOC_TYPE_GROUP:
            ...
            if (
                doc2.contents.type === DOC_TYPE_GROUP &&
                doc2.contents.id === doc2.id &&
                doc2.contents.break === doc2.break &&
                doc2.contents.expandedStates === doc2.expandedStates
            ) {
                return doc2.contents;
            }
            break;
    ...
    function printDoc(doc3, index, parentParts) {
        ...
        if (doc3.type === DOC_TYPE_LINE) {
            const withBreakParent =
                ((_a = parentParts == null ? void 0 : parentParts[index + 1]) == null
                    ? void 0
                    : _a.type) === DOC_TYPE_BREAK_PARENT;
            if (doc3.literal) {
        ...
        if (doc3.type === DOC_TYPE_BREAK_PARENT) {
            const afterHardline =
                ((_b = parentParts == null ? void 0 : parentParts[index - 1]) == null
                    ? void 0
                    : _b.type) === DOC_TYPE_LINE && parentParts[index - 1].hard;
        ...
        if (doc3.type === DOC_TYPE_ALIGN) {
            return doc3.n === Number.NEGATIVE_INFINITY
                ? "dedentToRoot(" + printDoc(doc3.contents) + ")"
                : doc3.n < 0
                  ? "dedent(" + printDoc(doc3.contents) + ")"
                  : doc3.n.type === "root"
                    ? "markAsRoot(" + printDoc(doc3.contents) + ")"
                    : "align(" + JSON.stringify(doc3.n) + ", " + printDoc(doc3.contents) + ")";
        }
        if (doc3.type === DOC_TYPE_IF_BREAK) {
            return (
                "ifBreak(" +
                printDoc(doc3.breakContents) +
                (doc3.flatContents ? ", " + printDoc(doc3.flatContents) : "") +
                (doc3.groupId
                    ? (!doc3.flatContents ? ', ""' : "") +
                      `, { groupId: ${printGroupId(doc3.groupId)} }`
                    : "") +
                ")"
            );
        }
    ...
    while (width >= 0) {
        ...
        switch (docType) {
            ...
            case DOC_TYPE_GROUP: {
                ...
                const contents =
                    doc2.expandedStates && groupMode === MODE_BREAK
                        ? at_default(
                              /* isOptionalObject */
                              false,
                              doc2.expandedStates,
        ...
        switch (get_doc_type_default(doc3)) {
            ...
            case DOC_TYPE_INDENT_IF_BREAK: {
                ...
                if (groupMode === MODE_BREAK) {
                    const breakContents =
                        doc3.type === DOC_TYPE_IF_BREAK
                            ? doc3.breakContents
                            : doc3.negate
                              ? doc3.contents
                              : indent(doc3.contents);
                    if (breakContents) {
...
var AstPath = class {
    ...
    getNode(count = 0) {
        const stackIndex = __privateMethod(this, _AstPath_instances, getNodeStackIndex_fn).call(
            this,
            count
        );
...
var defaultGetVisitorKeys = (node) =>
    Object.keys(node).filter((key2) => !nonTraversableKeys.has(key2));
...
function describeNodeForDebugging(node) {
    ...
    let nodeName = String(
        node.name ||
            ...
            (node.value && (typeof node.value === "object" ? "" : String(node.value))) ||
            node.operator ||
            ""
    );
...
function getSortedChildNodes(node, options8) {
    ...
    const {
        printer: { getCommentChildNodes, canAttachComment, getVisitorKeys: printerGetVisitorKeys },
        locStart,
        locEnd,
    } = options8;
    if (!canAttachComment) {
    ...
    const childNodes = (
        (getCommentChildNodes == null ? void 0 : getCommentChildNodes(node, options8)) ?? [
            ...getChildren(node, {
                getVisitorKeys: create_get_visitor_keys_function_default(printerGetVisitorKeys),
            }),
        ]
    ).flatMap((node2) =>
        canAttachComment(node2) ? [node2] : getSortedChildNodes(node2, options8)
    );
    childNodes.sort(
...
function decorateComment(node, comment, options8, enclosingNode) {
    ...
    if ((enclosingNode == null ? void 0 : enclosingNode.type) === "TemplateLiteral") {
        ...
        if (
            precedingNode &&
            findExpressionIndexForComment(quasis, precedingNode, options8) !== commentIndex
        ) {
            precedingNode = null;
        }
        if (
            followingNode &&
            findExpressionIndexForComment(quasis, followingNode, options8) !== commentIndex
        ) {
            followingNode = null;
        }
    }
...
function isOwnLineComment(text, options8, decoratedComments, commentIndex) {
    ...
    if (precedingNode) {
        for (let index = commentIndex - 1; index >= 0; index--) {
            const { comment: comment2, precedingNode: currentCommentPrecedingNode } =
...
function isEndOfLineComment(text, options8, decoratedComments, commentIndex) {
    ...
    if (followingNode) {
        for (let index = commentIndex + 1; index < decoratedComments.length; index++) {
            const { comment: comment2, followingNode: currentCommentFollowingNode } =
                decoratedComments[index];
            if (
...
function breakTies(tiesToBreak, options8) {
    ...
    for (
        ...
        if (
            ((_b = (_a = options8.printer).isGap) == null ? void 0 : _b.call(_a, gap, options8)) ??
            /^[\s(]*$/u.test(gap)
        ) {
...
function printLeadingComment(path14, options8) {
    ...
    if (isBlock) {
        const lineBreak = has_newline_default(originalText, locEnd(comment))
            ? has_newline_default(originalText, locStart(comment), {
                  backwards: true,
              })
                ? hardline
                : line2
...
function printTrailingComment(path14, options8, previousComment) {
    ...
    const isBlock = (_a = printer.isBlockComment) == null ? void 0 : _a.call(printer, comment);
    if (
        ((previousComment == null ? void 0 : previousComment.hasLineSuffix) &&
            !(previousComment == null ? void 0 : previousComment.isBlock)) ||
        has_newline_default(originalText, locStart(comment), { backwards: true })
    ) {
...
function printCommentsSeparately(path14, options8) {
    ...
    path14.each(() => {
        ...
        if (leading) {
            ...
            printedTrailingComment = printTrailingComment(path14, options8, printedTrailingComment);
...
function ensureAllCommentsPrinted(options8) {
    const { [Symbol.for("comments")]: comments, [Symbol.for("printedComments")]: printedComments } =
        options8;
    for (const comment of comments) {
...
function createPrintPreCheckFunction(options8) {
    ...
    return function (path14) {
        ...
        throw Object.assign(new Error("Calling `print()` on non-node object."), {
            ...
            pathStack:
                path14.stack.length > 5 ? ["...", ...path14.stack.slice(-5)] : [...path14.stack],
        });
    };
}
...
function getSupportInfo({ plugins = [], showDeprecated = false } = {}) {
    ...
    for (const option of normalizeOptionSettings(
        Object.assign(
            {},
            ...plugins.map(({ options: options9 }) => options9),
        ...
        option.pluginDefaults = Object.fromEntries(
            plugins
                .filter((plugin) => {
                    var _a;
                    return (
                        ((_a = plugin.defaultOptions) == null ? void 0 : _a[option.name]) !== void 0
                    );
                })
            ...
            for (const parserName of language.parsers) {
                if (!existingParsers.has(parserName)) {
                    ...
                    const plugin = plugins.find(
                        (plugin2) =>
                            plugin2.parsers &&
                            Object.prototype.hasOwnProperty.call(plugin2.parsers, parserName)
                    );
...
function getLanguageByFileName(languages2, file) {
    ...
    return (
        languages2.find(({ filenames }) =>
            filenames == null ? void 0 : filenames.some((name) => name.toLowerCase() === basename)
        ) ??
        languages2.find(({ extensions }) =>
            extensions == null
                ? void 0
...
function getLanguageByLanguageName(languages2, languageName) {
    ...
    return (
        languages2.find(({ name }) => name.toLowerCase() === languageName) ??
        languages2.find(({ aliases }) =>
            aliases == null ? void 0 : aliases.includes(languageName)
        ) ??
        languages2.find(({ extensions }) =>
            extensions == null ? void 0 : extensions.includes(`.${languageName}`)
        )
    );
}
function getLanguageByInterpreter(languages2, file) {
    ...
    const languagesWithInterpreters = languages2.filter(({ interpreters }) =>
...
function getLanguageByIsSupported(languages2, file) {
    ...
    return languages2.find(({ isSupported }) =>
        isSupported == null ? void 0 : isSupported({ filepath: file })
    );
}
function inferParser(options8, fileInfo) {
    ...
    const language =
        getLanguageByLanguageName(languages2, fileInfo.language) ??
        getLanguageByFileName(languages2, fileInfo.physicalFile) ??
        getLanguageByFileName(languages2, fileInfo.file) ??
        getLanguageByIsSupported(languages2, fileInfo.physicalFile) ??
        getLanguageByIsSupported(languages2, fileInfo.file) ??
        getLanguageByInterpreter(languages2, fileInfo.physicalFile);
...
function normalizeOptions(
    options8,
    optionInfos,
    { logger = false, isCLI = false, passThrough = false, FlagSchema, descriptor } = {}
) {
    if (isCLI) {
        if (!FlagSchema) {
    ...
    const unknown = !passThrough
        ...
        : Array.isArray(passThrough)
          ? (key2, value) => (!passThrough.includes(key2) ? void 0 : { [key2]: value })
...
function optionInfoToSchema(optionInfo, { isCLI, optionInfos, FlagSchema }) {
    ...
    switch (optionInfo.type) {
        ...
        case "choice":
            ...
            parameters.choices = optionInfo.choices.map((choiceInfo) =>
                (choiceInfo == null ? void 0 : choiceInfo.redirect)
                    ? {
                          ...choiceInfo,
                          redirect: {
    ...
    if (optionInfo.exception) {
        ...
        parameters.validate = (value, schema, utils) =>
            value === void 0 || schema.validate(value, utils);
    }
...
function getParserPluginByParserName(plugins, parserName) {
    ...
    const plugin = array_find_last_default(
        ...
        plugins,
        (plugin2) =>
            plugin2.parsers && Object.prototype.hasOwnProperty.call(plugin2.parsers, parserName)
    );
    if (plugin) {
        return plugin;
    }
...
function getPrinterPluginByAstFormat(plugins, astFormat) {
    ...
    const plugin = array_find_last_default(
        ...
        plugins,
        (plugin2) =>
            plugin2.printers && Object.prototype.hasOwnProperty.call(plugin2.printers, astFormat)
    );
    if (plugin) {
        return plugin;
    }
...
async function normalizeFormatOptions(options8, opts = {}) {
    ...
    const defaults = {
        ...
        ...Object.fromEntries(
            supportOptions
                .filter((optionInfo) => optionInfo.default !== void 0)
    ...
    const printerPlugin = ((_a = parserPlugin.printers) == null ? void 0 : _a[parser.astFormat])
        ? parserPlugin
    ...
    const pluginDefaults = printerPlugin.defaultOptions
        ? Object.fromEntries(
              Object.entries(printerPlugin.defaultOptions).filter(([, value]) => value !== void 0)
          )
        : {};
...
function handleParseError(error, text) {
    const { loc } = error;
    if (loc) {
        const codeFrame = (0, import_code_frame2.codeFrameColumns)(text, loc, {
            highlightCode: true,
        });
        error.message += "\n" + codeFrame;
...
async function printEmbeddedLanguages(path14, genericPrint, options8, printAstToDoc2, embeds) {
    const {
        embeddedLanguageFormatting,
        printer: { embed, hasPrettierIgnore = () => false, getVisitorKeys: printerGetVisitorKeys },
    } = options8;
...
async function printAstToDoc(ast, options8) {
    ...
    const doc2 = await callPluginPrintFunction(path14, options8, mainPrint, void 0, embeds);
...
function callPluginPrintFunction(path14, options8, printPath, args, embeds) {
    ...
    if (
        ...
        (!printer.willPrintOwnComments || !printer.willPrintOwnComments(path14, options8))
    ) {
...
function getCursorLocation(ast, options8) {
    ...
    while (
        ...
        (nodeBeforeCursor === void 0 || nodeAfterCursor === void 0)
    ) {
...
function massageAst(ast, options8) {
    const {
        printer: { massageAstNode: cleanFunction, getVisitorKeys: printerGetVisitorKeys },
    } = options8;
    if (!cleanFunction) {
        return ast;
    }
    ...
    function recurse(original, parent) {
        ...
        for (const key2 in original) {
            if (
                !Object.prototype.hasOwnProperty.call(original, key2) ||
                ignoredProperties.has(key2)
            ) {
                continue;
            }
...
function normalizeInputAndOptions(text, options8) {
    let { cursorOffset, rangeStart, rangeEnd, endOfLine } = normalizeIndexes(text, options8);
...
async function formatWithCursor(originalText, originalOptions) {
    ...
    if (
        (options8.rangeStart >= options8.rangeEnd && text !== "") ||
        (options8.requirePragma && !(await hasPragma(text, options8))) ||
        (options8.checkIgnorePragma && (await hasIgnorePragma(text, options8)))
    ) {
        return {
    ...
    if (options8.rangeStart > 0 || options8.rangeEnd < text.length) {
        ...
        if (
            !options8.requirePragma &&
            options8.insertPragma &&
            options8.printer.insertPragma &&
            !(await hasPragma(text, options8))
        ) {
...
async function getParser(file, options8) {
    ...
    plugins = (
        await Promise.all([load_builtin_plugins_default(), load_plugins_default(plugins)])
    ).flat();
...
var inferParser2 = withPlugins((file, options8) =>
    infer_parser_default(options8, { physicalFile: file })
);
var sharedWithCli = {
    ...
    inferParser: (file, options8) =>
        Promise.resolve(
            (options8 == null ? void 0 : options8.parser) ?? inferParser2(file, options8)
        ),
    vnopts: {
        ChoiceSchema,
        apiDescriptor,
