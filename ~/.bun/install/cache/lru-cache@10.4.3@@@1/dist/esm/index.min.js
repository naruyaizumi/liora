...
var I = (l, t, e) => (
  ...
  x = (l, t, e, i) => (
    G(l, t, 'write to private field'),
    i ? i.call(l, e) : t.set(l, e),
    e
  )
var T =
  ...
  H = (l, t, e, i) => {
    typeof M.emitWarning == 'function'
      ? M.emitWarning(l, t, e, i)
      : console.error(`[${e}] ${t}: ${l}`)
  },
  W = globalThis.AbortController,
  N = globalThis.AbortSignal
if (typeof W > 'u') {
  ;((N = class {
    onabort
    _onabort = []
  ...
  let l = M.env?.LRU_CACHE_IGNORE_AC_WARNING !== '1',
    t = () => {
      l &&
        ((l = !1),
        H(
...
var V = l => !P.has(l),
  Y = Symbol('type'),
  A = l => l && l === Math.floor(l) && l > 0 && isFinite(l),
  k = l =>
    A(l)
      ? l <= Math.pow(2, 8)
        ? Uint8Array
...
var D = class {
  ...
  constructor(t) {
    ...
    let y = e ? k(e) : Array
    if (!y) throw new Error('invalid max value: ' + e)
    if (
      ((this.#g = e),
      (this.#f = c),
      (this.maxEntrySize = F || this.#f),
    ...
    if (((this.#W = a), S !== void 0 && typeof S != 'function'))
      throw new TypeError(
    ...
    if (this.#g === 0 && this.ttl === 0 && this.#f === 0)
      throw new TypeError(
        'At least one of max, maxSize, or ttl is required',
      )
    if (!this.ttlAutopurge && !this.#g && !this.#f) {
      let C = 'LRU_CACHE_UNBOUNDED'
      V(C) &&
        (P.add(C),
        H(
    ...
    ;((this.#u = t),
      ...
      (this.#U = (n, h, o = T.now()) => {
        if (
          ...
          let r = setTimeout(() => {
            this.#d(n) && this.#T(this.#i[n], 'expire')
          }, h + 1)
          r.unref && r.unref()
        }
      }),
  ...
  *rvalues() {
  ...
  purgeStale() {
    ...
    for (let e of this.#F({ allowStale: !0 }))
      this.#d(e) && (this.#T(this.#i[e], 'expire'), (t = !0))
    return t
  }
  info(t) {
    let e = this.#s.get(t)
  ...
  set(t, e, i = {}) {
      ...
      if (e !== u) {
        if (this.#O && this.#e(u)) {
          ...
          c !== void 0 &&
            ...
            this.#a && this.#r?.push([c, t, 'set']))
        } else
          h ||
            (this.#y && this.#p?.(u, t, 'set'),
            this.#a && this.#r?.push([u, t, 'set']))
        if ((this.#v(f), this.#D(f, m, r), (this.#t[f] = e), r)) {
          r.set = 'replace'
    ...
    if (
      (s !== 0 && !this.#u && this.#M(),
      this.#u && (g || this.#U(f, s, n), r && this.#E(r, f)),
      !h && this.#a && this.#r)
    ) {
      let u = this.#r,
        c
  ...
  has(t, e = {}) {
    ...
    if (n !== void 0) {
      ...
      if (this.#d(n)) s && ((s.has = 'stale'), this.#E(s, n))
      else
        return (
          i && this.#z(n),
    ...
    let r = { signal: h.signal, options: i, context: s },
      ...
      f = d => {
        let { aborted: S } = h.signal,
          a = S && i.allowStaleOnFetchAbort,
          w = a || i.allowStaleOnFetchRejection,
          b = w || i.noDeleteOnFetchRejection,
          p = c
        if (
          (this.#t[e] === c &&
            (!b || p.__staleWhileFetching === void 0
              ? this.#T(t, 'fetch')
              : a || (this.#t[e] = p.__staleWhileFetching)),
          w)
        )
          return (
            i.status &&
      ...
      u = (d, S) => {
        ...
        ;(a &&
          ...
          a.then(w => d(w === void 0 ? void 0 : w), S),
          h.signal.addEventListener('abort', () => {
            ;(!i.ignoreFetchAbort || i.allowStaleOnFetchAbort) &&
              (d(void 0),
              i.allowStaleOnFetchAbort && (d = w => g(w, !0)))
          }))
      }
    i.status && (i.status.fetchDispatched = !0)
    let c = new Promise(u).then(g, m),
      F = Object.assign(c, {
        __abortController: h,
  ...
  #e(t) {
    ...
    return (
      ...
      e.__abortController instanceof W
    )
  }
  async fetch(t, e = {}) {
    let {
    ...
    if (p === void 0) {
      a && (a.fetch = 'miss')
      let _ = this.#x(t, p, b, d)
      return (_.__returned = _)
    } else {
      let _ = this.#t[p]
      if (this.#e(_)) {
        let U = i && _.__staleWhileFetching !== void 0
        return (
          a && ((a.fetch = 'inflight'), U && (a.returnedStale = !0)),
          U ? _.__staleWhileFetching : (_.__returned = _)
        )
      }
      let v = this.#d(p)
      if (!S && !v)
      ...
      let y = this.#x(t, p, b, d),
        L = y.__staleWhileFetching !== void 0 && i
      return (
        a &&
          ((a.fetch = v ? 'stale' : 'refresh'),
          L && v && (a.returnedStale = !0)),
        L ? y.__staleWhileFetching : (y.__returned = y)
      )
    }
  }
        ...
        this.#d(o)
          ...
          : (h && (h.get = 'hit'),
            g
              ...
              : (this.#C(o), s && this.#z(o), r))
      )
    } else h && (h.get = 'miss')
  }
  #j(t, e) {
    ;((this.#c[e] = t), (this.#l[t] = e))
  }
  #C(t) {
    t !== this.#h &&
      (t === this.#o
        ? (this.#o = this.#l[t])
        : this.#j(this.#c[t], this.#l[t]),
      this.#j(this.#h, t),
      (this.#h = t))
  }
  delete(t) {
      ...
      if (s !== void 0)
        if (((i = !0), this.#n === 1)) this.#N(e)
          ...
          if (
            ...
            this.#h = this.#c[s]
          else if (s === this.#o) this.#o = this.#l[s]
          else {
            let h = this.#c[s]
            this.#l[h] = this.#l[s]
            let o = this.#l[s]
  ...
  #N(t) {
    ...
    if (
      ...
      this.#t.fill(void 0),
      this.#i.fill(void 0),
      this.#u && this.#b && (this.#u.fill(0), this.#b.fill(0)),
