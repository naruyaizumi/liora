...
export declare namespace LRUCache {
   ...
   */
  interface FetchOptionsWithContext<K, V, FC>
   ...
   * `undefined` or `void`
   */
  interface FetchOptionsNoContext<K, V>
    extends FetchOptions<K, V, undefined> {
    context?: undefined
  }
  interface MemoOptions<K, V, FC = unknown>
    extends Pick<
      OptionsBase<K, V, FC>,
      | 'allowStale'
      | 'updateAgeOnGet'
   ...
   * other than `unknown`, `undefined`, or `void`
   */
  interface MemoOptionsWithContext<K, V, FC>
   ...
   * `undefined` or `void`
   */
  interface MemoOptionsNoContext<K, V>
   ...
   */
  interface MemoizerMemoOptions<K, V, FC = unknown>
    extends Pick<
      OptionsBase<K, V, FC>,
      | 'allowStale'
      | 'updateAgeOnGet'
...
> implements Map<K, V>
{
  ...
  peek(
    k: K,
    peekOptions?: LRUCache.PeekOptions<K, V, FC>,
  ): V | undefined
  /**
