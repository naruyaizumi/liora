...
!(function (e, t) {
    ...
    var ue = {
        ...
        TAG: function (e, t, n) {
            ...
            (2 !== n.length && ce(e, "TAG directive accepts exactly two arguments"),
                ...
                P.call(e.tagMap, i) &&
                    ce(e, 'there is a previously declared suffix for "' + i + '" tag handle'),
    ...
    function fe(e, t, i, r) {
        ...
        for (
            n.isObject(i) ||
                ce(e, "cannot merge mappings; the provided source object is unacceptable"),
                l = 0,
            ...
            for (s = 0, u = (r = Array.prototype.slice.call(r)).length; s < u; s += 1)
                (Array.isArray(r[s]) && ce(e, "nested arrays are not supported inside keys"),
                    "object" == typeof r &&
                        ...
                        (r[s] = "[object Object]"));
        if (
            ("object" == typeof r && "[object Object]" === Z(r) && (r = "[object Object]"),
            (r = String(r)),
            null === t && (t = {}),
            "tag:yaml.org,2002:merge" === i)
        )
            if (Array.isArray(o)) for (s = 0, u = o.length; s < u; s += 1) fe(e, t, o[s], n);
            else fe(e, t, o, n);
        else
            (e.json ||
                P.call(n, r) ||
    ...
    function ve(e) {
        ...
        for (
            ...
            n = e.input.charCodeAt(++e.position);
        return (
            e.position === t && ce(e, "name of an anchor node must contain at least one character"),
    ...
    function we(e, t, i, r, o) {
        ...
        if (
                    ...
                    ? (c &&
                      ...
                      (function (e, t) {
                          ...
                          for (
                              ...
                              (h
                                  ? 44 === d && ce(e, "expected the node content, but found ','")
            ...
            if (P.call(e.typeMap[e.kind || "fallback"], e.tag))
                ...
                for (
                    f = null, s = 0, u = (p = e.typeMap.multi[e.kind || "fallback"]).length;
                    s < u;
                    s += 1
                )
    ...
    function ke(e) {
        ...
        for (
            ...
            (ge(e, !0, -1), (r = e.input.charCodeAt(e.position)), !(e.lineIndent > 0 || 37 !== r));
            ...
            for (
                i = [],
                    (n = e.input.slice(t, e.position)).length < 1 &&
                        ce(e, "directive name must not be less than one character in length");
                0 !== r;
        ...
        (ge(e, !0, -1),
            ...
            e.position === e.lineStart && me(e)
                ? 46 === e.input.charCodeAt(e.position) && ((e.position += 3), ge(e, !0, -1))
    ...
    function Ce(e, t) {
        ...
        var n = new ae(e, t),
            i = e.indexOf("\0");
        for (
            -1 !== i && ((n.position = i), ce(n, "null byte is not allowed in input")),
                n.input += "\0";
    ...
    function Je(e, t, n) {
        ...
        if (null !== e && "object" == typeof e)
            ...
            else for (r = 0, o = (i = Object.keys(e)).length; r < o; r += 1) Je(e[i[r]], t, n);
    }
    function Qe(e, t) {
        return function () {
            throw new Error(
