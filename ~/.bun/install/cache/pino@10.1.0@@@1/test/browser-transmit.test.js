...
test("passes send function message strings in logEvent object when asObject is not set", ({
    end,
    same,
    is,
}) => {
...
test("passes send function message objects in logEvent object when asObject is not set", ({
    end,
    same,
    is,
}) => {
...
test("passes send function message strings in logEvent object when asObject is set", ({
    end,
    same,
    is,
}) => {
...
test("passes send function message objects in logEvent object when asObject is set", ({
    end,
    same,
    is,
}) => {
...
test("supplies a timestamp (ts) in logEvent object which is exactly the same as the `time` property in asObject mode", ({
    end,
    is,
}) => {
    let expected;
...
test("applies all serializers to messages and bindings (serialize:false - default)", ({
    end,
    same,
    is,
}) => {
