 ...
 */
export function boomify<Data, Decoration>(
    err: Error,
    options?: Options<Data> & Decorate<Decoration>
): Boom<Data> & Decoration;
...
export function unauthorized<Data>(
    message: "" | null,
    scheme: string,
    attributes?: string | unauthorized.Attributes
): Boom<Data> & unauthorized.MissingAuth;
export function unauthorized<Data>(
    message: string | null,
    scheme: string,
    attributes?: string | unauthorized.Attributes
 ...
 * @returns A 405 Method Not Allowed error
 */
export function methodNotAllowed<Data>(
    message?: string,
    data?: Data,
    allow?: string | string[]
): Boom<Data>;
